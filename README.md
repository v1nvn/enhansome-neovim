...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 20,591 | 🐛 57 | 🌐 Lua | 📅 2025-12-17 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [nvim-mini/mini.nvim#mini.deps](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.
...
* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,468 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Quickstart configurations for the LSP client.
...
* [stevearc/aerial.nvim](https://github.com/stevearc/aerial.nvim) ⭐ 2,253 | 🐛 72 | 🌐 Lua | 📅 2026-02-25 - A code outline window for skimming and quick navigation.
...
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 982 | 🐛 11 | 🌐 Lua | 📅 2026-03-26 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,694 | 🐛 116 | 🌐 JavaScript | 📅 2026-03-28 catalog.
...
* [tamago324/nlsp-settings.nvim](https://github.com/tamago324/nlsp-settings.nvim) ⭐ 334 | 🐛 10 | 🌐 Lua | 📅 2026-03-25 - Setup LSP with JSON or YAML files.
...
* [nvimtools/none-ls.nvim](https://github.com/nvimtools/none-ls.nvim) ⭐ 3,225 | 🐛 9 | 🌐 Lua | 📅 2026-03-10 - Null-ls.nvim reloaded / Use Neovim as a language server to inject LSP diagnostics, code actions, and more via Lua.
...
* [jmbuhr/otter.nvim](https://github.com/jmbuhr/otter.nvim) ⭐ 865 | 🐛 17 | 🌐 Lua | 📅 2026-03-27 - Provides LSP features and a nvim-cmp completion source for languages embedded in other documents.
* [mrcjkb/haskell-tools.nvim](https://github.com/mrcjkb/haskell-tools.nvim) ⭐ 582 | 🐛 22 | 🌐 Lua | 📅 2026-03-25 - Seamless integration for Haskell development tools like `haskell-language-server` and Hoogle.
...
* [linrongbin16/lsp-progress.nvim](https://github.com/linrongbin16/lsp-progress.nvim) ⭐ 232 | 🐛 0 | 🌐 Lua | 📅 2026-02-02 - A performant LSP progress status.
...
* [mason-org/mason.nvim](https://github.com/mason-org/mason.nvim) ⭐ 10,140 | 🐛 269 | 🌐 Lua | 📅 2026-01-07 - Portable package manager that runs everywhere Neovim runs. Easily install and manage LSP servers, DAP servers, linters, and formatters.

### Diagnostics

* [folke/trouble.nvim](https://github.com/folke/trouble.nvim) ⭐ 6,724 | 🐛 20 | 🌐 Lua | 📅 2025-10-31 - A pretty diagnostics list to help you solve all the trouble your code is causing.
...
* [hrsh7th/nvim-cmp](https://github.com/hrsh7th/nvim-cmp) ⭐ 9,373 | 🐛 298 | 🌐 Lua | 📅 2026-03-25 - Completion engine written in Lua, successor of `nvim-compe`.
  ...
  * [hrsh7th/cmp-nvim-lsp-signature-help](https://github.com/hrsh7th/cmp-nvim-lsp-signature-help) ⭐ 677 | 🐛 29 | 🌐 Lua | 📅 2025-11-14 - `nvim-cmp` source for displaying function signatures from an LSP client.
...
* [nvim-mini/mini.nvim#mini.completion](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 6,075 | 🐛 100 | 🌐 Lua | 📅 2026-03-27 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [mikavilpas/blink-ripgrep.nvim](https://github.com/mikavilpas/blink-ripgrep.nvim) ⭐ 112 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-28 - `blink.cmp` source for `ripgrep` / `git grep`.
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 10 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 43,626 | 🐛 65 | 🌐 C | 📅 2026-03-27.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 4,025 | 🐛 14 | 🌐 Lua | 📅 2026-03-28 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,490 | 🐛 50 | 🌐 Vim Script | 📅 2026-01-09.
...
* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 17,657 | 🐛 73 | 🌐 Lua | 📅 2026-03-20 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,361 | 🐛 25 | 🌐 Lua | 📅 2026-03-27 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
* [jackMort/ChatGPT.nvim](https://github.com/jackMort/ChatGPT.nvim) ⭐ 4,012 | 🐛 111 | 🌐 Lua | 📅 2026-01-13 - Effortless Natural Language Generation with OpenAI's ChatGPT API.
...
* [nickjvandyke/opencode.nvim](https://github.com/nickjvandyke/opencode.nvim) ⭐ 2,989 | 🐛 9 | 🌐 Lua | 📅 2026-03-24 - OpenCode AI assistant integration.
...
* [Kurama622/llm.nvim](https://github.com/Kurama622/llm.nvim) ⭐ 464 | 🐛 1 | 🌐 Lua | 📅 2026-03-12 - Free large language model (LLM) support, provides commands to interact with LLM.
* [dlants/magenta.nvim](https://github.com/dlants/magenta.nvim) ⭐ 431 | 🐛 22 | 🌐 TypeScript | 📅 2026-03-28 - Leverage coding assistants for chat and code generation. Provides tools for the AI/LLM agent to explore and edit your code, like Aider, Cursor and Windsurf.
...
* [carlos-algms/agentic.nvim](https://github.com/carlos-algms/agentic.nvim) ⭐ 347 | 🐛 14 | 🌐 Lua | 📅 2026-03-24 - Chat interface for AI ACP providers such as Claude, Gemini, Codex, OpenCode and Cursor.
...
* [wsdjeg/chat.nvim](https://github.com/wsdjeg/chat.nvim) ⭐ 25 | 🐛 1 | 🌐 Lua | 📅 2026-03-28 - A lightweight, extensible chat plugin with AI integration, multiple providers, and built-in tools.
...
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 8 | 🐛 4 | 🌐 Lua | 📅 2025-12-31 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 11,461 | 🐛 572 | 🌐 Python | 📅 2026-03-17 tool.
...
* [nvim-java/nvim-java](https://github.com/nvim-java/nvim-java) ⭐ 1,600 | 🐛 34 | 🌐 Lua | 📅 2026-02-05 - Everything you need for a painless Java experience.
* [nvim-flutter/flutter-tools.nvim](https://github.com/nvim-flutter/flutter-tools.nvim) ⭐ 1,373 | 🐛 33 | 🌐 Lua | 📅 2026-01-14 - Build Flutter and Dart applications using the native LSP.
...
* [Julian/lean.nvim](https://github.com/Julian/lean.nvim) ⭐ 499 | 🐛 38 | 🌐 Lua | 📅 2026-03-27 - Support for the [Lean Theorem Prover](https://leanprover.github.io/).
...
* [ray-x/go.nvim](https://github.com/ray-x/go.nvim) ⭐ 2,615 | 🐛 96 | 🌐 Lua | 📅 2026-03-22 - Golang plugin based on LSP and Tree-sitter.
* [olexsmir/gopher.nvim](https://github.com/olexsmir/gopher.nvim/) ⭐ 419 | 🐛 6 | 🌐 Lua | 📅 2026-03-04 - Plugin for making Golang development easiest.
...
* [mistweaverco/kulala.nvim](https://github.com/mistweaverco/kulala.nvim) ⭐ 1,938 | 🐛 16 | 🌐 Lua | 📅 2026-03-16 - A minimal HTTP-client interface.
...
* [mawkler/jsx-element.nvim](https://github.com/mawkler/jsx-element.nvim) ⭐ 26 | 🐛 1 | 🌐 Lua | 📅 2025-03-14 - JSX/TSX text-objects and motions.
...
* [ankushbhagats/liveserver.nvim](https://github.com/ankushbhagats/liveserver.nvim) ⭐ 10 | 🐛 0 | 🌐 Lua | 📅 2026-03-23 - Live-server integration with smart commands and a clickable lualine toggle.
...
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 4,318 | 🐛 8 | 🌐 Lua | 📅 2026-03-09 - Improve viewing Markdown files directly.
...
* [Thiago4532/mdmath.nvim](https://github.com/Thiago4532/mdmath.nvim) ⭐ 211 | 🐛 14 | 🌐 Lua | 📅 2024-12-27 - A Markdown equation previewer, using kitty Graphics Protocol.
...
* [gbprod/phpactor.nvim](https://github.com/gbprod/phpactor.nvim) ⭐ 94 | 🐛 2 | 🌐 Lua | 📅 2026-01-07 - Lua version of [phpactor](https://github.com/phpactor/phpactor) ⭐ 1,839 | 🐛 298 | 🌐 PHP | 📅 2026-03-25.
...
* [nvim-treesitter/nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter) ⭐ 13,431 | 🐛 271 | 🌐 Tree-sitter Query | 📅 2026-03-27 - Tree-sitter configurations and abstraction layer.
* [nvim-mini/mini.nvim#mini.surround](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-surround.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for working with text surroundings (add, delete, replace, find, highlight). Supports dot-repeat, different search methods, "last"/"next" extended mappings, Tree-sitter integration, and more.
* [kylechui/nvim-surround](https://github.com/kylechui/nvim-surround) ⭐ 4,150 | 🐛 8 | 🌐 Lua | 📅 2026-03-07 - A plugin for adding/changing/deleting surrounding delimiter pairs.
...
* [IndianBoy42/tree-sitter-just](https://github.com/IndianBoy42/tree-sitter-just) ⭐ 184 | 🐛 5 | 🌐 Just | 📅 2026-03-25 - Tree-sitter grammar for [Justfiles](https://github.com/casey/just) ⭐ 32,421 | 🐛 337 | 🌐 Rust | 📅 2026-03-28.
...
* [nvim-mini/mini.nvim#mini.snippets](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.
* [L3MON4D3/LuaSnip](https://github.com/L3MON4D3/LuaSnip) ⭐ 4,312 | 🐛 131 | 🌐 Lua | 📅 2026-03-21 - A snippet engine written in Lua.
* [rafamadriz/friendly-snippets](https://github.com/rafamadriz/friendly-snippets) ⭐ 2,676 | 🐛 69 | 🌐 Lua | 📅 2026-01-23 - Set of preconfigured snippets for different languages.
...
* [ThePrimeagen/harpoon](https://github.com/ThePrimeagen/harpoon/tree/harpoon2) ⭐ 8,972 | 🐛 149 | 🌐 Lua | 📅 2025-10-31 - A per project, auto updating and editable marks utility for fast file navigation.
...
* [MagicDuck/grug-far.nvim](https://github.com/MagicDuck/grug-far.nvim) ⭐ 1,839 | 🐛 4 | 🌐 Lua | 📅 2026-03-25 - Buffer-based live search and replace with full power of `rg` flags. Grug like!
...
* [nvim-telescope/telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) ⭐ 19,229 | 🐛 491 | 🌐 Lua | 📅 2026-03-26 - Telescope.nvim is a highly [extendable](https://github.com/nvim-telescope/telescope.nvim/wiki/Extensions) ⭐ 19,229 | 🐛 491 | 🌐 Lua | 📅 2026-03-26 A highly extensible fuzzy finder over lists.
* [nvim-mini/mini.nvim#mini.fuzzy](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
* [nvim-mini/mini.nvim#mini.pick](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
* [nvim-mini/mini.nvim#mini.extra](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.
* [folke/snacks.nvim#picker](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) ⭐ 7,312 | 🐛 103 | 🌐 Lua | 📅 2026-03-21 - A modern fuzzy-finder to navigate the Neovim universe.
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,149 | 🐛 8 | 🌐 Lua | 📅 2026-03-28 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,699 | 🐛 26 | 🌐 Rust | 📅 2026-03-26 as its fzf binary.
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 2,043 | 🐛 43 | 🌐 Rust | 📅 2026-03-27 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 367 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 34,969 | 🐛 157 | 🌐 Rust | 📅 2026-03-23, a smart directory picker that tracks your usage.
...
* [crispgm/telescope-heading.nvim](https://github.com/crispgm/telescope-heading.nvim) ⭐ 140 | 🐛 5 | 🌐 Lua | 📅 2026-03-18 - Telescope extension to switch between headings of AsciiDoc, Markdown, Vimdoc, etc.
...
* [nvim-mini/mini.nvim#mini.files](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.
* [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) ⭐ 8,440 | 🐛 97 | 🌐 Lua | 📅 2026-03-28 - A simple and fast file explorer tree.
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,378 | 🐛 128 | 🌐 Lua | 📅 2026-02-24 - Edit your filesystem like a buffer.
* [nvim-neo-tree/neo-tree.nvim](https://github.com/nvim-neo-tree/neo-tree.nvim) ⭐ 5,322 | 🐛 168 | 🌐 Lua | 📅 2026-03-28 - Browse the file system and other tree-like structures in whatever style suits you, including sidebars, floating windows, `netrw` split style, or all of them at once.
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,687 | 🐛 93 | 🌐 Python | 📅 2026-03-28 - File manager. Better than NERDTree.
* [mikavilpas/yazi.nvim](https://github.com/mikavilpas/yazi.nvim) ⭐ 1,616 | 🐛 7 | 🌐 Lua | 📅 2026-03-27 - Integration with the Yazi terminal file manager.
* [kevinhwang91/rnvimr](https://github.com/kevinhwang91/rnvimr) ⭐ 842 | 🐛 10 | 🌐 Python | 📅 2026-01-11 - A simple yet amazing file explorer.
* [A7Lavinraj/fyler.nvim](https://github.com/A7Lavinraj/fyler.nvim) ⭐ 677 | 🐛 21 | 🌐 Lua | 📅 2026-03-19 - File manager which can edit file system like a buffer with tree view.
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 458 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,430 | 🐛 2 | 🌐 C | 📅 2026-03-28 and Lua.
...
* [kelly-lin/ranger.nvim](https://github.com/kelly-lin/ranger.nvim) ⭐ 181 | 🐛 11 | 🌐 Lua | 📅 2024-11-18 - [Ranger](https://github.com/ranger/ranger) ⭐ 17,089 | 🐛 935 | 🌐 Python | 📅 2026-02-25 integration.
* [Xuyuanp/yanil](https://github.com/Xuyuanp/yanil) ⭐ 98 | 🐛 5 | 🌐 Lua | 📅 2026-01-15 - Yet Another Nerdtree In Lua.
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 98 | 🐛 2 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 35,432 | 🐛 62 | 🌐 Rust | 📅 2026-03-26).
...
* [nvim-mini/mini.nvim#mini.visits](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.
...
* [mrjones2014/codesettings.nvim](https://github.com/mrjones2014/codesettings.nvim) ⭐ 63 | 🐛 2 | 🌐 Lua | 📅 2026-03-28 - Easily load project-local settings (like `.vscode/settings.json`) into Neovim 0.11+ native LSP settings.
...
* [francescarpi/buffon.nvim](https://github.com/francescarpi/buffon.nvim) ⭐ 30 | 🐛 6 | 🌐 Lua | 📅 2025-08-19 - Buffers navigation, reorganize and close.
...
* [nvim-mini/mini.nvim#mini.hipatterns](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.
...
* [catgoose/nvim-colorizer.lua](https://github.com/catgoose/nvim-colorizer.lua) ⭐ 1,018 | 🐛 1 | 🌐 Lua | 📅 2026-03-27 - A high-performance color highlighter which has no external dependencies.
...
* [xzbdmw/colorful-menu.nvim](https://github.com/xzbdmw/colorful-menu.nvim) ⭐ 460 | 🐛 3 | 🌐 Lua | 📅 2025-11-25 - Colorize your auto completion menu using Tree-sitter.
...
* [folke/tokyonight.nvim](https://github.com/folke/tokyonight.nvim) ⭐ 7,926 | 🐛 11 | 🌐 Lua | 📅 2026-03-24 - ***`[TS][LSP][L/D][Lua]`*** A clean, dark and light theme written in Lua, with support for LSP, Tree-sitter and lots of plugins.
* [sainnhe/everforest](https://github.com/sainnhe/everforest) ⭐ 3,917 | 🐛 7 | 🌐 Vim Script | 📅 2026-01-21 - ***`[TS][LSP][L/D]`*** A green based colorscheme designed to be warm, soft and easy on the eyes.
* [sainnhe/gruvbox-material](https://github.com/sainnhe/gruvbox-material) ⭐ 2,515 | 🐛 8 | 🌐 Vim Script | 📅 2026-01-21 - ***`[TS][LSP]`*** Gruvbox modification with softer contrast and Tree-sitter support.
* [projekt0n/github-nvim-theme](https://github.com/projekt0n/github-nvim-theme) ⭐ 2,440 | 🐛 28 | 🌐 Lua | 📅 2024-12-31 - ***`[TS][LSP][L/D][Lua]`*** A GitHub theme, kitty, alacritty written in Lua. Support built-in LSP and Tree-sitter.
* [navarasu/onedark.nvim](https://github.com/navarasu/onedark.nvim) ⭐ 1,941 | 🐛 54 | 🌐 Lua | 📅 2025-11-24 - ***`[TS][LSP][Lua]`*** A One Dark Theme written in Lua based on Atom's One Dark Theme.
...
* [dracula/vim](https://github.com/dracula/vim) ⭐ 1,381 | 🐛 10 | 🌐 Vim Script | 📅 2026-03-16 - ***`[TS][LSP]`*** Famous beautiful dark powered theme.
...
* [neanias/everforest-nvim](https://github.com/neanias/everforest-nvim) ⭐ 428 | 🐛 7 | 🌐 Lua | 📅 2026-03-08 - ***`[TS][LSP][L/D][Lua]`*** A Lua port of the Everforest colour scheme.
...
* [rose-pine/neovim](https://github.com/rose-pine/neovim) ⭐ 2,973 | 🐛 5 | 🌐 Lua | 📅 2025-12-21 - ***`[TS][LSP][L/D][Lua]`*** All natural pine, faux fur and a bit of soho vibes for the classy minimalist.

<!--lint enable awesome-spell-check-->

* [nvim-mini/mini.nvim#colorschemes](https://github.com/nvim-mini/mini.nvim#plugin-color-schemes) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - ***`[TS][LSP][L/D][Lua]`*** Color schemes included in `mini.nvim`. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.
* [catppuccin/nvim](https://github.com/catppuccin/nvim) ⭐ 7,281 | 🐛 12 | 🌐 Lua | 📅 2026-03-26 - ***`[TS][LSP][L/D][Lua]`*** Warm mid-tone dark theme to show off your vibrant self! With support for native LSP, Tree-sitter, and more.
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 6,010 | 🐛 91 | 🌐 Lua | 📅 2025-10-15 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
* [EdenEast/nightfox.nvim](https://github.com/EdenEast/nightfox.nvim) ⭐ 3,941 | 🐛 35 | 🌐 Lua | 📅 2025-02-09 - ***`[TS][LSP][L/D][Lua]`*** A soft dark, fully customizable colorscheme with support for LSP, Tree-sitter and a variety of plugins.
* [ellisonleao/gruvbox.nvim](https://github.com/ellisonleao/gruvbox.nvim) ⭐ 2,493 | 🐛 27 | 🌐 Lua | 📅 2026-03-09 - ***`[TS][LSP][L/D][Lua]`*** Gruvbox community colorscheme Lua port.
* [scottmckendry/cyberdream.nvim](https://github.com/scottmckendry/cyberdream.nvim) ⭐ 1,293 | 🐛 5 | 🌐 Lua | 📅 2026-01-27 - ***`[TS][L/D][Lua]`*** A high-contrast, futuristic and vibrant coloursheme.
...
* [olimorris/onedarkpro.nvim](https://github.com/olimorris/onedarkpro.nvim) ⭐ 1,040 | 🐛 0 | 🌐 Lua | 📅 2026-03-10 - ***`[TS][L/D][Lua]`*** Atom's iconic One Dark theme. Cacheable, fully customisable, Tree-sitter and LSP semantic token support. Comes with light and dark variants.
...
* [xero/miasma.nvim](https://github.com/xero/miasma.nvim) ⭐ 521 | 🐛 5 | 🌐 Vim Script | 📅 2025-07-12 - ***`[TS][LSP]`*** A dark pastel color scheme inspired by the woods. Built using lush and supports Tree-sitter, diagnostics, CMP, Git-Signs, Telescope, Which-key, Lazy, and more.
...
* [mellow-theme/mellow.nvim](https://github.com/mellow-theme/mellow.nvim) ⭐ 413 | 🐛 3 | 🌐 Lua | 📅 2025-09-02 - ***`[TS][LSP][Lua]`*** A soothing dark color scheme with Tree-sitter support.
...
* [oxfist/night-owl.nvim](https://github.com/oxfist/night-owl.nvim) ⭐ 343 | 🐛 5 | 🌐 Lua | 📅 2024-09-12 - ***`[TS][LSP][Lua]`*** A [Night Owl colorscheme port from VSCode](https://github.com/sdras/night-owl-vscode-theme) ⭐ 2,942 | 🐛 47 | 📅 2024-12-31 with support for Tree-sitter and semantic tokens.
...
* [ankushbhagats/pastel.nvim](https://github.com/ankushbhagats/pastel.nvim) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-03-27 - ***`[TS][LSP][L/D][Lua]`*** Elegant pastel colorschemes with advanced customization, styles, and integrations.
...
* [nvim-mini/mini.nvim#mini.base16](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
* [nvim-mini/mini.nvim#mini.colors](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
* [nvim-mini/mini.nvim#mini.hues](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.
* [rktjmp/lush.nvim](https://github.com/rktjmp/lush.nvim) ⭐ 1,758 | 🐛 13 | 🌐 Lua | 📅 2025-09-01 - Define Neovim themes as a DSL in Lua, with real-time feedback.
...
* [RRethy/base16-nvim](https://github.com/RRethy/base16-nvim) ⭐ 626 | 🐛 4 | 🌐 Lua | 📅 2026-03-05 - A base16 colorscheme builder. Includes support for Tree-sitter and LSP highlight groups.
...
* [f-person/auto-dark-mode.nvim](https://github.com/f-person/auto-dark-mode.nvim) ⭐ 482 | 🐛 12 | 🌐 Lua | 📅 2025-08-03 - Follow the system appearance on macOS.
...
* [SmiteshP/nvim-navic](https://github.com/SmiteshP/nvim-navic) ⭐ 1,644 | 🐛 29 | 🌐 Lua | 📅 2025-12-29 - A simple statusline/winbar component that uses LSP to show your current code context.
* [Bekaboo/dropbar.nvim](https://github.com/Bekaboo/dropbar.nvim) ⭐ 1,525 | 🐛 12 | 🌐 Lua | 📅 2025-10-05 - IDE-like breadcrumbs, out of the box.
...
* [nvim-mini/mini.nvim#mini.statusline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.
...
* [ojroques/nvim-hardline](https://github.com/ojroques/nvim-hardline) ⭐ 201 | 🐛 2 | 🌐 Lua | 📅 2023-12-27 - A statusline / bufferline inspired by [vim-airline](https://github.com/vim-airline/vim-airline) ⭐ 17,949 | 🐛 51 | 🌐 Vim Script | 📅 2026-03-11 that aims to be as light and simple as possible.
...
* [Zeioth/heirline-components.nvim](https://github.com/Zeioth/heirline-components.nvim) ⭐ 152 | 🐛 4 | 🌐 Lua | 📅 2026-02-25 - 30+ `heirline.nvim` components to be used out of the box to create the perfect user interface.
...
* [nvim-mini/mini.nvim#mini.tabline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.
...
* [romgrk/barbar.nvim](https://github.com/romgrk/barbar.nvim) ⭐ 2,672 | 🐛 34 | 🌐 Lua | 📅 2025-12-02 - A tabline with re-orderable, auto-sizing, clickable tabs, icons, nice highlighting, sort-by commands and a magic jump-to-buffer mode.
...
* [nvim-mini/mini.nvim#mini.cursorword](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).
...
* [nvim-mini/mini.nvim#mini.starter](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.
...
* [goolord/alpha-nvim](https://github.com/goolord/alpha-nvim) ⭐ 2,347 | 🐛 38 | 🌐 Lua | 📅 2026-02-10 - A fast and highly customizable greeter like [vim-startify](https://github.com/mhinz/vim-startify) ⭐ 5,393 | 🐛 80 | 🌐 Vim Script | 📅 2024-01-05/dashboard-nvim.
...
* [nvim-mini/mini.nvim#mini.icons](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-icons.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` meant as a general icon provider. Uses fixed set of highlight groups. Supports various categories, icon and style customizations, caching for performance. Integrates with built-in filetype matching.
* [nvim-tree/nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons) ⭐ 2,639 | 🐛 17 | 🌐 Lua | 📅 2026-03-11 - A Lua fork of [vim-devicons](https://github.com/ryanoasis/vim-devicons) ⭐ 5,797 | 🐛 70 | 🌐 Vim Script | 📅 2024-05-09.
...
* [vyfor/cord.nvim](https://github.com/vyfor/cord.nvim) ⭐ 573 | 🐛 0 | 🌐 Lua | 📅 2026-02-17 - Highly extensible Rich Presence for Discord.
...
* [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ⭐ 7,254 | 🐛 221 | 🌐 Lua | 📅 2026-03-21 - Modernity meets insane extensibility. The future of organizing your life.
* [nvim-orgmode/orgmode](https://github.com/nvim-orgmode/orgmode) ⭐ 3,706 | 🐛 138 | 🌐 Lua | 📅 2026-03-19 - Org-mode clone written in Lua.
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 1,705 | 🐛 72 | 🌐 Lua | 📅 2026-03-27 - Plugin for Obsidian, written in Lua.
...
* [ymic9963/mdnotes.nvim](https://github.com/ymic9963/mdnotes.nvim) ⭐ 21 | 🐛 11 | 🌐 Lua | 📅 2026-03-27 - Simple, improved, and extensible Markdown note taking.
...
* [philosofonusus/ecolog.nvim](https://github.com/philosofonusus/ecolog.nvim) ⭐ 175 | 🐛 3 | 🌐 Lua | 📅 2026-02-02 - Sophisticated all-in-one toolkit to work with `.env` files and environment variables.
...
* [MisanthropicBit/decipher.nvim](https://github.com/MisanthropicBit/decipher.nvim) ⭐ 43 | 🐛 5 | 🌐 Lua | 📅 2026-03-27 - Encode and decode text using various codecs such as base64.
...
* [AlejandroSuero/freeze-code.nvim](https://github.com/AlejandroSuero/freeze-code.nvim) ⭐ 31 | 🐛 2 | 🌐 Lua | 📅 2025-03-15 - Code screenshot plugin that makes use of [freeze](https://github.com/charmbracelet/freeze) ⭐ 4,404 | 🐛 68 | 🌐 Go | 📅 2026-03-16 inside the editor.
...
* [hat0uma/csvview.nvim](https://github.com/hat0uma/csvview.nvim) ⭐ 584 | 🐛 15 | 🌐 Lua | 📅 2026-02-14 - An asynchronous CSV/TSV table viewer with real-time updates, configurable comments and delimiters, and multiple display modes.
...
* [theKnightsOfRohan/csvlens.nvim](https://github.com/theKnightsOfRohan/csvlens.nvim) ⭐ 39 | 🐛 1 | 🌐 Lua | 📅 2024-04-28 - A port of [YS-L/csvlens](https://github.com/YS-L/csvlens) ⭐ 3,669 | 🐛 57 | 🌐 Rust | 📅 2026-03-17, for easy previewing of tabular data.
...
* [nvim-mini/mini.nvim#mini.animate](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).
...
* [mfussenegger/nvim-dap](https://github.com/mfussenegger/nvim-dap) ⭐ 7,024 | 🐛 28 | 🌐 Lua | 📅 2026-03-26 - Debug Adapter Protocol client implementation.
* [rcarriga/nvim-dap-ui](https://github.com/rcarriga/nvim-dap-ui) ⭐ 3,303 | 🐛 104 | 🌐 Lua | 📅 2026-03-23 - A UI for nvim-dap.
* [theHamsta/nvim-dap-virtual-text](https://github.com/theHamsta/nvim-dap-virtual-text) ⭐ 1,062 | 🐛 10 | 🌐 Lua | 📅 2025-05-25 - Virtual text support for nvim-dap.
* [igorlfs/nvim-dap-view](https://github.com/igorlfs/nvim-dap-view) ⭐ 796 | 🐛 8 | 🌐 Lua | 📅 2026-03-17 - A modern, minimalistic UI for nvim-dap.
...
* [nvim-neotest/neotest](https://github.com/nvim-neotest/neotest) ⭐ 3,053 | 🐛 98 | 🌐 Lua | 📅 2026-03-26 - An extensible framework for interacting with tests within Neovim.
...
* [Vigemus/iron.nvim](https://github.com/Vigemus/iron.nvim) ⭐ 1,320 | 🐛 57 | 🌐 Lua | 📅 2026-02-20 - Interactive REPLs of over 30 languages embedded.
...
* [Civitasv/cmake-tools.nvim](https://github.com/Civitasv/cmake-tools.nvim) ⭐ 526 | 🐛 19 | 🌐 Lua | 📅 2026-03-27 - CMake integration.
...
* [nvim-mini/mini.nvim#mini.doc](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
* [nvim-mini/mini.nvim#mini.test](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` with framework for writing extensive Neovim plugin tests with support for hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.
...
* [folke/lazydev.nvim](https://github.com/folke/lazydev.nvim) ⭐ 1,480 | 🐛 5 | 🌐 Lua | 📅 2026-03-14 - Faster LuaLS setup.
...
* [jrop/morph.nvim](https://github.com/jrop/morph.nvim) ⭐ 108 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - A React-like renderer for building interactive buffers/TUIs.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2025-05-23 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 21,768 | 🐛 17 | 🌐 Go | 📅 2026-03-20 or compatible encryption tools for cryptographic safety.
...
* [Olical/conjure](https://github.com/Olical/conjure) ⭐ 2,071 | 🐛 93 | 🌐 Fennel | 📅 2026-03-27 - Interactive evaluation (Clojure, Fennel, Janet, Racket, Hy, MIT Scheme, Guile).
...
* [nvim-mini/mini.nvim#mini.diff](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
* [nvim-mini/mini.nvim#mini.git](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for enhanced Git integration with current Neovim process that implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.
* [lewis6991/gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) ⭐ 6,667 | 🐛 29 | 🌐 Lua | 📅 2026-03-27 - Git integration: signs, hunk actions, blame, etc.
* [sindrets/diffview.nvim](https://github.com/sindrets/diffview.nvim) ⭐ 5,456 | 🐛 133 | 🌐 Lua | 📅 2024-08-02 - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev.
* [NeogitOrg/neogit](https://github.com/NeogitOrg/neogit) ⭐ 5,248 | 🐛 180 | 🌐 Lua | 📅 2026-03-27 - A Magit clone that may change some things to fit the Vim philosophy.
* [kdheepak/lazygit.nvim](https://github.com/kdheepak/lazygit.nvim) ⭐ 2,223 | 🐛 50 | 🌐 Lua | 📅 2025-12-19 - Plugin for calling lazygit.
* [esmuellert/codediff.nvim](https://github.com/esmuellert/codediff.nvim) ⭐ 1,218 | 🐛 60 | 🌐 Lua | 📅 2026-03-11 - Side-by-side diff with two-tier highlighting (line + character level) using VSCode's algorithm implemented in C.
...
* [chojs23/ec](https://github.com/chojs23/ec) ⭐ 159 | 🐛 1 | 🌐 Go | 📅 2026-03-24 - A TUI native Git mergetool with 3 panes.
...
* [barrettruth/diffs.nvim](https://github.com/barrettruth/diffs.nvim) ⭐ 67 | 🐛 3 | 🌐 Lua | 📅 2026-03-25 - Syntax highlighting for diffs with Tree-sitter support for `vim-fugitive` and `&diff` buffers.
...
* [jceb/jiejie.nvim](https://github.com/jceb/jiejie.nvim) ⭐ 49 | 🐛 2 | 🌐 Lua | 📅 2026-03-23 - Frontend for Jujutsu in the style of `fugitive`.
...
* [pwntester/octo.nvim](https://github.com/pwntester/octo.nvim) ⭐ 3,207 | 🐛 227 | 🌐 Lua | 📅 2026-03-26 - Work with GitHub issues and PRs.
...
* [harrisoncramer/GitLab.nvim](https://github.com/harrisoncramer/GitLab.nvim) ⭐ 365 | 🐛 22 | 🌐 Lua | 📅 2026-03-25 - Review pull requests and manage other GitLab resources.
...
* [nvim-mini/mini.nvim#mini.jump](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for smarter jumping to a single character.
* [nvim-mini/mini.nvim#mini.jump2d](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
* [nvim-mini/mini.nvim#mini.bracketed](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` to go forward/backward with square brackets.
...
* [nvim-mini/mini.nvim#mini.clue](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
* [nvim-mini/mini.nvim#mini.keymap](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).
* [folke/which-key.nvim](https://github.com/folke/which-key.nvim) ⭐ 7,016 | 🐛 34 | 🌐 Lua | 📅 2025-10-28 - Shows a popup with possible keybindings of the command you started typing.
...
* [nvim-mini/mini.nvim#mini.map](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.
...
* [nvim-mini/mini.nvim#mini.pairs](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
* [nvim-mini/mini.nvim#mini.trailspace](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
* [nvim-mini/mini.nvim#mini.operators](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
* [nvim-mini/mini.nvim#mini.move](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
* [nvim-mini/mini.nvim#mini.ai](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some built-in textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
* [nvim-mini/mini.nvim#mini.splitjoin](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
* [nvim-mini/mini.nvim#mini.basics](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.
...
* [nvim-treesitter/nvim-treesitter-context](https://github.com/nvim-treesitter/nvim-treesitter-context) ⭐ 3,144 | 🐛 20 | 🌐 Janet | 📅 2026-03-22 - Shows floating hover with the current function/block context.
...
* [jake-stewart/multicursor.nvim](https://github.com/jake-stewart/multicursor.nvim) ⭐ 1,425 | 🐛 0 | 🌐 Lua | 📅 2026-03-24 - Adds support for multiple cursors which work how you expect.
...
* [gbprod/yanky.nvim](https://github.com/gbprod/yanky.nvim) ⭐ 1,227 | 🐛 33 | 🌐 Lua | 📅 2026-03-12 - Improved Yank and Put functionalities.
...
* [shortcuts/no-neck-pain.nvim](https://github.com/shortcuts/no-neck-pain.nvim) ⭐ 921 | 🐛 16 | 🌐 Lua | 📅 2026-03-25 - Center the currently focused buffer to the middle of your terminal.
...
* [nvim-mini/mini.nvim#mini.comment](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.
* [numToStr/Comment.nvim](https://github.com/numToStr/Comment.nvim) ⭐ 4,612 | 🐛 82 | 🌐 Lua | 📅 2024-08-19 - Smart and powerful comment plugin. Supports commentstring, motions, dot-repeat and more.
...
* [danymat/neogen](https://github.com/danymat/neogen) ⭐ 1,632 | 🐛 44 | 🌐 Lua | 📅 2026-01-10 - A better annotation generator which supports multiple languages and annotation conventions.
...
* [kevinhwang91/nvim-ufo](https://github.com/kevinhwang91/nvim-ufo) ⭐ 2,890 | 🐛 46 | 🌐 Lua | 📅 2026-01-11 - Ultra fold with modern looking and performance boosting.
...
* [nvim-mini/mini.nvim#mini.align](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for aligning text interactively (with or without instant preview).
* [stevearc/conform.nvim](https://github.com/stevearc/conform.nvim) ⭐ 5,007 | 🐛 88 | 🌐 Lua | 📅 2026-03-10 - A lightweight formatting engine that plays nice with LSP.
...
* [nvim-mini/mini.nvim#mini.indentscope](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.
* [lukas-reineke/indent-blankline.nvim](https://github.com/lukas-reineke/indent-blankline.nvim) ⭐ 4,888 | 🐛 24 | 🌐 Lua | 📅 2026-02-17 - IndentLine replacement in Lua with more features and Tree-sitter support.
...
* [nvim-mini/mini.nvim#mini.cmdline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cmdline.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for command line tweaks. Adds autocompletion with customizable delay, autocorrection for words with fixed candidates, and autopeek command range in a floating window.
...
* [nvim-mini/mini.nvim#mini.sessions](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for session management (read, write, delete).
* [rmagatti/auto-session](https://github.com/rmagatti/auto-session) ⭐ 1,796 | 🐛 17 | 🌐 Lua | 📅 2026-02-15 - A small automated session manager.
* [folke/persistence.nvim](https://github.com/folke/persistence.nvim) ⭐ 967 | 🐛 9 | 🌐 Lua | 📅 2025-10-28 - Simple automated session management.
...
* [brianhuster/live-preview.nvim](https://github.com/brianhuster/live-preview.nvim) ⭐ 365 | 🐛 25 | 🌐 Lua | 📅 2026-03-22 - Live preview HTML, Markdown and Asciidoc in the browser.
...
* [nvim-mini/mini.nvim#mini.bufremove](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,596 | 🐛 14 | 🌐 Lua | 📅 2026-03-27 - Smart, seamless, directional navigation and resizing of splits.
...
* [seandewar/actually-doom.nvim](https://github.com/seandewar/actually-doom.nvim) ⭐ 133 | 🐛 3 | 🌐 C | 📅 2025-08-26 - Editing text is boring; play DOOM instead!.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 56 | 🐛 4 | 🌐 Go | 📅 2026-03-28 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [kndndrj/nvim-dbee](https://github.com/kndndrj/nvim-dbee) ⭐ 1,242 | 🐛 76 | 🌐 Go | 📅 2025-07-25 - Interactive database client.
...
* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 29,977 | 🐛 27 | 🌐 Lua | 📅 2026-03-20 - A launch point for your personal Neovim configuration.
* [siduck76/NvChad](https://github.com/siduck76/NvChad) ⭐ 28,034 | 🐛 1 | 🌐 Lua | 📅 2026-02-07 - An attempt to make Neovim's CLI as functional as an IDE while retaining beauty with less bloat.
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 25,588 | 🐛 36 | 🌐 Lua | 📅 2026-03-21 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
* [LunarVim/LunarVim](https://github.com/LunarVim/LunarVim) ⭐ 19,258 | 🐛 34 | 🌐 Lua | 📅 2025-06-05 - This project aims to help one transition away from VSCode, and into a superior text editing experience.
* [AstroNvim/AstroNvim](https://github.com/AstroNvim/AstroNvim) ⭐ 14,212 | 🐛 2 | 🌐 Lua | 📅 2026-02-18 - An aesthetic and feature-rich config that is extensible and easy to use with a great set of plugins.
...
* [nvim-mini/MiniMax](https://github.com/nvim-mini/MiniMax) ⭐ 360 | 🐛 2 | 🌐 Lua | 📅 2026-03-27 - A collection of self-contained and extensively commented configurations which mostly use MINI tools.
...
* [abdellatif-temsamani/adev.nvim](https://github.com/abdellatif-temsamani/adev.nvim) ⭐ 6 | 🐛 3 | 🌐 Lua | 📅 2026-03-13 - The over-engineered Neovim distribution for developers who want everything.
...
* [y3owk1n/nvs](https://github.com/y3owk1n/nvs) ⭐ 30 | 🐛 0 | 🌐 Go | 📅 2026-03-27 - Another Neovim version manager with config switcher.
...
* [m15a/flake-awesome-neovim-plugins](https://github.com/m15a/flake-awesome-neovim-plugins) ⭐ 62 | 🐛 0 | 🌐 Nix | 📅 2026-03-27 - Nix flake that provides a collection of `awesome-neovim` plugins as Nix packages.
...
* [nvim-mini/mini.nvim#mini.notify](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) ⭐ 8,913 | 🐛 34 | 🌐 Lua | 📅 2026-03-27 - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.
* [folke/noice.nvim](https://github.com/folke/noice.nvim) ⭐ 5,667 | 🐛 27 | 🌐 Lua | 📅 2025-11-03 - Highly experimental plugin that completely replaces the UI for messages, cmdline and the popupmenu.
