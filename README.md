...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 20,538 | 🐛 53 | 🌐 Lua | 📅 2025-12-17 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [nvim-mini/mini.nvim#mini.deps](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.
...
* [zuqini/zpack.nvim](https://github.com/zuqini/zpack.nvim) ⭐ 75 | 🐛 0 | 🌐 Lua | 📅 2026-03-06 - A thin layer on top of `vim.pack` to support lazy-loading and `lazy.nvim`'s declarative spec.
...
* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,446 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Quickstart configurations for the LSP client.
...
* [mfussenegger/nvim-lint](https://github.com/mfussenegger/nvim-lint) ⭐ 2,666 | 🐛 43 | 🌐 Lua | 📅 2026-02-23 - An asynchronous linter plugin, complementary to the built-in Language Server Protocol support.
...
* [stevearc/aerial.nvim](https://github.com/stevearc/aerial.nvim) ⭐ 2,248 | 🐛 72 | 🌐 Lua | 📅 2026-02-25 - A code outline window for skimming and quick navigation.
...
* [rmagatti/goto-preview](https://github.com/rmagatti/goto-preview) ⭐ 1,029 | 🐛 10 | 🌐 Lua | 📅 2025-12-26 - Previewing native LSP's goto definition calls in floating windows.
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 982 | 🐛 11 | 🌐 Lua | 📅 2026-03-19 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,683 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-20 catalog.
* [hedyhli/outline.nvim](https://github.com/hedyhli/outline.nvim) ⭐ 971 | 🐛 35 | 🌐 Lua | 📅 2026-01-31 - A significantly enhanced and refactored fork of `symbols-outline.nvim`.
...
* [tamago324/nlsp-settings.nvim](https://github.com/tamago324/nlsp-settings.nvim) ⭐ 336 | 🐛 10 | 🌐 Lua | 📅 2026-03-18 - Setup LSP with JSON or YAML files.
...
* [nvimtools/none-ls.nvim](https://github.com/nvimtools/none-ls.nvim) ⭐ 3,227 | 🐛 8 | 🌐 Lua | 📅 2026-03-10 - Null-ls.nvim reloaded / Use Neovim as a language server to inject LSP diagnostics, code actions, and more via Lua.
* [mrcjkb/rustaceanvim](https://github.com/mrcjkb/rustaceanvim) ⭐ 2,881 | 🐛 18 | 🌐 Lua | 📅 2026-03-04 - A heavily modified fork of rust-tools.nvim that does not require a `setup` call and does not depend on nvim-lspconfig.
* [rachartier/tiny-inline-diagnostic.nvim](https://github.com/rachartier/tiny-inline-diagnostic.nvim) ⭐ 1,603 | 🐛 0 | 🌐 Lua | 📅 2026-02-24 - Display prettier diagnostic messages. Display one line diagnostic messages where the cursor is, with icons and colors.
* [mfussenegger/nvim-jdtls](https://github.com/mfussenegger/nvim-jdtls) ⭐ 1,450 | 🐛 1 | 🌐 Lua | 📅 2026-02-10 - Extensions for the built-in LSP support for the Eclipse JDT Language Server.
...
* [mrcjkb/haskell-tools.nvim](https://github.com/mrcjkb/haskell-tools.nvim) ⭐ 578 | 🐛 22 | 🌐 Lua | 📅 2026-03-15 - Seamless integration for Haskell development tools like `haskell-language-server` and Hoogle.
...
* [mason-org/mason.nvim](https://github.com/mason-org/mason.nvim) ⭐ 10,122 | 🐛 269 | 🌐 Lua | 📅 2026-01-07 - Portable package manager that runs everywhere Neovim runs. Easily install and manage LSP servers, DAP servers, linters, and formatters.
...
* [piersolenski/wtf.nvim](https://github.com/piersolenski/wtf.nvim) ⭐ 589 | 🐛 2 | 🌐 Lua | 📅 2026-03-02 - AI powered diagnostic debugging, helps explain complex errors and offers custom tailored solutions.
...
* [hrsh7th/nvim-cmp](https://github.com/hrsh7th/nvim-cmp) ⭐ 9,368 | 🐛 301 | 🌐 Lua | 📅 2026-01-23 - Completion engine written in Lua, successor of `nvim-compe`.
...
* [nvim-mini/mini.nvim#mini.completion](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 6,060 | 🐛 99 | 🌐 Lua | 📅 2026-03-18 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 10 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 43,321 | 🐛 57 | 🌐 C | 📅 2026-03-20.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 4,017 | 🐛 15 | 🌐 Lua | 📅 2026-03-18 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,461 | 🐛 50 | 🌐 Vim Script | 📅 2026-01-09.
...
* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 17,609 | 🐛 63 | 🌐 Lua | 📅 2026-03-20 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,323 | 🐛 23 | 🌐 Lua | 📅 2026-03-20 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
...
* [nickjvandyke/opencode.nvim](https://github.com/nickjvandyke/opencode.nvim) ⭐ 2,930 | 🐛 11 | 🌐 Lua | 📅 2026-03-18 - OpenCode AI assistant integration.
...
* [Robitx/gp.nvim](https://github.com/Robitx/gp.nvim) ⭐ 1,311 | 🐛 69 | 🌐 Lua | 📅 2025-08-11 - ChatGPT like sessions and instructable text/code operations in your favorite editor.
* [Exafunction/windsurf.nvim](https://github.com/Exafunction/windsurf.nvim) ⭐ 1,258 | 🐛 115 | 🌐 Lua | 📅 2025-04-30 - Free, ultrafast Copilot alternative. Supports LSP and Tree-sitter.
* [milanglacier/minuet-ai.nvim](https://github.com/milanglacier/minuet-ai.nvim) ⭐ 1,066 | 🐛 12 | 🌐 Lua | 📅 2026-03-20 - Minuet offers code completion from LLM providers including OpenAI (compatible), Gemini, Claude, Ollama, Deepseek and more providers, with support for nvim-cmp, blink.cmp and virtual-text frontend.
...
* [dlants/magenta.nvim](https://github.com/dlants/magenta.nvim) ⭐ 430 | 🐛 23 | 🌐 TypeScript | 📅 2026-03-15 - Leverage coding assistants for chat and code generation. Provides tools for the AI/LLM agent to explore and edit your code, like Aider, Cursor and Windsurf.
...
* [carlos-algms/agentic.nvim](https://github.com/carlos-algms/agentic.nvim) ⭐ 309 | 🐛 12 | 🌐 Lua | 📅 2026-03-20 - Chat interface for AI ACP providers such as Claude, Gemini, Codex, OpenCode and Cursor.
...
* [Flemma-Dev/flemma.nvim](https://github.com/Flemma-Dev/flemma.nvim) ⭐ 49 | 🐛 2 | 🌐 Lua | 📅 2026-03-20 - A first-class AI workspace.
...
* [wsdjeg/chat.nvim](https://github.com/wsdjeg/chat.nvim) ⭐ 25 | 🐛 1 | 🌐 Lua | 📅 2026-03-20 - A lightweight, extensible chat plugin with AI integration, multiple providers, and built-in tools.
...
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 8 | 🐛 4 | 🌐 Lua | 📅 2025-12-31 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 11,385 | 🐛 569 | 🌐 Python | 📅 2026-03-17 tool.
...
* [nvim-java/nvim-java](https://github.com/nvim-java/nvim-java) ⭐ 1,594 | 🐛 35 | 🌐 Lua | 📅 2026-02-05 - Everything you need for a painless Java experience.
...
* [chomosuke/typst-preview.nvim](https://github.com/chomosuke/typst-preview.nvim) ⭐ 867 | 🐛 14 | 🌐 Lua | 📅 2026-03-18 - Preview Typst documents in the browser, instant update on each keystroke, and cross jump between code and preview.
...
* [Julian/lean.nvim](https://github.com/Julian/lean.nvim) ⭐ 491 | 🐛 35 | 🌐 Lua | 📅 2026-03-18 - Support for the [Lean Theorem Prover](https://leanprover.github.io/).
...
* [mistweaverco/kulala.nvim](https://github.com/mistweaverco/kulala.nvim) ⭐ 1,931 | 🐛 16 | 🌐 Lua | 📅 2026-03-16 - A minimal HTTP-client interface.
...
* [iamcco/markdown-preview.nvim](https://github.com/iamcco/markdown-preview.nvim) ⭐ 7,764 | 🐛 259 | 🌐 JavaScript | 📅 2024-07-23 - Preview Markdown on your modern browser with synchronised scrolling and flexible configuration.
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 4,290 | 🐛 7 | 🌐 Lua | 📅 2026-03-09 - Improve viewing Markdown files directly.
* [OXY2DEV/markview.nvim](https://github.com/OXY2DEV/markview.nvim) ⭐ 3,340 | 🐛 3 | 🌐 Lua | 📅 2026-03-20 - A hackable Markdown, Typst, LaTeX, HTML (inline) and YAML renderer.
...
* [YousefHadder/markdown-plus.nvim](https://github.com/YousefHadder/markdown-plus.nvim) ⭐ 228 | 🐛 4 | 🌐 Lua | 📅 2026-03-16 - Provides a full editing experience for Markdown files which includes support for lists, links, TOC, and more with simple and fast keymaps.
...
* [gbprod/phpactor.nvim](https://github.com/gbprod/phpactor.nvim) ⭐ 94 | 🐛 2 | 🌐 Lua | 📅 2026-01-07 - Lua version of [phpactor](https://github.com/phpactor/phpactor) ⭐ 1,831 | 🐛 300 | 🌐 PHP | 📅 2026-03-20.
...
* [nvim-treesitter/nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter) ⭐ 13,409 | 🐛 271 | 🌐 Tree-sitter Query | 📅 2026-03-20 - Tree-sitter configurations and abstraction layer.
* [nvim-mini/mini.nvim#mini.surround](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-surround.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for working with text surroundings (add, delete, replace, find, highlight). Supports dot-repeat, different search methods, "last"/"next" extended mappings, Tree-sitter integration, and more.
* [kylechui/nvim-surround](https://github.com/kylechui/nvim-surround) ⭐ 4,140 | 🐛 8 | 🌐 Lua | 📅 2026-03-07 - A plugin for adding/changing/deleting surrounding delimiter pairs.
* [nvim-treesitter/nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects) ⭐ 2,707 | 🐛 113 | 🌐 Tree-sitter Query | 📅 2026-03-20 - Create your own textobjects using Tree-sitter queries.
...
* [IndianBoy42/tree-sitter-just](https://github.com/IndianBoy42/tree-sitter-just) ⭐ 182 | 🐛 5 | 🌐 Just | 📅 2026-03-15 - Tree-sitter grammar for [Justfiles](https://github.com/casey/just) ⭐ 32,238 | 🐛 363 | 🌐 Rust | 📅 2026-03-21.
...
* [MeanderingProgrammer/treesitter-modules.nvim](https://github.com/MeanderingProgrammer/treesitter-modules.nvim) ⭐ 152 | 🐛 0 | 🌐 Lua | 📅 2026-02-05 - Original modules from nvim-treesitter master branch.
* [calops/hmts.nvim](https://github.com/calops/hmts.nvim) ⭐ 92 | 🐛 13 | 🌐 Lua | 📅 2025-06-11 - Tree-sitter queries for Home Manager Nix files.
...
* [nvim-mini/mini.nvim#mini.snippets](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.
* [L3MON4D3/LuaSnip](https://github.com/L3MON4D3/LuaSnip) ⭐ 4,302 | 🐛 132 | 🌐 Lua | 📅 2026-01-19 - A snippet engine written in Lua.
* [rafamadriz/friendly-snippets](https://github.com/rafamadriz/friendly-snippets) ⭐ 2,667 | 🐛 68 | 🌐 Lua | 📅 2026-01-23 - Set of preconfigured snippets for different languages.
* [chrisgrieser/nvim-scissors](https://github.com/chrisgrieser/nvim-scissors) ⭐ 569 | 🐛 0 | 🌐 Lua | 📅 2026-03-11 - Automagical editing and creation of snippets.
* [dcampos/nvim-snippy](https://github.com/dcampos/nvim-snippy) ⭐ 339 | 🐛 8 | 🌐 Lua | 📅 2026-03-16 - Snippet plugin written in Lua with support for [vim-snippets](https://github.com/honza/vim-snippets) ⭐ 4,873 | 🐛 85 | 🌐 Vim Snippet | 📅 2025-10-28.
...
* [ThePrimeagen/harpoon](https://github.com/ThePrimeagen/harpoon/tree/harpoon2) ⭐ 8,961 | 🐛 150 | 🌐 Lua | 📅 2025-10-31 - A per project, auto updating and editable marks utility for fast file navigation.
...
* [cbochs/grapple.nvim](https://github.com/cbochs/grapple.nvim) ⭐ 691 | 🐛 24 | 🌐 Lua | 📅 2024-09-29 - Provides tagging, cursor tracking, and immediate navigation to important project files.
...
* [nvim-telescope/telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) ⭐ 19,205 | 🐛 489 | 🌐 Lua | 📅 2026-03-17 - Telescope.nvim is a highly [extendable](https://github.com/nvim-telescope/telescope.nvim/wiki/Extensions) ⭐ 19,205 | 🐛 489 | 🌐 Lua | 📅 2026-03-17 A highly extensible fuzzy finder over lists.
* [nvim-mini/mini.nvim#mini.fuzzy](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
* [nvim-mini/mini.nvim#mini.pick](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
* [nvim-mini/mini.nvim#mini.extra](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.
* [folke/snacks.nvim#picker](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) ⭐ 7,270 | 🐛 97 | 🌐 Lua | 📅 2026-03-20 - A modern fuzzy-finder to navigate the Neovim universe.
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,138 | 🐛 7 | 🌐 Lua | 📅 2026-03-19 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,685 | 🐛 21 | 🌐 Rust | 📅 2026-03-20 as its fzf binary.
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 1,904 | 🐛 40 | 🌐 Rust | 📅 2026-03-20 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 366 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 34,736 | 🐛 154 | 🌐 Rust | 📅 2026-03-16, a smart directory picker that tracks your usage.
...
* [nvim-mini/mini.nvim#mini.files](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.
* [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) ⭐ 8,431 | 🐛 94 | 🌐 Lua | 📅 2026-03-20 - A simple and fast file explorer tree.
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,364 | 🐛 128 | 🌐 Lua | 📅 2026-02-24 - Edit your filesystem like a buffer.
* [nvim-neo-tree/neo-tree.nvim](https://github.com/nvim-neo-tree/neo-tree.nvim) ⭐ 5,317 | 🐛 169 | 🌐 Lua | 📅 2026-03-19 - Browse the file system and other tree-like structures in whatever style suits you, including sidebars, floating windows, `netrw` split style, or all of them at once.
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,686 | 🐛 93 | 🌐 Python | 📅 2026-03-21 - File manager. Better than NERDTree.
...
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 457 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,405 | 🐛 1 | 🌐 C | 📅 2026-03-19 and Lua.
...
* [kelly-lin/ranger.nvim](https://github.com/kelly-lin/ranger.nvim) ⭐ 180 | 🐛 11 | 🌐 Lua | 📅 2024-11-18 - [Ranger](https://github.com/ranger/ranger) ⭐ 17,067 | 🐛 931 | 🌐 Python | 📅 2026-02-25 integration.
* [Xuyuanp/yanil](https://github.com/Xuyuanp/yanil) ⭐ 98 | 🐛 5 | 🌐 Lua | 📅 2026-01-15 - Yet Another Nerdtree In Lua.
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 98 | 🐛 2 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 34,911 | 🐛 61 | 🌐 Rust | 📅 2026-03-20).
...
* [nvim-mini/mini.nvim#mini.visits](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.
...
* [mrjones2014/codesettings.nvim](https://github.com/mrjones2014/codesettings.nvim) ⭐ 62 | 🐛 2 | 🌐 Lua | 📅 2026-03-20 - Easily load project-local settings (like `.vscode/settings.json`) into Neovim 0.11+ native LSP settings.
...
* [nvim-mini/mini.nvim#mini.hipatterns](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.
...
* [catgoose/nvim-colorizer.lua](https://github.com/catgoose/nvim-colorizer.lua) ⭐ 1,012 | 🐛 3 | 🌐 Lua | 📅 2026-03-18 - A high-performance color highlighter which has no external dependencies.
...
* [xzbdmw/colorful-menu.nvim](https://github.com/xzbdmw/colorful-menu.nvim) ⭐ 457 | 🐛 3 | 🌐 Lua | 📅 2025-11-25 - Colorize your auto completion menu using Tree-sitter.
...
* [folke/tokyonight.nvim](https://github.com/folke/tokyonight.nvim) ⭐ 7,892 | 🐛 13 | 🌐 Lua | 📅 2025-11-05 - ***`[TS][LSP][L/D][Lua]`*** A clean, dark and light theme written in Lua, with support for LSP, Tree-sitter and lots of plugins.
...
* [sainnhe/gruvbox-material](https://github.com/sainnhe/gruvbox-material) ⭐ 2,507 | 🐛 8 | 🌐 Vim Script | 📅 2026-01-21 - ***`[TS][LSP]`*** Gruvbox modification with softer contrast and Tree-sitter support.
...
* [navarasu/onedark.nvim](https://github.com/navarasu/onedark.nvim) ⭐ 1,934 | 🐛 55 | 🌐 Lua | 📅 2025-11-24 - ***`[TS][LSP][Lua]`*** A One Dark Theme written in Lua based on Atom's One Dark Theme.
* [sainnhe/sonokai](https://github.com/sainnhe/sonokai) ⭐ 1,919 | 🐛 1 | 🌐 Vim Script | 📅 2026-01-21 - ***`[TS][LSP]`*** High Contrast and Vivid Color Scheme based on Monokai Pro.
...
* [AlexvZyl/nordic.nvim](https://github.com/AlexvZyl/nordic.nvim) ⭐ 998 | 🐛 4 | 🌐 Lua | 📅 2026-02-08 - ***`[TS][Lua]`*** Nord theme, but warmer and darker. Supports a variety of plugins and other platforms.
...
* [fenetikm/falcon](https://github.com/fenetikm/falcon) ⭐ 829 | 🐛 12 | 🌐 Vim Script | 📅 2026-03-07 - ***`[TS][Lua]`*** A colour scheme for terminals, Vim and friends.
* [Mofiqul/dracula.nvim](https://github.com/Mofiqul/dracula.nvim) ⭐ 763 | 🐛 24 | 🌐 Lua | 📅 2025-11-05 - ***`[TS]`*** Dracula colorscheme written in Lua.
* [everviolet/nvim](https://github.com/everviolet/nvim) ⭐ 612 | 🐛 0 | 🌐 Lua | 📅 2026-03-02 - ***`[TS][LSP][L/D][Lua]`*** A comfy colorscheme for cozy morning coding.
...
* [nvim-mini/mini.nvim#colorschemes](https://github.com/nvim-mini/mini.nvim#plugin-color-schemes) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - ***`[TS][LSP][L/D][Lua]`*** Color schemes included in `mini.nvim`. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.
* [catppuccin/nvim](https://github.com/catppuccin/nvim) ⭐ 7,270 | 🐛 14 | 🌐 Lua | 📅 2026-03-21 - ***`[TS][LSP][L/D][Lua]`*** Warm mid-tone dark theme to show off your vibrant self! With support for native LSP, Tree-sitter, and more.
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 5,999 | 🐛 91 | 🌐 Lua | 📅 2025-10-15 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
* [EdenEast/nightfox.nvim](https://github.com/EdenEast/nightfox.nvim) ⭐ 3,934 | 🐛 35 | 🌐 Lua | 📅 2025-02-09 - ***`[TS][LSP][L/D][Lua]`*** A soft dark, fully customizable colorscheme with support for LSP, Tree-sitter and a variety of plugins.
* [ellisonleao/gruvbox.nvim](https://github.com/ellisonleao/gruvbox.nvim) ⭐ 2,486 | 🐛 27 | 🌐 Lua | 📅 2026-03-09 - ***`[TS][LSP][L/D][Lua]`*** Gruvbox community colorscheme Lua port.
* [scottmckendry/cyberdream.nvim](https://github.com/scottmckendry/cyberdream.nvim) ⭐ 1,286 | 🐛 5 | 🌐 Lua | 📅 2026-01-27 - ***`[TS][L/D][Lua]`*** A high-contrast, futuristic and vibrant coloursheme.
...
* [embark-theme/vim](https://github.com/embark-theme/vim) ⭐ 724 | 🐛 1 | 🌐 Vim Script | 📅 2025-10-07 - ***`[TS]`*** A deep inky purple theme leveraging bright colors.
...
* [xero/miasma.nvim](https://github.com/xero/miasma.nvim) ⭐ 515 | 🐛 5 | 🌐 Vim Script | 📅 2025-07-12 - ***`[TS][LSP]`*** A dark pastel color scheme inspired by the woods. Built using lush and supports Tree-sitter, diagnostics, CMP, Git-Signs, Telescope, Which-key, Lazy, and more.
...
* [miikanissi/modus-themes.nvim](https://github.com/miikanissi/modus-themes.nvim) ⭐ 414 | 🐛 12 | 🌐 Lua | 📅 2025-10-05 - ***`[TS][LSP][L/D][Lua]`*** Accessible theme, conforming with the highest standard for color contrast (WCAG AAA).
* [mellow-theme/mellow.nvim](https://github.com/mellow-theme/mellow.nvim) ⭐ 407 | 🐛 1 | 🌐 Lua | 📅 2025-09-02 - ***`[TS][LSP][Lua]`*** A soothing dark color scheme with Tree-sitter support.
...
* [dybdeskarphet/gruvbox-minimal.nvim](https://github.com/dybdeskarphet/gruvbox-minimal.nvim) ⭐ 14 | 🐛 0 | 🌐 Lua | 📅 2026-03-15 - ***`[TS][L/D][Lua]`*** A Gruvbox Material theme conceptually inspired by Alabaster.
...
* [nvim-mini/mini.nvim#mini.base16](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
* [nvim-mini/mini.nvim#mini.colors](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
* [nvim-mini/mini.nvim#mini.hues](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.
...
* [nvim-mini/mini.nvim#mini.statusline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.
* [nvim-lualine/lualine.nvim](https://github.com/nvim-lualine/lualine.nvim) ⭐ 7,810 | 🐛 269 | 🌐 Lua | 📅 2025-11-23 - Easily configurable, blazingly fast statusline.
...
* [sschleemilch/slimline.nvim](https://github.com/sschleemilch/slimline.nvim) ⭐ 127 | 🐛 3 | 🌐 Lua | 📅 2026-02-28 - A slim, minimal and opinionated Lua statusline.
...
* [nvim-mini/mini.nvim#mini.tabline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.
* [akinsho/bufferline.nvim](https://github.com/akinsho/bufferline.nvim) ⭐ 4,277 | 🐛 100 | 🌐 Lua | 📅 2025-01-14 - A snazzy bufferline built using Lua.
...
* [nvim-mini/mini.nvim#mini.cursorword](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).
...
* [nvim-mini/mini.nvim#mini.starter](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.
...
* [goolord/alpha-nvim](https://github.com/goolord/alpha-nvim) ⭐ 2,345 | 🐛 38 | 🌐 Lua | 📅 2026-02-10 - A fast and highly customizable greeter like [vim-startify](https://github.com/mhinz/vim-startify) ⭐ 5,393 | 🐛 80 | 🌐 Vim Script | 📅 2024-01-05/dashboard-nvim.
...
* [nvim-mini/mini.nvim#mini.icons](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-icons.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` meant as a general icon provider. Uses fixed set of highlight groups. Supports various categories, icon and style customizations, caching for performance. Integrates with built-in filetype matching.
* [nvim-tree/nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons) ⭐ 2,634 | 🐛 17 | 🌐 Lua | 📅 2026-03-11 - A Lua fork of [vim-devicons](https://github.com/ryanoasis/vim-devicons) ⭐ 5,799 | 🐛 70 | 🌐 Vim Script | 📅 2024-05-09.
...
* [3rd/image.nvim](https://github.com/3rd/image.nvim) ⭐ 1,921 | 🐛 54 | 🌐 Lua | 📅 2026-02-21 - Add image support through kitty's graphics protocol or ueberzugpp.
...
* [vyfor/cord.nvim](https://github.com/vyfor/cord.nvim) ⭐ 568 | 🐛 0 | 🌐 Lua | 📅 2026-02-17 - Highly extensible Rich Presence for Discord.
...
* [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ⭐ 7,253 | 🐛 220 | 🌐 Lua | 📅 2026-03-18 - Modernity meets insane extensibility. The future of organizing your life.
* [nvim-orgmode/orgmode](https://github.com/nvim-orgmode/orgmode) ⭐ 3,703 | 🐛 137 | 🌐 Lua | 📅 2026-03-19 - Org-mode clone written in Lua.
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 1,675 | 🐛 70 | 🌐 Lua | 📅 2026-03-19 - Plugin for Obsidian, written in Lua.
...
* [echaya/neowiki.nvim](https://github.com/echaya/neowiki.nvim) ⭐ 134 | 🐛 1 | 🌐 Lua | 📅 2026-03-19 - The modern vimwiki successor offering a minimal, intuitive workflow out of the box for note-taking and Getting Things Done (GTD).
...
* [AlejandroSuero/freeze-code.nvim](https://github.com/AlejandroSuero/freeze-code.nvim) ⭐ 31 | 🐛 2 | 🌐 Lua | 📅 2025-03-15 - Code screenshot plugin that makes use of [freeze](https://github.com/charmbracelet/freeze) ⭐ 4,393 | 🐛 68 | 🌐 Go | 📅 2026-03-16 inside the editor.
...
* [emrearmagan/dockyard.nvim](https://github.com/emrearmagan/dockyard.nvim) ⭐ 15 | 🐛 0 | 🌐 Lua | 📅 2026-03-20 - Docker dashboard for managing containers, images, networks, and logs.
...
* [hat0uma/csvview.nvim](https://github.com/hat0uma/csvview.nvim) ⭐ 572 | 🐛 15 | 🌐 Lua | 📅 2026-02-14 - An asynchronous CSV/TSV table viewer with real-time updates, configurable comments and delimiters, and multiple display modes.
...
* [theKnightsOfRohan/csvlens.nvim](https://github.com/theKnightsOfRohan/csvlens.nvim) ⭐ 39 | 🐛 1 | 🌐 Lua | 📅 2024-04-28 - A port of [YS-L/csvlens](https://github.com/YS-L/csvlens) ⭐ 3,643 | 🐛 55 | 🌐 Rust | 📅 2026-03-17, for easy previewing of tabular data.
...
* [nvim-mini/mini.nvim#mini.animate](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).
* [sphamba/smear-cursor.nvim](https://github.com/sphamba/smear-cursor.nvim) ⭐ 1,725 | 🐛 6 | 🌐 Lua | 📅 2025-12-01 - Animate the cursor with a smear effect in all terminals. Inspired by Neovide's animated cursor.
...
* [akinsho/toggleterm.nvim](https://github.com/akinsho/toggleterm.nvim) ⭐ 5,422 | 🐛 87 | 🌐 Lua | 📅 2025-03-09 - Easily manage multiple terminal windows.
* [kassio/neoterm](https://github.com/kassio/neoterm) ⭐ 1,336 | 🐛 31 | 🌐 Vim Script | 📅 2023-03-09 - Wrapper of some `:terminal` functions.
* [mikesmithgh/kitty-scrollback.nvim](https://github.com/mikesmithgh/kitty-scrollback.nvim) ⭐ 844 | 🐛 28 | 🌐 Lua | 📅 2026-03-20 - Open your kitty scrollback buffer. Ameowzing.
...
* [igorlfs/nvim-dap-view](https://github.com/igorlfs/nvim-dap-view) ⭐ 789 | 🐛 7 | 🌐 Lua | 📅 2026-03-17 - A modern, minimalistic UI for nvim-dap.
* [sakhnik/nvim-gdb](https://github.com/sakhnik/nvim-gdb) ⭐ 772 | 🐛 5 | 🌐 Lua | 📅 2025-12-31 - Thin wrapper for GDB, LLDB, PDB/PDB++ and BashDB.
* [andrewferrier/debugprint.nvim](https://github.com/andrewferrier/debugprint.nvim) ⭐ 516 | 🐛 10 | 🌐 Lua | 📅 2026-03-08 - Debugging the print() way.
...
* [nvim-neotest/neotest](https://github.com/nvim-neotest/neotest) ⭐ 3,047 | 🐛 113 | 🌐 Lua | 📅 2025-11-08 - An extensible framework for interacting with tests within Neovim.
...
* [mr-u0b0dy/crazy-coverage.nvim](https://github.com/mr-u0b0dy/crazy-coverage.nvim) ⭐ 13 | 🐛 4 | 🌐 Lua | 📅 2026-03-01 - Display code coverage.
...
* [Vigemus/iron.nvim](https://github.com/Vigemus/iron.nvim) ⭐ 1,316 | 🐛 56 | 🌐 Lua | 📅 2026-02-20 - Interactive REPLs of over 30 languages embedded.
...
* [CRAG666/code\_runner.nvim](https://github.com/CRAG666/code_runner.nvim) ⭐ 682 | 🐛 6 | 🌐 Lua | 📅 2026-03-15 - The best code runner you could have, with super powers.
...
* [nvim-mini/mini.nvim#mini.doc](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
* [nvim-mini/mini.nvim#mini.test](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` with framework for writing extensive Neovim plugin tests with support for hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.
...
* [MunifTanjim/nui.nvim](https://github.com/MunifTanjim/nui.nvim) ⭐ 2,038 | 🐛 30 | 🌐 Lua | 📅 2025-06-08 - UI Component Library.
* [folke/lazydev.nvim](https://github.com/folke/lazydev.nvim) ⭐ 1,473 | 🐛 5 | 🌐 Lua | 📅 2026-03-14 - Faster LuaLS setup.
...
* [lumen-oss/lz.n](https://github.com/lumen-oss/lz.n) ⭐ 252 | 🐛 0 | 🌐 Lua | 📅 2026-03-15 - A simple lazy loading library for Neovim plugins.
* [DrKJeff16/wezterm-types](https://github.com/DrKJeff16/wezterm-types) ⭐ 188 | 🐛 2 | 🌐 Lua | 📅 2026-03-16 - WezTerm config type annotations for LuaLS, including support for community plugins.
...
* [BirdeeHub/lze](https://github.com/BirdeeHub/lze) ⭐ 109 | 🐛 0 | 🌐 Lua | 📅 2026-03-15 - A lazy-loading library for Neovim plugins.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2025-05-23 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 21,700 | 🐛 20 | 🌐 Go | 📅 2026-03-20 or compatible encryption tools for cryptographic safety.
...
* [nvim-mini/mini.nvim#mini.diff](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
* [nvim-mini/mini.nvim#mini.git](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for enhanced Git integration with current Neovim process that implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.
* [lewis6991/gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) ⭐ 6,652 | 🐛 33 | 🌐 Lua | 📅 2026-03-06 - Git integration: signs, hunk actions, blame, etc.
* [sindrets/diffview.nvim](https://github.com/sindrets/diffview.nvim) ⭐ 5,433 | 🐛 132 | 🌐 Lua | 📅 2024-08-02 - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev.
* [NeogitOrg/neogit](https://github.com/NeogitOrg/neogit) ⭐ 5,235 | 🐛 179 | 🌐 Lua | 📅 2026-03-14 - A Magit clone that may change some things to fit the Vim philosophy.
* [kdheepak/lazygit.nvim](https://github.com/kdheepak/lazygit.nvim) ⭐ 2,215 | 🐛 49 | 🌐 Lua | 📅 2025-12-19 - Plugin for calling lazygit.
* [esmuellert/codediff.nvim](https://github.com/esmuellert/codediff.nvim) ⭐ 1,202 | 🐛 51 | 🌐 Lua | 📅 2026-03-11 - Side-by-side diff with two-tier highlighting (line + character level) using VSCode's algorithm implemented in C.
...
* [chojs23/ec](https://github.com/chojs23/ec) ⭐ 153 | 🐛 5 | 🌐 Go | 📅 2026-03-20 - A TUI native Git mergetool with 3 panes.
...
* [barrettruth/diffs.nvim](https://github.com/barrettruth/diffs.nvim) ⭐ 61 | 🐛 1 | 🌐 Lua | 📅 2026-03-20 - Syntax highlighting for diffs with Tree-sitter support for `vim-fugitive` and `&diff` buffers.
...
* [pwntester/octo.nvim](https://github.com/pwntester/octo.nvim) ⭐ 3,203 | 🐛 228 | 🌐 Lua | 📅 2026-03-13 - Work with GitHub issues and PRs.
...
* [nvim-mini/mini.nvim#mini.jump](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for smarter jumping to a single character.
* [nvim-mini/mini.nvim#mini.jump2d](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
* [nvim-mini/mini.nvim#mini.bracketed](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to go forward/backward with square brackets.
* [ggandor/leap.nvim](https://github.com/ggandor/leap.nvim) ⭐ 5,025 | 🐛 30 | 🌐 Fennel | 📅 2026-01-25 - A refined successor of Lightspeed, aiming to establish a widely accepted standard interface extension for moving around in Vim-like editors.
* [folke/flash.nvim](https://github.com/folke/flash.nvim) ⭐ 3,964 | 🐛 25 | 🌐 Lua | 📅 2025-10-28 - Navigate your code with search labels, enhanced character motions and Tree-sitter integration.
...
* [chrisgrieser/nvim-spider](https://github.com/chrisgrieser/nvim-spider) ⭐ 854 | 🐛 0 | 🌐 Lua | 📅 2026-02-26 - Use the w, e, b motions like a spider. Considers camelCase and skips insignificant punctuation.
...
* [nvim-mini/mini.nvim#mini.clue](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
* [nvim-mini/mini.nvim#mini.keymap](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).
...
* [mawkler/demicolon.nvim](https://github.com/mawkler/demicolon.nvim) ⭐ 125 | 🐛 0 | 🌐 Lua | 📅 2026-01-25 - Use `;` and `,` keys to also repeat jumps to diagnostics (e.g. `]d`) and to [nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects?tab=readme-ov-file#text-objects-move) ⭐ 2,707 | 🐛 113 | 🌐 Tree-sitter Query | 📅 2026-03-20 (e.g. `]f`), in addition to repeating `t`/`T`/`f`/`F`.
...
* [karb94/neoscroll.nvim](https://github.com/karb94/neoscroll.nvim) ⭐ 1,987 | 🐛 11 | 🌐 Lua | 📅 2025-12-31 - Smooth scrolling.
...
* [nvim-mini/mini.nvim#mini.map](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.
...
* [nvim-mini/mini.nvim#mini.pairs](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
* [nvim-mini/mini.nvim#mini.trailspace](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
* [nvim-mini/mini.nvim#mini.operators](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
* [nvim-mini/mini.nvim#mini.move](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
* [nvim-mini/mini.nvim#mini.ai](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some built-in textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
* [nvim-mini/mini.nvim#mini.splitjoin](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
* [nvim-mini/mini.nvim#mini.basics](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.
...
* [nvim-treesitter/nvim-treesitter-context](https://github.com/nvim-treesitter/nvim-treesitter-context) ⭐ 3,141 | 🐛 20 | 🌐 Janet | 📅 2026-03-14 - Shows floating hover with the current function/block context.
...
* [shortcuts/no-neck-pain.nvim](https://github.com/shortcuts/no-neck-pain.nvim) ⭐ 918 | 🐛 16 | 🌐 Lua | 📅 2026-03-15 - Center the currently focused buffer to the middle of your terminal.
* [nacro90/numb.nvim](https://github.com/nacro90/numb.nvim) ⭐ 845 | 🐛 1 | 🌐 Lua | 📅 2026-01-17 - Peek lines in a non-obtrusive way.
* [HiPhish/rainbow-delimiters.nvim](https://github.com/HiPhish/rainbow-delimiters.nvim) ⭐ 844 | 🐛 20 | 🌐 Lua | 📅 2026-03-18 - Rainbow delimiters with Tree-sitter.
...
* [m4xshen/autoclose.nvim](https://github.com/m4xshen/autoclose.nvim) ⭐ 635 | 🐛 14 | 🌐 Lua | 📅 2025-07-21 - A minimalist autoclose plugin written in Lua.
...
* [necrom4/convy.nvim](https://github.com/necrom4/convy.nvim) ⭐ 38 | 🐛 1 | 🌐 Lua | 📅 2026-03-10 - Easily convert strings between various formats.
...
* [qwavies/smart-backspace.nvim](https://github.com/qwavies/smart-backspace.nvim) ⭐ 28 | 🐛 0 | 🌐 Lua | 📅 2026-03-17 - Context-aware backspace which handles pairs, whitespace and indentation.
...
* [nvim-mini/mini.nvim#mini.comment](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.
* [numToStr/Comment.nvim](https://github.com/numToStr/Comment.nvim) ⭐ 4,607 | 🐛 81 | 🌐 Lua | 📅 2024-08-19 - Smart and powerful comment plugin. Supports commentstring, motions, dot-repeat and more.
* [folke/todo-comments.nvim](https://github.com/folke/todo-comments.nvim) ⭐ 4,091 | 🐛 20 | 🌐 Lua | 📅 2025-11-10 - Highlight, list and search TODO comments in your projects.
...
* [JoosepAlviste/nvim-ts-context-commentstring](https://github.com/JoosepAlviste/nvim-ts-context-commentstring) ⭐ 1,285 | 🐛 23 | 🌐 Lua | 📅 2024-12-07 - Sets the `commentstring` option based on the cursor location in the file. The location is checked via Tree-sitter queries.
...
* [nvim-mini/mini.nvim#mini.align](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for aligning text interactively (with or without instant preview).
* [stevearc/conform.nvim](https://github.com/stevearc/conform.nvim) ⭐ 4,984 | 🐛 86 | 🌐 Lua | 📅 2026-03-10 - A lightweight formatting engine that plays nice with LSP.
...
* [nvim-mini/mini.nvim#mini.indentscope](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.
* [lukas-reineke/indent-blankline.nvim](https://github.com/lukas-reineke/indent-blankline.nvim) ⭐ 4,878 | 🐛 24 | 🌐 Lua | 📅 2026-02-17 - IndentLine replacement in Lua with more features and Tree-sitter support.
...
* [nvim-mini/mini.nvim#mini.cmdline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cmdline.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for command line tweaks. Adds autocompletion with customizable delay, autocorrection for words with fixed candidates, and autopeek command range in a floating window.
...
* [nvim-mini/mini.nvim#mini.sessions](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for session management (read, write, delete).
...
* [coffebar/neovim-project](https://github.com/coffebar/neovim-project) ⭐ 283 | 🐛 3 | 🌐 Lua | 📅 2026-01-08 - Declarative project management, automatic saving of sessions, uses Telescope.
...
* [brianhuster/live-preview.nvim](https://github.com/brianhuster/live-preview.nvim) ⭐ 360 | 🐛 25 | 🌐 Lua | 📅 2026-03-15 - Live preview HTML, Markdown and Asciidoc in the browser.
...
* [nvim-mini/mini.nvim#mini.bufremove](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,592 | 🐛 15 | 🌐 Lua | 📅 2026-03-20 - Smart, seamless, directional navigation and resizing of splits.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 55 | 🐛 5 | 🌐 Go | 📅 2026-03-21 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [joryeugene/dadbod-grip.nvim](https://github.com/joryeugene/dadbod-grip.nvim) ⭐ 120 | 🐛 0 | 🌐 Lua | 📅 2026-03-21 - Database editor with inline cell editing, staged mutations with live SQL preview, schema browser, DDL, AI SQL generation, FK navigation, and DuckDB/Parquet support.
...
* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 29,914 | 🐛 25 | 🌐 Lua | 📅 2026-03-20 - A launch point for your personal Neovim configuration.
* [siduck76/NvChad](https://github.com/siduck76/NvChad) ⭐ 27,990 | 🐛 0 | 🌐 Lua | 📅 2026-02-07 - An attempt to make Neovim's CLI as functional as an IDE while retaining beauty with less bloat.
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 25,497 | 🐛 43 | 🌐 Lua | 📅 2026-03-20 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
...
* [AstroNvim/AstroNvim](https://github.com/AstroNvim/AstroNvim) ⭐ 14,203 | 🐛 1 | 🌐 Lua | 📅 2026-02-18 - An aesthetic and feature-rich config that is extensible and easy to use with a great set of plugins.
* [ayamir/nvimdots](https://github.com/ayamir/nvimdots) ⭐ 3,382 | 🐛 11 | 🌐 Lua | 📅 2026-03-15 - A well-configured and structured configuration with NixOS support.
...
* [CosmicNvim/CosmicNvim](https://github.com/CosmicNvim/CosmicNvim) ⭐ 1,148 | 🐛 0 | 🌐 Lua | 📅 2026-03-19 - CosmicNvim is a lightweight and opinionated config for web development, specifically designed to provide a COSMIC programming experience!
* [dam9000/kickstart-modular.nvim](https://github.com/dam9000/kickstart-modular.nvim) ⭐ 954 | 🐛 0 | 🌐 Lua | 📅 2026-03-15 - This is a fork of nvim-lua/kickstart.nvim that moves from a single file to a multi file configuration.
...
* [crivotz/nv-ide](https://github.com/crivotz/nv-ide) ⭐ 647 | 🐛 2 | 🌐 Lua | 📅 2026-03-12 - Custom configuration oriented for Full-Stack developers (Rails, Ruby, PHP, HTML, CSS, SCSS, JavaScript).
...
* [nvim-mini/MiniMax](https://github.com/nvim-mini/MiniMax) ⭐ 345 | 🐛 2 | 🌐 Lua | 📅 2026-03-14 - A collection of self-contained and extensively commented configurations which mostly use MINI tools.
...
* [adoyle-h/one.nvim](https://github.com/adoyle-h/one.nvim) ⭐ 180 | 🐛 0 | 🌐 Lua | 📅 2025-11-02 - All-in-one config framework in Lua.
...
* [y3owk1n/nvs](https://github.com/y3owk1n/nvs) ⭐ 30 | 🐛 0 | 🌐 Go | 📅 2026-03-20 - Another Neovim version manager with config switcher.

### Plugin Template

* [ellisonleao/nvim-plugin-template](https://github.com/ellisonleao/nvim-plugin-template) ⭐ 464 | 🐛 2 | 🌐 Lua | 📅 2025-10-08 - Another Neovim plugin template, using GitHub's template feature.
...
* [m15a/flake-awesome-neovim-plugins](https://github.com/m15a/flake-awesome-neovim-plugins) ⭐ 62 | 🐛 0 | 🌐 Nix | 📅 2026-03-20 - Nix flake that provides a collection of `awesome-neovim` plugins as Nix packages.
...
* [nvim-mini/mini.nvim#mini.notify](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) ⭐ 8,882 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.
* [folke/noice.nvim](https://github.com/folke/noice.nvim) ⭐ 5,653 | 🐛 26 | 🌐 Lua | 📅 2025-11-03 - Highly experimental plugin that completely replaces the UI for messages, cmdline and the popupmenu.
* [rcarriga/nvim-notify](https://github.com/rcarriga/nvim-notify) ⭐ 3,536 | 🐛 75 | 🌐 Lua | 📅 2025-09-06 - A fancy, configurable, notification manager.
...
* [CosmicNvim/cosmic-ui](https://github.com/CosmicNvim/cosmic-ui) ⭐ 170 | 🐛 0 | 🌐 Lua | 📅 2026-03-17 - Cosmic-UI is a simple wrapper around specific Vim functionality.
