...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 20,767 | 🐛 57 | 🌐 Lua | 📅 2025-12-17 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [nvim-mini/mini.nvim#mini.deps](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.
* [lumen-oss/rocks.nvim](https://github.com/lumen-oss/rocks.nvim) ⭐ 1,022 | 🐛 56 | 🌐 Lua | 📅 2026-04-13 - A modern approach to plugin management using LuaRocks, inspired by Cargo.
...
* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,562 | 🐛 31 | 🌐 Lua | 📅 2026-04-20 - Quickstart configurations for the LSP client.
...
* [mfussenegger/nvim-lint](https://github.com/mfussenegger/nvim-lint) ⭐ 2,708 | 🐛 44 | 🌐 Lua | 📅 2026-04-09 - An asynchronous linter plugin, complementary to the built-in Language Server Protocol support.
...
* [ray-x/navigator.lua](https://github.com/ray-x/navigator.lua) ⭐ 1,392 | 🐛 23 | 🌐 Lua | 📅 2026-04-10 - Learn existing code quickly and navigate code like a breeze. A swiss army knife makes exploring LSP and Tree-sitter symbols a piece of cake.
...
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 993 | 🐛 11 | 🌐 Lua | 📅 2026-04-17 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,726 | 🐛 97 | 🌐 JavaScript | 📅 2026-04-20 catalog.
...
* [mrcjkb/rustaceanvim](https://github.com/mrcjkb/rustaceanvim) ⭐ 2,938 | 🐛 18 | 🌐 Lua | 📅 2026-04-21 - A heavily modified fork of rust-tools.nvim that does not require a `setup` call and does not depend on nvim-lspconfig.
* [rachartier/tiny-inline-diagnostic.nvim](https://github.com/rachartier/tiny-inline-diagnostic.nvim) ⭐ 1,646 | 🐛 0 | 🌐 Lua | 📅 2026-04-17 - Display prettier diagnostic messages. Display one line diagnostic messages where the cursor is, with icons and colors.
...
* [jmbuhr/otter.nvim](https://github.com/jmbuhr/otter.nvim) ⭐ 875 | 🐛 20 | 🌐 Lua | 📅 2026-03-27 - Provides LSP features and a nvim-cmp completion source for languages embedded in other documents.
* [mrcjkb/haskell-tools.nvim](https://github.com/mrcjkb/haskell-tools.nvim) ⭐ 592 | 🐛 22 | 🌐 Lua | 📅 2026-04-21 - Seamless integration for Haskell development tools like `haskell-language-server` and Hoogle.
...
* [Wansmer/symbol-usage.nvim](https://github.com/Wansmer/symbol-usage.nvim) ⭐ 483 | 🐛 2 | 🌐 Lua | 📅 2026-04-06 - Display references, definitions and implementations of document symbols.
* [rachartier/tiny-code-action.nvim](https://github.com/rachartier/tiny-code-action.nvim) ⭐ 476 | 🐛 0 | 🌐 Lua | 📅 2026-04-14 - Provides a simple way to run and visualize code actions with Telescope.
* [soulis-1256/eagle.nvim](https://github.com/soulis-1256/eagle.nvim) ⭐ 347 | 🐛 0 | 🌐 Lua | 📅 2026-02-09 - Mouse-hover LSP hints.
* [VidocqH/lsp-lens.nvim](https://github.com/VidocqH/lsp-lens.nvim) ⭐ 318 | 🐛 20 | 🌐 Lua | 📅 2024-08-09 - Display function references above function definition like IDEA codelens.
...
* [mason-org/mason.nvim](https://github.com/mason-org/mason.nvim) ⭐ 10,216 | 🐛 274 | 🌐 Lua | 📅 2026-04-06 - Portable package manager that runs everywhere Neovim runs. Easily install and manage LSP servers, DAP servers, linters, and formatters.
...
* [piersolenski/wtf.nvim](https://github.com/piersolenski/wtf.nvim) ⭐ 599 | 🐛 1 | 🌐 Lua | 📅 2026-04-06 - AI powered diagnostic debugging, helps explain complex errors and offers custom tailored solutions.
...
* [hrsh7th/nvim-cmp](https://github.com/hrsh7th/nvim-cmp) ⭐ 9,403 | 🐛 301 | 🌐 Lua | 📅 2026-03-25 - Completion engine written in Lua, successor of `nvim-compe`.
...
* [nvim-mini/mini.nvim#mini.completion](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 6,191 | 🐛 111 | 🌐 Lua | 📅 2026-04-21 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [disrupted/blink-cmp-conventional-commits](https://github.com/disrupted/blink-cmp-conventional-commits) ⭐ 32 | 🐛 0 | 🌐 Lua | 📅 2026-04-20 - `blink.cmp` source for [Conventional Commits](https://www.conventionalcommits.org/).
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 11 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 44,722 | 🐛 61 | 🌐 C | 📅 2026-04-16.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 4,057 | 🐛 14 | 🌐 Lua | 📅 2026-04-19 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,555 | 🐛 59 | 🌐 Vim Script | 📅 2026-01-09.
...
* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 17,794 | 🐛 54 | 🌐 Lua | 📅 2026-03-30 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,476 | 🐛 12 | 🌐 Lua | 📅 2026-04-19 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
...
* [nickjvandyke/opencode.nvim](https://github.com/nickjvandyke/opencode.nvim) ⭐ 3,232 | 🐛 11 | 🌐 Lua | 📅 2026-04-15 - OpenCode AI assistant integration.
...
* [milanglacier/minuet-ai.nvim](https://github.com/milanglacier/minuet-ai.nvim) ⭐ 1,106 | 🐛 13 | 🌐 Lua | 📅 2026-04-18 - Minuet offers code completion from LLM providers including OpenAI (compatible), Gemini, Claude, Ollama, Deepseek and more providers, with support for nvim-cmp, blink.cmp and virtual-text frontend.
...
* [dlants/magenta.nvim](https://github.com/dlants/magenta.nvim) ⭐ 438 | 🐛 14 | 🌐 TypeScript | 📅 2026-04-21 - Leverage coding assistants for chat and code generation. Provides tools for the AI/LLM agent to explore and edit your code, like Aider, Cursor and Windsurf.
* [carlos-algms/agentic.nvim](https://github.com/carlos-algms/agentic.nvim) ⭐ 408 | 🐛 7 | 🌐 Lua | 📅 2026-04-18 - Chat interface for AI ACP providers such as Claude, Gemini, Codex, OpenCode and Cursor.
...
* [Flemma-Dev/flemma.nvim](https://github.com/Flemma-Dev/flemma.nvim) ⭐ 52 | 🐛 1 | 🌐 Lua | 📅 2026-04-20 - A first-class AI workspace.
...
* [wsdjeg/chat.nvim](https://github.com/wsdjeg/chat.nvim) ⭐ 25 | 🐛 1 | 🌐 Lua | 📅 2026-04-20 - A lightweight, extensible chat plugin with AI integration, multiple providers, and built-in tools.
...
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 8 | 🐛 4 | 🌐 Lua | 📅 2026-04-05 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 11,657 | 🐛 587 | 🌐 Python | 📅 2026-04-15 tool.
...
* [nvim-java/nvim-java](https://github.com/nvim-java/nvim-java) ⭐ 1,614 | 🐛 36 | 🌐 Lua | 📅 2026-02-05 - Everything you need for a painless Java experience.
* [nvim-flutter/flutter-tools.nvim](https://github.com/nvim-flutter/flutter-tools.nvim) ⭐ 1,381 | 🐛 34 | 🌐 Lua | 📅 2026-01-14 - Build Flutter and Dart applications using the native LSP.
* [chomosuke/typst-preview.nvim](https://github.com/chomosuke/typst-preview.nvim) ⭐ 902 | 🐛 11 | 🌐 Lua | 📅 2026-03-30 - Preview Typst documents in the browser, instant update on each keystroke, and cross jump between code and preview.
...
* [Julian/lean.nvim](https://github.com/Julian/lean.nvim) ⭐ 510 | 🐛 37 | 🌐 Lua | 📅 2026-04-20 - Support for the [Lean Theorem Prover](https://leanprover.github.io/).
...
* [apyra/nvim-unity.nvim](https://github.com/apyra/nvim-unity) ⭐ 107 | 🐛 9 | 🌐 C# | 📅 2026-04-01 - Use Neovim as your default Unity editor with full LSP support via OmniSharp.
...
* [mistweaverco/kulala.nvim](https://github.com/mistweaverco/kulala.nvim) ⭐ 1,964 | 🐛 19 | 🌐 Lua | 📅 2026-03-16 - A minimal HTTP-client interface.
...
* [iamcco/markdown-preview.nvim](https://github.com/iamcco/markdown-preview.nvim) ⭐ 7,817 | 🐛 261 | 🌐 JavaScript | 📅 2024-07-23 - Preview Markdown on your modern browser with synchronised scrolling and flexible configuration.
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 4,436 | 🐛 5 | 🌐 Lua | 📅 2026-04-21 - Improve viewing Markdown files directly.
* [OXY2DEV/markview.nvim](https://github.com/OXY2DEV/markview.nvim) ⭐ 3,437 | 🐛 3 | 🌐 Lua | 📅 2026-04-18 - A hackable Markdown, Typst, LaTeX, HTML (inline) and YAML renderer.
...
* [kdheepak/panvimdoc](https://github.com/kdheepak/panvimdoc) ⭐ 312 | 🐛 6 | 🌐 CSS | 📅 2026-04-12 - A pandoc to vimdoc GitHub action.
...
* [YousefHadder/markdown-plus.nvim](https://github.com/YousefHadder/markdown-plus.nvim) ⭐ 238 | 🐛 3 | 🌐 Lua | 📅 2026-04-20 - Provides a full editing experience for Markdown files which includes support for lists, links, TOC, and more with simple and fast keymaps.
...
* [gbprod/phpactor.nvim](https://github.com/gbprod/phpactor.nvim) ⭐ 94 | 🐛 2 | 🌐 Lua | 📅 2026-01-07 - Lua version of [phpactor](https://github.com/phpactor/phpactor) ⭐ 1,855 | 🐛 297 | 🌐 PHP | 📅 2026-04-20.
...
* [nvim-treesitter/nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects) ⭐ 2,741 | 🐛 116 | 🌐 Tree-sitter Query | 📅 2026-04-07 - Create your own textobjects using Tree-sitter queries.
...
* [romus204/tree-sitter-manager.nvim](https://github.com/romus204/tree-sitter-manager.nvim) ⭐ 355 | 🐛 13 | 🌐 Tree-sitter Query | 📅 2026-04-21 - A lightweight Tree-sitter parser manager for Neovim 0.12+ to replace the archived `nvim-treesitter` plugin.
* [IndianBoy42/tree-sitter-just](https://github.com/IndianBoy42/tree-sitter-just) ⭐ 188 | 🐛 7 | 🌐 Just | 📅 2026-03-25 - Tree-sitter grammar for [Justfiles](https://github.com/casey/just) ⭐ 33,027 | 🐛 306 | 🌐 Rust | 📅 2026-04-20.
...
* [nvim-mini/mini.nvim#mini.snippets](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.
* [L3MON4D3/LuaSnip](https://github.com/L3MON4D3/LuaSnip) ⭐ 4,322 | 🐛 128 | 🌐 Lua | 📅 2026-04-05 - A snippet engine written in Lua.
...
* [ThePrimeagen/harpoon](https://github.com/ThePrimeagen/harpoon/tree/harpoon2) ⭐ 9,036 | 🐛 150 | 🌐 Lua | 📅 2025-10-31 - A per project, auto updating and editable marks utility for fast file navigation.
...
* [nvim-pack/nvim-spectre](https://github.com/nvim-pack/nvim-spectre) ⭐ 2,388 | 🐛 13 | 🌐 Lua | 📅 2025-05-19 - Search and replace panel.
* [MagicDuck/grug-far.nvim](https://github.com/MagicDuck/grug-far.nvim) ⭐ 1,879 | 🐛 0 | 🌐 Lua | 📅 2026-04-11 - Buffer-based live search and replace with full power of `rg` flags. Grug like.
* [kevinhwang91/nvim-hlslens](https://github.com/kevinhwang91/nvim-hlslens) ⭐ 899 | 🐛 9 | 🌐 Lua | 📅 2026-01-11 - Helps you better glance searched information, seamlessly jump matched instances.
...
* [nvim-telescope/telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) ⭐ 19,332 | 🐛 458 | 🌐 Lua | 📅 2026-04-19 - Telescope.nvim is a highly [extendable](https://github.com/nvim-telescope/telescope.nvim/wiki/Extensions) ⭐ 19,332 | 🐛 458 | 🌐 Lua | 📅 2026-04-19 A highly extensible fuzzy finder over lists.
* [nvim-mini/mini.nvim#mini.fuzzy](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
* [nvim-mini/mini.nvim#mini.pick](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
* [nvim-mini/mini.nvim#mini.extra](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.
* [folke/snacks.nvim#picker](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) ⭐ 7,476 | 🐛 115 | 🌐 Lua | 📅 2026-03-21 - A modern fuzzy-finder to navigate the Neovim universe.
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 5,270 | 🐛 60 | 🌐 Rust | 📅 2026-04-21 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,218 | 🐛 7 | 🌐 Lua | 📅 2026-04-20 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,762 | 🐛 21 | 🌐 Rust | 📅 2026-04-21 as its fzf binary.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 369 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 35,883 | 🐛 163 | 🌐 Rust | 📅 2026-04-13, a smart directory picker that tracks your usage.
...
* [dtormoen/neural-open.nvim](https://github.com/dtormoen/neural-open.nvim) ⭐ 58 | 🐛 2 | 🌐 Lua | 📅 2026-04-08 - Intelligent `snacks.nvim` picker that teaches a neural network to rank files by what you're most likely to open next.
...
* [nvim-mini/mini.nvim#mini.files](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.
* [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) ⭐ 8,466 | 🐛 92 | 🌐 Lua | 📅 2026-04-16 - A simple and fast file explorer tree.
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,484 | 🐛 133 | 🌐 Lua | 📅 2026-02-24 - Edit your filesystem like a buffer.
* [nvim-neo-tree/neo-tree.nvim](https://github.com/nvim-neo-tree/neo-tree.nvim) ⭐ 5,383 | 🐛 171 | 🌐 Lua | 📅 2026-04-17 - Browse the file system and other tree-like structures in whatever style suits you, including sidebars, floating windows, `netrw` split style, or all of them at once.
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,693 | 🐛 93 | 🌐 Python | 📅 2026-04-21 - File manager. Better than NERDTree.
* [mikavilpas/yazi.nvim](https://github.com/mikavilpas/yazi.nvim) ⭐ 1,674 | 🐛 8 | 🌐 Lua | 📅 2026-04-21 - Integration with the Yazi terminal file manager.
* [kevinhwang91/rnvimr](https://github.com/kevinhwang91/rnvimr) ⭐ 843 | 🐛 10 | 🌐 Python | 📅 2026-01-11 - A simple yet amazing file explorer.
* [A7Lavinraj/fyler.nvim](https://github.com/A7Lavinraj/fyler.nvim) ⭐ 681 | 🐛 21 | 🌐 Lua | 📅 2026-04-05 - File manager which can edit file system like a buffer with tree view.
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 463 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,501 | 🐛 2 | 🌐 C | 📅 2026-04-19 and Lua.
...
* [kelly-lin/ranger.nvim](https://github.com/kelly-lin/ranger.nvim) ⭐ 182 | 🐛 11 | 🌐 Lua | 📅 2024-11-18 - [Ranger](https://github.com/ranger/ranger) ⭐ 17,142 | 🐛 916 | 🌐 Python | 📅 2026-04-17 integration.
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 99 | 🐛 2 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 36,828 | 🐛 65 | 🌐 Rust | 📅 2026-04-19).
...
* [nvim-mini/mini.nvim#mini.visits](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.
...
* [DrKJeff16/project.nvim](https://github.com/DrKJeff16/project.nvim) ⭐ 160 | 🐛 2 | 🌐 Lua | 📅 2026-04-20 - Project manager with project root detection, documented code and lots of improvements, including `snacks.nvim`, `fzf-lua` and `picker.nvim` support.
...
* [nvim-mini/mini.nvim#mini.hipatterns](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.
...
* [catgoose/nvim-colorizer.lua](https://github.com/catgoose/nvim-colorizer.lua) ⭐ 1,057 | 🐛 6 | 🌐 Lua | 📅 2026-04-19 - A high-performance color highlighter which has no external dependencies.
...
* [nvzone/minty](https://github.com/nvzone/minty) ⭐ 587 | 🐛 2 | 🌐 Lua | 📅 2025-02-28 - Beautifully crafted color tools.
...
* [sainnhe/everforest](https://github.com/sainnhe/everforest) ⭐ 3,973 | 🐛 6 | 🌐 Vim Script | 📅 2026-04-16 - ***`[TS][LSP][L/D]`*** A green based colorscheme designed to be warm, soft and easy on the eyes.
...
* [projekt0n/github-nvim-theme](https://github.com/projekt0n/github-nvim-theme) ⭐ 2,452 | 🐛 28 | 🌐 Lua | 📅 2024-12-31 - ***`[TS][LSP][L/D][Lua]`*** A GitHub theme, kitty, alacritty written in Lua. Support built-in LSP and Tree-sitter.
* [navarasu/onedark.nvim](https://github.com/navarasu/onedark.nvim) ⭐ 1,959 | 🐛 54 | 🌐 Lua | 📅 2026-04-13 - ***`[TS][LSP][Lua]`*** A One Dark Theme written in Lua based on Atom's One Dark Theme.
...
* [nyoom-engineering/oxocarbon.nvim](https://github.com/nyoom-engineering/oxocarbon.nvim) ⭐ 1,557 | 🐛 20 | 🌐 Fennel | 📅 2026-03-18 - ***`[TS][LSP][L/D][Lua]`*** A dark and light theme written in Fennel, inspired by IBM Carbon.
* [dracula/vim](https://github.com/dracula/vim) ⭐ 1,384 | 🐛 10 | 🌐 Vim Script | 📅 2026-04-13 - ***`[TS][LSP]`*** Famous beautiful dark powered theme.
* [bluz71/vim-moonfly-colors](https://github.com/bluz71/vim-moonfly-colors) ⭐ 1,273 | 🐛 0 | 🌐 Lua | 📅 2026-04-20 - ***`[TS][LSP][Lua]`*** A dark charcoal colorscheme with Tree-sitter support.
...
* [AlexvZyl/nordic.nvim](https://github.com/AlexvZyl/nordic.nvim) ⭐ 1,008 | 🐛 1 | 🌐 Lua | 📅 2026-04-19 - ***`[TS][Lua]`*** Nord theme, but warmer and darker. Supports a variety of plugins and other platforms.
* [sainnhe/edge](https://github.com/sainnhe/edge) ⭐ 1,004 | 🐛 2 | 🌐 Vim Script | 📅 2026-01-21 - ***`[TS][LSP][L/D]`*** Clean and Elegant Color Scheme inspired by Atom One and Material.
...
* [everviolet/nvim](https://github.com/everviolet/nvim) ⭐ 637 | 🐛 0 | 🌐 Lua | 📅 2026-03-31 - ***`[TS][LSP][L/D][Lua]`*** A comfy colorscheme for cozy morning coding.
* [neanias/everforest-nvim](https://github.com/neanias/everforest-nvim) ⭐ 433 | 🐛 7 | 🌐 Lua | 📅 2026-04-16 - ***`[TS][LSP][L/D][Lua]`*** A Lua port of the Everforest colour scheme.
...
* [uhs-robert/oasis.nvim](https://github.com/uhs-robert/oasis.nvim) ⭐ 133 | 🐛 3 | 🌐 CSS | 📅 2026-04-15 - ***`[TS][LSP][L/D][Lua]`*** Desert theme from Vim ported to Neovim and made modern with 12 variants, a collection of dark themes for every color of the rainbow.
...
* [rose-pine/neovim](https://github.com/rose-pine/neovim) ⭐ 3,002 | 🐛 5 | 🌐 Lua | 📅 2026-04-09 - ***`[TS][LSP][L/D][Lua]`*** All natural pine, faux fur and a bit of soho vibes for the classy minimalist.

<!--lint enable awesome-spell-check-->

* [nvim-mini/mini.nvim#colorschemes](https://github.com/nvim-mini/mini.nvim#plugin-color-schemes) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - ***`[TS][LSP][L/D][Lua]`*** Color schemes included in `mini.nvim`. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.
* [catppuccin/nvim](https://github.com/catppuccin/nvim) ⭐ 7,364 | 🐛 11 | 🌐 Lua | 📅 2026-04-06 - ***`[TS][LSP][L/D][Lua]`*** Warm mid-tone dark theme to show off your vibrant self! With support for native LSP, Tree-sitter, and more.
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 6,085 | 🐛 89 | 🌐 Lua | 📅 2026-04-20 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
* [EdenEast/nightfox.nvim](https://github.com/EdenEast/nightfox.nvim) ⭐ 3,965 | 🐛 35 | 🌐 Lua | 📅 2025-02-09 - ***`[TS][LSP][L/D][Lua]`*** A soft dark, fully customizable colorscheme with support for LSP, Tree-sitter and a variety of plugins.
* [ellisonleao/gruvbox.nvim](https://github.com/ellisonleao/gruvbox.nvim) ⭐ 2,520 | 🐛 27 | 🌐 Lua | 📅 2026-04-15 - ***`[TS][LSP][L/D][Lua]`*** Gruvbox community colorscheme Lua port.
...
* [zenbones-theme/zenbones.nvim](https://github.com/zenbones-theme/zenbones.nvim) ⭐ 1,095 | 🐛 19 | 🌐 Vim Script | 📅 2026-02-11 - ***`[TS][LSP][L/D][Lua]`*** A collection of Vim/Neovim colorschemes designed to highlight code using contrasts and font variations.
* [olimorris/onedarkpro.nvim](https://github.com/olimorris/onedarkpro.nvim) ⭐ 1,054 | 🐛 0 | 🌐 Lua | 📅 2026-04-11 - ***`[TS][L/D][Lua]`*** Atom's iconic One Dark theme. Cacheable, fully customisable, Tree-sitter and LSP semantic token support. Comes with light and dark variants.
...
* [xero/miasma.nvim](https://github.com/xero/miasma.nvim) ⭐ 531 | 🐛 6 | 🌐 Vim Script | 📅 2025-07-12 - ***`[TS][LSP]`*** A dark pastel color scheme inspired by the woods. Built using lush and supports Tree-sitter, diagnostics, CMP, Git-Signs, Telescope, Which-key, Lazy, and more.
* [ribru17/bamboo.nvim](https://github.com/ribru17/bamboo.nvim) ⭐ 457 | 🐛 2 | 🌐 Lua | 📅 2025-11-25 - ***`[TS][LSP][Lua]`*** A warm green theme.
...
* [uloco/bluloco.nvim](https://github.com/uloco/bluloco.nvim) ⭐ 439 | 🐛 10 | 🌐 Lua | 📅 2026-04-04 - ***`[TS][LSP][L/D][Lua]`*** A fancy and sophisticated colorscheme for night and day coding. Supports LSP, Tree-sitter and all the plugins you love.
...
* [Verf/deepwhite.nvim](https://github.com/Verf/deepwhite.nvim) ⭐ 171 | 🐛 0 | 🌐 Lua | 📅 2026-04-20 - ***`[TS][LSP][Lua]`*** A light colorscheme inspired by [flatwhite-syntax](https://github.com/biletskyy/flatwhite-syntax) ⭐ 192 | 🐛 15 | 🌐 CSS | 📅 2020-04-27 and [elegant-emacs](https://github.com/rougier/elegant-emacs) ⭐ 1,433 | 🐛 8 | 🌐 Emacs Lisp | 📅 2021-11-22.
...
* [jpwol/thorn.nvim](https://github.com/jpwol/thorn.nvim) ⭐ 78 | 🐛 0 | 🌐 Lua | 📅 2026-04-09 - ***`[TS][LSP][L/D][Lua]`*** A rich green theme with dark and light options. Supports LSP, transparency, many plugins, and more.
...
* [T-b-t-nchos/Aquavium.nvim](https://github.com/T-b-t-nchos/Aquavium.nvim) ⭐ 13 | 🐛 1 | 🌐 Lua | 📅 2026-04-17 - ***`[TS][Lua]`*** Aquarium-themed color scheme, designed for use with a transparent terminal background.
...
* [nvim-mini/mini.nvim#mini.base16](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
* [nvim-mini/mini.nvim#mini.colors](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
* [nvim-mini/mini.nvim#mini.hues](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.
...
* [tjdevries/colorbuddy.nvim](https://github.com/tjdevries/colorbuddy.nvim) ⭐ 771 | 🐛 4 | 🌐 Lua | 📅 2024-05-08 - A colorscheme helper. Written in Lua! Quick and Easy Color Schemes.
...
* [Bekaboo/dropbar.nvim](https://github.com/Bekaboo/dropbar.nvim) ⭐ 1,538 | 🐛 15 | 🌐 Lua | 📅 2025-10-05 - IDE-like breadcrumbs, out of the box.
...
* [nvim-mini/mini.nvim#mini.statusline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.
...
* [b0o/incline.nvim](https://github.com/b0o/incline.nvim) ⭐ 1,020 | 🐛 9 | 🌐 Lua | 📅 2025-12-18 - Lightweight floating statuslines, intended for use with Neovim's new global statusline.
...
* [ojroques/nvim-hardline](https://github.com/ojroques/nvim-hardline) ⭐ 203 | 🐛 2 | 🌐 Lua | 📅 2023-12-27 - A statusline / bufferline inspired by [vim-airline](https://github.com/vim-airline/vim-airline) ⭐ 17,947 | 🐛 35 | 🌐 Vim Script | 📅 2026-04-20 that aims to be as light and simple as possible.
...
* [nvim-mini/mini.nvim#mini.tabline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.
...
* [romgrk/barbar.nvim](https://github.com/romgrk/barbar.nvim) ⭐ 2,682 | 🐛 34 | 🌐 Lua | 📅 2025-12-02 - A tabline with re-orderable, auto-sizing, clickable tabs, icons, nice highlighting, sort-by commands and a magic jump-to-buffer mode.
* [nanozuki/tabby.nvim](https://github.com/nanozuki/tabby.nvim) ⭐ 745 | 🐛 8 | 🌐 Lua | 📅 2026-01-07 - A minimal, configurable tabline that allows using tabs as workspace multiplexers.
* [willothy/nvim-cokeline](https://github.com/willothy/nvim-cokeline) ⭐ 626 | 🐛 13 | 🌐 Lua | 📅 2025-01-24 - A bufferline for people with addictive personalities.
...
* [nvim-mini/mini.nvim#mini.cursorword](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).
* [RRethy/vim-illuminate](https://github.com/RRethy/vim-illuminate) ⭐ 2,444 | 🐛 12 | 🌐 Lua | 📅 2025-05-24 - Highlight the word under the cursor with built-in LSP support.
...
* [nvim-mini/mini.nvim#mini.starter](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.
* [nvimdev/dashboard-nvim](https://github.com/nvimdev/dashboard-nvim) ⭐ 2,809 | 🐛 73 | 🌐 Lua | 📅 2026-04-17 - A minimalist dashboard, inspired by doom-emacs.
* [goolord/alpha-nvim](https://github.com/goolord/alpha-nvim) ⭐ 2,359 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - A fast and highly customizable greeter like [vim-startify](https://github.com/mhinz/vim-startify) ⭐ 5,397 | 🐛 80 | 🌐 Vim Script | 📅 2024-01-05/dashboard-nvim.
...
* [nvim-mini/mini.nvim#mini.icons](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-icons.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` meant as a general icon provider. Uses fixed set of highlight groups. Supports various categories, icon and style customizations, caching for performance. Integrates with built-in filetype matching.
* [nvim-tree/nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons) ⭐ 2,650 | 🐛 18 | 🌐 Lua | 📅 2026-04-09 - A Lua fork of [vim-devicons](https://github.com/ryanoasis/vim-devicons) ⭐ 5,805 | 🐛 70 | 🌐 Vim Script | 📅 2024-05-09.
...
* [3rd/image.nvim](https://github.com/3rd/image.nvim) ⭐ 1,960 | 🐛 55 | 🌐 Lua | 📅 2026-02-21 - Add image support through kitty's graphics protocol or ueberzugpp.
...
* [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ⭐ 7,272 | 🐛 214 | 🌐 Lua | 📅 2026-04-09 - Modernity meets insane extensibility. The future of organizing your life.
* [nvim-orgmode/orgmode](https://github.com/nvim-orgmode/orgmode) ⭐ 3,725 | 🐛 146 | 🌐 Lua | 📅 2026-04-20 - Org-mode clone written in Lua.
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 1,790 | 🐛 70 | 🌐 Lua | 📅 2026-04-20 - Plugin for Obsidian, written in Lua.
...
* [jakewvincent/mkdnflow.nvim](https://github.com/jakewvincent/mkdnflow.nvim) ⭐ 803 | 🐛 16 | 🌐 Lua | 📅 2026-03-25 - Fluent Markdown notebook navigation and management (create links, follow links, create and manage to-do lists, reference bib files, and more).
...
* [mluders/comfy-line-numbers.nvim](https://github.com/mluders/comfy-line-numbers.nvim) ⭐ 118 | 🐛 8 | 🌐 Lua | 📅 2026-01-26 - Limits relative numbers to only show left-hand digits on the keyboard.
...
* [AlejandroSuero/freeze-code.nvim](https://github.com/AlejandroSuero/freeze-code.nvim) ⭐ 32 | 🐛 2 | 🌐 Lua | 📅 2025-03-15 - Code screenshot plugin that makes use of [freeze](https://github.com/charmbracelet/freeze) ⭐ 4,469 | 🐛 69 | 🌐 Go | 📅 2026-04-20 inside the editor.
...
* [theKnightsOfRohan/csvlens.nvim](https://github.com/theKnightsOfRohan/csvlens.nvim) ⭐ 39 | 🐛 1 | 🌐 Lua | 📅 2024-04-28 - A port of [YS-L/csvlens](https://github.com/YS-L/csvlens) ⭐ 3,728 | 🐛 59 | 🌐 Rust | 📅 2026-03-29, for easy previewing of tabular data.
...
* [nvim-mini/mini.nvim#mini.animate](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).
...
* [rachartier/tiny-glimmer.nvim](https://github.com/rachartier/tiny-glimmer.nvim/) ⭐ 414 | 🐛 1 | 🌐 Lua | 📅 2026-04-16 - Adds subtle animations to various operations.
...
* [akinsho/toggleterm.nvim](https://github.com/akinsho/toggleterm.nvim) ⭐ 5,470 | 🐛 88 | 🌐 Lua | 📅 2025-03-09 - Easily manage multiple terminal windows.
...
* [jlesquembre/nterm.nvim](https://github.com/jlesquembre/nterm.nvim) ⭐ 58 | 🐛 1 | 🌐 Lua | 📅 2026-04-14 - Interact with the terminal, with notifications.
...
* [logicmagix/tide42](https://github.com/logicmagix/tide42) ⭐ 24 | 🐛 0 | 🌐 Shell | 📅 2026-04-21 - A fully integrated terminal IDE built on Neovim, tmux, and scriptable workflows.
...
* [mfussenegger/nvim-dap](https://github.com/mfussenegger/nvim-dap) ⭐ 7,081 | 🐛 30 | 🌐 Lua | 📅 2026-04-06 - Debug Adapter Protocol client implementation.
* [rcarriga/nvim-dap-ui](https://github.com/rcarriga/nvim-dap-ui) ⭐ 3,319 | 🐛 103 | 🌐 Lua | 📅 2026-04-05 - A UI for nvim-dap.
...
* [igorlfs/nvim-dap-view](https://github.com/igorlfs/nvim-dap-view) ⭐ 856 | 🐛 11 | 🌐 Lua | 📅 2026-04-21 - A modern, minimalistic UI for nvim-dap.
...
* [kevinhwang91/nvim-bqf](https://github.com/kevinhwang91/nvim-bqf) ⭐ 2,011 | 🐛 19 | 🌐 Lua | 📅 2026-04-02 - Makes the quickfix window better.
...
* [nvim-neotest/neotest](https://github.com/nvim-neotest/neotest) ⭐ 3,066 | 🐛 98 | 🌐 Lua | 📅 2026-04-01 - An extensible framework for interacting with tests within Neovim.
...
* [stevearc/overseer.nvim](https://github.com/stevearc/overseer.nvim) ⭐ 1,863 | 🐛 77 | 🌐 Lua | 📅 2026-04-01 - A task runner and job management plugin.
...
* [nvim-mini/mini.nvim#mini.doc](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
* [nvim-mini/mini.nvim#mini.test](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` with framework for writing extensive Neovim plugin tests with support for hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.
* [nvim-lua/plenary.nvim](https://github.com/nvim-lua/plenary.nvim) ⭐ 3,441 | 🐛 154 | 🌐 Lua | 📅 2026-04-10 - Plenary: full; complete; entire; absolute; unqualified. All the Lua functions I don't want to write twice.
* [MunifTanjim/nui.nvim](https://github.com/MunifTanjim/nui.nvim) ⭐ 2,056 | 🐛 31 | 🌐 Lua | 📅 2025-06-08 - UI Component Library.
* [folke/lazydev.nvim](https://github.com/folke/lazydev.nvim) ⭐ 1,498 | 🐛 8 | 🌐 Lua | 📅 2026-03-14 - Faster LuaLS setup.
...
* [lumen-oss/lz.n](https://github.com/lumen-oss/lz.n) ⭐ 267 | 🐛 2 | 🌐 Lua | 📅 2026-04-19 - A simple lazy loading library for Neovim plugins.
* [DrKJeff16/wezterm-types](https://github.com/DrKJeff16/wezterm-types) ⭐ 193 | 🐛 1 | 🌐 Lua | 📅 2026-04-20 - WezTerm config type annotations for LuaLS, including support for community plugins.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2025-05-23 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 22,036 | 🐛 17 | 🌐 Go | 📅 2026-03-20 or compatible encryption tools for cryptographic safety.
...
* [Olical/conjure](https://github.com/Olical/conjure) ⭐ 2,084 | 🐛 89 | 🌐 Fennel | 📅 2026-04-10 - Interactive evaluation (Clojure, Fennel, Janet, Racket, Hy, MIT Scheme, Guile).
* [Olical/aniseed](https://github.com/Olical/aniseed) ⭐ 646 | 🐛 7 | 🌐 Fennel | 📅 2025-06-12 - Configure and extend Neovim with Fennel.
* [rktjmp/hotpot.nvim](https://github.com/rktjmp/hotpot.nvim) ⭐ 394 | 🐛 0 | 🌐 Fennel | 📅 2026-04-17 - Seamless, transparent Fennel inside Neovim.
* [Olical/nfnl](https://github.com/Olical/nfnl) ⭐ 349 | 🐛 6 | 🌐 Fennel | 📅 2026-04-13 - Streamlined successor to Aniseed, compiling Fennel to Lua on file write.
...
* [Saecki/crates.nvim](https://github.com/Saecki/crates.nvim) ⭐ 1,093 | 🐛 10 | 🌐 Lua | 📅 2026-04-13 - Rust dependency management for `Cargo.toml`.
...
* [nvim-mini/mini.nvim#mini.diff](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
* [nvim-mini/mini.nvim#mini.git](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for enhanced Git integration with current Neovim process that implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.
* [lewis6991/gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) ⭐ 6,742 | 🐛 33 | 🌐 Lua | 📅 2026-04-20 - Git integration: signs, hunk actions, blame, etc.
* [NeogitOrg/neogit](https://github.com/NeogitOrg/neogit) ⭐ 5,300 | 🐛 186 | 🌐 Lua | 📅 2026-04-19 - A Magit clone that may change some things to fit the Vim philosophy.
* [kdheepak/lazygit.nvim](https://github.com/kdheepak/lazygit.nvim) ⭐ 2,256 | 🐛 51 | 🌐 Lua | 📅 2025-12-19 - Plugin for calling lazygit.
* [esmuellert/codediff.nvim](https://github.com/esmuellert/codediff.nvim) ⭐ 1,299 | 🐛 73 | 🌐 Lua | 📅 2026-04-20 - Side-by-side diff with two-tier highlighting (line + character level) using VSCode's algorithm implemented in C.
...
* [dlyongemallo/diffview.nvim](https://github.com/dlyongemallo/diffview.nvim) ⭐ 143 | 🐛 3 | 🌐 Lua | 📅 2026-04-20 - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev. Maintained fork of sindrets/diffview\.nvim.
...
* [kokusenz/deltaview.nvim](https://github.com/kokusenz/deltaview.nvim) ⭐ 82 | 🐛 2 | 🌐 Lua | 📅 2026-04-14 - Inline/unified diff viewer with Tree-sitter syntax highlighting and diff highlighting in the style of [delta](https://github.com/dandavison/delta) ⭐ 30,371 | 🐛 380 | 🌐 Rust | 📅 2026-03-28, with enhanced navigational features.
...
* [spacedentist/resolve.nvim](https://github.com/spacedentist/resolve.nvim) ⭐ 54 | 🐛 8 | 🌐 Lua | 📅 2026-01-25 - Resolve merge conflicts with ease.
...
* [pwntester/octo.nvim](https://github.com/pwntester/octo.nvim) ⭐ 3,241 | 🐛 235 | 🌐 Lua | 📅 2026-04-20 - Work with GitHub issues and PRs.
...
* [nvim-mini/mini.nvim#mini.jump](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for smarter jumping to a single character.
* [nvim-mini/mini.nvim#mini.jump2d](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
* [nvim-mini/mini.nvim#mini.bracketed](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` to go forward/backward with square brackets.
* [ggandor/leap.nvim](https://github.com/ggandor/leap.nvim) ⭐ 5,022 | 🐛 27 | 🌐 Fennel | 📅 2026-04-11 - A refined successor of Lightspeed, aiming to establish a widely accepted standard interface extension for moving around in Vim-like editors.
* [folke/flash.nvim](https://github.com/folke/flash.nvim) ⭐ 4,015 | 🐛 23 | 🌐 Lua | 📅 2025-10-28 - Navigate your code with search labels, enhanced character motions and Tree-sitter integration.
...
* [nvim-mini/mini.nvim#mini.clue](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
* [nvim-mini/mini.nvim#mini.keymap](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).
* [folke/which-key.nvim](https://github.com/folke/which-key.nvim) ⭐ 7,068 | 🐛 38 | 🌐 Lua | 📅 2025-10-28 - Shows a popup with possible keybindings of the command you started typing.
...
* [max397574/better-escape.nvim](https://github.com/max397574/better-escape.nvim) ⭐ 782 | 🐛 6 | 🌐 Lua | 📅 2025-04-29 - Create shortcuts to escape insert mode without getting delay.
...
* [mawkler/demicolon.nvim](https://github.com/mawkler/demicolon.nvim) ⭐ 129 | 🐛 1 | 🌐 Lua | 📅 2026-01-25 - Use `;` and `,` keys to also repeat jumps to diagnostics (e.g. `]d`) and to [nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects?tab=readme-ov-file#text-objects-move) ⭐ 2,741 | 🐛 116 | 🌐 Tree-sitter Query | 📅 2026-04-07 (e.g. `]f`), in addition to repeating `t`/`T`/`f`/`F`.
...
* [karb94/neoscroll.nvim](https://github.com/karb94/neoscroll.nvim) ⭐ 2,008 | 🐛 11 | 🌐 Lua | 📅 2025-12-31 - Smooth scrolling.
...
* [nvim-mini/mini.nvim#mini.map](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.
...
* [nvim-mini/mini.nvim#mini.pairs](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
* [nvim-mini/mini.nvim#mini.trailspace](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
* [nvim-mini/mini.nvim#mini.operators](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
* [nvim-mini/mini.nvim#mini.move](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
* [nvim-mini/mini.nvim#mini.ai](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some built-in textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
* [nvim-mini/mini.nvim#mini.splitjoin](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
* [nvim-mini/mini.nvim#mini.basics](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.
...
* [nvim-treesitter/nvim-treesitter-context](https://github.com/nvim-treesitter/nvim-treesitter-context) ⭐ 3,164 | 🐛 25 | 🌐 Janet | 📅 2026-04-02 - Shows floating hover with the current function/block context.
...
* [jake-stewart/multicursor.nvim](https://github.com/jake-stewart/multicursor.nvim) ⭐ 1,455 | 🐛 0 | 🌐 Lua | 📅 2026-03-24 - Adds support for multiple cursors which work how you expect.
...
* [monaqa/dial.nvim](https://github.com/monaqa/dial.nvim) ⭐ 1,065 | 🐛 18 | 🌐 Lua | 📅 2025-12-21 - Extended increment/decrement.
...
* [HiPhish/rainbow-delimiters.nvim](https://github.com/HiPhish/rainbow-delimiters.nvim) ⭐ 853 | 🐛 23 | 🌐 Lua | 📅 2026-04-17 - Rainbow delimiters with Tree-sitter.
...
* [bennypowers/splitjoin.nvim](https://github.com/bennypowers/splitjoin.nvim) ⭐ 94 | 🐛 0 | 🌐 Lua | 📅 2026-04-18 - Split and join various syntax structures.
...
* [nvim-mini/mini.nvim#mini.comment](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.
...
* [jeangiraldoo/codedocs.nvim](https://github.com/jeangiraldoo/codedocs.nvim) ⭐ 78 | 🐛 3 | 🌐 Lua | 📅 2026-04-19 - A powerful and customizable annotation framework with support for many languages and annotation conventions.
...
* [kevinhwang91/nvim-ufo](https://github.com/kevinhwang91/nvim-ufo) ⭐ 2,907 | 🐛 46 | 🌐 Lua | 📅 2026-01-11 - Ultra fold with modern looking and performance boosting.
* [chrisgrieser/nvim-origami](https://github.com/chrisgrieser/nvim-origami) ⭐ 484 | 🐛 3 | 🌐 Lua | 📅 2026-04-06 - Fold with relentless elegance.
...
* [nvim-mini/mini.nvim#mini.align](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for aligning text interactively (with or without instant preview).
* [stevearc/conform.nvim](https://github.com/stevearc/conform.nvim) ⭐ 5,067 | 🐛 93 | 🌐 Lua | 📅 2026-03-10 - A lightweight formatting engine that plays nice with LSP.
...
* [nvim-mini/mini.nvim#mini.indentscope](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.
* [lukas-reineke/indent-blankline.nvim](https://github.com/lukas-reineke/indent-blankline.nvim) ⭐ 4,911 | 🐛 25 | 🌐 Lua | 📅 2026-02-17 - IndentLine replacement in Lua with more features and Tree-sitter support.
...
* [NMAC427/guess-indent.nvim](https://github.com/NMAC427/guess-indent.nvim) ⭐ 624 | 🐛 17 | 🌐 Lua | 📅 2025-03-25 - Automatic indentation style detection.
...
* [nvim-mini/mini.nvim#mini.cmdline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cmdline.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for command line tweaks. Adds autocompletion with customizable delay, autocorrection for words with fixed candidates, and autopeek command range in a floating window.
...
* [nvim-mini/mini.nvim#mini.sessions](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for session management (read, write, delete).
* [rmagatti/auto-session](https://github.com/rmagatti/auto-session) ⭐ 1,812 | 🐛 24 | 🌐 Lua | 📅 2026-04-15 - A small automated session manager.
...
* [esensar/nvim-dev-container](https://github.com/esensar/nvim-dev-container) ⭐ 714 | 🐛 10 | 🌐 Lua | 📅 2026-02-13 - Provide functionality similar to VSCode's [remote container development](https://code.visualstudio.com/docs/remote/containers) plugin, with other functionalities that enable development in Docker containers.
...
* [miversen33/netman.nvim](https://github.com/miversen33/netman.nvim) ⭐ 375 | 🐛 51 | 🌐 Lua | 📅 2025-09-13 - Lua powered Network Resource Manager.
* [azratul/live-share.nvim](https://github.com/azratul/live-share.nvim) ⭐ 245 | 🐛 0 | 🌐 Lua | 📅 2026-04-20 - Provides remote collaboration capabilities from anywhere, making it ideal for pair-programming scenarios.
...
* [kiyoon/jupynium.nvim](https://github.com/kiyoon/jupynium.nvim) ⭐ 758 | 🐛 10 | 🌐 Python | 📅 2025-12-26 - Selenium-automated Jupyter Notebook that is synchronised with Neovim in real-time.
* [gruvw/strudel.nvim](https://github.com/gruvw/strudel.nvim) ⭐ 423 | 🐛 4 | 🌐 JavaScript | 📅 2026-04-10 - Live coding controller for [strudel](https://strudel.cc).
...
* [SUSTech-data/neopyter](https://github.com/SUSTech-data/neopyter) ⭐ 164 | 🐛 3 | 🌐 Lua | 📅 2026-04-20 - Edit in Neovim and preview/run in Jupyter Lab.
...
* [nvim-mini/mini.nvim#mini.bufremove](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.
...
* [aserowy/tmux.nvim](https://github.com/aserowy/tmux.nvim) ⭐ 795 | 🐛 15 | 🌐 Lua | 📅 2026-04-13 - Tmux integration features pane movement and resizing.
...
* [kawre/leetcode.nvim](https://github.com/kawre/leetcode.nvim) ⭐ 2,046 | 🐛 60 | 🌐 Lua | 📅 2025-09-21 - Solve Leetcode problems.
* [xeluxee/competitest.nvim](https://github.com/xeluxee/competitest.nvim) ⭐ 575 | 🐛 22 | 🌐 Lua | 📅 2025-05-13 - A plugin to automate testcases management and checking for Competitive Programming contests.
* [2KAbhishek/exercism.nvim](https://github.com/2KAbhishek/exercism.nvim) ⭐ 42 | 🐛 0 | 🌐 Lua | 📅 2026-03-12 - Browse and solve Exercism problems.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 61 | 🐛 8 | 🌐 Go | 📅 2026-04-21 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [joryeugene/dadbod-grip.nvim](https://github.com/joryeugene/dadbod-grip.nvim) ⭐ 136 | 🐛 0 | 🌐 Lua | 📅 2026-04-10 - Database editor with inline cell editing, staged mutations with live SQL preview, schema browser, DDL, AI SQL generation, FK navigation, and DuckDB/Parquet support.
...
* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 30,284 | 🐛 21 | 🌐 Lua | 📅 2026-04-19 - A launch point for your personal Neovim configuration.
* [siduck76/NvChad](https://github.com/siduck76/NvChad) ⭐ 28,098 | 🐛 1 | 🌐 Lua | 📅 2026-04-13 - An attempt to make Neovim's CLI as functional as an IDE while retaining beauty with less bloat.
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 25,976 | 🐛 48 | 🌐 Lua | 📅 2026-04-02 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
...
* [AstroNvim/AstroNvim](https://github.com/AstroNvim/AstroNvim) ⭐ 14,256 | 🐛 1 | 🌐 Lua | 📅 2026-04-07 - An aesthetic and feature-rich config that is extensible and easy to use with a great set of plugins.
* [ayamir/nvimdots](https://github.com/ayamir/nvimdots) ⭐ 3,392 | 🐛 12 | 🌐 Lua | 📅 2026-04-15 - A well-configured and structured configuration with NixOS support.
...
* [dam9000/kickstart-modular.nvim](https://github.com/dam9000/kickstart-modular.nvim) ⭐ 975 | 🐛 0 | 🌐 Lua | 📅 2026-04-18 - This is a fork of nvim-lua/kickstart.nvim that moves from a single file to a multi file configuration.
...
* [nvim-mini/MiniMax](https://github.com/nvim-mini/MiniMax) ⭐ 396 | 🐛 2 | 🌐 Lua | 📅 2026-04-18 - A collection of self-contained and extensively commented configurations which mostly use MINI tools.
...
* [MordechaiHadad/bob](https://github.com/MordechaiHadad/bob) ⭐ 2,081 | 🐛 31 | 🌐 Rust | 📅 2026-03-24 - A cross-platform, easy to use Neovim version manager.
...
* [y3owk1n/nvs](https://github.com/y3owk1n/nvs) ⭐ 32 | 🐛 0 | 🌐 Go | 📅 2026-04-20 - Another Neovim version manager with config switcher.
...
* [m15a/flake-awesome-neovim-plugins](https://github.com/m15a/flake-awesome-neovim-plugins) ⭐ 62 | 🐛 0 | 🌐 Nix | 📅 2026-04-20 - Nix flake that provides a collection of `awesome-neovim` plugins as Nix packages.
...
* [nvim-mini/mini.nvim#mini.notify](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) ⭐ 9,040 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.
* [folke/noice.nvim](https://github.com/folke/noice.nvim) ⭐ 5,702 | 🐛 33 | 🌐 Lua | 📅 2025-11-03 - Highly experimental plugin that completely replaces the UI for messages, cmdline and the popupmenu.
* [rcarriga/nvim-notify](https://github.com/rcarriga/nvim-notify) ⭐ 3,546 | 🐛 78 | 🌐 Lua | 📅 2025-09-06 - A fancy, configurable, notification manager.
