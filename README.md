...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 20,541 | 🐛 52 | 🌐 Lua | 📅 2025-12-17 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [nvim-mini/mini.nvim#mini.deps](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.
...
* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,449 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Quickstart configurations for the LSP client.
...
* [mfussenegger/nvim-lint](https://github.com/mfussenegger/nvim-lint) ⭐ 2,669 | 🐛 43 | 🌐 Lua | 📅 2026-02-23 - An asynchronous linter plugin, complementary to the built-in Language Server Protocol support.
* [j-hui/fidget.nvim](https://github.com/j-hui/fidget.nvim) ⭐ 2,490 | 🐛 22 | 🌐 Lua | 📅 2026-01-13 - Standalone UI for LSP progress.
...
* [stevearc/aerial.nvim](https://github.com/stevearc/aerial.nvim) ⭐ 2,250 | 🐛 72 | 🌐 Lua | 📅 2026-02-25 - A code outline window for skimming and quick navigation.
* [onsails/lspkind.nvim](https://github.com/onsails/lspkind.nvim) ⭐ 1,671 | 🐛 15 | 🌐 Lua | 📅 2026-01-29 - The plugin adds VSCode-like icons to LSP completions.
...
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 982 | 🐛 11 | 🌐 Lua | 📅 2026-03-19 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,684 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-21 catalog.
* [hedyhli/outline.nvim](https://github.com/hedyhli/outline.nvim) ⭐ 972 | 🐛 35 | 🌐 Lua | 📅 2026-01-31 - A significantly enhanced and refactored fork of `symbols-outline.nvim`.
...
* [tamago324/nlsp-settings.nvim](https://github.com/tamago324/nlsp-settings.nvim) ⭐ 336 | 🐛 10 | 🌐 Lua | 📅 2026-03-21 - Setup LSP with JSON or YAML files.
...
* [scalameta/nvim-metals](https://github.com/scalameta/nvim-metals) ⭐ 555 | 🐛 23 | 🌐 Lua | 📅 2026-01-16 - Provides a better experience while using [Metals](https://scalameta.org/metals/), the Scala Language Server, using the built-in LSP support.

<!--lint enable double-link-->

* [nvimtools/none-ls.nvim](https://github.com/nvimtools/none-ls.nvim) ⭐ 3,226 | 🐛 9 | 🌐 Lua | 📅 2026-03-10 - Null-ls.nvim reloaded / Use Neovim as a language server to inject LSP diagnostics, code actions, and more via Lua.
* [mrcjkb/rustaceanvim](https://github.com/mrcjkb/rustaceanvim) ⭐ 2,882 | 🐛 18 | 🌐 Lua | 📅 2026-03-04 - A heavily modified fork of rust-tools.nvim that does not require a `setup` call and does not depend on nvim-lspconfig.
* [rachartier/tiny-inline-diagnostic.nvim](https://github.com/rachartier/tiny-inline-diagnostic.nvim) ⭐ 1,604 | 🐛 0 | 🌐 Lua | 📅 2026-02-24 - Display prettier diagnostic messages. Display one line diagnostic messages where the cursor is, with icons and colors.
...
* [p00f/clangd\_extensions.nvim](https://github.com/p00f/clangd_extensions.nvim) ⭐ 573 | 🐛 8 | 🌐 Lua | 📅 2026-03-04 - Off-spec `clangd` features for the built-in LSP client.
...
* [amrbashir/nvim-docs-view](https://github.com/amrbashir/nvim-docs-view) ⭐ 178 | 🐛 0 | 🌐 Lua | 📅 2025-08-12 - Display LSP hover documentation in a side panel.
...
* [mason-org/mason.nvim](https://github.com/mason-org/mason.nvim) ⭐ 10,123 | 🐛 269 | 🌐 Lua | 📅 2026-01-07 - Portable package manager that runs everywhere Neovim runs. Easily install and manage LSP servers, DAP servers, linters, and formatters.

### Diagnostics

* [folke/trouble.nvim](https://github.com/folke/trouble.nvim) ⭐ 6,715 | 🐛 19 | 🌐 Lua | 📅 2025-10-31 - A pretty diagnostics list to help you solve all the trouble your code is causing.
...
* [nvim-mini/mini.nvim#mini.completion](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 6,060 | 🐛 98 | 🌐 Lua | 📅 2026-03-21 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [mikavilpas/blink-ripgrep.nvim](https://github.com/mikavilpas/blink-ripgrep.nvim) ⭐ 111 | 🐛 1 | 🌐 TypeScript | 📅 2026-03-20 - `blink.cmp` source for `ripgrep` / `git grep`.
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 10 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 43,395 | 🐛 58 | 🌐 C | 📅 2026-03-20.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 4,017 | 🐛 15 | 🌐 Lua | 📅 2026-03-18 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,465 | 🐛 50 | 🌐 Vim Script | 📅 2026-01-09.
...
* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 17,610 | 🐛 65 | 🌐 Lua | 📅 2026-03-20 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,322 | 🐛 23 | 🌐 Lua | 📅 2026-03-21 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
...
* [CopilotC-Nvim/CopilotChat.nvim](https://github.com/CopilotC-Nvim/CopilotChat.nvim) ⭐ 3,597 | 🐛 24 | 🌐 Lua | 📅 2026-03-09 - A chat interface for GitHub Copilot that allows you to directly ask and receive answers to coding-related questions.
* [nickjvandyke/opencode.nvim](https://github.com/nickjvandyke/opencode.nvim) ⭐ 2,941 | 🐛 10 | 🌐 Lua | 📅 2026-03-18 - OpenCode AI assistant integration.
...
* [dlants/magenta.nvim](https://github.com/dlants/magenta.nvim) ⭐ 430 | 🐛 24 | 🌐 TypeScript | 📅 2026-03-22 - Leverage coding assistants for chat and code generation. Provides tools for the AI/LLM agent to explore and edit your code, like Aider, Cursor and Windsurf.
...
* [carlos-algms/agentic.nvim](https://github.com/carlos-algms/agentic.nvim) ⭐ 324 | 🐛 14 | 🌐 Lua | 📅 2026-03-21 - Chat interface for AI ACP providers such as Claude, Gemini, Codex, OpenCode and Cursor.
* [azorng/goose.nvim](https://github.com/azorng/goose.nvim) ⭐ 304 | 🐛 4 | 🌐 Lua | 📅 2026-03-20 - Seamless integration with [goose](https://block.github.io/goose) - work with a powerful AI agent without leaving your editor.
...
* [Flemma-Dev/flemma.nvim](https://github.com/Flemma-Dev/flemma.nvim) ⭐ 49 | 🐛 2 | 🌐 Lua | 📅 2026-03-21 - A first-class AI workspace.
...
* [wsdjeg/chat.nvim](https://github.com/wsdjeg/chat.nvim) ⭐ 25 | 🐛 1 | 🌐 Lua | 📅 2026-03-21 - A lightweight, extensible chat plugin with AI integration, multiple providers, and built-in tools.
...
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 8 | 🐛 4 | 🌐 Lua | 📅 2025-12-31 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 11,395 | 🐛 568 | 🌐 Python | 📅 2026-03-17 tool.
...
* [0xble/dotagent.nvim](https://github.com/0xble/dotagent.nvim) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2026-03-13 - Command and skill completion for Claude Code and Codex-style prompt editors, configurable from local agent command and skill directories.
...
* [nvim-flutter/flutter-tools.nvim](https://github.com/nvim-flutter/flutter-tools.nvim) ⭐ 1,370 | 🐛 34 | 🌐 Lua | 📅 2026-01-14 - Build Flutter and Dart applications using the native LSP.
* [chomosuke/typst-preview.nvim](https://github.com/chomosuke/typst-preview.nvim) ⭐ 868 | 🐛 14 | 🌐 Lua | 📅 2026-03-21 - Preview Typst documents in the browser, instant update on each keystroke, and cross jump between code and preview.
...
* [ray-x/go.nvim](https://github.com/ray-x/go.nvim) ⭐ 2,613 | 🐛 96 | 🌐 Lua | 📅 2026-03-17 - Golang plugin based on LSP and Tree-sitter.
...
* [iamcco/markdown-preview.nvim](https://github.com/iamcco/markdown-preview.nvim) ⭐ 7,765 | 🐛 260 | 🌐 JavaScript | 📅 2024-07-23 - Preview Markdown on your modern browser with synchronised scrolling and flexible configuration.
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 4,293 | 🐛 7 | 🌐 Lua | 📅 2026-03-09 - Improve viewing Markdown files directly.
* [OXY2DEV/markview.nvim](https://github.com/OXY2DEV/markview.nvim) ⭐ 3,345 | 🐛 3 | 🌐 Lua | 📅 2026-03-20 - A hackable Markdown, Typst, LaTeX, HTML (inline) and YAML renderer.
...
* [Zeioth/markmap.nvim](https://github.com/Zeioth/markmap.nvim) ⭐ 241 | 🐛 2 | 🌐 Lua | 📅 2025-11-11 - Visualize your Markdown as mindmaps.
* [tadmccorkle/markdown.nvim](https://github.com/tadmccorkle/markdown.nvim) ⭐ 235 | 🐛 8 | 🌐 Lua | 📅 2025-12-22 - Configurable tools for Markdown files, including inline-style, link, and navigation keymaps, table of contents, improved list editing, and more.
...
* [rogue-87/inlyne.nvim](https://github.com/rogue-87/inlyne.nvim) ⭐ 3 | 🐛 0 | 🌐 Lua | 📅 2026-02-05 - Wrapper for [inlyne](https://github.com/Inlyne-Project/inlyne) ⭐ 1,275 | 🐛 58 | 🌐 Rust | 📅 2026-03-02 Markdown viewer.

### PHP

* [gbprod/phpactor.nvim](https://github.com/gbprod/phpactor.nvim) ⭐ 94 | 🐛 2 | 🌐 Lua | 📅 2026-01-07 - Lua version of [phpactor](https://github.com/phpactor/phpactor) ⭐ 1,831 | 🐛 296 | 🌐 PHP | 📅 2026-03-21.
...
* [nvim-treesitter/nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter) ⭐ 13,408 | 🐛 271 | 🌐 Tree-sitter Query | 📅 2026-03-21 - Tree-sitter configurations and abstraction layer.
* [nvim-mini/mini.nvim#mini.surround](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-surround.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for working with text surroundings (add, delete, replace, find, highlight). Supports dot-repeat, different search methods, "last"/"next" extended mappings, Tree-sitter integration, and more.
...
* [nvim-treesitter/nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects) ⭐ 2,707 | 🐛 112 | 🌐 Tree-sitter Query | 📅 2026-03-21 - Create your own textobjects using Tree-sitter queries.
...
* [IndianBoy42/tree-sitter-just](https://github.com/IndianBoy42/tree-sitter-just) ⭐ 182 | 🐛 5 | 🌐 Just | 📅 2026-03-15 - Tree-sitter grammar for [Justfiles](https://github.com/casey/just) ⭐ 32,255 | 🐛 360 | 🌐 Rust | 📅 2026-03-22.
...
* [nvim-mini/mini.nvim#mini.snippets](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.
* [L3MON4D3/LuaSnip](https://github.com/L3MON4D3/LuaSnip) ⭐ 4,304 | 🐛 130 | 🌐 Lua | 📅 2026-03-21 - A snippet engine written in Lua.
...
* [ThePrimeagen/harpoon](https://github.com/ThePrimeagen/harpoon/tree/harpoon2) ⭐ 8,963 | 🐛 150 | 🌐 Lua | 📅 2025-10-31 - A per project, auto updating and editable marks utility for fast file navigation.
...
* [otavioschwanck/arrow.nvim](https://github.com/otavioschwanck/arrow.nvim) ⭐ 733 | 🐛 34 | 🌐 Lua | 📅 2025-11-28 - Like harpoon, but with a different UX, single keybinding needed and statusline support.
...
* [dimtion/guttermarks.nvim](https://github.com/dimtion/guttermarks.nvim) ⭐ 48 | 🐛 0 | 🌐 Lua | 📅 2026-03-16 - Display marks in the buffer gutter.
...
* [nvim-pack/nvim-spectre](https://github.com/nvim-pack/nvim-spectre) ⭐ 2,379 | 🐛 13 | 🌐 Lua | 📅 2025-05-19 - Search and replace panel.
...
* [nvim-telescope/telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) ⭐ 19,207 | 🐛 490 | 🌐 Lua | 📅 2026-03-17 - Telescope.nvim is a highly [extendable](https://github.com/nvim-telescope/telescope.nvim/wiki/Extensions) ⭐ 19,207 | 🐛 490 | 🌐 Lua | 📅 2026-03-17 A highly extensible fuzzy finder over lists.
* [nvim-mini/mini.nvim#mini.fuzzy](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
* [nvim-mini/mini.nvim#mini.pick](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
* [nvim-mini/mini.nvim#mini.extra](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.
* [folke/snacks.nvim#picker](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) ⭐ 7,276 | 🐛 98 | 🌐 Lua | 📅 2026-03-21 - A modern fuzzy-finder to navigate the Neovim universe.
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,142 | 🐛 7 | 🌐 Lua | 📅 2026-03-19 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,686 | 🐛 21 | 🌐 Rust | 📅 2026-03-20 as its fzf binary.
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 1,917 | 🐛 40 | 🌐 Rust | 📅 2026-03-20 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 366 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 34,791 | 🐛 154 | 🌐 Rust | 📅 2026-03-21, a smart directory picker that tracks your usage.
...
* [juniorsundar/refer.nvim](https://github.com/juniorsundar/refer.nvim) ⭐ 44 | 🐛 2 | 🌐 Lua | 📅 2026-03-20 - A minimalist picker that doesn't get in your way.
...
* [nvim-mini/mini.nvim#mini.files](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.
* [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) ⭐ 8,433 | 🐛 97 | 🌐 Lua | 📅 2026-03-22 - A simple and fast file explorer tree.
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,367 | 🐛 128 | 🌐 Lua | 📅 2026-02-24 - Edit your filesystem like a buffer.
* [nvim-neo-tree/neo-tree.nvim](https://github.com/nvim-neo-tree/neo-tree.nvim) ⭐ 5,319 | 🐛 170 | 🌐 Lua | 📅 2026-03-19 - Browse the file system and other tree-like structures in whatever style suits you, including sidebars, floating windows, `netrw` split style, or all of them at once.
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,686 | 🐛 93 | 🌐 Python | 📅 2026-03-22 - File manager. Better than NERDTree.
* [mikavilpas/yazi.nvim](https://github.com/mikavilpas/yazi.nvim) ⭐ 1,598 | 🐛 7 | 🌐 Lua | 📅 2026-03-20 - Integration with the Yazi terminal file manager.
...
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 457 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,406 | 🐛 1 | 🌐 C | 📅 2026-03-19 and Lua.
...
* [kelly-lin/ranger.nvim](https://github.com/kelly-lin/ranger.nvim) ⭐ 180 | 🐛 11 | 🌐 Lua | 📅 2024-11-18 - [Ranger](https://github.com/ranger/ranger) ⭐ 17,071 | 🐛 931 | 🌐 Python | 📅 2026-02-25 integration.
* [Xuyuanp/yanil](https://github.com/Xuyuanp/yanil) ⭐ 98 | 🐛 5 | 🌐 Lua | 📅 2026-01-15 - Yet Another Nerdtree In Lua.
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 98 | 🐛 2 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 34,983 | 🐛 63 | 🌐 Rust | 📅 2026-03-21).
...
* [nvim-mini/mini.nvim#mini.visits](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.
...
* [mrjones2014/codesettings.nvim](https://github.com/mrjones2014/codesettings.nvim) ⭐ 62 | 🐛 2 | 🌐 Lua | 📅 2026-03-22 - Easily load project-local settings (like `.vscode/settings.json`) into Neovim 0.11+ native LSP settings.
...
* [dzfrias/arena.nvim](https://github.com/dzfrias/arena.nvim) ⭐ 111 | 🐛 3 | 🌐 Lua | 📅 2026-03-15 - A smart (frecency-based) buffer switcher.
...
* [nvim-mini/mini.nvim#mini.hipatterns](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.
...
* [catgoose/nvim-colorizer.lua](https://github.com/catgoose/nvim-colorizer.lua) ⭐ 1,014 | 🐛 1 | 🌐 Lua | 📅 2026-03-22 - A high-performance color highlighter which has no external dependencies.
* [uga-rosa/ccc.nvim](https://github.com/uga-rosa/ccc.nvim) ⭐ 961 | 🐛 12 | 🌐 Lua | 📅 2025-05-06 - Super powerful color picker / colorizer plugin.
* [TaDaa/vimade](https://github.com/TaDaa/vimade) ⭐ 650 | 🐛 6 | 🌐 Lua | 📅 2025-12-14 - Dim, fade, tint, animate, and customize colors in your windows and buffers.
* [nvzone/minty](https://github.com/nvzone/minty) ⭐ 580 | 🐛 2 | 🌐 Lua | 📅 2025-02-28 - Beautifully crafted color tools.
* [xzbdmw/colorful-menu.nvim](https://github.com/xzbdmw/colorful-menu.nvim) ⭐ 458 | 🐛 3 | 🌐 Lua | 📅 2025-11-25 - Colorize your auto completion menu using Tree-sitter.
...
* [folke/tokyonight.nvim](https://github.com/folke/tokyonight.nvim) ⭐ 7,899 | 🐛 13 | 🌐 Lua | 📅 2025-11-05 - ***`[TS][LSP][L/D][Lua]`*** A clean, dark and light theme written in Lua, with support for LSP, Tree-sitter and lots of plugins.
* [sainnhe/everforest](https://github.com/sainnhe/everforest) ⭐ 3,907 | 🐛 7 | 🌐 Vim Script | 📅 2026-01-21 - ***`[TS][LSP][L/D]`*** A green based colorscheme designed to be warm, soft and easy on the eyes.
* [sainnhe/gruvbox-material](https://github.com/sainnhe/gruvbox-material) ⭐ 2,508 | 🐛 8 | 🌐 Vim Script | 📅 2026-01-21 - ***`[TS][LSP]`*** Gruvbox modification with softer contrast and Tree-sitter support.
...
* [navarasu/onedark.nvim](https://github.com/navarasu/onedark.nvim) ⭐ 1,935 | 🐛 55 | 🌐 Lua | 📅 2025-11-24 - ***`[TS][LSP][Lua]`*** A One Dark Theme written in Lua based on Atom's One Dark Theme.
...
* [Mofiqul/vscode.nvim](https://github.com/Mofiqul/vscode.nvim) ⭐ 959 | 🐛 51 | 🌐 Lua | 📅 2025-12-03 - ***`[TS][L/D][Lua]`*** A Lua port of vim-code-dark colorscheme with VSCode light and dark theme.
...
* [everviolet/nvim](https://github.com/everviolet/nvim) ⭐ 614 | 🐛 0 | 🌐 Lua | 📅 2026-03-21 - ***`[TS][LSP][L/D][Lua]`*** A comfy colorscheme for cozy morning coding.
...
* [rafamadriz/neon](https://github.com/rafamadriz/neon) ⭐ 208 | 🐛 2 | 🌐 Lua | 📅 2022-11-27 - ***`[TS][LSP][L/D][Lua]`*** Customizable colorscheme with excellent italic and bold support, dark and light variants. Made to work and look good with Tree-sitter.
...
* [rose-pine/neovim](https://github.com/rose-pine/neovim) ⭐ 2,969 | 🐛 5 | 🌐 Lua | 📅 2025-12-21 - ***`[TS][LSP][L/D][Lua]`*** All natural pine, faux fur and a bit of soho vibes for the classy minimalist.

<!--lint enable awesome-spell-check-->

* [nvim-mini/mini.nvim#colorschemes](https://github.com/nvim-mini/mini.nvim#plugin-color-schemes) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - ***`[TS][LSP][L/D][Lua]`*** Color schemes included in `mini.nvim`. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.
* [catppuccin/nvim](https://github.com/catppuccin/nvim) ⭐ 7,272 | 🐛 13 | 🌐 Lua | 📅 2026-03-22 - ***`[TS][LSP][L/D][Lua]`*** Warm mid-tone dark theme to show off your vibrant self! With support for native LSP, Tree-sitter, and more.
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 6,001 | 🐛 91 | 🌐 Lua | 📅 2025-10-15 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
...
* [ellisonleao/gruvbox.nvim](https://github.com/ellisonleao/gruvbox.nvim) ⭐ 2,488 | 🐛 27 | 🌐 Lua | 📅 2026-03-09 - ***`[TS][LSP][L/D][Lua]`*** Gruvbox community colorscheme Lua port.
...
* [miikanissi/modus-themes.nvim](https://github.com/miikanissi/modus-themes.nvim) ⭐ 415 | 🐛 7 | 🌐 Lua | 📅 2026-03-22 - ***`[TS][LSP][L/D][Lua]`*** Accessible theme, conforming with the highest standard for color contrast (WCAG AAA).
...
* [oxfist/night-owl.nvim](https://github.com/oxfist/night-owl.nvim) ⭐ 339 | 🐛 5 | 🌐 Lua | 📅 2024-09-12 - ***`[TS][LSP][Lua]`*** A [Night Owl colorscheme port from VSCode](https://github.com/sdras/night-owl-vscode-theme) ⭐ 2,939 | 🐛 47 | 📅 2024-12-31 with support for Tree-sitter and semantic tokens.
...
* [Verf/deepwhite.nvim](https://github.com/Verf/deepwhite.nvim) ⭐ 165 | 🐛 0 | 🌐 Lua | 📅 2026-03-17 - ***`[TS][LSP][Lua]`*** A light colorscheme inspired by [flatwhite-syntax](https://github.com/biletskyy/flatwhite-syntax) ⭐ 191 | 🐛 15 | 🌐 CSS | 📅 2020-04-27 and [elegant-emacs](https://github.com/rougier/elegant-emacs) ⭐ 1,431 | 🐛 8 | 🌐 Emacs Lisp | 📅 2021-11-22.
...
* [dybdeskarphet/gruvbox-minimal.nvim](https://github.com/dybdeskarphet/gruvbox-minimal.nvim) ⭐ 14 | 🐛 0 | 🌐 Lua | 📅 2026-03-21 - ***`[TS][L/D][Lua]`*** A Gruvbox Material theme conceptually inspired by Alabaster.
...
* [nvim-mini/mini.nvim#mini.base16](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
* [nvim-mini/mini.nvim#mini.colors](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
* [nvim-mini/mini.nvim#mini.hues](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.
...
* [Bekaboo/dropbar.nvim](https://github.com/Bekaboo/dropbar.nvim) ⭐ 1,520 | 🐛 10 | 🌐 Lua | 📅 2025-10-05 - IDE-like breadcrumbs, out of the box.
...
* [nvim-mini/mini.nvim#mini.statusline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.
* [nvim-lualine/lualine.nvim](https://github.com/nvim-lualine/lualine.nvim) ⭐ 7,811 | 🐛 269 | 🌐 Lua | 📅 2025-11-23 - Easily configurable, blazingly fast statusline.
...
* [nvim-mini/mini.nvim#mini.tabline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.
* [akinsho/bufferline.nvim](https://github.com/akinsho/bufferline.nvim) ⭐ 4,278 | 🐛 100 | 🌐 Lua | 📅 2025-01-14 - A snazzy bufferline built using Lua.
...
* [nvim-mini/mini.nvim#mini.cursorword](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).
...
* [nvim-mini/mini.nvim#mini.starter](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.
...
* [3rd/image.nvim](https://github.com/3rd/image.nvim) ⭐ 1,922 | 🐛 54 | 🌐 Lua | 📅 2026-02-21 - Add image support through kitty's graphics protocol or ueberzugpp.
...
* [HakonHarnes/img-clip.nvim](https://github.com/HakonHarnes/img-clip.nvim) ⭐ 884 | 🐛 9 | 🌐 Lua | 📅 2025-12-19 - Effortlessly embed images into any markup language, like LaTeX, Markdown or Typst.
...
* [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ⭐ 7,255 | 🐛 219 | 🌐 Lua | 📅 2026-03-21 - Modernity meets insane extensibility. The future of organizing your life.
* [nvim-orgmode/orgmode](https://github.com/nvim-orgmode/orgmode) ⭐ 3,704 | 🐛 137 | 🌐 Lua | 📅 2026-03-19 - Org-mode clone written in Lua.
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 1,678 | 🐛 72 | 🌐 Lua | 📅 2026-03-19 - Plugin for Obsidian, written in Lua.
* [nvim-telekasten/telekasten.nvim](https://github.com/nvim-telekasten/telekasten.nvim) ⭐ 1,654 | 🐛 65 | 🌐 Lua | 📅 2026-03-17 - Work with a text-based, Markdown zettelkasten / wiki and mix it with a journal, based on telescope.nvim.
...
* [jghauser/papis.nvim](https://github.com/jghauser/papis.nvim) ⭐ 177 | 🐛 12 | 🌐 Lua | 📅 2025-11-19 - Manage your bibliography from within your favourite editor.
...
* [gmcusaro/ma.nvim](https://github.com/gmcusaro/ma.nvim) ⭐ 5 | 🐛 0 | 🌐 Lua | 📅 2026-03-12 - Minimal Markdown knowledge management with relational note navigation and safe file operations.
...
* [code-biscuits/nvim-biscuits](https://github.com/code-biscuits/nvim-biscuits) ⭐ 325 | 🐛 9 | 🌐 Lua | 📅 2026-03-02 - A port of Assorted Biscuits. Ends up with more supported languages too.
...
* [AlejandroSuero/freeze-code.nvim](https://github.com/AlejandroSuero/freeze-code.nvim) ⭐ 31 | 🐛 2 | 🌐 Lua | 📅 2025-03-15 - Code screenshot plugin that makes use of [freeze](https://github.com/charmbracelet/freeze) ⭐ 4,394 | 🐛 68 | 🌐 Go | 📅 2026-03-16 inside the editor.
...
* [hat0uma/csvview.nvim](https://github.com/hat0uma/csvview.nvim) ⭐ 575 | 🐛 15 | 🌐 Lua | 📅 2026-02-14 - An asynchronous CSV/TSV table viewer with real-time updates, configurable comments and delimiters, and multiple display modes.
...
* [theKnightsOfRohan/csvlens.nvim](https://github.com/theKnightsOfRohan/csvlens.nvim) ⭐ 39 | 🐛 1 | 🌐 Lua | 📅 2024-04-28 - A port of [YS-L/csvlens](https://github.com/YS-L/csvlens) ⭐ 3,646 | 🐛 56 | 🌐 Rust | 📅 2026-03-17, for easy previewing of tabular data.
...
* [nvim-mini/mini.nvim#mini.animate](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).
* [sphamba/smear-cursor.nvim](https://github.com/sphamba/smear-cursor.nvim) ⭐ 1,726 | 🐛 6 | 🌐 Lua | 📅 2025-12-01 - Animate the cursor with a smear effect in all terminals. Inspired by Neovide's animated cursor.
...
* [mikesmithgh/kitty-scrollback.nvim](https://github.com/mikesmithgh/kitty-scrollback.nvim) ⭐ 845 | 🐛 28 | 🌐 Lua | 📅 2026-03-22 - Open your kitty scrollback buffer. Ameowzing.
...
* [mfussenegger/nvim-dap](https://github.com/mfussenegger/nvim-dap) ⭐ 7,008 | 🐛 28 | 🌐 Lua | 📅 2026-03-06 - Debug Adapter Protocol client implementation.
...
* [igorlfs/nvim-dap-view](https://github.com/igorlfs/nvim-dap-view) ⭐ 791 | 🐛 7 | 🌐 Lua | 📅 2026-03-17 - A modern, minimalistic UI for nvim-dap.
...
* [nvim-neotest/neotest](https://github.com/nvim-neotest/neotest) ⭐ 3,048 | 🐛 113 | 🌐 Lua | 📅 2025-11-08 - An extensible framework for interacting with tests within Neovim.
...
* [stevearc/overseer.nvim](https://github.com/stevearc/overseer.nvim) ⭐ 1,842 | 🐛 73 | 🌐 Lua | 📅 2026-03-10 - A task runner and job management plugin.
* [michaelb/sniprun](https://github.com/michaelb/sniprun) ⭐ 1,682 | 🐛 11 | 🌐 Rust | 📅 2026-02-26 - Run parts of code of any language directly from Neovim.
...
* [benlubas/molten-nvim](https://github.com/benlubas/molten-nvim) ⭐ 1,139 | 🐛 38 | 🌐 Python | 📅 2026-03-01 - Enables running code chunks via the Jupyter kernel. Output (including image output) is rendered in a floating window below the code.
...
* [nvim-mini/mini.nvim#mini.doc](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
* [nvim-mini/mini.nvim#mini.test](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` with framework for writing extensive Neovim plugin tests with support for hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.
* [nvim-lua/plenary.nvim](https://github.com/nvim-lua/plenary.nvim) ⭐ 3,420 | 🐛 155 | 🌐 Lua | 📅 2025-07-26 - Plenary: full; complete; entire; absolute; unqualified. All the Lua functions I don't want to write twice.
* [MunifTanjim/nui.nvim](https://github.com/MunifTanjim/nui.nvim) ⭐ 2,039 | 🐛 30 | 🌐 Lua | 📅 2025-06-08 - UI Component Library.
* [folke/lazydev.nvim](https://github.com/folke/lazydev.nvim) ⭐ 1,474 | 🐛 5 | 🌐 Lua | 📅 2026-03-14 - Faster LuaLS setup.
...
* [lumen-oss/luarocks-tag-release](https://github.com/lumen-oss/luarocks-tag-release) ⭐ 56 | 🐛 11 | 🌐 Lua | 📅 2026-03-18 - A GitHub action that publishes your Neovim plugins to LuaRocks.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2025-05-23 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 21,712 | 🐛 20 | 🌐 Go | 📅 2026-03-20 or compatible encryption tools for cryptographic safety.
...
* [Olical/conjure](https://github.com/Olical/conjure) ⭐ 2,070 | 🐛 93 | 🌐 Fennel | 📅 2026-03-15 - Interactive evaluation (Clojure, Fennel, Janet, Racket, Hy, MIT Scheme, Guile).
...
* [aileot/nvim-thyme](https://github.com/aileot/nvim-thyme) ⭐ 39 | 🐛 2 | 🌐 Fennel | 📅 2025-11-04 - Zero-overhead Fennel JIT compiler with safety rollbacks and [parinfer-rust](https://github.com/eraserhd/parinfer-rust) ⭐ 614 | 🐛 35 | 🌐 Rust | 📅 2026-01-03 integration.
...
* [nvim-mini/mini.nvim#mini.diff](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
* [nvim-mini/mini.nvim#mini.git](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for enhanced Git integration with current Neovim process that implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.
* [lewis6991/gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) ⭐ 6,653 | 🐛 33 | 🌐 Lua | 📅 2026-03-06 - Git integration: signs, hunk actions, blame, etc.
* [sindrets/diffview.nvim](https://github.com/sindrets/diffview.nvim) ⭐ 5,437 | 🐛 132 | 🌐 Lua | 📅 2024-08-02 - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev.
* [NeogitOrg/neogit](https://github.com/NeogitOrg/neogit) ⭐ 5,236 | 🐛 180 | 🌐 Lua | 📅 2026-03-14 - A Magit clone that may change some things to fit the Vim philosophy.
* [kdheepak/lazygit.nvim](https://github.com/kdheepak/lazygit.nvim) ⭐ 2,215 | 🐛 49 | 🌐 Lua | 📅 2025-12-19 - Plugin for calling lazygit.
* [esmuellert/codediff.nvim](https://github.com/esmuellert/codediff.nvim) ⭐ 1,204 | 🐛 53 | 🌐 Lua | 📅 2026-03-11 - Side-by-side diff with two-tier highlighting (line + character level) using VSCode's algorithm implemented in C.
* [f-person/git-blame.nvim](https://github.com/f-person/git-blame.nvim) ⭐ 1,072 | 🐛 11 | 🌐 Lua | 📅 2025-11-05 - Show Git blame info.
* [tanvirtin/vgit.nvim](https://github.com/tanvirtin/vgit.nvim) ⭐ 843 | 🐛 15 | 🌐 Lua | 📅 2026-03-04 - Visual Git Plugin to enhance your Git experience.
* [SuperBo/fugit2.nvim](https://github.com/SuperBo/fugit2.nvim) ⭐ 466 | 🐛 15 | 🌐 Lua | 📅 2025-09-02 - Git GUI powered by [libgit2](https://libgit2.org).
...
* [chojs23/ec](https://github.com/chojs23/ec) ⭐ 153 | 🐛 3 | 🌐 Go | 📅 2026-03-21 - A TUI native Git mergetool with 3 panes.
...
* [barrettruth/diffs.nvim](https://github.com/barrettruth/diffs.nvim) ⭐ 63 | 🐛 1 | 🌐 Lua | 📅 2026-03-21 - Syntax highlighting for diffs with Tree-sitter support for `vim-fugitive` and `&diff` buffers.
...
* [Salanoid/gitlogdiff.nvim](https://github.com/Salanoid/gitlogdiff.nvim) ⭐ 19 | 🐛 0 | 🌐 Lua | 📅 2026-01-22 - Diff between multiple Git commits, similar to JetBrains's Git log.
...
* [nvim-mini/mini.nvim#mini.jump](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for smarter jumping to a single character.
* [nvim-mini/mini.nvim#mini.jump2d](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
* [nvim-mini/mini.nvim#mini.bracketed](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to go forward/backward with square brackets.
* [ggandor/leap.nvim](https://github.com/ggandor/leap.nvim) ⭐ 5,025 | 🐛 30 | 🌐 Fennel | 📅 2026-03-21 - A refined successor of Lightspeed, aiming to establish a widely accepted standard interface extension for moving around in Vim-like editors.
...
* [smoka7/hop.nvim](https://github.com/smoka7/hop.nvim) ⭐ 764 | 🐛 36 | 🌐 Lua | 📅 2025-08-22 - Hop is an EasyMotion-like plugin allowing you to jump anywhere in a document with as few keystrokes as possible.
...
* [nvim-mini/mini.nvim#mini.clue](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
* [nvim-mini/mini.nvim#mini.keymap](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).
* [folke/which-key.nvim](https://github.com/folke/which-key.nvim) ⭐ 7,005 | 🐛 36 | 🌐 Lua | 📅 2025-10-28 - Shows a popup with possible keybindings of the command you started typing.
...
* [mawkler/demicolon.nvim](https://github.com/mawkler/demicolon.nvim) ⭐ 125 | 🐛 0 | 🌐 Lua | 📅 2026-01-25 - Use `;` and `,` keys to also repeat jumps to diagnostics (e.g. `]d`) and to [nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects?tab=readme-ov-file#text-objects-move) ⭐ 2,707 | 🐛 112 | 🌐 Tree-sitter Query | 📅 2026-03-21 (e.g. `]f`), in addition to repeating `t`/`T`/`f`/`F`.
...
* [nvim-mini/mini.nvim#mini.map](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.
...
* [nvim-mini/mini.nvim#mini.pairs](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
* [nvim-mini/mini.nvim#mini.trailspace](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
* [nvim-mini/mini.nvim#mini.operators](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
* [nvim-mini/mini.nvim#mini.move](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
* [nvim-mini/mini.nvim#mini.ai](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some built-in textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
* [nvim-mini/mini.nvim#mini.splitjoin](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
* [nvim-mini/mini.nvim#mini.basics](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.
* [windwp/nvim-autopairs](https://github.com/windwp/nvim-autopairs) ⭐ 3,975 | 🐛 16 | 🌐 Lua | 📅 2026-01-30 - A minimalist autopairs written by Lua.
* [nvim-treesitter/nvim-treesitter-context](https://github.com/nvim-treesitter/nvim-treesitter-context) ⭐ 3,142 | 🐛 21 | 🌐 Janet | 📅 2026-03-14 - Shows floating hover with the current function/block context.
...
* [shortcuts/no-neck-pain.nvim](https://github.com/shortcuts/no-neck-pain.nvim) ⭐ 919 | 🐛 16 | 🌐 Lua | 📅 2026-03-15 - Center the currently focused buffer to the middle of your terminal.
* [HiPhish/rainbow-delimiters.nvim](https://github.com/HiPhish/rainbow-delimiters.nvim) ⭐ 845 | 🐛 20 | 🌐 Lua | 📅 2026-03-18 - Rainbow delimiters with Tree-sitter.
* [nacro90/numb.nvim](https://github.com/nacro90/numb.nvim) ⭐ 845 | 🐛 1 | 🌐 Lua | 📅 2026-01-17 - Peek lines in a non-obtrusive way.
...
* [XXiaoA/atone.nvim](https://github.com/XXiaoA/atone.nvim) ⭐ 152 | 🐛 5 | 🌐 Lua | 📅 2026-03-01 - Undo tree for visualizing and managing undo history.
...
* [nvim-mini/mini.nvim#mini.comment](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.
...
* [folke/todo-comments.nvim](https://github.com/folke/todo-comments.nvim) ⭐ 4,092 | 🐛 20 | 🌐 Lua | 📅 2025-11-10 - Highlight, list and search TODO comments in your projects.
...
* [kevinhwang91/nvim-ufo](https://github.com/kevinhwang91/nvim-ufo) ⭐ 2,890 | 🐛 47 | 🌐 Lua | 📅 2026-01-11 - Ultra fold with modern looking and performance boosting.
* [chrisgrieser/nvim-origami](https://github.com/chrisgrieser/nvim-origami) ⭐ 477 | 🐛 2 | 🌐 Lua | 📅 2026-03-06 - Fold with relentless elegance.
...
* [nvim-mini/mini.nvim#mini.align](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for aligning text interactively (with or without instant preview).
* [stevearc/conform.nvim](https://github.com/stevearc/conform.nvim) ⭐ 4,988 | 🐛 87 | 🌐 Lua | 📅 2026-03-10 - A lightweight formatting engine that plays nice with LSP.
...
* [nvim-mini/mini.nvim#mini.indentscope](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.
...
* [shellRaining/hlchunk.nvim](https://github.com/shellRaining/hlchunk.nvim) ⭐ 895 | 🐛 32 | 🌐 Lua | 📅 2025-12-15 - A Lua implementation of `nvim-hlchunk`, contains more features, such as highlight `{}` chunk, indent line, space blank etc.
...
* [nvim-mini/mini.nvim#mini.cmdline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cmdline.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for command line tweaks. Adds autocompletion with customizable delay, autocorrection for words with fixed candidates, and autopeek command range in a floating window.
...
* [nvim-mini/mini.nvim#mini.sessions](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for session management (read, write, delete).
* [rmagatti/auto-session](https://github.com/rmagatti/auto-session) ⭐ 1,794 | 🐛 15 | 🌐 Lua | 📅 2026-02-15 - A small automated session manager.
...
* [gruvw/strudel.nvim](https://github.com/gruvw/strudel.nvim) ⭐ 406 | 🐛 5 | 🌐 JavaScript | 📅 2025-12-06 - Live coding controller for [strudel](https://strudel.cc).
* [brianhuster/live-preview.nvim](https://github.com/brianhuster/live-preview.nvim) ⭐ 361 | 🐛 25 | 🌐 Lua | 📅 2026-03-22 - Live preview HTML, Markdown and Asciidoc in the browser.
...
* [nvim-mini/mini.nvim#mini.bufremove](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.
...
* [nvim-zh/colorful-winsep.nvim](https://github.com/nvim-zh/colorful-winsep.nvim) ⭐ 661 | 🐛 1 | 🌐 Lua | 📅 2026-02-19 - A configurable color split line.
...
* [aikhe/wrapped.nvim](https://github.com/aikhe/wrapped.nvim) ⭐ 169 | 🐛 5 | 🌐 Lua | 📅 2026-03-20 - Visualize and review your configuration activity with stats, insights, history, heatmaps and more.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 55 | 🐛 4 | 🌐 Go | 📅 2026-03-22 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 29,917 | 🐛 25 | 🌐 Lua | 📅 2026-03-20 - A launch point for your personal Neovim configuration.
* [siduck76/NvChad](https://github.com/siduck76/NvChad) ⭐ 27,995 | 🐛 1 | 🌐 Lua | 📅 2026-02-07 - An attempt to make Neovim's CLI as functional as an IDE while retaining beauty with less bloat.
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 25,512 | 🐛 32 | 🌐 Lua | 📅 2026-03-21 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
* [LunarVim/LunarVim](https://github.com/LunarVim/LunarVim) ⭐ 19,257 | 🐛 34 | 🌐 Lua | 📅 2025-06-05 - This project aims to help one transition away from VSCode, and into a superior text editing experience.
* [AstroNvim/AstroNvim](https://github.com/AstroNvim/AstroNvim) ⭐ 14,205 | 🐛 1 | 🌐 Lua | 📅 2026-02-18 - An aesthetic and feature-rich config that is extensible and easy to use with a great set of plugins.
...
* [CosmicNvim/CosmicNvim](https://github.com/CosmicNvim/CosmicNvim) ⭐ 1,149 | 🐛 0 | 🌐 Lua | 📅 2026-03-21 - CosmicNvim is a lightweight and opinionated config for web development, specifically designed to provide a COSMIC programming experience!
* [dam9000/kickstart-modular.nvim](https://github.com/dam9000/kickstart-modular.nvim) ⭐ 955 | 🐛 0 | 🌐 Lua | 📅 2026-03-15 - This is a fork of nvim-lua/kickstart.nvim that moves from a single file to a multi file configuration.
...
* [nvim-mini/MiniMax](https://github.com/nvim-mini/MiniMax) ⭐ 349 | 🐛 2 | 🌐 Lua | 📅 2026-03-21 - A collection of self-contained and extensively commented configurations which mostly use MINI tools.
...
* [Abstract-IDE/Abstract](https://github.com/Abstract-IDE/Abstract) ⭐ 208 | 🐛 2 | 🌐 Lua | 📅 2026-03-19 - Configuration to achieve the power of Modern IDE.
* [shaeinst/roshnivim](https://github.com/shaeinst/roshnivim) ⭐ 208 | 🐛 2 | 🌐 Lua | 📅 2026-03-19 - A predefined config to save you thousands of hours to setup Neovim as an IDE.
...
* [sontungexpt/stinvim](https://github.com/sontungexpt/stinvim) ⭐ 49 | 🐛 1 | 🌐 Lua | 📅 2026-02-22 - Configuration for Full-Stack developers.
...
* [MordechaiHadad/bob](https://github.com/MordechaiHadad/bob) ⭐ 2,046 | 🐛 30 | 🌐 Rust | 📅 2026-03-08 - A cross-platform, easy to use Neovim version manager.
...
* [y3owk1n/nvs](https://github.com/y3owk1n/nvs) ⭐ 30 | 🐛 0 | 🌐 Go | 📅 2026-03-21 - Another Neovim version manager with config switcher.

### Plugin Template

* [ellisonleao/nvim-plugin-template](https://github.com/ellisonleao/nvim-plugin-template) ⭐ 466 | 🐛 2 | 🌐 Lua | 📅 2025-10-08 - Another Neovim plugin template, using GitHub's template feature.
...
* [m15a/flake-awesome-neovim-plugins](https://github.com/m15a/flake-awesome-neovim-plugins) ⭐ 62 | 🐛 0 | 🌐 Nix | 📅 2026-03-21 - Nix flake that provides a collection of `awesome-neovim` plugins as Nix packages.
* [iamironz/android-nvim-plugin](https://github.com/iamironz/android-nvim-plugin) ⭐ 44 | 🐛 1 | 🌐 Lua | 📅 2026-02-27 - Android build, deploy, and logcat commands with Gradle integration.
...
* [nvim-mini/mini.nvim#mini.notify](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) ⭐ 8,892 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.
* [folke/noice.nvim](https://github.com/folke/noice.nvim) ⭐ 5,654 | 🐛 27 | 🌐 Lua | 📅 2025-11-03 - Highly experimental plugin that completely replaces the UI for messages, cmdline and the popupmenu.
...
* [CosmicNvim/cosmic-ui](https://github.com/CosmicNvim/cosmic-ui) ⭐ 170 | 🐛 1 | 🌐 Lua | 📅 2026-03-21 - Cosmic-UI is a simple wrapper around specific Vim functionality.
