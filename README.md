...
* [rachartier/tiny-code-action.nvim](https://github.com/rachartier/tiny-code-action.nvim) ⭐ 451 | 🐛 0 | 🌐 Lua | 📅 2026-02-25 - Provides a simple way to run and visualize code actions with Telescope.
...
* [hrsh7th/nvim-cmp](https://github.com/hrsh7th/nvim-cmp) ⭐ 9,349 | 🐛 299 | 🌐 Lua | 📅 2026-01-23 - Completion engine written in Lua, successor of `nvim-compe`.
...
* [zootedb0t/citruszest.nvim](https://github.com/zootedb0t/citruszest.nvim) ⭐ 248 | 🐛 2 | 🌐 Lua | 📅 2025-06-16 - ***`[TS][LSP][Lua]`*** A colorscheme that features a combination of bright and juicy colors reminiscent of various citrus fruits, with LSP and Tree-sitter support.
...
* [hadishahpuri/nvimlaunch](https://github.com/hadishahpuri/nvimlaunch) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2026-03-02 - Define, run, and manage project-specific commands.
...
* [DrKJeff16/wezterm-types](https://github.com/DrKJeff16/wezterm-types) ⭐ 183 | 🐛 1 | 🌐 Lua | 📅 2026-03-09 - WezTerm config type annotations for LuaLS, including support for community plugins.
...
* [Olical/conjure](https://github.com/Olical/conjure) ⭐ 2,067 | 🐛 96 | 🌐 Fennel | 📅 2026-02-13 - Interactive evaluation (Clojure, Fennel, Janet, Racket, Hy, MIT Scheme, Guile).
...
* [nvim-mini/MiniMax](https://github.com/nvim-mini/MiniMax) ⭐ 333 | 🐛 2 | 🌐 Lua | 📅 2026-02-19 - A collection of self-contained and extensively commented configurations which mostly use MINI tools.
