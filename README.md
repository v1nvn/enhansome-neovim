...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 20,240 | 🐛 50 | 🌐 Lua | 📅 2025-12-17 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [nvim-mini/mini.nvim#mini.deps](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.
...
* [wsdjeg/nvim-plug](https://github.com/wsdjeg/nvim-plug) ⭐ 30 | 🐛 1 | 🌐 Lua | 📅 2026-02-01 - Asynchronous plugin manager written in Lua.
...
* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,339 | 🐛 34 | 🌐 Lua | 📅 2026-02-12 - Quickstart configurations for the LSP client.

<!--lint enable awesome-spell-check-->

* [nvimdev/lspsaga.nvim](https://github.com/nvimdev/lspsaga.nvim) ⭐ 3,745 | 🐛 100 | 🌐 Lua | 📅 2025-06-25 - A light-weight LSP plugin based on the built-in LSP with a highly performant UI.
* [mfussenegger/nvim-lint](https://github.com/mfussenegger/nvim-lint) ⭐ 2,639 | 🐛 44 | 🌐 Lua | 📅 2026-01-31 - An asynchronous linter plugin, complementary to the built-in Language Server Protocol support.
* [j-hui/fidget.nvim](https://github.com/j-hui/fidget.nvim) ⭐ 2,473 | 🐛 19 | 🌐 Lua | 📅 2026-01-13 - Standalone UI for LSP progress.
...
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 970 | 🐛 11 | 🌐 Lua | 📅 2026-02-12 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,642 | 🐛 111 | 🌐 JavaScript | 📅 2026-02-12 catalog.
* [hedyhli/outline.nvim](https://github.com/hedyhli/outline.nvim) ⭐ 955 | 🐛 31 | 🌐 Lua | 📅 2026-01-31 - A significantly enhanced and refactored fork of `symbols-outline.nvim`.
...
* [tamago324/nlsp-settings.nvim](https://github.com/tamago324/nlsp-settings.nvim) ⭐ 336 | 🐛 10 | 🌐 Lua | 📅 2026-02-13 - Setup LSP with JSON or YAML files.
...
* [nvimtools/none-ls.nvim](https://github.com/nvimtools/none-ls.nvim) ⭐ 3,213 | 🐛 8 | 🌐 Lua | 📅 2026-02-04 - Null-ls.nvim reloaded / Use Neovim as a language server to inject LSP diagnostics, code actions, and more via Lua.
* [mrcjkb/rustaceanvim](https://github.com/mrcjkb/rustaceanvim) ⭐ 2,832 | 🐛 19 | 🌐 Lua | 📅 2026-02-08 - A heavily modified fork of rust-tools.nvim that does not require a `setup` call and does not depend on nvim-lspconfig.
...
* [mfussenegger/nvim-jdtls](https://github.com/mfussenegger/nvim-jdtls) ⭐ 1,434 | 🐛 1 | 🌐 Lua | 📅 2026-02-10 - Extensions for the built-in LSP support for the Eclipse JDT Language Server.
...
* [jmbuhr/otter.nvim](https://github.com/jmbuhr/otter.nvim) ⭐ 836 | 🐛 16 | 🌐 Lua | 📅 2026-02-10 - Provides LSP features and a nvim-cmp completion source for languages embedded in other documents.
...
* [mrcjkb/haskell-tools.nvim](https://github.com/mrcjkb/haskell-tools.nvim) ⭐ 569 | 🐛 22 | 🌐 Lua | 📅 2026-02-09 - Seamless integration for Haskell development tools like `haskell-language-server` and Hoogle.
...
* [rachartier/tiny-code-action.nvim](https://github.com/rachartier/tiny-code-action.nvim) ⭐ 446 | 🐛 0 | 🌐 Lua | 📅 2026-02-07 - Provides a simple way to run and visualize code actions with Telescope.
* [soulis-1256/eagle.nvim](https://github.com/soulis-1256/eagle.nvim) ⭐ 340 | 🐛 0 | 🌐 Lua | 📅 2026-02-09 - Mouse-hover LSP hints.
...
* [amrbashir/nvim-docs-view](https://github.com/amrbashir/nvim-docs-view) ⭐ 176 | 🐛 0 | 🌐 Lua | 📅 2025-08-12 - Display LSP hover documentation in a side panel.
...
* [mason-org/mason.nvim](https://github.com/mason-org/mason.nvim) ⭐ 10,023 | 🐛 267 | 🌐 Lua | 📅 2026-01-07 - Portable package manager that runs everywhere Neovim runs. Easily install and manage LSP servers, DAP servers, linters, and formatters.

### Diagnostics

* [folke/trouble.nvim](https://github.com/folke/trouble.nvim) ⭐ 6,670 | 🐛 17 | 🌐 Lua | 📅 2025-10-31 - A pretty diagnostics list to help you solve all the trouble your code is causing.
* [piersolenski/wtf.nvim](https://github.com/piersolenski/wtf.nvim) ⭐ 577 | 🐛 1 | 🌐 Lua | 📅 2026-02-02 - AI powered diagnostic debugging, helps explain complex errors and offers custom tailored solutions.
* [artemave/workspace-diagnostics.nvim](https://github.com/artemave/workspace-diagnostics.nvim) ⭐ 241 | 🐛 2 | 🌐 Lua | 📅 2025-05-25 - Populate diagnostics for all projects files, not just the opened ones.
...
* [hrsh7th/nvim-cmp](https://github.com/hrsh7th/nvim-cmp) ⭐ 9,324 | 🐛 297 | 🌐 Lua | 📅 2026-01-23 - Completion engine written in Lua, successor of `nvim-compe`.
...
* [nvim-mini/mini.nvim#mini.completion](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 5,925 | 🐛 141 | 🌐 Lua | 📅 2026-02-13 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [mikavilpas/blink-ripgrep.nvim](https://github.com/mikavilpas/blink-ripgrep.nvim) ⭐ 111 | 🐛 3 | 🌐 Lua | 📅 2026-02-12 - `blink.cmp` source for `ripgrep` / `git grep`.
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 10 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 41,704 | 🐛 39 | 🌐 C | 📅 2026-02-12.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 3,957 | 🐛 33 | 🌐 Lua | 📅 2026-02-12 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,347 | 🐛 46 | 🌐 Vim Script | 📅 2026-01-09.
* [ms-jpq/coq\_nvim](https://github.com/ms-jpq/coq_nvim) ⭐ 3,773 | 🐛 186 | 🌐 Python | 📅 2026-01-06 - Fast as FUCK completion. SQLite, concurrent scheduler, hundreds of hours of optimization.
...
* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 17,360 | 🐛 71 | 🌐 Lua | 📅 2026-02-03 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,128 | 🐛 22 | 🌐 Lua | 📅 2026-02-12 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
...
* [CopilotC-Nvim/CopilotChat.nvim](https://github.com/CopilotC-Nvim/CopilotChat.nvim) ⭐ 3,555 | 🐛 19 | 🌐 Lua | 📅 2026-02-12 - A chat interface for GitHub Copilot that allows you to directly ask and receive answers to coding-related questions.
...
* [milanglacier/minuet-ai.nvim](https://github.com/milanglacier/minuet-ai.nvim) ⭐ 1,005 | 🐛 14 | 🌐 Lua | 📅 2026-02-03 - Minuet offers code completion from LLM providers including OpenAI (compatible), Gemini, Claude, Ollama, Deepseek and more providers, with support for nvim-cmp, blink.cmp and virtual-text frontend.
* [Davidyz/VectorCode](https://github.com/davidyz/vectorcode) ⭐ 796 | 🐛 14 | 🌐 Python | 📅 2025-12-26 - Supercharge your LLM experience with repository-level RAG.
...
* [Kurama622/llm.nvim](https://github.com/Kurama622/llm.nvim) ⭐ 456 | 🐛 4 | 🌐 Lua | 📅 2026-02-12 - Free large language model (LLM) support, provides commands to interact with LLM.
* [dlants/magenta.nvim](https://github.com/dlants/magenta.nvim) ⭐ 425 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-12 - Leverage coding assistants for chat and code generation. Provides tools for the AI/LLM agent to explore and edit your code, like Aider, Cursor and Windsurf.
...
* [carlos-algms/agentic.nvim](https://github.com/carlos-algms/agentic.nvim) ⭐ 198 | 🐛 9 | 🌐 Lua | 📅 2026-02-11 - Chat interface for AI ACP providers such as Claude, Gemini, Codex, OpenCode and Cursor.
...
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 8 | 🐛 4 | 🌐 Lua | 📅 2025-12-31 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 11,125 | 🐛 557 | 🌐 Python | 📅 2026-02-07 tool.
...
* [chomosuke/typst-preview.nvim](https://github.com/chomosuke/typst-preview.nvim) ⭐ 826 | 🐛 13 | 🌐 Lua | 📅 2025-12-31 - Preview Typst documents in the browser, instant update on each keystroke, and cross jump between code and preview.
...
* [mistweaverco/kulala.nvim](https://github.com/mistweaverco/kulala.nvim) ⭐ 1,893 | 🐛 10 | 🌐 Lua | 📅 2026-02-11 - A minimal HTTP-client interface.
...
* [yelog/i18n.nvim](https://github.com/yelog/i18n.nvim) ⭐ 52 | 🐛 2 | 🌐 Lua | 📅 2026-01-25 - Internationalization (i18n) management with LSP support for `Vue`, `React`, `Java` and more.
...
* [iamcco/markdown-preview.nvim](https://github.com/iamcco/markdown-preview.nvim) ⭐ 7,688 | 🐛 257 | 🌐 JavaScript | 📅 2024-07-23 - Preview Markdown on your modern browser with synchronised scrolling and flexible configuration.
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 4,110 | 🐛 10 | 🌐 Lua | 📅 2026-02-03 - Improve viewing Markdown files directly.
* [OXY2DEV/markview.nvim](https://github.com/OXY2DEV/markview.nvim) ⭐ 3,262 | 🐛 3 | 🌐 Lua | 📅 2026-02-02 - A hackable Markdown, Typst, LaTeX, HTML (inline) and YAML renderer.
* [toppair/peek.nvim](https://github.com/toppair/peek.nvim) ⭐ 835 | 🐛 37 | 🌐 TypeScript | 📅 2024-08-20 - Preview Markdown in a webview window.
...
* [Zeioth/markmap.nvim](https://github.com/Zeioth/markmap.nvim) ⭐ 234 | 🐛 2 | 🌐 Lua | 📅 2025-11-11 - Visualize your Markdown as mindmaps.
* [tadmccorkle/markdown.nvim](https://github.com/tadmccorkle/markdown.nvim) ⭐ 227 | 🐛 8 | 🌐 Lua | 📅 2025-12-22 - Configurable tools for Markdown files, including inline-style, link, and navigation keymaps, table of contents, improved list editing, and more.
...
* [rogue-87/inlyne.nvim](https://github.com/rogue-87/inlyne.nvim) ⭐ 3 | 🐛 0 | 🌐 Lua | 📅 2026-02-05 - Wrapper for [inlyne](https://github.com/Inlyne-Project/inlyne) ⭐ 1,257 | 🐛 56 | 🌐 Rust | 📅 2025-12-19 Markdown viewer.
...
* [nvim-treesitter/nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter) ⭐ 13,258 | 🐛 267 | 🌐 Tree-sitter Query | 📅 2026-02-11 - Tree-sitter configurations and abstraction layer.
* [nvim-mini/mini.nvim#mini.surround](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-surround.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for working with text surroundings (add, delete, replace, find, highlight). Supports dot-repeat, different search methods, "last"/"next" extended mappings, Tree-sitter integration, and more.
* [kylechui/nvim-surround](https://github.com/kylechui/nvim-surround) ⭐ 4,103 | 🐛 9 | 🌐 Lua | 📅 2025-12-14 - A plugin for adding/changing/deleting surrounding delimiter pairs.
* [nvim-treesitter/nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects) ⭐ 2,651 | 🐛 109 | 🌐 Tree-sitter Query | 📅 2026-01-28 - Create your own textobjects using Tree-sitter queries.
...
* [IndianBoy42/tree-sitter-just](https://github.com/IndianBoy42/tree-sitter-just) ⭐ 179 | 🐛 4 | 🌐 Just | 📅 2026-02-09 - Tree-sitter grammar for [Justfiles](https://github.com/casey/just) ⭐ 31,209 | 🐛 387 | 🌐 Rust | 📅 2026-02-11.
...
* [MeanderingProgrammer/treesitter-modules.nvim](https://github.com/MeanderingProgrammer/treesitter-modules.nvim) ⭐ 147 | 🐛 0 | 🌐 Lua | 📅 2026-02-05 - Original modules from nvim-treesitter master branch.
...
* [nvim-mini/mini.nvim#mini.snippets](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.
* [L3MON4D3/LuaSnip](https://github.com/L3MON4D3/LuaSnip) ⭐ 4,270 | 🐛 128 | 🌐 Lua | 📅 2026-01-19 - A snippet engine written in Lua.
* [rafamadriz/friendly-snippets](https://github.com/rafamadriz/friendly-snippets) ⭐ 2,646 | 🐛 66 | 🌐 Lua | 📅 2026-01-23 - Set of preconfigured snippets for different languages.
...
* [ThePrimeagen/harpoon](https://github.com/ThePrimeagen/harpoon/tree/harpoon2) ⭐ 8,890 | 🐛 150 | 🌐 Lua | 📅 2025-10-31 - A per project, auto updating and editable marks utility for fast file navigation.
...
* [kevinhwang91/nvim-hlslens](https://github.com/kevinhwang91/nvim-hlslens) ⭐ 892 | 🐛 9 | 🌐 Lua | 📅 2026-01-11 - Helps you better glance searched information, seamlessly jump matched instances.
...
* [ray-x/sad.nvim](https://github.com/ray-x/sad.nvim) ⭐ 203 | 🐛 4 | 🌐 Lua | 📅 2025-05-01 - Space Age seD integration. Batch file edit tool, a wrapper for [sad](https://github.com/ms-jpq/sad) ⭐ 2,002 | 🐛 28 | 🌐 Rust | 📅 2025-09-30
...
* [2KAbhishek/seeker.nvim](https://github.com/2KAbhishek/seeker.nvim) ⭐ 119 | 🐛 2 | 🌐 Lua | 📅 2026-02-10 - Progressive file seeker built on top of `snacks.nvim`.
...
* [polirritmico/telescope-lazy-plugins.nvim](https://github.com/polirritmico/telescope-lazy-plugins.nvim) ⭐ 72 | 🐛 0 | 🌐 Lua | 📅 2025-02-15 - A Telescope picker to quickly access plugins configurations from the lazy.nvim spec.
...
* [bravoecho/brook.nvim](https://github.com/bravoecho/brook.nvim) ⭐ 10 | 🐛 0 | 🌐 Lua | 📅 2026-02-12 - Responsive, shell-safe ripgrep search for the quickfix list, with native n/N navigation.
...
* [nvim-telescope/telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) ⭐ 19,038 | 🐛 484 | 🌐 Lua | 📅 2026-02-03 - Telescope.nvim is a highly [extendable](https://github.com/nvim-telescope/telescope.nvim/wiki/Extensions) ⭐ 19,038 | 🐛 484 | 🌐 Lua | 📅 2026-02-03 A highly extensible fuzzy finder over lists.
* [nvim-mini/mini.nvim#mini.fuzzy](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
* [nvim-mini/mini.nvim#mini.pick](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
* [nvim-mini/mini.nvim#mini.extra](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.
* [folke/snacks.nvim#picker](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) ⭐ 7,049 | 🐛 90 | 🌐 Lua | 📅 2025-11-18 - A modern fuzzy-finder to navigate the Neovim universe.
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,062 | 🐛 9 | 🌐 Lua | 📅 2026-02-12 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,553 | 🐛 28 | 🌐 Rust | 📅 2026-02-12 as its fzf binary.
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 1,301 | 🐛 47 | 🌐 Rust | 📅 2026-02-12 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 367 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 33,344 | 🐛 152 | 🌐 Rust | 📅 2026-02-07, a smart directory picker that tracks your usage.
...
* [nvim-mini/mini.nvim#mini.files](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.
* [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) ⭐ 8,368 | 🐛 100 | 🌐 Lua | 📅 2026-02-13 - A simple and fast file explorer tree.
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,236 | 🐛 122 | 🌐 Lua | 📅 2026-01-17 - Edit your filesystem like a buffer.
...
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,684 | 🐛 93 | 🌐 Python | 📅 2026-02-13 - File manager. Better than NERDTree.
* [mikavilpas/yazi.nvim](https://github.com/mikavilpas/yazi.nvim) ⭐ 1,540 | 🐛 10 | 🌐 Lua | 📅 2026-02-12 - Integration with the Yazi terminal file manager.
...
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 450 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,231 | 🐛 1 | 🌐 C | 📅 2026-02-08 and Lua.
...
* [kelly-lin/ranger.nvim](https://github.com/kelly-lin/ranger.nvim) ⭐ 179 | 🐛 11 | 🌐 Lua | 📅 2024-11-18 - [Ranger](https://github.com/ranger/ranger) ⭐ 16,859 | 🐛 925 | 🌐 Python | 📅 2026-01-22 integration.
* [Xuyuanp/yanil](https://github.com/Xuyuanp/yanil) ⭐ 98 | 🐛 5 | 🌐 Lua | 📅 2026-01-15 - Yet Another Nerdtree In Lua.
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 96 | 🐛 2 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 32,554 | 🐛 65 | 🌐 Rust | 📅 2026-02-11).
...
* [nvim-mini/mini.nvim#mini.visits](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.
...
* [mrjones2014/codesettings.nvim](https://github.com/mrjones2014/codesettings.nvim) ⭐ 49 | 🐛 0 | 🌐 Lua | 📅 2026-02-13 - Easily load project-local settings (like `.vscode/settings.json`) into Neovim 0.11+ native LSP settings.
...
* [nvim-mini/mini.nvim#mini.hipatterns](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.
...
* [catgoose/nvim-colorizer.lua](https://github.com/catgoose/nvim-colorizer.lua) ⭐ 993 | 🐛 18 | 🌐 Lua | 📅 2026-01-31 - A high-performance color highlighter which has no external dependencies.
...
* [xzbdmw/colorful-menu.nvim](https://github.com/xzbdmw/colorful-menu.nvim) ⭐ 440 | 🐛 2 | 🌐 Lua | 📅 2025-11-25 - Colorize your auto completion menu using Tree-sitter.
...
* [folke/tokyonight.nvim](https://github.com/folke/tokyonight.nvim) ⭐ 7,802 | 🐛 16 | 🌐 Lua | 📅 2025-11-05 - ***`[TS][LSP][L/D][Lua]`*** A clean, dark and light theme written in Lua, with support for LSP, Tree-sitter and lots of plugins.
* [sainnhe/everforest](https://github.com/sainnhe/everforest) ⭐ 3,857 | 🐛 7 | 🌐 Vim Script | 📅 2026-01-21 - ***`[TS][LSP][L/D]`*** A green based colorscheme designed to be warm, soft and easy on the eyes.
...
* [navarasu/onedark.nvim](https://github.com/navarasu/onedark.nvim) ⭐ 1,925 | 🐛 55 | 🌐 Lua | 📅 2025-11-24 - ***`[TS][LSP][Lua]`*** A One Dark Theme written in Lua based on Atom's One Dark Theme.
...
* [bluz71/vim-moonfly-colors](https://github.com/bluz71/vim-moonfly-colors) ⭐ 1,246 | 🐛 0 | 🌐 Lua | 📅 2026-01-18 - ***`[TS][LSP][Lua]`*** A dark charcoal colorscheme with Tree-sitter support.
...
* [Mofiqul/vscode.nvim](https://github.com/Mofiqul/vscode.nvim) ⭐ 943 | 🐛 51 | 🌐 Lua | 📅 2025-12-03 - ***`[TS][L/D][Lua]`*** A Lua port of vim-code-dark colorscheme with VSCode light and dark theme.
...
* [fenetikm/falcon](https://github.com/fenetikm/falcon) ⭐ 825 | 🐛 12 | 🌐 Vim Script | 📅 2025-10-26 - ***`[TS][Lua]`*** A colour scheme for terminals, Vim and friends.
* [Mofiqul/dracula.nvim](https://github.com/Mofiqul/dracula.nvim) ⭐ 759 | 🐛 24 | 🌐 Lua | 📅 2025-11-05 - ***`[TS]`*** Dracula colorscheme written in Lua.
* [everviolet/nvim](https://github.com/everviolet/nvim) ⭐ 576 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - ***`[TS][LSP][L/D][Lua]`*** A comfy colorscheme for cozy morning coding.
* [neanias/everforest-nvim](https://github.com/neanias/everforest-nvim) ⭐ 417 | 🐛 7 | 🌐 Lua | 📅 2025-11-02 - ***`[TS][LSP][L/D][Lua]`*** A Lua port of the Everforest colour scheme.
...
* [rockerBOO/boo-colorscheme-nvim](https://github.com/rockerBOO/boo-colorscheme-nvim) ⭐ 236 | 🐛 4 | 🌐 Lua | 📅 2026-02-10 - ***`[TS][Lua]`*** A colorscheme with handcrafted support for LSP, Tree-sitter.
...
* [rose-pine/neovim](https://github.com/rose-pine/neovim) ⭐ 2,939 | 🐛 5 | 🌐 Lua | 📅 2025-12-21 - ***`[TS][LSP][L/D][Lua]`*** All natural pine, faux fur and a bit of soho vibes for the classy minimalist.

<!--lint enable awesome-spell-check-->

* [nvim-mini/mini.nvim#colorschemes](https://github.com/nvim-mini/mini.nvim#plugin-color-schemes) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - ***`[TS][LSP][L/D][Lua]`*** Color schemes included in `mini.nvim`. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.
* [catppuccin/nvim](https://github.com/catppuccin/nvim) ⭐ 7,195 | 🐛 15 | 🌐 Lua | 📅 2026-02-02 - ***`[TS][LSP][L/D][Lua]`*** Warm mid-tone dark theme to show off your vibrant self! With support for native LSP, Tree-sitter, and more.
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 5,903 | 🐛 90 | 🌐 Lua | 📅 2025-10-15 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
* [EdenEast/nightfox.nvim](https://github.com/EdenEast/nightfox.nvim) ⭐ 3,895 | 🐛 36 | 🌐 Lua | 📅 2025-02-09 - ***`[TS][LSP][L/D][Lua]`*** A soft dark, fully customizable colorscheme with support for LSP, Tree-sitter and a variety of plugins.
* [ellisonleao/gruvbox.nvim](https://github.com/ellisonleao/gruvbox.nvim) ⭐ 2,463 | 🐛 27 | 🌐 Lua | 📅 2026-01-13 - ***`[TS][LSP][L/D][Lua]`*** Gruvbox community colorscheme Lua port.
...
* [xero/miasma.nvim](https://github.com/xero/miasma.nvim) ⭐ 486 | 🐛 5 | 🌐 Vim Script | 📅 2025-07-12 - ***`[TS][LSP]`*** A dark pastel color scheme inspired by the woods. Built using lush and supports Tree-sitter, diagnostics, CMP, Git-Signs, Telescope, Which-key, Lazy, and more.
* [luisiacc/gruvbox-baby](https://github.com/luisiacc/gruvbox-baby) ⭐ 448 | 🐛 8 | 🌐 Lua | 📅 2024-01-25 - ***`[TS][LSP][Lua]`*** A modern gruvbox theme with full Tree-sitter support.
* [ribru17/bamboo.nvim](https://github.com/ribru17/bamboo.nvim) ⭐ 443 | 🐛 2 | 🌐 Lua | 📅 2025-11-25 - ***`[TS][LSP][Lua]`*** A warm green theme.
...
* [HoNamDuong/hybrid.nvim](https://github.com/HoNamDuong/hybrid.nvim) ⭐ 146 | 🐛 0 | 🌐 Lua | 📅 2026-02-12 - ***`[TS][LSP][Lua]`*** A dark theme written in Lua.
...
* [calind/selenized.nvim](https://github.com/calind/selenized.nvim) ⭐ 29 | 🐛 3 | 🌐 Lua | 📅 2025-08-06 - ***`[TS][LSP][L/D][Lua]`*** Lua port of [selenized](https://github.com/jan-warchol/selenized) ⭐ 889 | 🐛 57 | 🌐 Emacs Lisp | 📅 2025-09-28 with support for Tree-sitter, `nvim-cmp`, GitSigns, and more.
...
* [nvim-mini/mini.nvim#mini.base16](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
* [nvim-mini/mini.nvim#mini.colors](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
* [nvim-mini/mini.nvim#mini.hues](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.
...
* [DrKJeff16/which-colorscheme.nvim](https://github.com/DrKJeff16/which-colorscheme.nvim) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2026-02-12 - Cycle between colorschemes using either custom or autogenerated `which-key.nvim` bindings.
...
* [SmiteshP/nvim-navic](https://github.com/SmiteshP/nvim-navic) ⭐ 1,634 | 🐛 28 | 🌐 Lua | 📅 2025-12-29 - A simple statusline/winbar component that uses LSP to show your current code context.
* [Bekaboo/dropbar.nvim](https://github.com/Bekaboo/dropbar.nvim) ⭐ 1,494 | 🐛 9 | 🌐 Lua | 📅 2025-10-05 - IDE-like breadcrumbs, out of the box.
* [utilyre/barbecue.nvim](https://github.com/utilyre/barbecue.nvim) ⚠️ Archived - A VSCode like winbar.
* [luukvbaal/statuscol.nvim](https://github.com/luukvbaal/statuscol.nvim) ⭐ 598 | 🐛 9 | 🌐 Lua | 📅 2025-06-02 - Configurable 'statuscolumn' with built-in segments and click handlers.
...
* [Bekaboo/deadcolumn.nvim](https://github.com/Bekaboo/deadcolumn.nvim) ⭐ 341 | 🐛 2 | 🌐 Lua | 📅 2025-09-04 - Shows your colorcolumn dynamically.
...
* [OXY2DEV/bars.nvim](https://github.com/OXY2DEV/bars.nvim) ⭐ 91 | 🐛 1 | 🌐 Lua | 📅 2026-02-12 - A starting point/guide for creating custom statusline, statuscolumn, tabline and winbar.
...
* [nvim-mini/mini.nvim#mini.statusline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.
* [nvim-lualine/lualine.nvim](https://github.com/nvim-lualine/lualine.nvim) ⭐ 7,732 | 🐛 265 | 🌐 Lua | 📅 2025-11-23 - Easily configurable, blazingly fast statusline.
...
* [nvim-mini/mini.nvim#mini.tabline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.
...
* [romgrk/barbar.nvim](https://github.com/romgrk/barbar.nvim) ⭐ 2,644 | 🐛 32 | 🌐 Lua | 📅 2025-12-02 - A tabline with re-orderable, auto-sizing, clickable tabs, icons, nice highlighting, sort-by commands and a magic jump-to-buffer mode.
...
* [nvim-mini/mini.nvim#mini.cursorword](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).
* [RRethy/vim-illuminate](https://github.com/RRethy/vim-illuminate) ⭐ 2,435 | 🐛 11 | 🌐 Lua | 📅 2025-05-24 - Highlight the word under the cursor with built-in LSP support.
* [ya2s/nvim-cursorline](https://github.com/ya2s/nvim-cursorline) ⭐ 456 | 🐛 12 | 🌐 Lua | 📅 2026-02-13 - Highlights cursor words and lines.
...
* [nvim-mini/mini.nvim#mini.starter](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.
* [nvimdev/dashboard-nvim](https://github.com/nvimdev/dashboard-nvim) ⭐ 2,774 | 🐛 73 | 🌐 Lua | 📅 2025-08-31 - A minimalist dashboard, inspired by doom-emacs.
* [goolord/alpha-nvim](https://github.com/goolord/alpha-nvim) ⭐ 2,324 | 🐛 40 | 🌐 Lua | 📅 2026-02-10 - A fast and highly customizable greeter like [vim-startify](https://github.com/mhinz/vim-startify) ⭐ 5,387 | 🐛 80 | 🌐 Vim Script | 📅 2024-01-05/dashboard-nvim.
...
* [nvim-mini/mini.nvim#mini.icons](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-icons.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` meant as a general icon provider. Uses fixed set of highlight groups. Supports various categories, icon and style customizations, caching for performance. Integrates with built-in filetype matching.
* [nvim-tree/nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons) ⭐ 2,607 | 🐛 18 | 🌐 Lua | 📅 2026-02-05 - A Lua fork of [vim-devicons](https://github.com/ryanoasis/vim-devicons) ⭐ 5,792 | 🐛 70 | 🌐 Vim Script | 📅 2024-05-09.
...
* [vyfor/cord.nvim](https://github.com/vyfor/cord.nvim) ⭐ 556 | 🐛 0 | 🌐 Lua | 📅 2026-02-08 - Highly extensible Rich Presence for Discord.
...
* [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ⭐ 7,210 | 🐛 219 | 🌐 Lua | 📅 2026-02-01 - Modernity meets insane extensibility. The future of organizing your life.
* [nvim-orgmode/orgmode](https://github.com/nvim-orgmode/orgmode) ⭐ 3,668 | 🐛 135 | 🌐 Lua | 📅 2026-02-11 - Org-mode clone written in Lua.
* [nvim-telekasten/telekasten.nvim](https://github.com/nvim-telekasten/telekasten.nvim) ⭐ 1,635 | 🐛 66 | 🌐 Lua | 📅 2026-02-03 - Work with a text-based, Markdown zettelkasten / wiki and mix it with a journal, based on telescope.nvim.
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 1,530 | 🐛 71 | 🌐 Lua | 📅 2026-02-11 - Plugin for Obsidian, written in Lua.
* [jbyuki/venn.nvim](https://github.com/jbyuki/venn.nvim) ⭐ 1,149 | 🐛 4 | 🌐 Lua | 📅 2024-08-16 - Draw ASCII diagrams.
...
* [jakewvincent/mkdnflow.nvim](https://github.com/jakewvincent/mkdnflow.nvim) ⭐ 776 | 🐛 27 | 🌐 Lua | 📅 2026-02-13 - Fluent Markdown notebook navigation and management (create links, follow links, create and manage to-do lists, reference bib files, and more).
...
* [ymich9963/mdnotes.nvim](https://github.com/ymich9963/mdnotes.nvim) ⭐ 6 | 🐛 3 | 🌐 Lua | 📅 2026-02-12 - Simple and improved Markdown note taking.
...
* [AlejandroSuero/freeze-code.nvim](https://github.com/AlejandroSuero/freeze-code.nvim) ⭐ 31 | 🐛 2 | 🌐 Lua | 📅 2025-03-15 - Code screenshot plugin that makes use of [freeze](https://github.com/charmbracelet/freeze) ⭐ 4,338 | 🐛 66 | 🌐 Go | 📅 2026-02-09 inside the editor.
...
* [theKnightsOfRohan/csvlens.nvim](https://github.com/theKnightsOfRohan/csvlens.nvim) ⭐ 39 | 🐛 1 | 🌐 Lua | 📅 2024-04-28 - A port of [YS-L/csvlens](https://github.com/YS-L/csvlens) ⭐ 3,450 | 🐛 53 | 🌐 Rust | 📅 2026-02-02, for easy previewing of tabular data.
...
* [nvim-mini/mini.nvim#mini.animate](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).
* [sphamba/smear-cursor.nvim](https://github.com/sphamba/smear-cursor.nvim) ⭐ 1,658 | 🐛 6 | 🌐 Lua | 📅 2025-12-01 - Animate the cursor with a smear effect in all terminals. Inspired by Neovide's animated cursor.
...
* [akinsho/toggleterm.nvim](https://github.com/akinsho/toggleterm.nvim) ⭐ 5,365 | 🐛 84 | 🌐 Lua | 📅 2025-03-09 - Easily manage multiple terminal windows.
* [kassio/neoterm](https://github.com/kassio/neoterm) ⭐ 1,337 | 🐛 31 | 🌐 Vim Script | 📅 2023-03-09 - Wrapper of some `:terminal` functions.
* [mikesmithgh/kitty-scrollback.nvim](https://github.com/mikesmithgh/kitty-scrollback.nvim) ⭐ 817 | 🐛 29 | 🌐 Lua | 📅 2026-01-21 - Open your Kitty scrollback buffer. Ameowzing.
...
* [jlesquembre/nterm.nvim](https://github.com/jlesquembre/nterm.nvim) ⭐ 58 | 🐛 1 | 🌐 Lua | 📅 2026-02-10 - Interact with the terminal, with notifications.
...
* [mfussenegger/nvim-dap](https://github.com/mfussenegger/nvim-dap) ⭐ 6,937 | 🐛 29 | 🌐 Lua | 📅 2026-02-11 - Debug Adapter Protocol client implementation.
* [rcarriga/nvim-dap-ui](https://github.com/rcarriga/nvim-dap-ui) ⭐ 3,278 | 🐛 107 | 🌐 Lua | 📅 2025-07-09 - A UI for nvim-dap.
...
* [igorlfs/nvim-dap-view](https://github.com/igorlfs/nvim-dap-view) ⭐ 623 | 🐛 7 | 🌐 Lua | 📅 2026-02-11 - A modern, minimalistic UI for nvim-dap.
* [andrewferrier/debugprint.nvim](https://github.com/andrewferrier/debugprint.nvim) ⭐ 508 | 🐛 10 | 🌐 Lua | 📅 2026-02-12 - Debugging the print() way.
...
* [t-troebst/perfanno.nvim](https://github.com/t-troebst/perfanno.nvim) ⭐ 357 | 🐛 1 | 🌐 Lua | 📅 2026-01-20 - Annotate your code with callgraph profiling data. Native support for perf, flamegraph and the LuaJit profiler.
...
* [kevinhwang91/nvim-bqf](https://github.com/kevinhwang91/nvim-bqf) ⭐ 1,988 | 🐛 17 | 🌐 Lua | 📅 2026-02-02 - Makes the quickfix window better.
* [stevearc/quicker.nvim](https://github.com/stevearc/quicker.nvim) ⭐ 911 | 🐛 16 | 🌐 Lua | 📅 2026-01-12 - Improved quickfix UI and editable quickfix buffer.
...
* [nvim-neotest/neotest](https://github.com/nvim-neotest/neotest) ⭐ 3,018 | 🐛 104 | 🌐 Lua | 📅 2025-11-08 - An extensible framework for interacting with tests within Neovim.
...
* [Vigemus/iron.nvim](https://github.com/Vigemus/iron.nvim) ⭐ 1,294 | 🐛 56 | 🌐 Lua | 📅 2026-01-05 - Interactive REPLs of over 30 languages embedded.
* [benlubas/molten-nvim](https://github.com/benlubas/molten-nvim) ⭐ 1,102 | 🐛 38 | 🌐 Python | 📅 2025-11-05 - Enables running code chunks via the Jupyter kernel. Output (including image output) is rendered in a floating window below the code.
* [CRAG666/code\_runner.nvim](https://github.com/CRAG666/code_runner.nvim) ⭐ 675 | 🐛 8 | 🌐 Lua | 📅 2025-10-19 - The best code runner you could have, with super powers.
...
* [Civitasv/cmake-tools.nvim](https://github.com/Civitasv/cmake-tools.nvim) ⭐ 522 | 🐛 24 | 🌐 Lua | 📅 2026-02-12 - CMake integration.
...
* [nvim-mini/mini.nvim#mini.doc](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
* [nvim-mini/mini.nvim#mini.test](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` with framework for writing extensive Neovim plugin tests with support for hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.
* [nvim-lua/plenary.nvim](https://github.com/nvim-lua/plenary.nvim) ⭐ 3,380 | 🐛 156 | 🌐 Lua | 📅 2025-07-26 - Plenary: full; complete; entire; absolute; unqualified. All the Lua functions I don't want to write twice.
* [MunifTanjim/nui.nvim](https://github.com/MunifTanjim/nui.nvim) ⭐ 2,023 | 🐛 30 | 🌐 Lua | 📅 2025-06-08 - UI Component Library.
* [folke/lazydev.nvim](https://github.com/folke/lazydev.nvim) ⭐ 1,449 | 🐛 6 | 🌐 Lua | 📅 2025-11-06 - Faster LuaLS setup.
...
* [lumen-oss/lz.n](https://github.com/lumen-oss/lz.n) ⭐ 244 | 🐛 0 | 🌐 Lua | 📅 2026-02-08 - A simple lazy loading library for Neovim plugins.
...
* [jrop/morph.nvim](https://github.com/jrop/morph.nvim) ⭐ 97 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - A React-like renderer for building interactive buffers/TUIs.
...
* [lumen-oss/luarocks-tag-release](https://github.com/lumen-oss/luarocks-tag-release) ⭐ 55 | 🐛 10 | 🌐 Lua | 📅 2026-02-12 - A GitHub action that publishes your Neovim plugins to LuaRocks.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 11 | 🐛 0 | 🌐 Lua | 📅 2025-05-23 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 21,273 | 🐛 14 | 🌐 Go | 📅 2026-02-02 or compatible encryption tools for cryptographic safety.
...
* [aileot/nvim-thyme](https://github.com/aileot/nvim-thyme) ⭐ 37 | 🐛 2 | 🌐 Fennel | 📅 2025-11-04 - Zero-overhead Fennel JIT compiler with safety rollbacks and [parinfer-rust](https://github.com/eraserhd/parinfer-rust) ⭐ 609 | 🐛 35 | 🌐 Rust | 📅 2026-01-03 integration.
...
* [Saecki/crates.nvim](https://github.com/Saecki/crates.nvim) ⭐ 1,076 | 🐛 10 | 🌐 Lua | 📅 2025-08-23 - Rust dependency management for `Cargo.toml`.
* [vuki656/package-info.nvim](https://github.com/vuki656/package-info.nvim) ⭐ 585 | 🐛 26 | 🌐 Lua | 📅 2025-12-27 - Display latest package version as virtual text in package.json.
...
* [DrKJeff16/pipenv.nvim](https://github.com/DrKJeff16/pipenv.nvim) ⭐ 6 | 🐛 0 | 🌐 Lua | 📅 2026-02-13 - Asynchronous `Pipenv` manager with `spinner.nvim` integration.
...
* [nvim-mini/mini.nvim#mini.diff](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
* [nvim-mini/mini.nvim#mini.git](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for enhanced Git integration with current Neovim process that implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.
...
* [sindrets/diffview.nvim](https://github.com/sindrets/diffview.nvim) ⭐ 5,329 | 🐛 132 | 🌐 Lua | 📅 2024-08-02 - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev.
* [NeogitOrg/neogit](https://github.com/NeogitOrg/neogit) ⭐ 5,097 | 🐛 171 | 🌐 Lua | 📅 2026-02-12 - A Magit clone that may change some things to fit the Vim philosophy.
* [kdheepak/lazygit.nvim](https://github.com/kdheepak/lazygit.nvim) ⭐ 2,178 | 🐛 49 | 🌐 Lua | 📅 2025-12-19 - Plugin for calling lazygit.
* [esmuellert/codediff.nvim](https://github.com/esmuellert/codediff.nvim) ⭐ 1,088 | 🐛 41 | 🌐 Lua | 📅 2026-02-11 - Side-by-side diff with two-tier highlighting (line + character level) using VSCode's algorithm implemented in C.
...
* [chojs23/ec](https://github.com/chojs23/ec) ⭐ 98 | 🐛 2 | 🌐 Go | 📅 2026-02-12 - A TUI native Git mergetool with 3 panes.
...
* [isak102/telescope-git-file-history.nvim](https://github.com/isak102/telescope-git-file-history.nvim) ⭐ 88 | 🐛 1 | 🌐 Lua | 📅 2025-05-27 - Open/preview contents of the current file at a specific commit, without using `git checkout`.
...
* [jceb/jiejie.nvim](https://github.com/jceb/jiejie.nvim) ⭐ 41 | 🐛 2 | 🌐 Lua | 📅 2026-02-02 - Frontend for Jujutsu in the style of `fugitive`.
* [barrettruth/diffs.nvim](https://github.com/barrettruth/diffs.nvim) ⭐ 38 | 🐛 1 | 🌐 Lua | 📅 2026-02-12 - Syntax highlighting for diffs with Tree-sitter support for `vim-fugitive` and `&diff` buffers.
...
* [harrisoncramer/GitLab.nvim](https://github.com/harrisoncramer/GitLab.nvim) ⭐ 355 | 🐛 26 | 🌐 Lua | 📅 2026-01-31 - Review pull requests and manage other GitLab resources.
...
* [nvim-mini/mini.nvim#mini.jump](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for smarter jumping to a single character.
* [nvim-mini/mini.nvim#mini.jump2d](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
* [nvim-mini/mini.nvim#mini.bracketed](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` to go forward/backward with square brackets.
...
* [folke/flash.nvim](https://github.com/folke/flash.nvim) ⭐ 3,890 | 🐛 18 | 🌐 Lua | 📅 2025-10-28 - Navigate your code with search labels, enhanced character motions and Tree-sitter integration.
...
* [chrisgrieser/nvim-spider](https://github.com/chrisgrieser/nvim-spider) ⭐ 836 | 🐛 1 | 🌐 Lua | 📅 2026-02-10 - Use the w, e, b motions like a spider. Considers camelCase and skips insignificant punctuation.
...
* [nvim-mini/mini.nvim#mini.clue](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
* [nvim-mini/mini.nvim#mini.keymap](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).
* [folke/which-key.nvim](https://github.com/folke/which-key.nvim) ⭐ 6,932 | 🐛 38 | 🌐 Lua | 📅 2025-10-28 - Shows a popup with possible keybindings of the command you started typing.
...
* [max397574/better-escape.nvim](https://github.com/max397574/better-escape.nvim) ⭐ 774 | 🐛 6 | 🌐 Lua | 📅 2025-04-29 - Create shortcuts to escape insert mode without getting delay.
...
* [notomo/gesture.nvim](https://github.com/notomo/gesture.nvim) ⭐ 537 | 🐛 0 | 🌐 Lua | 📅 2025-10-08 - Mouse gesture plugin.
...
* [karb94/neoscroll.nvim](https://github.com/karb94/neoscroll.nvim) ⭐ 1,968 | 🐛 11 | 🌐 Lua | 📅 2025-12-31 - Smooth scrolling.
...
* [nvim-mini/mini.nvim#mini.map](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.
* [petertriho/nvim-scrollbar](https://github.com/petertriho/nvim-scrollbar) ⭐ 1,027 | 🐛 30 | 🌐 Lua | 📅 2025-11-17 - Extensible scrollbar that shows diagnostics and search results.
* [lewis6991/satellite.nvim](https://github.com/lewis6991/satellite.nvim) ⭐ 699 | 🐛 16 | 🌐 Lua | 📅 2026-01-22 - Decorate scrollbar.
* [dstein64/nvim-scrollview](https://github.com/dstein64/nvim-scrollview) ⭐ 679 | 🐛 5 | 🌐 Lua | 📅 2026-02-05 - Display interactive scrollbars.
...
* [nvim-mini/mini.nvim#mini.pairs](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
* [nvim-mini/mini.nvim#mini.trailspace](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
* [nvim-mini/mini.nvim#mini.operators](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
* [nvim-mini/mini.nvim#mini.move](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
* [nvim-mini/mini.nvim#mini.ai](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some built-in textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
* [nvim-mini/mini.nvim#mini.splitjoin](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
* [nvim-mini/mini.nvim#mini.basics](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.
...
* [nvim-treesitter/nvim-treesitter-context](https://github.com/nvim-treesitter/nvim-treesitter-context) ⭐ 3,112 | 🐛 18 | 🌐 Janet | 📅 2025-12-06 - Shows floating hover with the current function/block context.
* [folke/zen-mode.nvim](https://github.com/folke/zen-mode.nvim) ⭐ 2,093 | 🐛 15 | 🌐 Lua | 📅 2025-10-28 - Distraction-free coding.
* [windwp/nvim-ts-autotag](https://github.com/windwp/nvim-ts-autotag) ⭐ 2,050 | 🐛 8 | 🌐 Lua | 📅 2026-02-04 - Use Tree-sitter to autoclose and autorename XML, HTML, JSX tag.
...
* [Wansmer/treesj](https://github.com/Wansmer/treesj) ⭐ 1,301 | 🐛 5 | 🌐 Lua | 📅 2025-12-08 - Splitting/joining blocks of code like arrays, hashes, statements, objects, dictionaries, etc. Using Tree-sitter. Inspired by greatest splitjoin.vim.
...
* [HiPhish/rainbow-delimiters.nvim](https://github.com/HiPhish/rainbow-delimiters.nvim) ⭐ 830 | 🐛 19 | 🌐 Lua | 📅 2026-01-11 - Rainbow delimiters with Tree-sitter.
...
* [gbprod/substitute.nvim](https://github.com/gbprod/substitute.nvim) ⭐ 725 | 🐛 5 | 🌐 Lua | 📅 2026-02-05 - New operator motions to quickly replace and exchange text.
...
* [filipdutescu/renamer.nvim](https://github.com/filipdutescu/renamer.nvim) ⭐ 313 | 🐛 10 | 🌐 Lua | 📅 2024-01-04 - VSCode-like renaming UI, written in Lua.
* [okuuva/auto-save.nvim](https://github.com/okuuva/auto-save.nvim) ⭐ 303 | 🐛 2 | 🌐 Lua | 📅 2026-02-07 - Automatically saves your work as often as needed and as seldom as possible. Customizable with smart defaults. Maintained fork of Pocco81/auto-save.nvim.
...
* [XXiaoA/atone.nvim](https://github.com/XXiaoA/atone.nvim) ⭐ 144 | 🐛 5 | 🌐 Lua | 📅 2025-11-14 - Undo tree for visualizing and managing undo history.
...
* [nemanjamalesija/smart-paste.nvim](https://github.com/nemanjamalesija/smart-paste.nvim) ⭐ 61 | 🐛 2 | 🌐 Lua | 📅 2026-02-11 - Automatic indentation of pasted code using a three-tier indent strategy (indentexpr / Tree-sitter / heuristic).
...
* [niuiic/divider.nvim](https://github.com/niuiic/divider.nvim) ⭐ 29 | 🐛 0 | 🌐 Lua | 📅 2024-11-18 - Custom code divider line.
...
* [qwavies/smart-backspace.nvim](https://github.com/qwavies/smart-backspace.nvim) ⭐ 26 | 🐛 0 | 🌐 Lua | 📅 2026-02-09 - Context-aware backspace which handles pairs, whitespace and indentation.
...
* [nxhung2304/lastplace.nvim](https://github.com/nxhung2304/lastplace.nvim) ⭐ 22 | 🐛 0 | 🌐 Shell | 📅 2025-06-30 - Intelligently restore your cursor position when reopening files.
...
* [nvim-mini/mini.nvim#mini.comment](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.
* [numToStr/Comment.nvim](https://github.com/numToStr/Comment.nvim) ⭐ 4,578 | 🐛 80 | 🌐 Lua | 📅 2024-08-19 - Smart and powerful comment plugin. Supports commentstring, motions, dot-repeat and more.
* [folke/todo-comments.nvim](https://github.com/folke/todo-comments.nvim) ⭐ 4,046 | 🐛 23 | 🌐 Lua | 📅 2025-11-10 - Highlight, list and search TODO comments in your projects.
...
* [nvim-mini/mini.nvim#mini.align](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for aligning text interactively (with or without instant preview).
* [stevearc/conform.nvim](https://github.com/stevearc/conform.nvim) ⭐ 4,908 | 🐛 86 | 🌐 Lua | 📅 2026-01-18 - A lightweight formatting engine that plays nice with LSP.
...
* [nvim-mini/mini.nvim#mini.indentscope](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.
* [lukas-reineke/indent-blankline.nvim](https://github.com/lukas-reineke/indent-blankline.nvim) ⭐ 4,855 | 🐛 24 | 🌐 Lua | 📅 2025-03-17 - IndentLine replacement in Lua with more features and Tree-sitter support.
* [shellRaining/hlchunk.nvim](https://github.com/shellRaining/hlchunk.nvim) ⭐ 889 | 🐛 32 | 🌐 Lua | 📅 2025-12-15 - A Lua implementation of `nvim-hlchunk`, contains more features, such as highlight `{}` chunk, indent line, space blank etc.
...
* [nvimdev/indentmini.nvim](https://github.com/nvimdev/indentmini.nvim) ⭐ 281 | 🐛 1 | 🌐 Lua | 📅 2026-01-04 - A minimal and blazing fast indentline plugin by using the `nvim_set_decoration_provide` API function.
...
* [saghen/blink.indent](https://github.com/saghen/blink.indent) ⭐ 183 | 🐛 4 | 🌐 Lua | 📅 2026-01-13 - Performant indent guides with scope on every keystroke.
...
* [nvim-mini/mini.nvim#mini.cmdline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cmdline.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for command line tweaks. Adds autocompletion with customizable delay, autocorrection for words with fixed candidates, and autopeek command range in a floating window.
...
* [nvim-mini/mini.nvim#mini.sessions](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for session management (read, write, delete).
* [rmagatti/auto-session](https://github.com/rmagatti/auto-session) ⭐ 1,771 | 🐛 15 | 🌐 Lua | 📅 2026-02-09 - A small automated session manager.
* [folke/persistence.nvim](https://github.com/folke/persistence.nvim) ⭐ 948 | 🐛 9 | 🌐 Lua | 📅 2025-10-28 - Simple automated session management.
...
* [olimorris/persisted.nvim](https://github.com/olimorris/persisted.nvim) ⭐ 527 | 🐛 0 | 🌐 Lua | 📅 2026-02-02 - Simple session management with Git branching, autosave/autoload and Telescope support.
...
* [brianhuster/live-preview.nvim](https://github.com/brianhuster/live-preview.nvim) ⭐ 338 | 🐛 22 | 🌐 Lua | 📅 2026-02-01 - Live preview HTML, Markdown and Asciidoc in the browser.
...
* [nvim-mini/mini.nvim#mini.bufremove](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,544 | 🐛 13 | 🌐 Lua | 📅 2026-02-06 - Smart, seamless, directional navigation and resizing of splits.
...
* [anuvyklack/windows.nvim](https://github.com/anuvyklack/windows.nvim) ⭐ 630 | 🐛 22 | 🌐 Lua | 📅 2023-07-08 - Automatically expand width of the current window. Maximizes and restore it. And all this with nice animations!
...
* [aserowy/tmux.nvim](https://github.com/aserowy/tmux.nvim) ⭐ 772 | 🐛 16 | 🌐 Lua | 📅 2025-03-19 - Tmux integration features pane movement and resizing.
...
* [kawre/leetcode.nvim](https://github.com/kawre/leetcode.nvim) ⭐ 1,971 | 🐛 57 | 🌐 Lua | 📅 2025-09-21 - Solve Leetcode problems.
* [xeluxee/competitest.nvim](https://github.com/xeluxee/competitest.nvim) ⭐ 567 | 🐛 16 | 🌐 Lua | 📅 2025-05-13 - A plugin to automate testcases management and checking for Competitive Programming contests.
...
* [m4xshen/hardtime.nvim](https://github.com/m4xshen/hardtime.nvim) ⭐ 3,689 | 🐛 13 | 🌐 Lua | 📅 2025-09-13 - Helping you establish good command workflow and habit.
* [saxon1964/neovim-tips](https://github.com/saxon1964/neovim-tips) ⭐ 441 | 🐛 1 | 🌐 Lua | 📅 2026-02-06 - Provides hundreds of built-in tips, tricks and shortcuts, with a custom picker interface and the ability to add your own tips.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 14 | 🐛 2 | 🌐 Go | 📅 2026-02-13 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [kndndrj/nvim-dbee](https://github.com/kndndrj/nvim-dbee) ⭐ 1,214 | 🐛 75 | 🌐 Go | 📅 2025-07-25 - Interactive database client.
...
* [zerochae/dbab.nvim](https://github.com/zerochae/dbab.nvim) ⭐ 22 | 🐛 2 | 🌐 Lua | 📅 2026-02-09 - Lightweight database client with a modern UI and async execution.
...
* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 29,406 | 🐛 58 | 🌐 Lua | 📅 2026-01-27 - A launch point for your personal Neovim configuration.
* [siduck76/NvChad](https://github.com/siduck76/NvChad) ⭐ 27,860 | 🐛 1 | 🌐 Lua | 📅 2026-02-07 - An attempt to make Neovim's CLI as functional as an IDE while retaining beauty with less bloat.
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 25,027 | 🐛 55 | 🌐 Lua | 📅 2025-11-11 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
...
* [AstroNvim/AstroNvim](https://github.com/AstroNvim/AstroNvim) ⭐ 14,104 | 🐛 1 | 🌐 Lua | 📅 2026-02-11 - An aesthetic and feature-rich config that is extensible and easy to use with a great set of plugins.
* [ayamir/nvimdots](https://github.com/ayamir/nvimdots) ⭐ 3,370 | 🐛 13 | 🌐 Lua | 📅 2026-02-01 - A well-configured and structured configuration with NixOS support.
...
* [dam9000/kickstart-modular.nvim](https://github.com/dam9000/kickstart-modular.nvim) ⭐ 944 | 🐛 4 | 🌐 Lua | 📅 2025-06-14 - This is a fork of nvim-lua/kickstart.nvim that moves from a single file to a multi file configuration.
...
* [nvim-mini/MiniMax](https://github.com/nvim-mini/MiniMax) ⭐ 307 | 🐛 1 | 🌐 Lua | 📅 2026-02-12 - A collection of self-contained and extensively commented configurations which mostly use MINI tools.
...
* [MordechaiHadad/bob](https://github.com/MordechaiHadad/bob) ⭐ 2,003 | 🐛 29 | 🌐 Rust | 📅 2026-02-09 - A cross-platform, easy to use Neovim version manager.
...
* [y3owk1n/nvs](https://github.com/y3owk1n/nvs) ⭐ 28 | 🐛 0 | 🌐 Go | 📅 2026-02-12 - Another Neovim version manager with config switcher.
...
* [m15a/flake-awesome-neovim-plugins](https://github.com/m15a/flake-awesome-neovim-plugins) ⭐ 62 | 🐛 0 | 🌐 Nix | 📅 2026-02-12 - Nix flake that provides a collection of `awesome-neovim` plugins as Nix packages.
...
* [nvim-mini/mini.nvim#mini.notify](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) ⭐ 8,725 | 🐛 35 | 🌐 Lua | 📅 2026-02-12 - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.
* [folke/noice.nvim](https://github.com/folke/noice.nvim) ⭐ 5,600 | 🐛 28 | 🌐 Lua | 📅 2025-11-03 - Highly experimental plugin that completely replaces the UI for messages, cmdline and the popupmenu.
...
* [jrop/tuis.nvim](https://github.com/jrop/tuis.nvim) ⭐ 127 | 🐛 0 | 🌐 Lua | 📅 2026-01-15 - A collection of interactive TUIs which provides rich, interactive UIs to various CLIs.
* [xieyonn/spinner.nvim](https://github.com/xieyonn/spinner.nvim) ⭐ 79 | 🐛 2 | 🌐 Lua | 📅 2026-02-13 - Extensible spinner framework for animated spinners in statusline, tabline, winbar, buffer, cmdline, or next to the cursor.
...
* [Weyaaron/nvim-training](https://github.com/Weyaaron/nvim-training) ⭐ 117 | 🐛 4 | 🌐 Lua | 📅 2026-01-18 - A beginner-friendly tool for training your 'muscle memory' using small, repeatable tasks.
