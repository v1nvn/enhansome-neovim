...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 20,784 | 🐛 57 | 🌐 Lua | 📅 2025-12-17 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [nvim-mini/mini.nvim#mini.deps](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.
* [lumen-oss/rocks.nvim](https://github.com/lumen-oss/rocks.nvim) ⭐ 1,023 | 🐛 56 | 🌐 Lua | 📅 2026-04-13 - A modern approach to plugin management using LuaRocks, inspired by Cargo.
...
* [zuqini/zpack.nvim](https://github.com/zuqini/zpack.nvim) ⭐ 120 | 🐛 2 | 🌐 Lua | 📅 2026-04-15 - A thin layer on top of `vim.pack` to support lazy-loading and `lazy.nvim`'s declarative spec.
...
* [romus204/referencer.nvim](https://github.com/romus204/referencer.nvim) ⭐ 42 | 🐛 2 | 🌐 Lua | 📅 2025-11-19 - Lightweight, asynchronous that uses the LSP to show references to functions, methods, types and other.

<!--lint disable awesome-spell-check-->

* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,568 | 🐛 31 | 🌐 Lua | 📅 2026-04-23 - Quickstart configurations for the LSP client.
...
* [mfussenegger/nvim-lint](https://github.com/mfussenegger/nvim-lint) ⭐ 2,710 | 🐛 45 | 🌐 Lua | 📅 2026-04-09 - An asynchronous linter plugin, complementary to the built-in Language Server Protocol support.
* [j-hui/fidget.nvim](https://github.com/j-hui/fidget.nvim) ⭐ 2,511 | 🐛 21 | 🌐 Lua | 📅 2026-04-01 - Standalone UI for LSP progress.
...
* [stevearc/aerial.nvim](https://github.com/stevearc/aerial.nvim) ⭐ 2,270 | 🐛 77 | 🌐 Lua | 📅 2026-02-25 - A code outline window for skimming and quick navigation.
...
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 994 | 🐛 11 | 🌐 Lua | 📅 2026-04-23 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,729 | 🐛 98 | 🌐 JavaScript | 📅 2026-04-24 catalog.
...
* [smjonas/inc-rename.nvim](https://github.com/smjonas/inc-rename.nvim) ⭐ 848 | 🐛 10 | 🌐 Lua | 📅 2026-03-02 - Provides an incremental LSP rename command based on the command-preview feature.
...
* [retran/meow.yarn.nvim](https://github.com/retran/meow.yarn.nvim) ⭐ 70 | 🐛 2 | 🌐 Lua | 📅 2026-04-19 - Interactive LSP type and call hierarchy explorer with a tree view, live preview, navigation breadcrumbs, and a custom node renderer.
...
* [nvimtools/none-ls.nvim](https://github.com/nvimtools/none-ls.nvim) ⭐ 3,229 | 🐛 14 | 🌐 Lua | 📅 2026-04-19 - Null-ls.nvim reloaded / Use Neovim as a language server to inject LSP diagnostics, code actions, and more via Lua.
* [mrcjkb/rustaceanvim](https://github.com/mrcjkb/rustaceanvim) ⭐ 2,940 | 🐛 18 | 🌐 Lua | 📅 2026-04-24 - A heavily modified fork of rust-tools.nvim that does not require a `setup` call and does not depend on nvim-lspconfig.
* [rachartier/tiny-inline-diagnostic.nvim](https://github.com/rachartier/tiny-inline-diagnostic.nvim) ⭐ 1,649 | 🐛 1 | 🌐 Lua | 📅 2026-04-22 - Display prettier diagnostic messages. Display one line diagnostic messages where the cursor is, with icons and colors.
...
* [mrcjkb/haskell-tools.nvim](https://github.com/mrcjkb/haskell-tools.nvim) ⭐ 592 | 🐛 21 | 🌐 Lua | 📅 2026-04-24 - Seamless integration for Haskell development tools like `haskell-language-server` and Hoogle.
...
* [Wansmer/symbol-usage.nvim](https://github.com/Wansmer/symbol-usage.nvim) ⭐ 486 | 🐛 2 | 🌐 Lua | 📅 2026-04-06 - Display references, definitions and implementations of document symbols.
* [rachartier/tiny-code-action.nvim](https://github.com/rachartier/tiny-code-action.nvim) ⭐ 478 | 🐛 0 | 🌐 Lua | 📅 2026-04-14 - Provides a simple way to run and visualize code actions with Telescope.
...
* [jinzhongjia/LspUI.nvim](https://github.com/jinzhongjia/LspUI.nvim) ⭐ 287 | 🐛 0 | 🌐 Lua | 📅 2026-03-13 - A modern and useful UI that wraps LSP operations.
...
* [mason-org/mason.nvim](https://github.com/mason-org/mason.nvim) ⭐ 10,229 | 🐛 268 | 🌐 Lua | 📅 2026-04-21 - Portable package manager that runs everywhere Neovim runs. Easily install and manage LSP servers, DAP servers, linters, and formatters.

### Diagnostics

* [folke/trouble.nvim](https://github.com/folke/trouble.nvim) ⭐ 6,755 | 🐛 21 | 🌐 Lua | 📅 2025-10-31 - A pretty diagnostics list to help you solve all the trouble your code is causing.
...
* [hrsh7th/nvim-cmp](https://github.com/hrsh7th/nvim-cmp) ⭐ 9,407 | 🐛 302 | 🌐 Lua | 📅 2026-03-25 - Completion engine written in Lua, successor of `nvim-compe`.
...
* [nvim-mini/mini.nvim#mini.completion](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 6,200 | 🐛 109 | 🌐 Lua | 📅 2026-04-23 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [mikavilpas/blink-ripgrep.nvim](https://github.com/mikavilpas/blink-ripgrep.nvim) ⭐ 113 | 🐛 2 | 🌐 TypeScript | 📅 2026-04-24 - `blink.cmp` source for `ripgrep` / `git grep`.
  ...
  * [Kaiser-Yang/blink-cmp-git](https://github.com/Kaiser-Yang/blink-cmp-git) ⭐ 88 | 🐛 7 | 🌐 Lua | 📅 2026-02-21 - `blink.cmp` source for Git.
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 11 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 44,831 | 🐛 57 | 🌐 C | 📅 2026-04-23.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 4,059 | 🐛 15 | 🌐 Lua | 📅 2026-04-24 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,565 | 🐛 60 | 🌐 Vim Script | 📅 2026-01-09.
...
* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 17,806 | 🐛 48 | 🌐 Lua | 📅 2026-03-30 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,485 | 🐛 11 | 🌐 Lua | 📅 2026-04-23 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
...
* [nickjvandyke/opencode.nvim](https://github.com/nickjvandyke/opencode.nvim) ⭐ 3,247 | 🐛 12 | 🌐 Lua | 📅 2026-04-15 - OpenCode AI assistant integration.
...
* [Exafunction/windsurf.nvim](https://github.com/Exafunction/windsurf.nvim) ⭐ 1,267 | 🐛 115 | 🌐 Lua | 📅 2026-04-02 - Free, ultrafast Copilot alternative. Supports LSP and Tree-sitter.
* [milanglacier/minuet-ai.nvim](https://github.com/milanglacier/minuet-ai.nvim) ⭐ 1,117 | 🐛 13 | 🌐 Lua | 📅 2026-04-24 - Minuet offers code completion from LLM providers including OpenAI (compatible), Gemini, Claude, Ollama, Deepseek and more providers, with support for nvim-cmp, blink.cmp and virtual-text frontend.
...
* [Kurama622/llm.nvim](https://github.com/Kurama622/llm.nvim) ⭐ 469 | 🐛 1 | 🌐 Lua | 📅 2026-04-19 - Free large language model (LLM) support, provides commands to interact with LLM.
* [dlants/magenta.nvim](https://github.com/dlants/magenta.nvim) ⭐ 439 | 🐛 14 | 🌐 TypeScript | 📅 2026-04-24 - Leverage coding assistants for chat and code generation. Provides tools for the AI/LLM agent to explore and edit your code, like Aider, Cursor and Windsurf.
* [carlos-algms/agentic.nvim](https://github.com/carlos-algms/agentic.nvim) ⭐ 413 | 🐛 7 | 🌐 Lua | 📅 2026-04-18 - Chat interface for AI ACP providers such as Claude, Gemini, Codex, OpenCode and Cursor.
...
* [Flemma-Dev/flemma.nvim](https://github.com/Flemma-Dev/flemma.nvim) ⭐ 53 | 🐛 1 | 🌐 Lua | 📅 2026-04-23 - A first-class AI workspace.
...
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 8 | 🐛 4 | 🌐 Lua | 📅 2026-04-05 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 11,683 | 🐛 590 | 🌐 Python | 📅 2026-04-22 tool.
...
* [Julian/lean.nvim](https://github.com/Julian/lean.nvim) ⭐ 512 | 🐛 37 | 🌐 Lua | 📅 2026-04-23 - Support for the [Lean Theorem Prover](https://leanprover.github.io/).
...
* [apyra/nvim-unity.nvim](https://github.com/apyra/nvim-unity) ⭐ 107 | 🐛 10 | 🌐 C# | 📅 2026-04-01 - Use Neovim as your default Unity editor with full LSP support via OmniSharp.
...
* [mosheavni/yaml-companion.nvim](https://github.com/mosheavni/yaml-companion.nvim) ⭐ 14 | 🐛 3 | 🌐 Lua | 📅 2026-04-24 - Automatic schema detection and selection for YAML files with `yaml-language-server`, including built-in Kubernetes support.

### Web Development

* [rest-nvim/rest.nvim](https://github.com/rest-nvim/rest.nvim) ⭐ 2,020 | 🐛 46 | 🌐 Lua | 📅 2025-12-27 - A fast HTTP client written in Lua.
* [mistweaverco/kulala.nvim](https://github.com/mistweaverco/kulala.nvim) ⭐ 1,969 | 🐛 20 | 🌐 Lua | 📅 2026-03-16 - A minimal HTTP-client interface.
...
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 4,456 | 🐛 5 | 🌐 Lua | 📅 2026-04-21 - Improve viewing Markdown files directly.
...
* [YousefHadder/markdown-plus.nvim](https://github.com/YousefHadder/markdown-plus.nvim) ⭐ 241 | 🐛 5 | 🌐 Lua | 📅 2026-04-21 - Provides a full editing experience for Markdown files which includes support for lists, links, TOC, and more with simple and fast keymaps.
...
* [gbprod/phpactor.nvim](https://github.com/gbprod/phpactor.nvim) ⭐ 94 | 🐛 2 | 🌐 Lua | 📅 2026-01-07 - Lua version of [phpactor](https://github.com/phpactor/phpactor) ⭐ 1,856 | 🐛 295 | 🌐 PHP | 📅 2026-04-21.
...
* [nvim-mini/mini.nvim#mini.surround](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-surround.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for working with text surroundings (add, delete, replace, find, highlight). Supports dot-repeat, different search methods, "last"/"next" extended mappings, Tree-sitter integration, and more.
* [kylechui/nvim-surround](https://github.com/kylechui/nvim-surround) ⭐ 4,182 | 🐛 8 | 🌐 Lua | 📅 2026-04-05 - A plugin for adding/changing/deleting surrounding delimiter pairs.
* [nvim-treesitter/nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects) ⭐ 2,744 | 🐛 116 | 🌐 Tree-sitter Query | 📅 2026-04-07 - Create your own textobjects using Tree-sitter queries.
...
* [romus204/tree-sitter-manager.nvim](https://github.com/romus204/tree-sitter-manager.nvim) ⭐ 387 | 🐛 13 | 🌐 Tree-sitter Query | 📅 2026-04-23 - A lightweight Tree-sitter parser manager for Neovim 0.12+ to replace the archived `nvim-treesitter` plugin.
* [IndianBoy42/tree-sitter-just](https://github.com/IndianBoy42/tree-sitter-just) ⭐ 188 | 🐛 7 | 🌐 Just | 📅 2026-03-25 - Tree-sitter grammar for [Justfiles](https://github.com/casey/just) ⭐ 33,116 | 🐛 306 | 🌐 Rust | 📅 2026-04-23.
...
* [nvim-mini/mini.nvim#mini.snippets](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.
* [L3MON4D3/LuaSnip](https://github.com/L3MON4D3/LuaSnip) ⭐ 4,328 | 🐛 128 | 🌐 Lua | 📅 2026-04-05 - A snippet engine written in Lua.
* [rafamadriz/friendly-snippets](https://github.com/rafamadriz/friendly-snippets) ⭐ 2,701 | 🐛 71 | 🌐 Lua | 📅 2026-01-23 - Set of preconfigured snippets for different languages.
...
* [dcampos/nvim-snippy](https://github.com/dcampos/nvim-snippy) ⭐ 339 | 🐛 8 | 🌐 Lua | 📅 2026-04-09 - Snippet plugin written in Lua with support for [vim-snippets](https://github.com/honza/vim-snippets) ⭐ 4,872 | 🐛 85 | 🌐 Vim Snippet | 📅 2025-10-28.
...
* [ThePrimeagen/harpoon](https://github.com/ThePrimeagen/harpoon/tree/harpoon2) ⭐ 9,041 | 🐛 150 | 🌐 Lua | 📅 2025-10-31 - A per project, auto updating and editable marks utility for fast file navigation.
* [chentoast/marks.nvim](https://github.com/chentoast/marks.nvim) ⭐ 1,155 | 🐛 56 | 🌐 Lua | 📅 2025-05-13 - A better user experience for viewing and interacting with Vim marks.
...
* [fnune/recall.nvim](https://github.com/fnune/recall.nvim) ⭐ 92 | 🐛 3 | 🌐 Lua | 📅 2026-03-10 - Recall refines the use of marks by focusing on global marks, streamlining their usage and enhancing their visibility and navigability.
...
* [walkersumida/fusen.nvim](https://github.com/walkersumida/fusen.nvim) ⭐ 38 | 🐛 0 | 🌐 Lua | 📅 2026-02-02 - Sticky note bookmarks, per Git branch with hover annotations and Telescope integration.
...
* [MagicDuck/grug-far.nvim](https://github.com/MagicDuck/grug-far.nvim) ⭐ 1,886 | 🐛 0 | 🌐 Lua | 📅 2026-04-11 - Buffer-based live search and replace with full power of `rg` flags. Grug like.
...
* [nvim-telescope/telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) ⭐ 19,342 | 🐛 459 | 🌐 Lua | 📅 2026-04-22 - Telescope.nvim is a highly [extendable](https://github.com/nvim-telescope/telescope.nvim/wiki/Extensions) ⭐ 19,342 | 🐛 459 | 🌐 Lua | 📅 2026-04-22 A highly extensible fuzzy finder over lists.
* [nvim-mini/mini.nvim#mini.fuzzy](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
* [nvim-mini/mini.nvim#mini.pick](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
* [nvim-mini/mini.nvim#mini.extra](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.
* [folke/snacks.nvim#picker](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) ⭐ 7,484 | 🐛 116 | 🌐 Lua | 📅 2026-03-21 - A modern fuzzy-finder to navigate the Neovim universe.
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 5,372 | 🐛 58 | 🌐 Rust | 📅 2026-04-23 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,224 | 🐛 10 | 🌐 Lua | 📅 2026-04-24 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,768 | 🐛 18 | 🌐 Rust | 📅 2026-04-21 as its fzf binary.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 370 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 36,012 | 🐛 164 | 🌐 Rust | 📅 2026-04-13, a smart directory picker that tracks your usage.
...
* [juniorsundar/refer.nvim](https://github.com/juniorsundar/refer.nvim) ⭐ 47 | 🐛 1 | 🌐 Lua | 📅 2026-04-20 - A minimalist picker that doesn't get in your way.
...
* [nvim-mini/mini.nvim#mini.files](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.
* [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) ⭐ 8,467 | 🐛 93 | 🌐 Lua | 📅 2026-04-23 - A simple and fast file explorer tree.
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,499 | 🐛 134 | 🌐 Lua | 📅 2026-02-24 - Edit your filesystem like a buffer.
* [nvim-neo-tree/neo-tree.nvim](https://github.com/nvim-neo-tree/neo-tree.nvim) ⭐ 5,393 | 🐛 172 | 🌐 Lua | 📅 2026-04-17 - Browse the file system and other tree-like structures in whatever style suits you, including sidebars, floating windows, `netrw` split style, or all of them at once.
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,693 | 🐛 93 | 🌐 Python | 📅 2026-04-24 - File manager. Better than NERDTree.
* [mikavilpas/yazi.nvim](https://github.com/mikavilpas/yazi.nvim) ⭐ 1,682 | 🐛 8 | 🌐 Lua | 📅 2026-04-24 - Integration with the Yazi terminal file manager.
...
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 463 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,507 | 🐛 2 | 🌐 C | 📅 2026-04-19 and Lua.
...
* [kelly-lin/ranger.nvim](https://github.com/kelly-lin/ranger.nvim) ⭐ 182 | 🐛 11 | 🌐 Lua | 📅 2024-11-18 - [Ranger](https://github.com/ranger/ranger) ⭐ 17,148 | 🐛 917 | 🌐 Python | 📅 2026-04-17 integration.
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 99 | 🐛 2 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 36,974 | 🐛 63 | 🌐 Rust | 📅 2026-04-22).
...
* [nvim-mini/mini.nvim#mini.visits](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.
...
* [DrKJeff16/project.nvim](https://github.com/DrKJeff16/project.nvim) ⭐ 159 | 🐛 2 | 🌐 Lua | 📅 2026-04-24 - Project manager with project root detection, documented code and lots of improvements, including `snacks.nvim`, `fzf-lua` and `picker.nvim` support.
...
* [mrjones2014/codesettings.nvim](https://github.com/mrjones2014/codesettings.nvim) ⭐ 65 | 🐛 2 | 🌐 Lua | 📅 2026-04-23 - Easily load project-local settings (like `.vscode/settings.json`) into Neovim 0.11+ native LSP settings.
...
* [martuscellifaria/ahoicpp.nvim](https://github.com/martuscellifaria/ahoicpp.nvim) ⭐ 3 | 🐛 0 | 🌐 Lua | 📅 2026-04-22 - Sets up C++ projects on a modular fashion and helps newcomers with the language heavy lifting.
...
* [nvim-mini/mini.nvim#mini.hipatterns](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.
* [folke/twilight.nvim](https://github.com/folke/twilight.nvim) ⭐ 1,525 | 🐛 0 | 🌐 Lua | 📅 2025-10-28 - Dim inactive portions of the code you're editing using Tree-sitter.
* [catgoose/nvim-colorizer.lua](https://github.com/catgoose/nvim-colorizer.lua) ⭐ 1,061 | 🐛 5 | 🌐 Lua | 📅 2026-04-19 - A high-performance color highlighter which has no external dependencies.
...
* [nvzone/minty](https://github.com/nvzone/minty) ⭐ 589 | 🐛 2 | 🌐 Lua | 📅 2025-02-28 - Beautifully crafted color tools.
* [xzbdmw/colorful-menu.nvim](https://github.com/xzbdmw/colorful-menu.nvim) ⭐ 471 | 🐛 4 | 🌐 Lua | 📅 2025-11-25 - Colorize your auto completion menu using Tree-sitter.
...
* [folke/tokyonight.nvim](https://github.com/folke/tokyonight.nvim) ⭐ 7,974 | 🐛 16 | 🌐 Lua | 📅 2026-03-24 - ***`[TS][LSP][L/D][Lua]`*** A clean, dark and light theme written in Lua, with support for LSP, Tree-sitter and lots of plugins.
* [sainnhe/everforest](https://github.com/sainnhe/everforest) ⭐ 3,978 | 🐛 6 | 🌐 Vim Script | 📅 2026-04-16 - ***`[TS][LSP][L/D]`*** A green based colorscheme designed to be warm, soft and easy on the eyes.
...
* [navarasu/onedark.nvim](https://github.com/navarasu/onedark.nvim) ⭐ 1,961 | 🐛 54 | 🌐 Lua | 📅 2026-04-13 - ***`[TS][LSP][Lua]`*** A One Dark Theme written in Lua based on Atom's One Dark Theme.
* [sainnhe/sonokai](https://github.com/sainnhe/sonokai) ⭐ 1,935 | 🐛 1 | 🌐 Vim Script | 📅 2026-01-21 - ***`[TS][LSP]`*** High Contrast and Vivid Color Scheme based on Monokai Pro.
* [nyoom-engineering/oxocarbon.nvim](https://github.com/nyoom-engineering/oxocarbon.nvim) ⭐ 1,560 | 🐛 20 | 🌐 Fennel | 📅 2026-03-18 - ***`[TS][LSP][L/D][Lua]`*** A dark and light theme written in Fennel, inspired by IBM Carbon.
* [dracula/vim](https://github.com/dracula/vim) ⭐ 1,384 | 🐛 10 | 🌐 Vim Script | 📅 2026-04-22 - ***`[TS][LSP]`*** Famous beautiful dark powered theme.
* [bluz71/vim-moonfly-colors](https://github.com/bluz71/vim-moonfly-colors) ⭐ 1,274 | 🐛 0 | 🌐 Lua | 📅 2026-04-20 - ***`[TS][LSP][Lua]`*** A dark charcoal colorscheme with Tree-sitter support.
...
* [AlexvZyl/nordic.nvim](https://github.com/AlexvZyl/nordic.nvim) ⭐ 1,009 | 🐛 1 | 🌐 Lua | 📅 2026-04-19 - ***`[TS][Lua]`*** Nord theme, but warmer and darker. Supports a variety of plugins and other platforms.
...
* [bluz71/vim-nightfly-colors](https://github.com/bluz71/vim-nightfly-colors) ⭐ 926 | 🐛 0 | 🌐 Lua | 📅 2026-04-20 - ***`[TS][LSP][Lua]`*** A dark midnight colorscheme with Tree-sitter support.
...
* [everviolet/nvim](https://github.com/everviolet/nvim) ⭐ 640 | 🐛 0 | 🌐 Lua | 📅 2026-03-31 - ***`[TS][LSP][L/D][Lua]`*** A comfy colorscheme for cozy morning coding.
...
* [oskarnurm/koda.nvim](https://github.com/oskarnurm/koda.nvim) ⭐ 268 | 🐛 2 | 🌐 Lua | 📅 2026-04-16 - ***`[TS][LSP][L/D][Lua]`*** Code's quiet companion. A minimalist colorscheme, written in Lua.
...
* [uhs-robert/oasis.nvim](https://github.com/uhs-robert/oasis.nvim) ⭐ 134 | 🐛 3 | 🌐 CSS | 📅 2026-04-15 - ***`[TS][LSP][L/D][Lua]`*** Desert theme from Vim ported to Neovim and made modern with 12 variants, a collection of dark themes for every color of the rainbow.
...
* [nvim-mini/mini.nvim#colorschemes](https://github.com/nvim-mini/mini.nvim#plugin-color-schemes) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - ***`[TS][LSP][L/D][Lua]`*** Color schemes included in `mini.nvim`. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.
* [catppuccin/nvim](https://github.com/catppuccin/nvim) ⭐ 7,374 | 🐛 11 | 🌐 Lua | 📅 2026-04-22 - ***`[TS][LSP][L/D][Lua]`*** Warm mid-tone dark theme to show off your vibrant self! With support for native LSP, Tree-sitter, and more.
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 6,086 | 🐛 89 | 🌐 Lua | 📅 2026-04-20 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
* [EdenEast/nightfox.nvim](https://github.com/EdenEast/nightfox.nvim) ⭐ 3,971 | 🐛 35 | 🌐 Lua | 📅 2025-02-09 - ***`[TS][LSP][L/D][Lua]`*** A soft dark, fully customizable colorscheme with support for LSP, Tree-sitter and a variety of plugins.
* [ellisonleao/gruvbox.nvim](https://github.com/ellisonleao/gruvbox.nvim) ⭐ 2,522 | 🐛 27 | 🌐 Lua | 📅 2026-04-15 - ***`[TS][LSP][L/D][Lua]`*** Gruvbox community colorscheme Lua port.
...
* [olimorris/onedarkpro.nvim](https://github.com/olimorris/onedarkpro.nvim) ⭐ 1,056 | 🐛 0 | 🌐 Lua | 📅 2026-04-11 - ***`[TS][L/D][Lua]`*** Atom's iconic One Dark theme. Cacheable, fully customisable, Tree-sitter and LSP semantic token support. Comes with light and dark variants.
...
* [xero/miasma.nvim](https://github.com/xero/miasma.nvim) ⭐ 536 | 🐛 6 | 🌐 Vim Script | 📅 2025-07-12 - ***`[TS][LSP]`*** A dark pastel color scheme inspired by the woods. Built using lush and supports Tree-sitter, diagnostics, CMP, Git-Signs, Telescope, Which-key, Lazy, and more.
...
* [miikanissi/modus-themes.nvim](https://github.com/miikanissi/modus-themes.nvim) ⭐ 421 | 🐛 4 | 🌐 Lua | 📅 2026-03-22 - ***`[TS][LSP][L/D][Lua]`*** Accessible theme, conforming with the highest standard for color contrast (WCAG AAA).
...
* [gbprod/nord.nvim](https://github.com/gbprod/nord.nvim) ⭐ 299 | 🐛 7 | 🌐 Lua | 📅 2026-04-14 - ***`[TS][LSP][Lua]`*** An arctic, north-bluish clean and elegant theme, based on Nord Palette.
...
* [jpwol/thorn.nvim](https://github.com/jpwol/thorn.nvim) ⭐ 83 | 🐛 0 | 🌐 Lua | 📅 2026-04-09 - ***`[TS][LSP][L/D][Lua]`*** A rich green theme with dark and light options. Supports LSP, transparency, many plugins, and more.
...
* [cryptomilk/nightcity.nvim](https://github.com/cryptomilk/nightcity.nvim) ⭐ 71 | 🐛 0 | 🌐 Lua | 📅 2025-08-11 - ***`[TS][LSP][Lua]`*** A dark colorscheme inspired by Inkpot, Jellybeans, Gruvbox and Tokyonight with LSP support.
...
* [T-b-t-nchos/Aquavium.nvim](https://github.com/T-b-t-nchos/Aquavium.nvim) ⭐ 14 | 🐛 1 | 🌐 Lua | 📅 2026-04-22 - ***`[TS][Lua]`*** Aquarium-themed color scheme, designed for use with a transparent terminal background.
* [pebeto/dookie.nvim](https://github.com/pebeto/dookie.nvim) ⭐ 13 | 🐛 0 | 🌐 Lua | 📅 2026-04-15 - ***`[TS][Lua]`*** A color scheme inspired by Plan9's acme editor.
...
* [nvim-mini/mini.nvim#mini.base16](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
* [nvim-mini/mini.nvim#mini.colors](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
* [nvim-mini/mini.nvim#mini.hues](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.
...
* [tjdevries/colorbuddy.nvim](https://github.com/tjdevries/colorbuddy.nvim) ⭐ 774 | 🐛 4 | 🌐 Lua | 📅 2024-05-08 - A colorscheme helper. Written in Lua! Quick and Easy Color Schemes.
* [RRethy/base16-nvim](https://github.com/RRethy/base16-nvim) ⭐ 634 | 🐛 6 | 🌐 Lua | 📅 2026-04-19 - A base16 colorscheme builder. Includes support for Tree-sitter and LSP highlight groups.
...
* [Bekaboo/dropbar.nvim](https://github.com/Bekaboo/dropbar.nvim) ⭐ 1,542 | 🐛 15 | 🌐 Lua | 📅 2025-10-05 - IDE-like breadcrumbs, out of the box.
...
* [nvim-mini/mini.nvim#mini.statusline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.
* [nvim-lualine/lualine.nvim](https://github.com/nvim-lualine/lualine.nvim) ⭐ 7,890 | 🐛 268 | 🌐 Lua | 📅 2026-04-12 - Easily configurable, blazingly fast statusline.
...
* [nvim-mini/mini.nvim#mini.tabline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.
* [akinsho/bufferline.nvim](https://github.com/akinsho/bufferline.nvim) ⭐ 4,294 | 🐛 100 | 🌐 Lua | 📅 2025-01-14 - A snazzy bufferline built using Lua.
...
* [nvim-mini/mini.nvim#mini.cursorword](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).
...
* [nvim-mini/mini.nvim#mini.starter](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.
* [nvimdev/dashboard-nvim](https://github.com/nvimdev/dashboard-nvim) ⭐ 2,810 | 🐛 73 | 🌐 Lua | 📅 2026-04-17 - A minimalist dashboard, inspired by doom-emacs.
...
* [nvim-mini/mini.nvim#mini.icons](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-icons.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` meant as a general icon provider. Uses fixed set of highlight groups. Supports various categories, icon and style customizations, caching for performance. Integrates with built-in filetype matching.
* [nvim-tree/nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons) ⭐ 2,651 | 🐛 18 | 🌐 Lua | 📅 2026-04-09 - A Lua fork of [vim-devicons](https://github.com/ryanoasis/vim-devicons) ⭐ 5,806 | 🐛 70 | 🌐 Vim Script | 📅 2024-05-09.
...
* [3rd/image.nvim](https://github.com/3rd/image.nvim) ⭐ 1,964 | 🐛 55 | 🌐 Lua | 📅 2026-02-21 - Add image support through kitty's graphics protocol or ueberzugpp.
...
* [HakonHarnes/img-clip.nvim](https://github.com/HakonHarnes/img-clip.nvim) ⭐ 899 | 🐛 10 | 🌐 Lua | 📅 2025-12-19 - Effortlessly embed images into any markup language, like LaTeX, Markdown or Typst.
...
* [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ⭐ 7,278 | 🐛 213 | 🌐 Lua | 📅 2026-04-09 - Modernity meets insane extensibility. The future of organizing your life.
* [nvim-orgmode/orgmode](https://github.com/nvim-orgmode/orgmode) ⭐ 3,729 | 🐛 147 | 🌐 Lua | 📅 2026-04-22 - Org-mode clone written in Lua.
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 1,802 | 🐛 72 | 🌐 Lua | 📅 2026-04-23 - Plugin for Obsidian, written in Lua.
...
* [zk-org/zk-nvim](https://github.com/zk-org/zk-nvim) ⭐ 814 | 🐛 2 | 🌐 Lua | 📅 2026-04-10 -  Provides integration with `zk`, a plain text note-taking assistant.
...
* [philosofonusus/ecolog.nvim](https://github.com/philosofonusus/ecolog.nvim) ⭐ 172 | 🐛 3 | 🌐 Lua | 📅 2026-02-02 - Sophisticated all-in-one toolkit to work with `.env` files and environment variables.
...
* [mluders/comfy-line-numbers.nvim](https://github.com/mluders/comfy-line-numbers.nvim) ⭐ 119 | 🐛 8 | 🌐 Lua | 📅 2026-01-26 - Limits relative numbers to only show left-hand digits on the keyboard.
...
* [AlejandroSuero/freeze-code.nvim](https://github.com/AlejandroSuero/freeze-code.nvim) ⭐ 32 | 🐛 2 | 🌐 Lua | 📅 2025-03-15 - Code screenshot plugin that makes use of [freeze](https://github.com/charmbracelet/freeze) ⭐ 4,481 | 🐛 69 | 🌐 Go | 📅 2026-04-22 inside the editor.
...
* [theKnightsOfRohan/csvlens.nvim](https://github.com/theKnightsOfRohan/csvlens.nvim) ⭐ 39 | 🐛 1 | 🌐 Lua | 📅 2024-04-28 - A port of [YS-L/csvlens](https://github.com/YS-L/csvlens) ⭐ 3,737 | 🐛 59 | 🌐 Rust | 📅 2026-03-29, for easy previewing of tabular data.
...
* [nvim-mini/mini.nvim#mini.animate](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).
* [sphamba/smear-cursor.nvim](https://github.com/sphamba/smear-cursor.nvim) ⭐ 1,790 | 🐛 7 | 🌐 Lua | 📅 2026-04-15 - Animate the cursor with a smear effect in all terminals. Inspired by Neovide's animated cursor.
* [rachartier/tiny-glimmer.nvim](https://github.com/rachartier/tiny-glimmer.nvim/) ⭐ 415 | 🐛 1 | 🌐 Lua | 📅 2026-04-16 - Adds subtle animations to various operations.
...
* [akinsho/toggleterm.nvim](https://github.com/akinsho/toggleterm.nvim) ⭐ 5,479 | 🐛 89 | 🌐 Lua | 📅 2025-03-09 - Easily manage multiple terminal windows.
* [kassio/neoterm](https://github.com/kassio/neoterm) ⭐ 1,337 | 🐛 31 | 🌐 Vim Script | 📅 2023-03-09 - Wrapper of some `:terminal` functions.
* [mikesmithgh/kitty-scrollback.nvim](https://github.com/mikesmithgh/kitty-scrollback.nvim) ⭐ 854 | 🐛 29 | 🌐 Lua | 📅 2026-04-17 - Open your kitty scrollback buffer. Ameowzing.
...
* [LuxVim/nvim-luxterm](https://github.com/LuxVim/nvim-luxterm) ⭐ 14 | 🐛 2 | 🌐 Lua | 📅 2026-02-11 - A floating-window terminal session manager, offering elegant multi-terminal organization, live previews, and intuitive navigation with modern UI design. Manage, switch, and customize multiple terminals effortlessly.
...
* [mfussenegger/nvim-dap](https://github.com/mfussenegger/nvim-dap) ⭐ 7,088 | 🐛 30 | 🌐 Lua | 📅 2026-04-06 - Debug Adapter Protocol client implementation.
* [rcarriga/nvim-dap-ui](https://github.com/rcarriga/nvim-dap-ui) ⭐ 3,324 | 🐛 103 | 🌐 Lua | 📅 2026-04-05 - A UI for nvim-dap.
...
* [igorlfs/nvim-dap-view](https://github.com/igorlfs/nvim-dap-view) ⭐ 857 | 🐛 8 | 🌐 Lua | 📅 2026-04-23 - A modern, minimalistic UI for nvim-dap.
* [sakhnik/nvim-gdb](https://github.com/sakhnik/nvim-gdb) ⭐ 776 | 🐛 5 | 🌐 Lua | 📅 2025-12-31 - Thin wrapper for GDB, LLDB, PDB/PDB++ and BashDB.
* [andrewferrier/debugprint.nvim](https://github.com/andrewferrier/debugprint.nvim) ⭐ 521 | 🐛 9 | 🌐 Lua | 📅 2026-04-06 - Debugging the print() way.
...
* [t-troebst/perfanno.nvim](https://github.com/t-troebst/perfanno.nvim) ⭐ 363 | 🐛 1 | 🌐 Lua | 📅 2026-01-20 - Annotate your code with callgraph profiling data. Native support for perf, flamegraph and the LuaJIT profiler.
...
* [stevearc/quicker.nvim](https://github.com/stevearc/quicker.nvim) ⭐ 957 | 🐛 20 | 🌐 Lua | 📅 2026-03-10 - Improved quickfix UI and editable quickfix buffer.
...
* [nvim-neotest/neotest](https://github.com/nvim-neotest/neotest) ⭐ 3,070 | 🐛 101 | 🌐 Lua | 📅 2026-04-01 - An extensible framework for interacting with tests within Neovim.
...
* [stevearc/overseer.nvim](https://github.com/stevearc/overseer.nvim) ⭐ 1,867 | 🐛 78 | 🌐 Lua | 📅 2026-04-01 - A task runner and job management plugin.
...
* [Zeioth/compiler.nvim](https://github.com/Zeioth/compiler.nvim) ⭐ 662 | 🐛 9 | 🌐 Lua | 📅 2025-08-14 - Compiler for building and running your code without having to configure anything.
...
* [nvim-mini/mini.nvim#mini.doc](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
* [nvim-mini/mini.nvim#mini.test](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` with framework for writing extensive Neovim plugin tests with support for hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.
* [nvim-lua/plenary.nvim](https://github.com/nvim-lua/plenary.nvim) ⭐ 3,446 | 🐛 154 | 🌐 Lua | 📅 2026-04-10 - Plenary: full; complete; entire; absolute; unqualified. All the Lua functions I don't want to write twice.
* [MunifTanjim/nui.nvim](https://github.com/MunifTanjim/nui.nvim) ⭐ 2,058 | 🐛 31 | 🌐 Lua | 📅 2025-06-08 - UI Component Library.
* [folke/lazydev.nvim](https://github.com/folke/lazydev.nvim) ⭐ 1,499 | 🐛 8 | 🌐 Lua | 📅 2026-03-14 - Faster LuaLS setup.
...
* [lumen-oss/luarocks-tag-release](https://github.com/lumen-oss/luarocks-tag-release) ⭐ 56 | 🐛 10 | 🌐 Lua | 📅 2026-04-22 - A GitHub action that publishes your Neovim plugins to LuaRocks.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2025-05-23 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 22,082 | 🐛 17 | 🌐 Go | 📅 2026-03-20 or compatible encryption tools for cryptographic safety.
...
* [Olical/conjure](https://github.com/Olical/conjure) ⭐ 2,089 | 🐛 89 | 🌐 Fennel | 📅 2026-04-10 - Interactive evaluation (Clojure, Fennel, Janet, Racket, Hy, MIT Scheme, Guile).
...
* [Saecki/crates.nvim](https://github.com/Saecki/crates.nvim) ⭐ 1,094 | 🐛 10 | 🌐 Lua | 📅 2026-04-13 - Rust dependency management for `Cargo.toml`.
...
* [nvim-mini/mini.nvim#mini.diff](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
* [nvim-mini/mini.nvim#mini.git](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for enhanced Git integration with current Neovim process that implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.
* [lewis6991/gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) ⭐ 6,750 | 🐛 34 | 🌐 Lua | 📅 2026-04-20 - Git integration: signs, hunk actions, blame, etc.
* [NeogitOrg/neogit](https://github.com/NeogitOrg/neogit) ⭐ 5,308 | 🐛 185 | 🌐 Lua | 📅 2026-04-23 - A Magit clone that may change some things to fit the Vim philosophy.
* [kdheepak/lazygit.nvim](https://github.com/kdheepak/lazygit.nvim) ⭐ 2,260 | 🐛 51 | 🌐 Lua | 📅 2025-12-19 - Plugin for calling lazygit.
* [esmuellert/codediff.nvim](https://github.com/esmuellert/codediff.nvim) ⭐ 1,307 | 🐛 75 | 🌐 Lua | 📅 2026-04-20 - Side-by-side diff with two-tier highlighting (line + character level) using VSCode's algorithm implemented in C.
...
* [dlyongemallo/diffview.nvim](https://github.com/dlyongemallo/diffview.nvim) ⭐ 154 | 🐛 6 | 🌐 Lua | 📅 2026-04-23 - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev. Maintained fork of sindrets/diffview\.nvim.
...
* [kokusenz/deltaview.nvim](https://github.com/kokusenz/deltaview.nvim) ⭐ 82 | 🐛 2 | 🌐 Lua | 📅 2026-04-22 - Inline/unified diff viewer with Tree-sitter syntax highlighting and diff highlighting in the style of [delta](https://github.com/dandavison/delta) ⭐ 30,461 | 🐛 379 | 🌐 Rust | 📅 2026-03-28, with enhanced navigational features.
...
* [AckslD/nvim-gfold.lua](https://github.com/AckslD/nvim-gfold.lua) ⭐ 32 | 🐛 0 | 🌐 Lua | 📅 2022-10-19 - Plugin using [gfold](https://github.com/nickgerace/gfold) ⭐ 388 | 🐛 8 | 🌐 Rust | 📅 2026-04-19 to switch repo and have statusline component.
...
* [pwntester/octo.nvim](https://github.com/pwntester/octo.nvim) ⭐ 3,245 | 🐛 228 | 🌐 Lua | 📅 2026-04-22 - Work with GitHub issues and PRs.
...
* [harrisoncramer/GitLab.nvim](https://github.com/harrisoncramer/GitLab.nvim) ⭐ 375 | 🐛 21 | 🌐 Lua | 📅 2026-04-24 - Review pull requests and manage other GitLab resources.
...
* [nvim-mini/mini.nvim#mini.jump](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for smarter jumping to a single character.
* [nvim-mini/mini.nvim#mini.jump2d](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
* [nvim-mini/mini.nvim#mini.bracketed](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` to go forward/backward with square brackets.
* [ggandor/leap.nvim](https://github.com/ggandor/leap.nvim) ⭐ 5,025 | 🐛 27 | 🌐 Fennel | 📅 2026-04-11 - A refined successor of Lightspeed, aiming to establish a widely accepted standard interface extension for moving around in Vim-like editors.
* [folke/flash.nvim](https://github.com/folke/flash.nvim) ⭐ 4,018 | 🐛 22 | 🌐 Lua | 📅 2025-10-28 - Navigate your code with search labels, enhanced character motions and Tree-sitter integration.
...
* [nvim-mini/mini.nvim#mini.clue](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
* [nvim-mini/mini.nvim#mini.keymap](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).
* [folke/which-key.nvim](https://github.com/folke/which-key.nvim) ⭐ 7,072 | 🐛 38 | 🌐 Lua | 📅 2025-10-28 - Shows a popup with possible keybindings of the command you started typing.
...
* [mawkler/demicolon.nvim](https://github.com/mawkler/demicolon.nvim) ⭐ 129 | 🐛 1 | 🌐 Lua | 📅 2026-01-25 - Use `;` and `,` keys to also repeat jumps to diagnostics (e.g. `]d`) and to [nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects?tab=readme-ov-file#text-objects-move) ⭐ 2,744 | 🐛 116 | 🌐 Tree-sitter Query | 📅 2026-04-07 (e.g. `]f`), in addition to repeating `t`/`T`/`f`/`F`.
...
* [nvim-mini/mini.nvim#mini.map](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.
...
* [nvim-mini/mini.nvim#mini.pairs](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
* [nvim-mini/mini.nvim#mini.trailspace](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
* [nvim-mini/mini.nvim#mini.operators](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
* [nvim-mini/mini.nvim#mini.move](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
* [nvim-mini/mini.nvim#mini.ai](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some built-in textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
* [nvim-mini/mini.nvim#mini.splitjoin](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
* [nvim-mini/mini.nvim#mini.basics](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.
* [windwp/nvim-autopairs](https://github.com/windwp/nvim-autopairs) ⭐ 4,003 | 🐛 15 | 🌐 Lua | 📅 2026-01-30 - A minimalist autopairs written by Lua.
...
* [folke/zen-mode.nvim](https://github.com/folke/zen-mode.nvim) ⭐ 2,125 | 🐛 18 | 🌐 Lua | 📅 2025-10-28 - Distraction-free coding.
...
* [shortcuts/no-neck-pain.nvim](https://github.com/shortcuts/no-neck-pain.nvim) ⭐ 932 | 🐛 16 | 🌐 Lua | 📅 2026-04-19 - Center the currently focused buffer to the middle of your terminal.
...
* [gbprod/substitute.nvim](https://github.com/gbprod/substitute.nvim) ⭐ 731 | 🐛 6 | 🌐 Lua | 📅 2026-02-17 - New operator motions to quickly replace and exchange text.
...
* [keaising/im-select.nvim](https://github.com/keaising/im-select.nvim) ⭐ 339 | 🐛 8 | 🌐 Lua | 📅 2026-03-18 - Switching and restoring input method automatically depends on Neovim's edit mode.
...
* [XXiaoA/atone.nvim](https://github.com/XXiaoA/atone.nvim) ⭐ 173 | 🐛 4 | 🌐 Lua | 📅 2026-04-11 - Undo tree for visualizing and managing undo history.
...
* [bennypowers/splitjoin.nvim](https://github.com/bennypowers/splitjoin.nvim) ⭐ 96 | 🐛 0 | 🌐 Lua | 📅 2026-04-21 - Split and join various syntax structures.
...
* [DrKJeff16/shebang.nvim](https://github.com/DrKJeff16/shebang.nvim) ⭐ 3 | 🐛 0 | 🌐 Lua | 📅 2026-04-24 - Add or modify a shebang on top of the current file.
...
* [nvim-mini/mini.nvim#mini.comment](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.
* [numToStr/Comment.nvim](https://github.com/numToStr/Comment.nvim) ⭐ 4,632 | 🐛 83 | 🌐 Lua | 📅 2024-08-19 - Smart and powerful comment plugin. Supports commentstring, motions, dot-repeat and more.
* [folke/todo-comments.nvim](https://github.com/folke/todo-comments.nvim) ⭐ 4,113 | 🐛 20 | 🌐 Lua | 📅 2025-11-10 - Highlight, list and search TODO comments in your projects.
...
* [jeangiraldoo/codedocs.nvim](https://github.com/jeangiraldoo/codedocs.nvim) ⭐ 80 | 🐛 1 | 🌐 Lua | 📅 2026-04-24 - A powerful and customizable annotation framework with support for many languages and annotation conventions.
...
* [nvim-mini/mini.nvim#mini.align](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for aligning text interactively (with or without instant preview).
* [stevearc/conform.nvim](https://github.com/stevearc/conform.nvim) ⭐ 5,073 | 🐛 93 | 🌐 Lua | 📅 2026-04-23 - A lightweight formatting engine that plays nice with LSP.
...
* [nvim-mini/mini.nvim#mini.indentscope](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.
...
* [nvim-mini/mini.nvim#mini.cmdline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cmdline.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for command line tweaks. Adds autocompletion with customizable delay, autocorrection for words with fixed candidates, and autopeek command range in a floating window.
...
* [nvim-mini/mini.nvim#mini.sessions](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for session management (read, write, delete).
* [rmagatti/auto-session](https://github.com/rmagatti/auto-session) ⭐ 1,813 | 🐛 25 | 🌐 Lua | 📅 2026-04-15 - A small automated session manager.
* [folke/persistence.nvim](https://github.com/folke/persistence.nvim) ⭐ 979 | 🐛 9 | 🌐 Lua | 📅 2025-10-28 - Simple automated session management.
...
* [coffebar/neovim-project](https://github.com/coffebar/neovim-project) ⭐ 291 | 🐛 3 | 🌐 Lua | 📅 2026-01-08 - Declarative project management, automatic saving of sessions, uses Telescope.
...
* [azratul/live-share.nvim](https://github.com/azratul/live-share.nvim) ⭐ 245 | 🐛 0 | 🌐 Lua | 📅 2026-04-23 - Provides remote collaboration capabilities from anywhere, making it ideal for pair-programming scenarios.
...
* [gruvw/strudel.nvim](https://github.com/gruvw/strudel.nvim) ⭐ 425 | 🐛 4 | 🌐 JavaScript | 📅 2026-04-10 - Live coding controller for [strudel](https://strudel.cc).
...
* [nvim-mini/mini.nvim#mini.bufremove](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,628 | 🐛 14 | 🌐 Lua | 📅 2026-04-17 - Smart, seamless, directional navigation and resizing of splits.
...
* [yorickpeterse/nvim-window](https://github.com/yorickpeterse/nvim-window) ⭐ 184 | 🐛 0 | 🌐 Lua | 📅 2026-01-20 - Easily jump between windows.
...
* [seandewar/nvimesweeper](https://github.com/seandewar/nvimesweeper) ⭐ 110 | 🐛 1 | 🌐 Lua | 📅 2024-06-29 - Play Minesweeper in your favourite text editor.
...
* [kawre/leetcode.nvim](https://github.com/kawre/leetcode.nvim) ⭐ 2,048 | 🐛 61 | 🌐 Lua | 📅 2025-09-21 - Solve Leetcode problems.
* [xeluxee/competitest.nvim](https://github.com/xeluxee/competitest.nvim) ⭐ 577 | 🐛 22 | 🌐 Lua | 📅 2025-05-13 - A plugin to automate testcases management and checking for Competitive Programming contests.
...
* [m4xshen/hardtime.nvim](https://github.com/m4xshen/hardtime.nvim) ⭐ 3,753 | 🐛 13 | 🌐 Lua | 📅 2025-09-13 - Helping you establish good command workflow and habit.
...
* [letieu/jira.nvim](https://github.com/letieu/jira.nvim) ⭐ 237 | 🐛 4 | 🌐 Lua | 📅 2026-04-15 - Manage Jira tasks with a beautiful UI.
* [emrearmagan/atlas.nvim](https://github.com/emrearmagan/atlas.nvim) ⭐ 23 | 🐛 2 | 🌐 Lua | 📅 2026-04-19 - Manage Bitbucket PRs and Jira issues.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 61 | 🐛 8 | 🌐 Go | 📅 2026-04-24 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 30,321 | 🐛 24 | 🌐 Lua | 📅 2026-04-23 - A launch point for your personal Neovim configuration.
* [siduck76/NvChad](https://github.com/siduck76/NvChad) ⭐ 28,109 | 🐛 1 | 🌐 Lua | 📅 2026-04-13 - An attempt to make Neovim's CLI as functional as an IDE while retaining beauty with less bloat.
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 26,035 | 🐛 51 | 🌐 Lua | 📅 2026-04-22 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
...
* [AstroNvim/AstroNvim](https://github.com/AstroNvim/AstroNvim) ⭐ 14,260 | 🐛 1 | 🌐 Lua | 📅 2026-04-07 - An aesthetic and feature-rich config that is extensible and easy to use with a great set of plugins.
...
* [shaunsingh/nyoom.nvim](https://github.com/shaunsingh/nyoom.nvim) ⭐ 1,588 | 🐛 30 | 🌐 Fennel | 📅 2023-11-05 - Blazing fast, configurable, minimal and "lispy" config written in Fennel.
...
* [dam9000/kickstart-modular.nvim](https://github.com/dam9000/kickstart-modular.nvim) ⭐ 976 | 🐛 0 | 🌐 Lua | 📅 2026-04-18 - This is a fork of nvim-lua/kickstart.nvim that moves from a single file to a multi file configuration.
...
* [MordechaiHadad/bob](https://github.com/MordechaiHadad/bob) ⭐ 2,086 | 🐛 31 | 🌐 Rust | 📅 2026-03-24 - A cross-platform, easy to use Neovim version manager.
...
* [y3owk1n/nvs](https://github.com/y3owk1n/nvs) ⭐ 32 | 🐛 0 | 🌐 Go | 📅 2026-04-23 - Another Neovim version manager with config switcher.
...
* [m15a/flake-awesome-neovim-plugins](https://github.com/m15a/flake-awesome-neovim-plugins) ⭐ 62 | 🐛 0 | 🌐 Nix | 📅 2026-04-23 - Nix flake that provides a collection of `awesome-neovim` plugins as Nix packages.
...
* [nvim-mini/mini.nvim#mini.notify](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) ⭐ 9,056 | 🐛 37 | 🌐 Lua | 📅 2026-04-21 - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.
* [folke/noice.nvim](https://github.com/folke/noice.nvim) ⭐ 5,708 | 🐛 34 | 🌐 Lua | 📅 2025-11-03 - Highly experimental plugin that completely replaces the UI for messages, cmdline and the popupmenu.
...
* [wsdjeg/calendar.nvim](https://github.com/wsdjeg/calendar.nvim) ⭐ 44 | 🐛 1 | 🌐 Lua | 📅 2026-01-30 - A simple floating calendar with extensions support.
