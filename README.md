...
* [lewis6991/pckr.nvim](https://github.com/lewis6991/pckr.nvim) ⭐ 343 | 🐛 8 | 🌐 Lua | 📅 2025-09-25 - Spiritual successor of `wbthomason/packer.nvim`.
...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 20,552 | 🐛 52 | 🌐 Lua | 📅 2025-12-17 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [nvim-mini/mini.nvim#mini.deps](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.
...
* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,455 | 🐛 34 | 🌐 Lua | 📅 2026-03-20 - Quickstart configurations for the LSP client.
...
* [mfussenegger/nvim-lint](https://github.com/mfussenegger/nvim-lint) ⭐ 2,671 | 🐛 43 | 🌐 Lua | 📅 2026-02-23 - An asynchronous linter plugin, complementary to the built-in Language Server Protocol support.
...
* [onsails/lspkind.nvim](https://github.com/onsails/lspkind.nvim) ⭐ 1,672 | 🐛 15 | 🌐 Lua | 📅 2026-01-29 - The plugin adds VSCode-like icons to LSP completions.
...
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 982 | 🐛 11 | 🌐 Lua | 📅 2026-03-19 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,686 | 🐛 111 | 🌐 JavaScript | 📅 2026-03-21 catalog.
...
* [smjonas/inc-rename.nvim](https://github.com/smjonas/inc-rename.nvim) ⭐ 837 | 🐛 9 | 🌐 Lua | 📅 2026-03-02 - Provides an incremental LSP rename command based on the command-preview feature.
...
* [tamago324/nlsp-settings.nvim](https://github.com/tamago324/nlsp-settings.nvim) ⭐ 336 | 🐛 10 | 🌐 Lua | 📅 2026-03-22 - Setup LSP with JSON or YAML files.
...
* [mrcjkb/rustaceanvim](https://github.com/mrcjkb/rustaceanvim) ⭐ 2,884 | 🐛 18 | 🌐 Lua | 📅 2026-03-04 - A heavily modified fork of rust-tools.nvim that does not require a `setup` call and does not depend on nvim-lspconfig.
...
* [mfussenegger/nvim-jdtls](https://github.com/mfussenegger/nvim-jdtls) ⭐ 1,451 | 🐛 1 | 🌐 Lua | 📅 2026-02-10 - Extensions for the built-in LSP support for the Eclipse JDT Language Server.
* [DNLHC/glance.nvim](https://github.com/DNLHC/glance.nvim) ⭐ 873 | 🐛 17 | 🌐 Lua | 📅 2025-06-16 - A pretty window for previewing, navigating and editing your LSP locations.
* [jmbuhr/otter.nvim](https://github.com/jmbuhr/otter.nvim) ⭐ 861 | 🐛 16 | 🌐 Lua | 📅 2026-02-14 - Provides LSP features and a nvim-cmp completion source for languages embedded in other documents.
* [mrcjkb/haskell-tools.nvim](https://github.com/mrcjkb/haskell-tools.nvim) ⭐ 578 | 🐛 22 | 🌐 Lua | 📅 2026-03-22 - Seamless integration for Haskell development tools like `haskell-language-server` and Hoogle.
...
* [Fildo7525/pretty\_hover](https://github.com/Fildo7525/pretty_hover) ⭐ 242 | 🐛 2 | 🌐 Lua | 📅 2026-03-12 - Highly customizable hover formatter, extendable to blink.cmp. As native hover supports multiple LSP servers.
...
* [mason-org/mason.nvim](https://github.com/mason-org/mason.nvim) ⭐ 10,126 | 🐛 269 | 🌐 Lua | 📅 2026-01-07 - Portable package manager that runs everywhere Neovim runs. Easily install and manage LSP servers, DAP servers, linters, and formatters.

### Diagnostics

* [folke/trouble.nvim](https://github.com/folke/trouble.nvim) ⭐ 6,717 | 🐛 19 | 🌐 Lua | 📅 2025-10-31 - A pretty diagnostics list to help you solve all the trouble your code is causing.
* [piersolenski/wtf.nvim](https://github.com/piersolenski/wtf.nvim) ⭐ 590 | 🐛 2 | 🌐 Lua | 📅 2026-03-02 - AI powered diagnostic debugging, helps explain complex errors and offers custom tailored solutions.
...
* [hrsh7th/nvim-cmp](https://github.com/hrsh7th/nvim-cmp) ⭐ 9,371 | 🐛 301 | 🌐 Lua | 📅 2026-01-23 - Completion engine written in Lua, successor of `nvim-compe`.
  * [hrsh7th/cmp-nvim-lsp](https://github.com/hrsh7th/cmp-nvim-lsp) ⭐ 1,493 | 🐛 29 | 🌐 Lua | 📅 2025-11-13 - `nvim-cmp` source for the built-in LSP client.
  ...
  * [hrsh7th/cmp-nvim-lsp-signature-help](https://github.com/hrsh7th/cmp-nvim-lsp-signature-help) ⭐ 679 | 🐛 25 | 🌐 Lua | 📅 2025-11-14 - `nvim-cmp` source for displaying function signatures from an LSP client.
...
* [nvim-mini/mini.nvim#mini.completion](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 6,060 | 🐛 98 | 🌐 Lua | 📅 2026-03-21 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [mikavilpas/blink-ripgrep.nvim](https://github.com/mikavilpas/blink-ripgrep.nvim) ⭐ 111 | 🐛 1 | 🌐 TypeScript | 📅 2026-03-23 - `blink.cmp` source for `ripgrep` / `git grep`.
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 10 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 43,442 | 🐛 60 | 🌐 C | 📅 2026-03-22.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 4,018 | 🐛 15 | 🌐 Lua | 📅 2026-03-18 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,467 | 🐛 50 | 🌐 Vim Script | 📅 2026-01-09.
...
* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 17,618 | 🐛 66 | 🌐 Lua | 📅 2026-03-20 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,326 | 🐛 24 | 🌐 Lua | 📅 2026-03-22 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
...
* [CopilotC-Nvim/CopilotChat.nvim](https://github.com/CopilotC-Nvim/CopilotChat.nvim) ⭐ 3,599 | 🐛 24 | 🌐 Lua | 📅 2026-03-09 - A chat interface for GitHub Copilot that allows you to directly ask and receive answers to coding-related questions.
* [nickjvandyke/opencode.nvim](https://github.com/nickjvandyke/opencode.nvim) ⭐ 2,949 | 🐛 10 | 🌐 Lua | 📅 2026-03-18 - OpenCode AI assistant integration.
...
* [Robitx/gp.nvim](https://github.com/Robitx/gp.nvim) ⭐ 1,309 | 🐛 69 | 🌐 Lua | 📅 2025-08-11 - ChatGPT like sessions and instructable text/code operations in your favorite editor.
* [Exafunction/windsurf.nvim](https://github.com/Exafunction/windsurf.nvim) ⭐ 1,259 | 🐛 115 | 🌐 Lua | 📅 2025-04-30 - Free, ultrafast Copilot alternative. Supports LSP and Tree-sitter.
* [milanglacier/minuet-ai.nvim](https://github.com/milanglacier/minuet-ai.nvim) ⭐ 1,066 | 🐛 12 | 🌐 Lua | 📅 2026-03-21 - Minuet offers code completion from LLM providers including OpenAI (compatible), Gemini, Claude, Ollama, Deepseek and more providers, with support for nvim-cmp, blink.cmp and virtual-text frontend.
* [Davidyz/VectorCode](https://github.com/davidyz/vectorcode) ⭐ 829 | 🐛 16 | 🌐 Python | 📅 2026-02-23 - Supercharge your LLM experience with repository-level RAG.
...
* [carlos-algms/agentic.nvim](https://github.com/carlos-algms/agentic.nvim) ⭐ 331 | 🐛 14 | 🌐 Lua | 📅 2026-03-22 - Chat interface for AI ACP providers such as Claude, Gemini, Codex, OpenCode and Cursor.
...
* [Flemma-Dev/flemma.nvim](https://github.com/Flemma-Dev/flemma.nvim) ⭐ 49 | 🐛 2 | 🌐 Lua | 📅 2026-03-22 - A first-class AI workspace.
...
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 8 | 🐛 4 | 🌐 Lua | 📅 2025-12-31 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 11,403 | 🐛 569 | 🌐 Python | 📅 2026-03-17 tool.
...
* [nvim-java/nvim-java](https://github.com/nvim-java/nvim-java) ⭐ 1,595 | 🐛 35 | 🌐 Lua | 📅 2026-02-05 - Everything you need for a painless Java experience.
...
* [chomosuke/typst-preview.nvim](https://github.com/chomosuke/typst-preview.nvim) ⭐ 868 | 🐛 14 | 🌐 Lua | 📅 2026-03-22 - Preview Typst documents in the browser, instant update on each keystroke, and cross jump between code and preview.
...
* [Julian/lean.nvim](https://github.com/Julian/lean.nvim) ⭐ 493 | 🐛 36 | 🌐 Lua | 📅 2026-03-18 - Support for the [Lean Theorem Prover](https://leanprover.github.io/).
...
* [ray-x/go.nvim](https://github.com/ray-x/go.nvim) ⭐ 2,613 | 🐛 96 | 🌐 Lua | 📅 2026-03-22 - Golang plugin based on LSP and Tree-sitter.
* [olexsmir/gopher.nvim](https://github.com/olexsmir/gopher.nvim/) ⭐ 416 | 🐛 5 | 🌐 Lua | 📅 2026-03-04 - Plugin for making Golang development easiest.
...
* [rest-nvim/rest.nvim](https://github.com/rest-nvim/rest.nvim) ⭐ 2,010 | 🐛 46 | 🌐 Lua | 📅 2025-12-27 - A fast HTTP client written in Lua.
* [mistweaverco/kulala.nvim](https://github.com/mistweaverco/kulala.nvim) ⭐ 1,932 | 🐛 16 | 🌐 Lua | 📅 2026-03-16 - A minimal HTTP-client interface.
...
* [iamcco/markdown-preview.nvim](https://github.com/iamcco/markdown-preview.nvim) ⭐ 7,768 | 🐛 260 | 🌐 JavaScript | 📅 2024-07-23 - Preview Markdown on your modern browser with synchronised scrolling and flexible configuration.
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 4,300 | 🐛 8 | 🌐 Lua | 📅 2026-03-09 - Improve viewing Markdown files directly.
* [OXY2DEV/markview.nvim](https://github.com/OXY2DEV/markview.nvim) ⭐ 3,352 | 🐛 3 | 🌐 Lua | 📅 2026-03-20 - A hackable Markdown, Typst, LaTeX, HTML (inline) and YAML renderer.
...
* [YousefHadder/markdown-plus.nvim](https://github.com/YousefHadder/markdown-plus.nvim) ⭐ 228 | 🐛 3 | 🌐 Lua | 📅 2026-03-16 - Provides a full editing experience for Markdown files which includes support for lists, links, TOC, and more with simple and fast keymaps.
...
* [jghauser/follow-md-links.nvim](https://github.com/jghauser/follow-md-links.nvim) ⭐ 169 | 🐛 6 | 🌐 Lua | 📅 2026-02-24 - Press enter to follow internal Markdown links.
...
* [Prgebish/sigil.nvim](https://github.com/Prgebish/sigil.nvim) ⭐ 30 | 🐛 0 | 🌐 Lua | 📅 2026-02-15 - Implementation of Emacs' `prettify-symbols-mode` to visually replace text patterns with Unicode symbols while editing LaTeX and Typst files.
...
* [rogue-87/inlyne.nvim](https://github.com/rogue-87/inlyne.nvim) ⭐ 3 | 🐛 0 | 🌐 Lua | 📅 2026-02-05 - Wrapper for [inlyne](https://github.com/Inlyne-Project/inlyne) ⭐ 1,276 | 🐛 59 | 🌐 Rust | 📅 2026-03-02 Markdown viewer.

### PHP

* [gbprod/phpactor.nvim](https://github.com/gbprod/phpactor.nvim) ⭐ 94 | 🐛 2 | 🌐 Lua | 📅 2026-01-07 - Lua version of [phpactor](https://github.com/phpactor/phpactor) ⭐ 1,832 | 🐛 296 | 🌐 PHP | 📅 2026-03-21.
...
* [nvim-treesitter/nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter) ⭐ 13,414 | 🐛 272 | 🌐 Tree-sitter Query | 📅 2026-03-22 - Tree-sitter configurations and abstraction layer.
* [nvim-mini/mini.nvim#mini.surround](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-surround.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for working with text surroundings (add, delete, replace, find, highlight). Supports dot-repeat, different search methods, "last"/"next" extended mappings, Tree-sitter integration, and more.
* [kylechui/nvim-surround](https://github.com/kylechui/nvim-surround) ⭐ 4,141 | 🐛 8 | 🌐 Lua | 📅 2026-03-07 - A plugin for adding/changing/deleting surrounding delimiter pairs.
* [nvim-treesitter/nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects) ⭐ 2,708 | 🐛 112 | 🌐 Tree-sitter Query | 📅 2026-03-21 - Create your own textobjects using Tree-sitter queries.
...
* [IndianBoy42/tree-sitter-just](https://github.com/IndianBoy42/tree-sitter-just) ⭐ 182 | 🐛 5 | 🌐 Just | 📅 2026-03-15 - Tree-sitter grammar for [Justfiles](https://github.com/casey/just) ⭐ 32,279 | 🐛 336 | 🌐 Rust | 📅 2026-03-23.
...
* [nvim-mini/mini.nvim#mini.snippets](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.
* [L3MON4D3/LuaSnip](https://github.com/L3MON4D3/LuaSnip) ⭐ 4,305 | 🐛 130 | 🌐 Lua | 📅 2026-03-21 - A snippet engine written in Lua.
* [rafamadriz/friendly-snippets](https://github.com/rafamadriz/friendly-snippets) ⭐ 2,670 | 🐛 68 | 🌐 Lua | 📅 2026-01-23 - Set of preconfigured snippets for different languages.
...
* [ThePrimeagen/harpoon](https://github.com/ThePrimeagen/harpoon/tree/harpoon2) ⭐ 8,970 | 🐛 150 | 🌐 Lua | 📅 2025-10-31 - A per project, auto updating and editable marks utility for fast file navigation.
...
* [otavioschwanck/arrow.nvim](https://github.com/otavioschwanck/arrow.nvim) ⭐ 734 | 🐛 34 | 🌐 Lua | 📅 2025-11-28 - Like harpoon, but with a different UX, single keybinding needed and statusline support.
...
* [Beargruug/skipper.nvim](https://github.com/Beargruug/skipper.nvim/) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2026-03-20 - Jump between functions in a file with ease.
...
* [ray-x/sad.nvim](https://github.com/ray-x/sad.nvim) ⭐ 204 | 🐛 4 | 🌐 Lua | 📅 2025-05-01 - Space Age seD integration. Batch file edit tool, a wrapper for [sad](https://github.com/ms-jpq/sad) ⭐ 2,018 | 🐛 28 | 🌐 Rust | 📅 2025-09-30
...
* [nvim-telescope/telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) ⭐ 19,212 | 🐛 490 | 🌐 Lua | 📅 2026-03-17 - Telescope.nvim is a highly [extendable](https://github.com/nvim-telescope/telescope.nvim/wiki/Extensions) ⭐ 19,212 | 🐛 490 | 🌐 Lua | 📅 2026-03-17 A highly extensible fuzzy finder over lists.
* [nvim-mini/mini.nvim#mini.fuzzy](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
* [nvim-mini/mini.nvim#mini.pick](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
* [nvim-mini/mini.nvim#mini.extra](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.
* [folke/snacks.nvim#picker](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) ⭐ 7,278 | 🐛 97 | 🌐 Lua | 📅 2026-03-21 - A modern fuzzy-finder to navigate the Neovim universe.
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,143 | 🐛 7 | 🌐 Lua | 📅 2026-03-19 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,687 | 🐛 21 | 🌐 Rust | 📅 2026-03-20 as its fzf binary.
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 1,925 | 🐛 40 | 🌐 Rust | 📅 2026-03-20 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
...
* [bassamsdata/namu.nvim](https://github.com/bassamsdata/namu.nvim) ⭐ 420 | 🐛 5 | 🌐 Lua | 📅 2026-02-17 - Flexible and sleek fuzzy picker, LSP symbol navigator, and more.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 367 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 34,846 | 🐛 154 | 🌐 Rust | 📅 2026-03-21, a smart directory picker that tracks your usage.
...
* [dtormoen/neural-open.nvim](https://github.com/dtormoen/neural-open.nvim) ⭐ 51 | 🐛 1 | 🌐 Lua | 📅 2026-03-11 - Intelligent `snacks.nvim` picker that teaches a neural network to rank files by what you're most likely to open next.
...
* [nvim-mini/mini.nvim#mini.files](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.
* [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) ⭐ 8,432 | 🐛 96 | 🌐 Lua | 📅 2026-03-22 - A simple and fast file explorer tree.
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,369 | 🐛 128 | 🌐 Lua | 📅 2026-02-24 - Edit your filesystem like a buffer.
* [nvim-neo-tree/neo-tree.nvim](https://github.com/nvim-neo-tree/neo-tree.nvim) ⭐ 5,321 | 🐛 169 | 🌐 Lua | 📅 2026-03-22 - Browse the file system and other tree-like structures in whatever style suits you, including sidebars, floating windows, `netrw` split style, or all of them at once.
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,686 | 🐛 93 | 🌐 Python | 📅 2026-03-23 - File manager. Better than NERDTree.
* [mikavilpas/yazi.nvim](https://github.com/mikavilpas/yazi.nvim) ⭐ 1,600 | 🐛 7 | 🌐 Lua | 📅 2026-03-23 - Integration with the Yazi terminal file manager.
* [kevinhwang91/rnvimr](https://github.com/kevinhwang91/rnvimr) ⭐ 843 | 🐛 10 | 🌐 Python | 📅 2026-01-11 - A simple yet amazing file explorer.
* [A7Lavinraj/fyler.nvim](https://github.com/A7Lavinraj/fyler.nvim) ⭐ 673 | 🐛 21 | 🌐 Lua | 📅 2026-03-19 - File manager which can edit file system like a buffer with tree view.
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 457 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,409 | 🐛 1 | 🌐 C | 📅 2026-03-19 and Lua.
...
* [kelly-lin/ranger.nvim](https://github.com/kelly-lin/ranger.nvim) ⭐ 180 | 🐛 11 | 🌐 Lua | 📅 2024-11-18 - [Ranger](https://github.com/ranger/ranger) ⭐ 17,074 | 🐛 931 | 🌐 Python | 📅 2026-02-25 integration.
* [Xuyuanp/yanil](https://github.com/Xuyuanp/yanil) ⭐ 98 | 🐛 5 | 🌐 Lua | 📅 2026-01-15 - Yet Another Nerdtree In Lua.
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 98 | 🐛 2 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 35,062 | 🐛 63 | 🌐 Rust | 📅 2026-03-21).
...
* [nvim-mini/mini.nvim#mini.visits](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.
...
* [DrKJeff16/project.nvim](https://github.com/DrKJeff16/project.nvim) ⭐ 146 | 🐛 0 | 🌐 Lua | 📅 2026-03-19 - Project manager with project root detection, documented code and lots of improvements, including `snacks.nvim`, `fzf-lua` and `picker.nvim` support.
...
* [mrjones2014/codesettings.nvim](https://github.com/mrjones2014/codesettings.nvim) ⭐ 62 | 🐛 2 | 🌐 Lua | 📅 2026-03-23 - Easily load project-local settings (like `.vscode/settings.json`) into Neovim 0.11+ native LSP settings.
...
* [dzfrias/arena.nvim](https://github.com/dzfrias/arena.nvim) ⭐ 112 | 🐛 3 | 🌐 Lua | 📅 2026-03-15 - A smart (frecency-based) buffer switcher.
...
* [nvim-mini/mini.nvim#mini.hipatterns](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.
...
* [catgoose/nvim-colorizer.lua](https://github.com/catgoose/nvim-colorizer.lua) ⭐ 1,015 | 🐛 1 | 🌐 Lua | 📅 2026-03-22 - A high-performance color highlighter which has no external dependencies.
* [uga-rosa/ccc.nvim](https://github.com/uga-rosa/ccc.nvim) ⭐ 961 | 🐛 12 | 🌐 Lua | 📅 2025-05-06 - Super powerful color picker / colorizer plugin.
* [TaDaa/vimade](https://github.com/TaDaa/vimade) ⭐ 650 | 🐛 6 | 🌐 Lua | 📅 2026-03-22 - Dim, fade, tint, animate, and customize colors in your windows and buffers.
...
* [folke/tokyonight.nvim](https://github.com/folke/tokyonight.nvim) ⭐ 7,903 | 🐛 13 | 🌐 Lua | 📅 2025-11-05 - ***`[TS][LSP][L/D][Lua]`*** A clean, dark and light theme written in Lua, with support for LSP, Tree-sitter and lots of plugins.
* [sainnhe/everforest](https://github.com/sainnhe/everforest) ⭐ 3,908 | 🐛 7 | 🌐 Vim Script | 📅 2026-01-21 - ***`[TS][LSP][L/D]`*** A green based colorscheme designed to be warm, soft and easy on the eyes.
* [sainnhe/gruvbox-material](https://github.com/sainnhe/gruvbox-material) ⭐ 2,509 | 🐛 8 | 🌐 Vim Script | 📅 2026-01-21 - ***`[TS][LSP]`*** Gruvbox modification with softer contrast and Tree-sitter support.
...
* [bluz71/vim-moonfly-colors](https://github.com/bluz71/vim-moonfly-colors) ⭐ 1,261 | 🐛 0 | 🌐 Lua | 📅 2026-01-18 - ***`[TS][LSP][Lua]`*** A dark charcoal colorscheme with Tree-sitter support.
...
* [everviolet/nvim](https://github.com/everviolet/nvim) ⭐ 615 | 🐛 0 | 🌐 Lua | 📅 2026-03-21 - ***`[TS][LSP][L/D][Lua]`*** A comfy colorscheme for cozy morning coding.
...
* [oskarnurm/koda.nvim](https://github.com/oskarnurm/koda.nvim) ⭐ 249 | 🐛 2 | 🌐 Lua | 📅 2026-03-07 - ***`[TS][LSP][L/D][Lua]`*** Code's quiet companion. A minimalist colorscheme, written in Lua.
...
* [uhs-robert/oasis.nvim](https://github.com/uhs-robert/oasis.nvim) ⭐ 124 | 🐛 3 | 🌐 CSS | 📅 2026-03-20 - ***`[TS][LSP][L/D][Lua]`*** Desert theme from Vim ported to Neovim and made modern with 12 variants, a collection of dark themes for every color of the rainbow.
...
* [rose-pine/neovim](https://github.com/rose-pine/neovim) ⭐ 2,968 | 🐛 5 | 🌐 Lua | 📅 2025-12-21 - ***`[TS][LSP][L/D][Lua]`*** All natural pine, faux fur and a bit of soho vibes for the classy minimalist.

<!--lint enable awesome-spell-check-->

* [nvim-mini/mini.nvim#colorschemes](https://github.com/nvim-mini/mini.nvim#plugin-color-schemes) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - ***`[TS][LSP][L/D][Lua]`*** Color schemes included in `mini.nvim`. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.
...
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 6,003 | 🐛 91 | 🌐 Lua | 📅 2025-10-15 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
* [EdenEast/nightfox.nvim](https://github.com/EdenEast/nightfox.nvim) ⭐ 3,933 | 🐛 35 | 🌐 Lua | 📅 2025-02-09 - ***`[TS][LSP][L/D][Lua]`*** A soft dark, fully customizable colorscheme with support for LSP, Tree-sitter and a variety of plugins.
* [ellisonleao/gruvbox.nvim](https://github.com/ellisonleao/gruvbox.nvim) ⭐ 2,489 | 🐛 27 | 🌐 Lua | 📅 2026-03-09 - ***`[TS][LSP][L/D][Lua]`*** Gruvbox community colorscheme Lua port.
* [scottmckendry/cyberdream.nvim](https://github.com/scottmckendry/cyberdream.nvim) ⭐ 1,287 | 🐛 5 | 🌐 Lua | 📅 2026-01-27 - ***`[TS][L/D][Lua]`*** A high-contrast, futuristic and vibrant coloursheme.
...
* [slugbyte/lackluster.nvim](https://github.com/slugbyte/lackluster.nvim) ⭐ 534 | 🐛 0 | 🌐 Lua | 📅 2025-10-06 - ***`[TS][LSP][Lua]`*** A delightful mostly grayscale colorscheme that is soft on the eyes, and supports heaps of plugins.
...
* [ptdewey/darkearth-nvim](https://github.com/ptdewey/darkearth-nvim) ⭐ 77 | 🐛 0 | 🌐 Fennel | 📅 2026-03-19 - ***`[TS][LSP][Fnl]`*** A dark and earthy colorscheme supporting Tree-sitter and LSP.
...
* [nvim-mini/mini.nvim#mini.base16](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
* [nvim-mini/mini.nvim#mini.colors](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
* [nvim-mini/mini.nvim#mini.hues](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.
* [rktjmp/lush.nvim](https://github.com/rktjmp/lush.nvim) ⭐ 1,753 | 🐛 13 | 🌐 Lua | 📅 2025-09-01 - Define Neovim themes as a DSL in Lua, with real-time feedback.
...
* [Bekaboo/dropbar.nvim](https://github.com/Bekaboo/dropbar.nvim) ⭐ 1,521 | 🐛 10 | 🌐 Lua | 📅 2025-10-05 - IDE-like breadcrumbs, out of the box.
...
* [m4xshen/smartcolumn.nvim](https://github.com/m4xshen/smartcolumn.nvim) ⭐ 361 | 🐛 2 | 🌐 Lua | 📅 2025-07-21 - Hide your colorcolumn when unneeded.
...
* [nvim-mini/mini.nvim#mini.statusline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.
* [nvim-lualine/lualine.nvim](https://github.com/nvim-lualine/lualine.nvim) ⭐ 7,812 | 🐛 269 | 🌐 Lua | 📅 2025-11-23 - Easily configurable, blazingly fast statusline.
...
* [nvim-mini/mini.nvim#mini.tabline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.
* [akinsho/bufferline.nvim](https://github.com/akinsho/bufferline.nvim) ⭐ 4,279 | 🐛 100 | 🌐 Lua | 📅 2025-01-14 - A snazzy bufferline built using Lua.
* [romgrk/barbar.nvim](https://github.com/romgrk/barbar.nvim) ⭐ 2,665 | 🐛 34 | 🌐 Lua | 📅 2025-12-02 - A tabline with re-orderable, auto-sizing, clickable tabs, icons, nice highlighting, sort-by commands and a magic jump-to-buffer mode.
...
* [nvim-mini/mini.nvim#mini.cursorword](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).
...
* [nvim-mini/mini.nvim#mini.starter](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.
...
* [nvim-mini/mini.nvim#mini.icons](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-icons.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` meant as a general icon provider. Uses fixed set of highlight groups. Supports various categories, icon and style customizations, caching for performance. Integrates with built-in filetype matching.
* [nvim-tree/nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons) ⭐ 2,635 | 🐛 17 | 🌐 Lua | 📅 2026-03-11 - A Lua fork of [vim-devicons](https://github.com/ryanoasis/vim-devicons) ⭐ 5,798 | 🐛 70 | 🌐 Vim Script | 📅 2024-05-09.
...
* [3rd/image.nvim](https://github.com/3rd/image.nvim) ⭐ 1,925 | 🐛 54 | 🌐 Lua | 📅 2026-02-21 - Add image support through kitty's graphics protocol or ueberzugpp.
...
* [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ⭐ 7,256 | 🐛 219 | 🌐 Lua | 📅 2026-03-21 - Modernity meets insane extensibility. The future of organizing your life.
* [nvim-orgmode/orgmode](https://github.com/nvim-orgmode/orgmode) ⭐ 3,705 | 🐛 137 | 🌐 Lua | 📅 2026-03-19 - Org-mode clone written in Lua.
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 1,681 | 🐛 72 | 🌐 Lua | 📅 2026-03-19 - Plugin for Obsidian, written in Lua.
* [nvim-telekasten/telekasten.nvim](https://github.com/nvim-telekasten/telekasten.nvim) ⭐ 1,654 | 🐛 66 | 🌐 Lua | 📅 2026-03-17 - Work with a text-based, Markdown zettelkasten / wiki and mix it with a journal, based on telescope.nvim.
* [jbyuki/venn.nvim](https://github.com/jbyuki/venn.nvim) ⭐ 1,159 | 🐛 4 | 🌐 Lua | 📅 2024-08-16 - Draw ASCII diagrams.
* [zk-org/zk-nvim](https://github.com/zk-org/zk-nvim) ⭐ 804 | 🐛 3 | 🌐 Lua | 📅 2026-03-13 -  Provides integration with `zk`, a plain text note-taking assistant.
...
* [iwe-org/iwe.nvim](https://github.com/iwe-org/iwe.nvim) ⭐ 41 | 🐛 1 | 🌐 Lua | 📅 2026-03-20 - Integration with `IWE`, an LSP designed for Markdown-based knowledge management and note-taking workflows.
...
* [ymich9963/mdnotes.nvim](https://github.com/ymich9963/mdnotes.nvim) ⭐ 10 | 🐛 10 | 🌐 Lua | 📅 2026-03-15 - Simple and improved Markdown note taking.
...
* [code-biscuits/nvim-biscuits](https://github.com/code-biscuits/nvim-biscuits) ⭐ 325 | 🐛 7 | 🌐 Lua | 📅 2026-03-23 - A port of Assorted Biscuits. Ends up with more supported languages too.
...
* [AlejandroSuero/freeze-code.nvim](https://github.com/AlejandroSuero/freeze-code.nvim) ⭐ 31 | 🐛 2 | 🌐 Lua | 📅 2025-03-15 - Code screenshot plugin that makes use of [freeze](https://github.com/charmbracelet/freeze) ⭐ 4,396 | 🐛 68 | 🌐 Go | 📅 2026-03-16 inside the editor.
...
* [emrearmagan/dockyard.nvim](https://github.com/emrearmagan/dockyard.nvim) ⭐ 16 | 🐛 0 | 🌐 Lua | 📅 2026-03-21 - Docker dashboard for managing containers, images, networks, and logs.
...
* [hat0uma/csvview.nvim](https://github.com/hat0uma/csvview.nvim) ⭐ 577 | 🐛 15 | 🌐 Lua | 📅 2026-02-14 - An asynchronous CSV/TSV table viewer with real-time updates, configurable comments and delimiters, and multiple display modes.
...
* [theKnightsOfRohan/csvlens.nvim](https://github.com/theKnightsOfRohan/csvlens.nvim) ⭐ 39 | 🐛 1 | 🌐 Lua | 📅 2024-04-28 - A port of [YS-L/csvlens](https://github.com/YS-L/csvlens) ⭐ 3,652 | 🐛 56 | 🌐 Rust | 📅 2026-03-17, for easy previewing of tabular data.
...
* [nvim-mini/mini.nvim#mini.animate](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).
* [sphamba/smear-cursor.nvim](https://github.com/sphamba/smear-cursor.nvim) ⭐ 1,728 | 🐛 6 | 🌐 Lua | 📅 2025-12-01 - Animate the cursor with a smear effect in all terminals. Inspired by Neovide's animated cursor.
...
* [numToStr/FTerm.nvim](https://github.com/numToStr/FTerm.nvim) ⭐ 805 | 🐛 26 | 🌐 Lua | 📅 2023-10-19 - No nonsense floating terminal written in Lua.
* [willothy/flatten.nvim](https://github.com/willothy/flatten.nvim) ⭐ 695 | 🐛 15 | 🌐 Lua | 📅 2025-05-27 - Open files from terminal buffers in your current Neovim instance instead of launching a nested instance.
...
* [mfussenegger/nvim-dap](https://github.com/mfussenegger/nvim-dap) ⭐ 7,009 | 🐛 29 | 🌐 Lua | 📅 2026-03-06 - Debug Adapter Protocol client implementation.
* [rcarriga/nvim-dap-ui](https://github.com/rcarriga/nvim-dap-ui) ⭐ 3,299 | 🐛 106 | 🌐 Lua | 📅 2025-07-09 - A UI for nvim-dap.
...
* [sakhnik/nvim-gdb](https://github.com/sakhnik/nvim-gdb) ⭐ 773 | 🐛 5 | 🌐 Lua | 📅 2025-12-31 - Thin wrapper for GDB, LLDB, PDB/PDB++ and BashDB.
...
* [stevearc/quicker.nvim](https://github.com/stevearc/quicker.nvim) ⭐ 932 | 🐛 17 | 🌐 Lua | 📅 2026-03-10 - Improved quickfix UI and editable quickfix buffer.
...
* [nvim-neotest/neotest](https://github.com/nvim-neotest/neotest) ⭐ 3,050 | 🐛 113 | 🌐 Lua | 📅 2025-11-08 - An extensible framework for interacting with tests within Neovim.
...
* [stevearc/overseer.nvim](https://github.com/stevearc/overseer.nvim) ⭐ 1,842 | 🐛 74 | 🌐 Lua | 📅 2026-03-10 - A task runner and job management plugin.
...
* [benlubas/molten-nvim](https://github.com/benlubas/molten-nvim) ⭐ 1,141 | 🐛 38 | 🌐 Python | 📅 2026-03-01 - Enables running code chunks via the Jupyter kernel. Output (including image output) is rendered in a floating window below the code.
...
* [rafcamlet/nvim-luapad](https://github.com/rafcamlet/nvim-luapad) ⭐ 677 | 🐛 5 | 🌐 Lua | 📅 2026-02-07 - Interactive scratchpad for running Lua code.
...
* [mikeboiko/nvim-flow](https://github.com/mikeboiko/nvim-flow) ⭐ 5 | 🐛 0 | 🌐 Lua | 📅 2026-03-06 - File-scoped command runner with YAML configuration, command preview, debug integration, and traceback quickfix.
...
* [nvim-mini/mini.nvim#mini.doc](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
* [nvim-mini/mini.nvim#mini.test](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` with framework for writing extensive Neovim plugin tests with support for hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.
...
* [DrKJeff16/wezterm-types](https://github.com/DrKJeff16/wezterm-types) ⭐ 189 | 🐛 2 | 🌐 Lua | 📅 2026-03-21 - WezTerm config type annotations for LuaLS, including support for community plugins.
...
* [jrop/morph.nvim](https://github.com/jrop/morph.nvim) ⭐ 105 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - A React-like renderer for building interactive buffers/TUIs.
...
* [lumen-oss/luarocks-tag-release](https://github.com/lumen-oss/luarocks-tag-release) ⭐ 56 | 🐛 11 | 🌐 Lua | 📅 2026-03-22 - A GitHub action that publishes your Neovim plugins to LuaRocks.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2025-05-23 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 21,726 | 🐛 17 | 🌐 Go | 📅 2026-03-20 or compatible encryption tools for cryptographic safety.
...
* [Olical/conjure](https://github.com/Olical/conjure) ⭐ 2,070 | 🐛 92 | 🌐 Fennel | 📅 2026-03-15 - Interactive evaluation (Clojure, Fennel, Janet, Racket, Hy, MIT Scheme, Guile).
* [Olical/aniseed](https://github.com/Olical/aniseed) ⭐ 645 | 🐛 7 | 🌐 Fennel | 📅 2025-06-12 - Configure and extend Neovim with Fennel.
* [rktjmp/hotpot.nvim](https://github.com/rktjmp/hotpot.nvim) ⭐ 388 | 🐛 11 | 🌐 Fennel | 📅 2025-12-23 - Seamless, transparent Fennel inside Neovim.
...
* [aileot/nvim-thyme](https://github.com/aileot/nvim-thyme) ⭐ 39 | 🐛 2 | 🌐 Fennel | 📅 2025-11-04 - Zero-overhead Fennel JIT compiler with safety rollbacks and [parinfer-rust](https://github.com/eraserhd/parinfer-rust) ⭐ 615 | 🐛 35 | 🌐 Rust | 📅 2026-01-03 integration.
...
* [nvim-mini/mini.nvim#mini.diff](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
* [nvim-mini/mini.nvim#mini.git](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for enhanced Git integration with current Neovim process that implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.
* [lewis6991/gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) ⭐ 6,657 | 🐛 33 | 🌐 Lua | 📅 2026-03-06 - Git integration: signs, hunk actions, blame, etc.
* [sindrets/diffview.nvim](https://github.com/sindrets/diffview.nvim) ⭐ 5,441 | 🐛 132 | 🌐 Lua | 📅 2024-08-02 - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev.
* [NeogitOrg/neogit](https://github.com/NeogitOrg/neogit) ⭐ 5,240 | 🐛 180 | 🌐 Lua | 📅 2026-03-14 - A Magit clone that may change some things to fit the Vim philosophy.
* [kdheepak/lazygit.nvim](https://github.com/kdheepak/lazygit.nvim) ⭐ 2,215 | 🐛 49 | 🌐 Lua | 📅 2025-12-19 - Plugin for calling lazygit.
* [esmuellert/codediff.nvim](https://github.com/esmuellert/codediff.nvim) ⭐ 1,209 | 🐛 53 | 🌐 Lua | 📅 2026-03-11 - Side-by-side diff with two-tier highlighting (line + character level) using VSCode's algorithm implemented in C.
* [f-person/git-blame.nvim](https://github.com/f-person/git-blame.nvim) ⭐ 1,073 | 🐛 11 | 🌐 Lua | 📅 2025-11-05 - Show Git blame info.
...
* [chojs23/ec](https://github.com/chojs23/ec) ⭐ 154 | 🐛 3 | 🌐 Go | 📅 2026-03-21 - A TUI native Git mergetool with 3 panes.
...
* [barrettruth/diffs.nvim](https://github.com/barrettruth/diffs.nvim) ⭐ 64 | 🐛 1 | 🌐 Lua | 📅 2026-03-21 - Syntax highlighting for diffs with Tree-sitter support for `vim-fugitive` and `&diff` buffers.
...
* [jceb/jiejie.nvim](https://github.com/jceb/jiejie.nvim) ⭐ 48 | 🐛 2 | 🌐 Lua | 📅 2026-03-10 - Frontend for Jujutsu in the style of `fugitive`.
...
* [pwntester/octo.nvim](https://github.com/pwntester/octo.nvim) ⭐ 3,204 | 🐛 228 | 🌐 Lua | 📅 2026-03-13 - Work with GitHub issues and PRs.
...
* [nvim-mini/mini.nvim#mini.jump](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for smarter jumping to a single character.
* [nvim-mini/mini.nvim#mini.jump2d](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
* [nvim-mini/mini.nvim#mini.bracketed](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` to go forward/backward with square brackets.
...
* [folke/flash.nvim](https://github.com/folke/flash.nvim) ⭐ 3,967 | 🐛 25 | 🌐 Lua | 📅 2025-10-28 - Navigate your code with search labels, enhanced character motions and Tree-sitter integration.
...
* [abecodes/tabout.nvim](https://github.com/abecodes/tabout.nvim) ⭐ 855 | 🐛 6 | 🌐 Lua | 📅 2024-12-10 - Jump out of bracket pairs, quotes, objects, etc.
* [chrisgrieser/nvim-spider](https://github.com/chrisgrieser/nvim-spider) ⭐ 855 | 🐛 0 | 🌐 Lua | 📅 2026-02-26 - Use the w, e, b motions like a spider. Considers camelCase and skips insignificant punctuation.
...
* [Aaronik/Treewalker.nvim](https://github.com/aaronik/Treewalker.nvim) ⭐ 593 | 🐛 1 | 🌐 Lua | 📅 2026-03-19 - Move seamlessly around the abstract syntax tree.
...
* [nvim-mini/mini.nvim#mini.clue](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
* [nvim-mini/mini.nvim#mini.keymap](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).
* [folke/which-key.nvim](https://github.com/folke/which-key.nvim) ⭐ 7,008 | 🐛 35 | 🌐 Lua | 📅 2025-10-28 - Shows a popup with possible keybindings of the command you started typing.
...
* [mawkler/demicolon.nvim](https://github.com/mawkler/demicolon.nvim) ⭐ 125 | 🐛 0 | 🌐 Lua | 📅 2026-01-25 - Use `;` and `,` keys to also repeat jumps to diagnostics (e.g. `]d`) and to [nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects?tab=readme-ov-file#text-objects-move) ⭐ 2,708 | 🐛 112 | 🌐 Tree-sitter Query | 📅 2026-03-21 (e.g. `]f`), in addition to repeating `t`/`T`/`f`/`F`.
...
* [karb94/neoscroll.nvim](https://github.com/karb94/neoscroll.nvim) ⭐ 1,988 | 🐛 11 | 🌐 Lua | 📅 2025-12-31 - Smooth scrolling.
...
* [nvim-mini/mini.nvim#mini.map](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.
* [petertriho/nvim-scrollbar](https://github.com/petertriho/nvim-scrollbar) ⭐ 1,032 | 🐛 30 | 🌐 Lua | 📅 2025-11-17 - Extensible scrollbar that shows diagnostics and search results.
...
* [nvim-mini/mini.nvim#mini.pairs](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
* [nvim-mini/mini.nvim#mini.trailspace](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
* [nvim-mini/mini.nvim#mini.operators](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
* [nvim-mini/mini.nvim#mini.move](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
* [nvim-mini/mini.nvim#mini.ai](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some built-in textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
* [nvim-mini/mini.nvim#mini.splitjoin](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
* [nvim-mini/mini.nvim#mini.basics](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.
* [windwp/nvim-autopairs](https://github.com/windwp/nvim-autopairs) ⭐ 3,976 | 🐛 16 | 🌐 Lua | 📅 2026-01-30 - A minimalist autopairs written by Lua.
* [nvim-treesitter/nvim-treesitter-context](https://github.com/nvim-treesitter/nvim-treesitter-context) ⭐ 3,143 | 🐛 20 | 🌐 Janet | 📅 2026-03-22 - Shows floating hover with the current function/block context.
...
* [monaqa/dial.nvim](https://github.com/monaqa/dial.nvim) ⭐ 1,057 | 🐛 17 | 🌐 Lua | 📅 2025-12-21 - Extended increment/decrement.
...
* [shortcuts/no-neck-pain.nvim](https://github.com/shortcuts/no-neck-pain.nvim) ⭐ 919 | 🐛 16 | 🌐 Lua | 📅 2026-03-22 - Center the currently focused buffer to the middle of your terminal.
* [HiPhish/rainbow-delimiters.nvim](https://github.com/HiPhish/rainbow-delimiters.nvim) ⭐ 846 | 🐛 20 | 🌐 Lua | 📅 2026-03-18 - Rainbow delimiters with Tree-sitter.
...
* [chrisgrieser/nvim-various-textobjs](https://github.com/chrisgrieser/nvim-various-textobjs) ⭐ 755 | 🐛 0 | 🌐 Lua | 📅 2026-02-10 - Bundle of more than 30 new text objects.
...
* [altermo/ultimate-autopair.nvim](https://github.com/altermo/ultimate-autopair.nvim) ⭐ 568 | 🐛 22 | 🌐 Lua | 📅 2026-03-17 - Autopair with extensions.
...
* [sQVe/sort.nvim](https://github.com/sQVe/sort.nvim) ⭐ 207 | 🐛 0 | 🌐 Lua | 📅 2026-01-28 - Sorting plugin that intelligently supports line-wise and delimiter sorting.
...
* [XXiaoA/atone.nvim](https://github.com/XXiaoA/atone.nvim) ⭐ 152 | 🐛 5 | 🌐 Lua | 📅 2026-03-22 - Undo tree for visualizing and managing undo history.
...
* [nvim-mini/mini.nvim#mini.comment](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.
* [numToStr/Comment.nvim](https://github.com/numToStr/Comment.nvim) ⭐ 4,608 | 🐛 82 | 🌐 Lua | 📅 2024-08-19 - Smart and powerful comment plugin. Supports commentstring, motions, dot-repeat and more.
* [folke/todo-comments.nvim](https://github.com/folke/todo-comments.nvim) ⭐ 4,093 | 🐛 20 | 🌐 Lua | 📅 2025-11-10 - Highlight, list and search TODO comments in your projects.
...
* [alexmozaidze/tree-comment.nvim](https://github.com/alexmozaidze/tree-comment.nvim) ⭐ 10 | 🐛 1 | 🌐 Fennel | 📅 2025-11-19 - Highlight and configure TODO comments for [tree-sitter-comment](https://github.com/stsewd/tree-sitter-comment) ⭐ 167 | 🐛 12 | 🌐 C | 📅 2025-12-16.
...
* [chrisgrieser/nvim-origami](https://github.com/chrisgrieser/nvim-origami) ⭐ 477 | 🐛 3 | 🌐 Lua | 📅 2026-03-06 - Fold with relentless elegance.
...
* [nvim-mini/mini.nvim#mini.align](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for aligning text interactively (with or without instant preview).
* [stevearc/conform.nvim](https://github.com/stevearc/conform.nvim) ⭐ 4,990 | 🐛 87 | 🌐 Lua | 📅 2026-03-10 - A lightweight formatting engine that plays nice with LSP.
...
* [nvim-mini/mini.nvim#mini.indentscope](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.
* [lukas-reineke/indent-blankline.nvim](https://github.com/lukas-reineke/indent-blankline.nvim) ⭐ 4,879 | 🐛 24 | 🌐 Lua | 📅 2026-02-17 - IndentLine replacement in Lua with more features and Tree-sitter support.
...
* [nvim-mini/mini.nvim#mini.cmdline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cmdline.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for command line tweaks. Adds autocompletion with customizable delay, autocorrection for words with fixed candidates, and autopeek command range in a floating window.
...
* [nvim-mini/mini.nvim#mini.sessions](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for session management (read, write, delete).
* [rmagatti/auto-session](https://github.com/rmagatti/auto-session) ⭐ 1,795 | 🐛 15 | 🌐 Lua | 📅 2026-02-15 - A small automated session manager.
...
* [olimorris/persisted.nvim](https://github.com/olimorris/persisted.nvim) ⭐ 531 | 🐛 1 | 🌐 Lua | 📅 2026-02-02 - Simple session management with Git branching, autosave/autoload and Telescope support.
...
* [gruvw/strudel.nvim](https://github.com/gruvw/strudel.nvim) ⭐ 409 | 🐛 5 | 🌐 JavaScript | 📅 2025-12-06 - Live coding controller for [strudel](https://strudel.cc).
* [brianhuster/live-preview.nvim](https://github.com/brianhuster/live-preview.nvim) ⭐ 363 | 🐛 25 | 🌐 Lua | 📅 2026-03-22 - Live preview HTML, Markdown and Asciidoc in the browser.
...
* [nvim-mini/mini.nvim#mini.bufremove](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,594 | 🐛 15 | 🌐 Lua | 📅 2026-03-20 - Smart, seamless, directional navigation and resizing of splits.
...
* [nvim-zh/colorful-winsep.nvim](https://github.com/nvim-zh/colorful-winsep.nvim) ⭐ 663 | 🐛 1 | 🌐 Lua | 📅 2026-02-19 - A configurable color split line.
...
* [kawre/leetcode.nvim](https://github.com/kawre/leetcode.nvim) ⭐ 2,013 | 🐛 58 | 🌐 Lua | 📅 2025-09-21 - Solve Leetcode problems.
* [xeluxee/competitest.nvim](https://github.com/xeluxee/competitest.nvim) ⭐ 570 | 🐛 18 | 🌐 Lua | 📅 2025-05-13 - A plugin to automate testcases management and checking for Competitive Programming contests.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 55 | 🐛 4 | 🌐 Go | 📅 2026-03-23 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [kndndrj/nvim-dbee](https://github.com/kndndrj/nvim-dbee) ⭐ 1,238 | 🐛 75 | 🌐 Go | 📅 2025-07-25 - Interactive database client.
* [joryeugene/dadbod-grip.nvim](https://github.com/joryeugene/dadbod-grip.nvim) ⭐ 122 | 🐛 0 | 🌐 Lua | 📅 2026-03-21 - Database editor with inline cell editing, staged mutations with live SQL preview, schema browser, DDL, AI SQL generation, FK navigation, and DuckDB/Parquet support.
...
* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 29,930 | 🐛 25 | 🌐 Lua | 📅 2026-03-20 - A launch point for your personal Neovim configuration.
* [siduck76/NvChad](https://github.com/siduck76/NvChad) ⭐ 28,014 | 🐛 1 | 🌐 Lua | 📅 2026-02-07 - An attempt to make Neovim's CLI as functional as an IDE while retaining beauty with less bloat.
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 25,530 | 🐛 31 | 🌐 Lua | 📅 2026-03-21 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
...
* [AstroNvim/AstroNvim](https://github.com/AstroNvim/AstroNvim) ⭐ 14,208 | 🐛 1 | 🌐 Lua | 📅 2026-02-18 - An aesthetic and feature-rich config that is extensible and easy to use with a great set of plugins.
...
* [crivotz/nv-ide](https://github.com/crivotz/nv-ide) ⭐ 648 | 🐛 2 | 🌐 Lua | 📅 2026-03-12 - Custom configuration oriented for Full-Stack developers (Rails, Ruby, PHP, HTML, CSS, SCSS, JavaScript).
...
* [mrcjkb/kickstart-nix.nvim](https://github.com/mrcjkb/kickstart-nix.nvim) ⭐ 395 | 🐛 2 | 🌐 Lua | 📅 2026-01-26 - A simple [Nix flake](https://wiki.nixos.org/wiki/Flakes) template repo for Neovim derivations, with the goal of simplifying the migration from existing Neovim configurations.
...
* [nvim-mini/MiniMax](https://github.com/nvim-mini/MiniMax) ⭐ 353 | 🐛 2 | 🌐 Lua | 📅 2026-03-21 - A collection of self-contained and extensively commented configurations which mostly use MINI tools.
...
* [Abstract-IDE/Abstract](https://github.com/Abstract-IDE/Abstract) ⭐ 208 | 🐛 2 | 🌐 Lua | 📅 2026-03-22 - Configuration to achieve the power of Modern IDE.
* [shaeinst/roshnivim](https://github.com/shaeinst/roshnivim) ⭐ 208 | 🐛 2 | 🌐 Lua | 📅 2026-03-22 - A predefined config to save you thousands of hours to setup Neovim as an IDE.
...
* [TheItcor/MoaiVim](https://github.com/TheItcor/MoaiVim) ⭐ 4 | 🐛 0 | 🌐 Lua | 📅 2026-03-09 - A minimalist config that emulates a lightweight IDE.
...
* [MordechaiHadad/bob](https://github.com/MordechaiHadad/bob) ⭐ 2,048 | 🐛 30 | 🌐 Rust | 📅 2026-03-08 - A cross-platform, easy to use Neovim version manager.
...
* [y3owk1n/nvs](https://github.com/y3owk1n/nvs) ⭐ 30 | 🐛 0 | 🌐 Go | 📅 2026-03-22 - Another Neovim version manager with config switcher.
...
* [m15a/flake-awesome-neovim-plugins](https://github.com/m15a/flake-awesome-neovim-plugins) ⭐ 62 | 🐛 0 | 🌐 Nix | 📅 2026-03-22 - Nix flake that provides a collection of `awesome-neovim` plugins as Nix packages.
...
* [nvim-mini/mini.nvim#mini.notify](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) ⭐ 8,899 | 🐛 34 | 🌐 Lua | 📅 2026-03-22 - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.
* [folke/noice.nvim](https://github.com/folke/noice.nvim) ⭐ 5,655 | 🐛 27 | 🌐 Lua | 📅 2025-11-03 - Highly experimental plugin that completely replaces the UI for messages, cmdline and the popupmenu.
...
* [CosmicNvim/cosmic-ui](https://github.com/CosmicNvim/cosmic-ui) ⭐ 170 | 🐛 1 | 🌐 Lua | 📅 2026-03-22 - Cosmic-UI is a simple wrapper around specific Vim functionality.
* [OXY2DEV/ui.nvim](https://github.com/OXY2DEV/ui.nvim) ⭐ 155 | 🐛 3 | 🌐 Lua | 📅 2026-02-14 - A blueprint/template/guide for customizing the UI.
* [jrop/tuis.nvim](https://github.com/jrop/tuis.nvim) ⭐ 134 | 🐛 0 | 🌐 Lua | 📅 2026-01-15 - A collection of interactive TUIs which provides rich, interactive UIs to various CLIs.
...
* [akrawchyk/awesome-vim#tools](https://github.com/akrawchyk/awesome-vim#tools) ⭐ 2,115 | 🐛 7 | 📅 2025-06-06 - A short list of Vim plugins and helpful guides.
