...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 20,667 | 🐛 56 | 🌐 Lua | 📅 2025-12-17 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [nvim-mini/mini.nvim#mini.deps](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.
...
* [zuqini/zpack.nvim](https://github.com/zuqini/zpack.nvim) ⭐ 96 | 🐛 1 | 🌐 Lua | 📅 2026-04-06 - A thin layer on top of `vim.pack` to support lazy-loading and `lazy.nvim`'s declarative spec.
...
* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,507 | 🐛 32 | 🌐 Lua | 📅 2026-04-06 - Quickstart configurations for the LSP client.

<!--lint enable awesome-spell-check-->

* [nvimdev/lspsaga.nvim](https://github.com/nvimdev/lspsaga.nvim) ⭐ 3,771 | 🐛 99 | 🌐 Lua | 📅 2026-03-03 - A light-weight LSP plugin based on the built-in LSP with a highly performant UI.
...
* [ray-x/lsp\_signature.nvim](https://github.com/ray-x/lsp_signature.nvim) ⭐ 2,346 | 🐛 88 | 🌐 Lua | 📅 2026-04-07 - LSP signature hint when you type.
...
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 987 | 🐛 11 | 🌐 Lua | 📅 2026-04-03 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,707 | 🐛 113 | 🌐 JavaScript | 📅 2026-04-07 catalog.
* [hedyhli/outline.nvim](https://github.com/hedyhli/outline.nvim) ⭐ 981 | 🐛 35 | 🌐 Lua | 📅 2026-03-29 - A significantly enhanced and refactored fork of `symbols-outline.nvim`.
...
* [tamago324/nlsp-settings.nvim](https://github.com/tamago324/nlsp-settings.nvim) ⭐ 336 | 🐛 10 | 🌐 Lua | 📅 2026-04-07 - Setup LSP with JSON or YAML files.
...
* [nvimtools/none-ls.nvim](https://github.com/nvimtools/none-ls.nvim) ⭐ 3,224 | 🐛 11 | 🌐 Lua | 📅 2026-04-06 - Null-ls.nvim reloaded / Use Neovim as a language server to inject LSP diagnostics, code actions, and more via Lua.
* [mrcjkb/rustaceanvim](https://github.com/mrcjkb/rustaceanvim) ⭐ 2,911 | 🐛 19 | 🌐 Lua | 📅 2026-04-08 - A heavily modified fork of rust-tools.nvim that does not require a `setup` call and does not depend on nvim-lspconfig.
...
* [mfussenegger/nvim-jdtls](https://github.com/mfussenegger/nvim-jdtls) ⭐ 1,456 | 🐛 1 | 🌐 Lua | 📅 2026-02-10 - Extensions for the built-in LSP support for the Eclipse JDT Language Server.
...
* [mrcjkb/haskell-tools.nvim](https://github.com/mrcjkb/haskell-tools.nvim) ⭐ 585 | 🐛 22 | 🌐 Lua | 📅 2026-04-08 - Seamless integration for Haskell development tools like `haskell-language-server` and Hoogle.
...
* [Wansmer/symbol-usage.nvim](https://github.com/Wansmer/symbol-usage.nvim) ⭐ 477 | 🐛 2 | 🌐 Lua | 📅 2026-04-06 - Display references, definitions and implementations of document symbols.
...
* [chrisgrieser/nvim-lsp-endhints](https://github.com/chrisgrieser/nvim-lsp-endhints) ⭐ 235 | 🐛 0 | 🌐 Lua | 📅 2026-04-06 - Display LSP inlay hints at the end of the line, rather than within the line.
...
* [mason-org/mason.nvim](https://github.com/mason-org/mason.nvim) ⭐ 10,180 | 🐛 271 | 🌐 Lua | 📅 2026-04-06 - Portable package manager that runs everywhere Neovim runs. Easily install and manage LSP servers, DAP servers, linters, and formatters.

### Diagnostics

* [folke/trouble.nvim](https://github.com/folke/trouble.nvim) ⭐ 6,732 | 🐛 21 | 🌐 Lua | 📅 2025-10-31 - A pretty diagnostics list to help you solve all the trouble your code is causing.
...
* [hrsh7th/nvim-cmp](https://github.com/hrsh7th/nvim-cmp) ⭐ 9,382 | 🐛 300 | 🌐 Lua | 📅 2026-03-25 - Completion engine written in Lua, successor of `nvim-compe`.
...
* [nvim-mini/mini.nvim#mini.completion](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 6,125 | 🐛 104 | 🌐 Lua | 📅 2026-04-07 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 11 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 44,163 | 🐛 69 | 🌐 C | 📅 2026-04-05.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 4,042 | 🐛 15 | 🌐 Lua | 📅 2026-04-07 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,525 | 🐛 56 | 🌐 Vim Script | 📅 2026-01-09.
...
* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 17,731 | 🐛 71 | 🌐 Lua | 📅 2026-03-30 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,425 | 🐛 7 | 🌐 Lua | 📅 2026-04-07 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
...
* [CopilotC-Nvim/CopilotChat.nvim](https://github.com/CopilotC-Nvim/CopilotChat.nvim) ⭐ 3,614 | 🐛 23 | 🌐 Lua | 📅 2026-04-06 - A chat interface for GitHub Copilot that allows you to directly ask and receive answers to coding-related questions.
* [nickjvandyke/opencode.nvim](https://github.com/nickjvandyke/opencode.nvim) ⭐ 3,108 | 🐛 7 | 🌐 Lua | 📅 2026-04-07 - OpenCode AI assistant integration.
...
* [Exafunction/windsurf.nvim](https://github.com/Exafunction/windsurf.nvim) ⭐ 1,264 | 🐛 116 | 🌐 Lua | 📅 2026-04-02 - Free, ultrafast Copilot alternative. Supports LSP and Tree-sitter.
* [milanglacier/minuet-ai.nvim](https://github.com/milanglacier/minuet-ai.nvim) ⭐ 1,084 | 🐛 13 | 🌐 Lua | 📅 2026-04-06 - Minuet offers code completion from LLM providers including OpenAI (compatible), Gemini, Claude, Ollama, Deepseek and more providers, with support for nvim-cmp, blink.cmp and virtual-text frontend.
* [Davidyz/VectorCode](https://github.com/davidyz/vectorcode) ⭐ 843 | 🐛 17 | 🌐 Python | 📅 2026-02-23 - Supercharge your LLM experience with repository-level RAG.
...
* [Kurama622/llm.nvim](https://github.com/Kurama622/llm.nvim) ⭐ 467 | 🐛 1 | 🌐 Lua | 📅 2026-04-07 - Free large language model (LLM) support, provides commands to interact with LLM.
* [dlants/magenta.nvim](https://github.com/dlants/magenta.nvim) ⭐ 434 | 🐛 22 | 🌐 TypeScript | 📅 2026-04-08 - Leverage coding assistants for chat and code generation. Provides tools for the AI/LLM agent to explore and edit your code, like Aider, Cursor and Windsurf.
...
* [carlos-algms/agentic.nvim](https://github.com/carlos-algms/agentic.nvim) ⭐ 376 | 🐛 12 | 🌐 Lua | 📅 2026-04-06 - Chat interface for AI ACP providers such as Claude, Gemini, Codex, OpenCode and Cursor.
...
* [cursortab/cursortab.nvim](https://github.com/cursortab/cursortab.nvim) ⭐ 152 | 🐛 7 | 🌐 Go | 📅 2026-04-04 - Edit completions and cursor predictions with multiple AI providers.
...
* [wsdjeg/chat.nvim](https://github.com/wsdjeg/chat.nvim) ⭐ 24 | 🐛 0 | 🌐 Lua | 📅 2026-04-07 - A lightweight, extensible chat plugin with AI integration, multiple providers, and built-in tools.
...
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 8 | 🐛 4 | 🌐 Lua | 📅 2026-04-05 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 11,559 | 🐛 581 | 🌐 Python | 📅 2026-04-07 tool.
...
* [nvim-java/nvim-java](https://github.com/nvim-java/nvim-java) ⭐ 1,609 | 🐛 35 | 🌐 Lua | 📅 2026-02-05 - Everything you need for a painless Java experience.
...
* [chomosuke/typst-preview.nvim](https://github.com/chomosuke/typst-preview.nvim) ⭐ 887 | 🐛 10 | 🌐 Lua | 📅 2026-03-30 - Preview Typst documents in the browser, instant update on each keystroke, and cross jump between code and preview.
...
* [Julian/lean.nvim](https://github.com/Julian/lean.nvim) ⭐ 504 | 🐛 37 | 🌐 Lua | 📅 2026-04-08 - Support for the [Lean Theorem Prover](https://leanprover.github.io/).
...
* [gennaro-tedesco/nvim-jqx](https://github.com/gennaro-tedesco/nvim-jqx) ⭐ 333 | 🐛 2 | 🌐 Lua | 📅 2024-05-31 - Interactive interface for JSON files.
...
* [apyra/nvim-unity.nvim](https://github.com/apyra/nvim-unity) ⭐ 105 | 🐛 9 | 🌐 C# | 📅 2026-04-01 - Use Neovim as your default Unity editor with full LSP support via OmniSharp.
...
* [atomicptr/defold.nvim](https://github.com/atomicptr/defold.nvim) ⭐ 25 | 🐛 7 | 🌐 Rust | 📅 2026-04-07 - Batteries-included development environment for the Defold game engine.
...
* [ray-x/go.nvim](https://github.com/ray-x/go.nvim) ⭐ 2,614 | 🐛 96 | 🌐 Lua | 📅 2026-04-08 - Golang plugin based on LSP and Tree-sitter.
* [olexsmir/gopher.nvim](https://github.com/olexsmir/gopher.nvim/) ⭐ 422 | 🐛 6 | 🌐 Lua | 📅 2026-03-04 - Plugin for making Golang development easiest.
...
* [mistweaverco/kulala.nvim](https://github.com/mistweaverco/kulala.nvim) ⭐ 1,951 | 🐛 19 | 🌐 Lua | 📅 2026-03-16 - A minimal HTTP-client interface.
...
* [iamcco/markdown-preview.nvim](https://github.com/iamcco/markdown-preview.nvim) ⭐ 7,789 | 🐛 260 | 🌐 JavaScript | 📅 2024-07-23 - Preview Markdown on your modern browser with synchronised scrolling and flexible configuration.
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 4,365 | 🐛 5 | 🌐 Lua | 📅 2026-04-08 - Improve viewing Markdown files directly.
* [OXY2DEV/markview.nvim](https://github.com/OXY2DEV/markview.nvim) ⭐ 3,409 | 🐛 4 | 🌐 Lua | 📅 2026-03-20 - A hackable Markdown, Typst, LaTeX, HTML (inline) and YAML renderer.
...
* [satozawa/graft.nvim](https://github.com/satozawa/graft.nvim) ⭐ 6 | 🐛 0 | 🌐 Lua | 📅 2026-04-06 - Tree-structured editing for Markdown bullet lists with subtree text objects, Alt+hjkl navigation, and structural operations.
...
* [gbprod/phpactor.nvim](https://github.com/gbprod/phpactor.nvim) ⭐ 94 | 🐛 2 | 🌐 Lua | 📅 2026-01-07 - Lua version of [phpactor](https://github.com/phpactor/phpactor) ⭐ 1,841 | 🐛 298 | 🌐 PHP | 📅 2026-04-06.
...
* [nvim-mini/mini.nvim#mini.surround](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-surround.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for working with text surroundings (add, delete, replace, find, highlight). Supports dot-repeat, different search methods, "last"/"next" extended mappings, Tree-sitter integration, and more.
* [kylechui/nvim-surround](https://github.com/kylechui/nvim-surround) ⭐ 4,158 | 🐛 8 | 🌐 Lua | 📅 2026-04-05 - A plugin for adding/changing/deleting surrounding delimiter pairs.
* [nvim-treesitter/nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects) ⭐ 2,725 | 🐛 112 | 🌐 Tree-sitter Query | 📅 2026-04-07 - Create your own textobjects using Tree-sitter queries.
...
* [IndianBoy42/tree-sitter-just](https://github.com/IndianBoy42/tree-sitter-just) ⭐ 186 | 🐛 5 | 🌐 Just | 📅 2026-03-25 - Tree-sitter grammar for [Justfiles](https://github.com/casey/just) ⭐ 32,692 | 🐛 307 | 🌐 Rust | 📅 2026-04-07.
* [MeanderingProgrammer/treesitter-modules.nvim](https://github.com/MeanderingProgrammer/treesitter-modules.nvim) ⭐ 162 | 🐛 1 | 🌐 Lua | 📅 2026-04-05 - Original modules from nvim-treesitter master branch.
...
* [nvim-mini/mini.nvim#mini.snippets](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.
* [L3MON4D3/LuaSnip](https://github.com/L3MON4D3/LuaSnip) ⭐ 4,311 | 🐛 128 | 🌐 Lua | 📅 2026-04-05 - A snippet engine written in Lua.
* [rafamadriz/friendly-snippets](https://github.com/rafamadriz/friendly-snippets) ⭐ 2,683 | 🐛 70 | 🌐 Lua | 📅 2026-01-23 - Set of preconfigured snippets for different languages.
* [chrisgrieser/nvim-scissors](https://github.com/chrisgrieser/nvim-scissors) ⭐ 572 | 🐛 0 | 🌐 Lua | 📅 2026-04-05 - Automagical editing and creation of snippets.
* [dcampos/nvim-snippy](https://github.com/dcampos/nvim-snippy) ⭐ 339 | 🐛 8 | 🌐 Lua | 📅 2026-04-08 - Snippet plugin written in Lua with support for [vim-snippets](https://github.com/honza/vim-snippets) ⭐ 4,873 | 🐛 85 | 🌐 Vim Snippet | 📅 2025-10-28.
...
* [tversteeg/registers.nvim](https://github.com/tversteeg/registers.nvim) ⭐ 620 | 🐛 11 | 🌐 Lua | 📅 2025-11-20 - Non-obtrusive minimal preview of Vim registers.
...
* [desdic/macrothis.nvim](https://github.com/desdic/macrothis.nvim) ⭐ 33 | 🐛 1 | 🌐 Lua | 📅 2025-02-12 - Save and load macros/registers.
...
* [ThePrimeagen/harpoon](https://github.com/ThePrimeagen/harpoon/tree/harpoon2) ⭐ 9,004 | 🐛 149 | 🌐 Lua | 📅 2025-10-31 - A per project, auto updating and editable marks utility for fast file navigation.
...
* [dimtion/guttermarks.nvim](https://github.com/dimtion/guttermarks.nvim) ⭐ 49 | 🐛 1 | 🌐 Lua | 📅 2026-03-22 - Display marks in the buffer gutter.
...
* [nvim-pack/nvim-spectre](https://github.com/nvim-pack/nvim-spectre) ⭐ 2,386 | 🐛 13 | 🌐 Lua | 📅 2025-05-19 - Search and replace panel.
* [MagicDuck/grug-far.nvim](https://github.com/MagicDuck/grug-far.nvim) ⭐ 1,856 | 🐛 5 | 🌐 Lua | 📅 2026-04-07 - Buffer-based live search and replace with full power of `rg` flags. Grug like!
...
* [nvim-telescope/telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) ⭐ 19,261 | 🐛 490 | 🌐 Lua | 📅 2026-04-07 - Telescope.nvim is a highly [extendable](https://github.com/nvim-telescope/telescope.nvim/wiki/Extensions) ⭐ 19,261 | 🐛 490 | 🌐 Lua | 📅 2026-04-07 A highly extensible fuzzy finder over lists.
* [nvim-mini/mini.nvim#mini.fuzzy](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
* [nvim-mini/mini.nvim#mini.pick](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
* [nvim-mini/mini.nvim#mini.extra](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.
* [folke/snacks.nvim#picker](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) ⭐ 7,391 | 🐛 114 | 🌐 Lua | 📅 2026-03-21 - A modern fuzzy-finder to navigate the Neovim universe.
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,177 | 🐛 11 | 🌐 Lua | 📅 2026-04-05 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,735 | 🐛 17 | 🌐 Rust | 📅 2026-04-07 as its fzf binary.
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 3,843 | 🐛 53 | 🌐 Rust | 📅 2026-04-08 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 367 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 35,340 | 🐛 158 | 🌐 Rust | 📅 2026-03-23, a smart directory picker that tracks your usage.
...
* [juniorsundar/refer.nvim](https://github.com/juniorsundar/refer.nvim) ⭐ 45 | 🐛 2 | 🌐 Lua | 📅 2026-04-07 - A minimalist picker that doesn't get in your way.
...
* [willyelm/pulse.nvim](https://github.com/willyelm/pulse.nvim) ⭐ 17 | 🐛 0 | 🌐 Lua | 📅 2026-03-30 - A single entrypoint for commands. Use prefixes to quickly access diagnostics, Git and more via pickers.
...
* [nvim-mini/mini.nvim#mini.files](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.
* [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) ⭐ 8,448 | 🐛 93 | 🌐 Lua | 📅 2026-04-07 - A simple and fast file explorer tree.
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,423 | 🐛 131 | 🌐 Lua | 📅 2026-02-24 - Edit your filesystem like a buffer.
* [nvim-neo-tree/neo-tree.nvim](https://github.com/nvim-neo-tree/neo-tree.nvim) ⭐ 5,355 | 🐛 170 | 🌐 Lua | 📅 2026-04-04 - Browse the file system and other tree-like structures in whatever style suits you, including sidebars, floating windows, `netrw` split style, or all of them at once.
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,688 | 🐛 93 | 🌐 Python | 📅 2026-04-08 - File manager. Better than NERDTree.
* [mikavilpas/yazi.nvim](https://github.com/mikavilpas/yazi.nvim) ⭐ 1,634 | 🐛 8 | 🌐 Lua | 📅 2026-04-07 - Integration with the Yazi terminal file manager.
...
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 459 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,456 | 🐛 1 | 🌐 C | 📅 2026-04-06 and Lua.
...
* [kelly-lin/ranger.nvim](https://github.com/kelly-lin/ranger.nvim) ⭐ 181 | 🐛 11 | 🌐 Lua | 📅 2024-11-18 - [Ranger](https://github.com/ranger/ranger) ⭐ 17,107 | 🐛 931 | 🌐 Python | 📅 2026-04-04 integration.
* [Xuyuanp/yanil](https://github.com/Xuyuanp/yanil) ⭐ 98 | 🐛 5 | 🌐 Lua | 📅 2026-01-15 - Yet Another Nerdtree In Lua.
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 98 | 🐛 2 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 36,095 | 🐛 67 | 🌐 Rust | 📅 2026-04-07).
...
* [nvim-mini/mini.nvim#mini.visits](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.
...
* [mrjones2014/codesettings.nvim](https://github.com/mrjones2014/codesettings.nvim) ⭐ 64 | 🐛 2 | 🌐 Lua | 📅 2026-04-08 - Easily load project-local settings (like `.vscode/settings.json`) into Neovim 0.11+ native LSP settings.
...
* [axkirillov/hbac.nvim](https://github.com/axkirillov/hbac.nvim) ⭐ 222 | 🐛 1 | 🌐 Lua | 📅 2024-10-09 - Automatically close buffers you are not working on.
...
* [nvim-mini/mini.nvim#mini.hipatterns](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.
...
* [catgoose/nvim-colorizer.lua](https://github.com/catgoose/nvim-colorizer.lua) ⭐ 1,038 | 🐛 1 | 🌐 Lua | 📅 2026-04-07 - A high-performance color highlighter which has no external dependencies.
...
* [xzbdmw/colorful-menu.nvim](https://github.com/xzbdmw/colorful-menu.nvim) ⭐ 462 | 🐛 4 | 🌐 Lua | 📅 2025-11-25 - Colorize your auto completion menu using Tree-sitter.
...
* [folke/tokyonight.nvim](https://github.com/folke/tokyonight.nvim) ⭐ 7,940 | 🐛 14 | 🌐 Lua | 📅 2026-03-24 - ***`[TS][LSP][L/D][Lua]`*** A clean, dark and light theme written in Lua, with support for LSP, Tree-sitter and lots of plugins.
* [sainnhe/everforest](https://github.com/sainnhe/everforest) ⭐ 3,932 | 🐛 8 | 🌐 Vim Script | 📅 2026-01-21 - ***`[TS][LSP][L/D]`*** A green based colorscheme designed to be warm, soft and easy on the eyes.
* [sainnhe/gruvbox-material](https://github.com/sainnhe/gruvbox-material) ⭐ 2,524 | 🐛 8 | 🌐 Vim Script | 📅 2026-04-03 - ***`[TS][LSP]`*** Gruvbox modification with softer contrast and Tree-sitter support.
...
* [navarasu/onedark.nvim](https://github.com/navarasu/onedark.nvim) ⭐ 1,950 | 🐛 54 | 🌐 Lua | 📅 2025-11-24 - ***`[TS][LSP][Lua]`*** A One Dark Theme written in Lua based on Atom's One Dark Theme.
...
* [nyoom-engineering/oxocarbon.nvim](https://github.com/nyoom-engineering/oxocarbon.nvim) ⭐ 1,552 | 🐛 19 | 🌐 Fennel | 📅 2026-03-18 - ***`[TS][LSP][L/D][Lua]`*** A dark and light theme written in Fennel, inspired by IBM Carbon.
* [dracula/vim](https://github.com/dracula/vim) ⭐ 1,383 | 🐛 11 | 🌐 Vim Script | 📅 2026-03-16 - ***`[TS][LSP]`*** Famous beautiful dark powered theme.
...
* [AlexvZyl/nordic.nvim](https://github.com/AlexvZyl/nordic.nvim) ⭐ 1,000 | 🐛 4 | 🌐 Lua | 📅 2026-04-05 - ***`[TS][Lua]`*** Nord theme, but warmer and darker. Supports a variety of plugins and other platforms.
...
* [shaunsingh/nord.nvim](https://github.com/shaunsingh/nord.nvim) ⭐ 991 | 🐛 33 | 🌐 Lua | 📅 2024-06-25 - ***`[TS][Lua]`*** A colorscheme based off of the Nord Color Palette.
...
* [everviolet/nvim](https://github.com/everviolet/nvim) ⭐ 628 | 🐛 0 | 🌐 Lua | 📅 2026-03-31 - ***`[TS][LSP][L/D][Lua]`*** A comfy colorscheme for cozy morning coding.
...
* [oskarnurm/koda.nvim](https://github.com/oskarnurm/koda.nvim) ⭐ 263 | 🐛 1 | 🌐 Lua | 📅 2026-03-07 - ***`[TS][LSP][L/D][Lua]`*** Code's quiet companion. A minimalist colorscheme, written in Lua.
* [rockerBOO/boo-colorscheme-nvim](https://github.com/rockerBOO/boo-colorscheme-nvim) ⭐ 259 | 🐛 3 | 🌐 Lua | 📅 2026-02-10 - ***`[TS][Lua]`*** A colorscheme with handcrafted support for LSP, Tree-sitter.
...
* [Th3Whit3Wolf/one-nvim](https://github.com/Th3Whit3Wolf/one-nvim) ⭐ 115 | 🐛 5 | 🌐 Lua | 📅 2021-07-26 - ***`[TS][L/D][Lua]`*** An Atom One inspired dark and light colorscheme.
* [Abstract-IDE/Abstract-cs](https://github.com/Abstract-IDE/Abstract-cs) ⭐ 114 | 🐛 2 | 🌐 Lua | 📅 2025-10-27 - ***`[TS][LSP][Lua]`*** Colorscheme written in Lua, specially made for roshnivim with Tree-sitter support.
...
* [wurli/cobalt.nvim](https://github.com/wurli/cobalt.nvim) ⭐ 26 | 🐛 0 | 🌐 Lua | 📅 2026-04-07 - ***`[TS][LSP][Lua]`*** A (mostly) faithful port of the classic blue theme from TextMate.
...
* [rose-pine/neovim](https://github.com/rose-pine/neovim) ⭐ 2,985 | 🐛 5 | 🌐 Lua | 📅 2025-12-21 - ***`[TS][LSP][L/D][Lua]`*** All natural pine, faux fur and a bit of soho vibes for the classy minimalist.

<!--lint enable awesome-spell-check-->

* [nvim-mini/mini.nvim#colorschemes](https://github.com/nvim-mini/mini.nvim#plugin-color-schemes) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - ***`[TS][LSP][L/D][Lua]`*** Color schemes included in `mini.nvim`. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.
* [catppuccin/nvim](https://github.com/catppuccin/nvim) ⭐ 7,319 | 🐛 9 | 🌐 Lua | 📅 2026-04-06 - ***`[TS][LSP][L/D][Lua]`*** Warm mid-tone dark theme to show off your vibrant self! With support for native LSP, Tree-sitter, and more.
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 6,047 | 🐛 91 | 🌐 Lua | 📅 2025-10-15 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
* [EdenEast/nightfox.nvim](https://github.com/EdenEast/nightfox.nvim) ⭐ 3,952 | 🐛 35 | 🌐 Lua | 📅 2025-02-09 - ***`[TS][LSP][L/D][Lua]`*** A soft dark, fully customizable colorscheme with support for LSP, Tree-sitter and a variety of plugins.
...
* [scottmckendry/cyberdream.nvim](https://github.com/scottmckendry/cyberdream.nvim) ⭐ 1,299 | 🐛 6 | 🌐 Lua | 📅 2026-01-27 - ***`[TS][L/D][Lua]`*** A high-contrast, futuristic and vibrant coloursheme.
* [zenbones-theme/zenbones.nvim](https://github.com/zenbones-theme/zenbones.nvim) ⭐ 1,084 | 🐛 17 | 🌐 Vim Script | 📅 2026-02-11 - ***`[TS][LSP][L/D][Lua]`*** A collection of Vim/Neovim colorschemes designed to highlight code using contrasts and font variations.
* [olimorris/onedarkpro.nvim](https://github.com/olimorris/onedarkpro.nvim) ⭐ 1,048 | 🐛 0 | 🌐 Lua | 📅 2026-03-10 - ***`[TS][L/D][Lua]`*** Atom's iconic One Dark theme. Cacheable, fully customisable, Tree-sitter and LSP semantic token support. Comes with light and dark variants.
...
* [slugbyte/lackluster.nvim](https://github.com/slugbyte/lackluster.nvim) ⭐ 542 | 🐛 0 | 🌐 Lua | 📅 2025-10-06 - ***`[TS][LSP][Lua]`*** A delightful mostly grayscale colorscheme that is soft on the eyes, and supports heaps of plugins.
* [xero/miasma.nvim](https://github.com/xero/miasma.nvim) ⭐ 524 | 🐛 5 | 🌐 Vim Script | 📅 2025-07-12 - ***`[TS][LSP]`*** A dark pastel color scheme inspired by the woods. Built using lush and supports Tree-sitter, diagnostics, CMP, Git-Signs, Telescope, Which-key, Lazy, and more.
* [ribru17/bamboo.nvim](https://github.com/ribru17/bamboo.nvim) ⭐ 455 | 🐛 2 | 🌐 Lua | 📅 2025-11-25 - ***`[TS][LSP][Lua]`*** A warm green theme.
...
* [thesimonho/kanagawa-paper.nvim](https://github.com/thesimonho/kanagawa-paper.nvim) ⭐ 369 | 🐛 2 | 🌐 Lua | 📅 2026-03-16 - ***`[TS][LSP][L/D][Lua]`*** Remixed light and dark Kanagawa colourschemes with muted colors.
* [oxfist/night-owl.nvim](https://github.com/oxfist/night-owl.nvim) ⭐ 344 | 🐛 5 | 🌐 Lua | 📅 2024-09-12 - ***`[TS][LSP][Lua]`*** A [Night Owl colorscheme port from VSCode](https://github.com/sdras/night-owl-vscode-theme) ⭐ 2,945 | 🐛 47 | 📅 2024-12-31 with support for Tree-sitter and semantic tokens.
...
* [maxmx03/fluoromachine.nvim](https://github.com/maxmx03/fluoromachine.nvim) ⭐ 302 | 🐛 1 | 🌐 Lua | 📅 2025-10-21 - ***`[TS][LSP][Lua]`*** Synthwave x Fluoromachine port.
...
* [ptdewey/darkearth-nvim](https://github.com/ptdewey/darkearth-nvim) ⭐ 80 | 🐛 0 | 🌐 Fennel | 📅 2026-03-19 - ***`[TS][LSP][Fnl]`*** A dark and earthy colorscheme supporting Tree-sitter and LSP.
...
* [ankushbhagats/pastel.nvim](https://github.com/ankushbhagats/pastel.nvim) ⭐ 30 | 🐛 0 | 🌐 Lua | 📅 2026-04-05 - ***`[TS][LSP][L/D][Lua]`*** Elegant pastel colorschemes with advanced customization, styles, and integrations.
...
* [judaew/ronny.nvim](https://github.com/judaew/ronny.nvim) ⭐ 16 | 🐛 0 | 🌐 Lua | 📅 2026-04-07 - ***`[TS][LSP][Lua]`*** A dark colorscheme, which mostly was inspired by the Monokai originally created by Wimem Hazenberg.
...
* [nvim-mini/mini.nvim#mini.base16](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
* [nvim-mini/mini.nvim#mini.colors](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
* [nvim-mini/mini.nvim#mini.hues](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.
...
* [f-person/auto-dark-mode.nvim](https://github.com/f-person/auto-dark-mode.nvim) ⭐ 486 | 🐛 11 | 🌐 Lua | 📅 2026-03-29 - Follow the system appearance on macOS.
* [zaldih/themery.nvim](https://github.com/zaldih/themery.nvim) ⭐ 369 | 🐛 18 | 🌐 Lua | 📅 2025-01-01 - A new way to change the colorscheme on the fly like in VSCode.
...
* [linrongbin16/colorbox.nvim](https://github.com/linrongbin16/colorbox.nvim) ⭐ 47 | 🐛 2 | 🌐 Lua | 📅 2026-04-07 - Load all the ultra colorschemes into your Neovim player.
...
* [Bekaboo/dropbar.nvim](https://github.com/Bekaboo/dropbar.nvim) ⭐ 1,529 | 🐛 14 | 🌐 Lua | 📅 2025-10-05 - IDE-like breadcrumbs, out of the box.
...
* [m4xshen/smartcolumn.nvim](https://github.com/m4xshen/smartcolumn.nvim) ⭐ 363 | 🐛 2 | 🌐 Lua | 📅 2025-07-21 - Hide your colorcolumn when unneeded.
...
* [nvim-mini/mini.nvim#mini.statusline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.
* [nvim-lualine/lualine.nvim](https://github.com/nvim-lualine/lualine.nvim) ⭐ 7,853 | 🐛 269 | 🌐 Lua | 📅 2026-04-04 - Easily configurable, blazingly fast statusline.
...
* [nvim-mini/mini.nvim#mini.tabline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.
* [akinsho/bufferline.nvim](https://github.com/akinsho/bufferline.nvim) ⭐ 4,285 | 🐛 100 | 🌐 Lua | 📅 2025-01-14 - A snazzy bufferline built using Lua.
* [romgrk/barbar.nvim](https://github.com/romgrk/barbar.nvim) ⭐ 2,678 | 🐛 34 | 🌐 Lua | 📅 2025-12-02 - A tabline with re-orderable, auto-sizing, clickable tabs, icons, nice highlighting, sort-by commands and a magic jump-to-buffer mode.
* [nanozuki/tabby.nvim](https://github.com/nanozuki/tabby.nvim) ⭐ 743 | 🐛 7 | 🌐 Lua | 📅 2026-01-07 - A minimal, configurable tabline that allows using tabs as workspace multiplexers.
...
* [nvim-mini/mini.nvim#mini.cursorword](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).
* [RRethy/vim-illuminate](https://github.com/RRethy/vim-illuminate) ⭐ 2,446 | 🐛 11 | 🌐 Lua | 📅 2025-05-24 - Highlight the word under the cursor with built-in LSP support.
* [ya2s/nvim-cursorline](https://github.com/ya2s/nvim-cursorline) ⭐ 463 | 🐛 7 | 🌐 Lua | 📅 2026-02-14 - Highlights cursor words and lines.
...
* [nvim-mini/mini.nvim#mini.starter](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.
* [nvimdev/dashboard-nvim](https://github.com/nvimdev/dashboard-nvim) ⭐ 2,802 | 🐛 73 | 🌐 Lua | 📅 2026-04-03 - A minimalist dashboard, inspired by doom-emacs.
* [goolord/alpha-nvim](https://github.com/goolord/alpha-nvim) ⭐ 2,353 | 🐛 39 | 🌐 Lua | 📅 2026-02-10 - A fast and highly customizable greeter like [vim-startify](https://github.com/mhinz/vim-startify) ⭐ 5,395 | 🐛 80 | 🌐 Vim Script | 📅 2024-01-05/dashboard-nvim.
...
* [nvim-mini/mini.nvim#mini.icons](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-icons.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` meant as a general icon provider. Uses fixed set of highlight groups. Supports various categories, icon and style customizations, caching for performance. Integrates with built-in filetype matching.
* [nvim-tree/nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons) ⭐ 2,645 | 🐛 18 | 🌐 Lua | 📅 2026-04-07 - A Lua fork of [vim-devicons](https://github.com/ryanoasis/vim-devicons) ⭐ 5,801 | 🐛 70 | 🌐 Vim Script | 📅 2024-05-09.
...
* [3rd/image.nvim](https://github.com/3rd/image.nvim) ⭐ 1,945 | 🐛 55 | 🌐 Lua | 📅 2026-02-21 - Add image support through kitty's graphics protocol or ueberzugpp.
...
* [HakonHarnes/img-clip.nvim](https://github.com/HakonHarnes/img-clip.nvim) ⭐ 895 | 🐛 9 | 🌐 Lua | 📅 2025-12-19 - Effortlessly embed images into any markup language, like LaTeX, Markdown or Typst.
* [vyfor/cord.nvim](https://github.com/vyfor/cord.nvim) ⭐ 587 | 🐛 0 | 🌐 Lua | 📅 2026-02-17 - Highly extensible Rich Presence for Discord.
...
* [sanjay-np/nvim-yt-player](https://github.com/sanjay-np/nvim-yt-player) ⭐ 13 | 🐛 0 | 🌐 Lua | 📅 2026-04-07 - Play YouTube audio using `mpv` and `yt-dlp` via IPC socket.
...
* [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ⭐ 7,263 | 🐛 211 | 🌐 Lua | 📅 2026-04-04 - Modernity meets insane extensibility. The future of organizing your life.
* [nvim-orgmode/orgmode](https://github.com/nvim-orgmode/orgmode) ⭐ 3,713 | 🐛 141 | 🌐 Lua | 📅 2026-04-01 - Org-mode clone written in Lua.
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 1,744 | 🐛 73 | 🌐 Lua | 📅 2026-04-07 - Plugin for Obsidian, written in Lua.
...
* [jakewvincent/mkdnflow.nvim](https://github.com/jakewvincent/mkdnflow.nvim) ⭐ 801 | 🐛 16 | 🌐 Lua | 📅 2026-03-25 - Fluent Markdown notebook navigation and management (create links, follow links, create and manage to-do lists, reference bib files, and more).
* [jbyuki/nabla.nvim](https://github.com/jbyuki/nabla.nvim) ⭐ 740 | 🐛 25 | 🌐 Lua | 📅 2025-04-21 - Take your scientific notes.
...
* [IlyasYOY/obs.nvim](https://github.com/IlyasYOY/obs.nvim) ⭐ 86 | 🐛 5 | 🌐 Lua | 📅 2026-02-01 - Your Obsidian notes at the speed of thought.
...
* [ymic9963/mdnotes.nvim](https://github.com/ymic9963/mdnotes.nvim) ⭐ 24 | 🐛 13 | 🌐 Lua | 📅 2026-04-07 - Simple, improved, and extensible Markdown note taking.
...
* [ovk/endec.nvim](https://github.com/ovk/endec.nvim) ⭐ 34 | 🐛 1 | 🌐 Lua | 📅 2025-04-07 - Encode, decode and re-encode text using Base64, Base64URL and URL (percent) encodings.
...
* [AlejandroSuero/freeze-code.nvim](https://github.com/AlejandroSuero/freeze-code.nvim) ⭐ 31 | 🐛 2 | 🌐 Lua | 📅 2025-03-15 - Code screenshot plugin that makes use of [freeze](https://github.com/charmbracelet/freeze) ⭐ 4,433 | 🐛 68 | 🌐 Go | 📅 2026-04-06 inside the editor.
...
* [hat0uma/csvview.nvim](https://github.com/hat0uma/csvview.nvim) ⭐ 594 | 🐛 16 | 🌐 Lua | 📅 2026-02-14 - An asynchronous CSV/TSV table viewer with real-time updates, configurable comments and delimiters, and multiple display modes.
...
* [theKnightsOfRohan/csvlens.nvim](https://github.com/theKnightsOfRohan/csvlens.nvim) ⭐ 39 | 🐛 1 | 🌐 Lua | 📅 2024-04-28 - A port of [YS-L/csvlens](https://github.com/YS-L/csvlens) ⭐ 3,698 | 🐛 59 | 🌐 Rust | 📅 2026-03-29, for easy previewing of tabular data.
...
* [nvim-mini/mini.nvim#mini.animate](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).
...
* [rachartier/tiny-glimmer.nvim](https://github.com/rachartier/tiny-glimmer.nvim/) ⭐ 407 | 🐛 1 | 🌐 Lua | 📅 2026-01-19 - Adds subtle animations to various operations.
...
* [mikesmithgh/kitty-scrollback.nvim](https://github.com/mikesmithgh/kitty-scrollback.nvim) ⭐ 845 | 🐛 26 | 🌐 Lua | 📅 2026-03-22 - Open your kitty scrollback buffer. Ameowzing.
...
* [nikvdp/neomux](https://github.com/nikvdp/neomux) ⭐ 381 | 🐛 0 | 🌐 Vim Script | 📅 2026-03-17 - Control Neovim from shells ran through the `:term` command.
...
* [mfussenegger/nvim-dap](https://github.com/mfussenegger/nvim-dap) ⭐ 7,047 | 🐛 29 | 🌐 Lua | 📅 2026-04-06 - Debug Adapter Protocol client implementation.
* [rcarriga/nvim-dap-ui](https://github.com/rcarriga/nvim-dap-ui) ⭐ 3,312 | 🐛 101 | 🌐 Lua | 📅 2026-04-05 - A UI for nvim-dap.
...
* [igorlfs/nvim-dap-view](https://github.com/igorlfs/nvim-dap-view) ⭐ 808 | 🐛 9 | 🌐 Lua | 📅 2026-04-03 - A modern, minimalistic UI for nvim-dap.
* [sakhnik/nvim-gdb](https://github.com/sakhnik/nvim-gdb) ⭐ 774 | 🐛 5 | 🌐 Lua | 📅 2025-12-31 - Thin wrapper for GDB, LLDB, PDB/PDB++ and BashDB.
* [andrewferrier/debugprint.nvim](https://github.com/andrewferrier/debugprint.nvim) ⭐ 519 | 🐛 9 | 🌐 Lua | 📅 2026-04-06 - Debugging the print() way.
...
* [stevearc/quicker.nvim](https://github.com/stevearc/quicker.nvim) ⭐ 945 | 🐛 20 | 🌐 Lua | 📅 2026-03-10 - Improved quickfix UI and editable quickfix buffer.
...
* [nvim-neotest/neotest](https://github.com/nvim-neotest/neotest) ⭐ 3,062 | 🐛 94 | 🌐 Lua | 📅 2026-04-01 - An extensible framework for interacting with tests within Neovim.
...
* [stevearc/overseer.nvim](https://github.com/stevearc/overseer.nvim) ⭐ 1,853 | 🐛 76 | 🌐 Lua | 📅 2026-04-01 - A task runner and job management plugin.
...
* [Vigemus/iron.nvim](https://github.com/Vigemus/iron.nvim) ⭐ 1,327 | 🐛 57 | 🌐 Lua | 📅 2026-02-20 - Interactive REPLs of over 30 languages embedded.
* [benlubas/molten-nvim](https://github.com/benlubas/molten-nvim) ⭐ 1,147 | 🐛 40 | 🌐 Python | 📅 2026-03-01 - Enables running code chunks via the Jupyter kernel. Output (including image output) is rendered in a floating window below the code.
...
* [Civitasv/cmake-tools.nvim](https://github.com/Civitasv/cmake-tools.nvim) ⭐ 532 | 🐛 14 | 🌐 Lua | 📅 2026-04-02 - CMake integration.
...
* [krady21/compiler-explorer.nvim](https://github.com/krady21/compiler-explorer.nvim) ⭐ 186 | 🐛 1 | 🌐 Lua | 📅 2026-02-09 - Asynchronous compilation using the [compiler-explorer](https://godbolt.org/) REST API.
...
* [nvim-mini/mini.nvim#mini.doc](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
* [nvim-mini/mini.nvim#mini.test](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` with framework for writing extensive Neovim plugin tests with support for hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.
* [nvim-lua/plenary.nvim](https://github.com/nvim-lua/plenary.nvim) ⭐ 3,432 | 🐛 155 | 🌐 Lua | 📅 2025-07-26 - Plenary: full; complete; entire; absolute; unqualified. All the Lua functions I don't want to write twice.
* [MunifTanjim/nui.nvim](https://github.com/MunifTanjim/nui.nvim) ⭐ 2,048 | 🐛 30 | 🌐 Lua | 📅 2025-06-08 - UI Component Library.
...
* [DrKJeff16/wezterm-types](https://github.com/DrKJeff16/wezterm-types) ⭐ 190 | 🐛 1 | 🌐 Lua | 📅 2026-04-07 - WezTerm config type annotations for LuaLS, including support for community plugins.
...
* [BirdeeHub/lze](https://github.com/BirdeeHub/lze) ⭐ 117 | 🐛 1 | 🌐 Lua | 📅 2026-04-07 - A lazy-loading library for Neovim plugins.
* [jrop/morph.nvim](https://github.com/jrop/morph.nvim) ⭐ 110 | 🐛 0 | 🌐 Lua | 📅 2026-03-30 - A React-like renderer for building interactive buffers/TUIs.
...
* [lumen-oss/luarocks-tag-release](https://github.com/lumen-oss/luarocks-tag-release) ⭐ 56 | 🐛 10 | 🌐 Lua | 📅 2026-04-07 - A GitHub action that publishes your Neovim plugins to LuaRocks.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2025-05-23 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 21,907 | 🐛 17 | 🌐 Go | 📅 2026-03-20 or compatible encryption tools for cryptographic safety.
...
* [rktjmp/hotpot.nvim](https://github.com/rktjmp/hotpot.nvim) ⭐ 390 | 🐛 0 | 🌐 Fennel | 📅 2026-04-08 - Seamless, transparent Fennel inside Neovim.
* [Olical/nfnl](https://github.com/Olical/nfnl) ⭐ 344 | 🐛 9 | 🌐 Fennel | 📅 2026-04-07 - Streamlined successor to Aniseed, compiling Fennel to Lua on file write.
...
* [nvim-mini/mini.nvim#mini.diff](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
* [nvim-mini/mini.nvim#mini.git](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for enhanced Git integration with current Neovim process that implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.
* [lewis6991/gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) ⭐ 6,699 | 🐛 32 | 🌐 Lua | 📅 2026-04-06 - Git integration: signs, hunk actions, blame, etc.
* [sindrets/diffview.nvim](https://github.com/sindrets/diffview.nvim) ⭐ 5,484 | 🐛 132 | 🌐 Lua | 📅 2024-08-02 - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev.
* [NeogitOrg/neogit](https://github.com/NeogitOrg/neogit) ⭐ 5,268 | 🐛 183 | 🌐 Lua | 📅 2026-04-07 - A Magit clone that may change some things to fit the Vim philosophy.
* [kdheepak/lazygit.nvim](https://github.com/kdheepak/lazygit.nvim) ⭐ 2,238 | 🐛 51 | 🌐 Lua | 📅 2025-12-19 - Plugin for calling lazygit.
* [esmuellert/codediff.nvim](https://github.com/esmuellert/codediff.nvim) ⭐ 1,258 | 🐛 67 | 🌐 Lua | 📅 2026-03-31 - Side-by-side diff with two-tier highlighting (line + character level) using VSCode's algorithm implemented in C.
* [f-person/git-blame.nvim](https://github.com/f-person/git-blame.nvim) ⭐ 1,078 | 🐛 12 | 🌐 Lua | 📅 2025-11-05 - Show Git blame info.
...
* [barrettruth/diffs.nvim](https://github.com/barrettruth/diffs.nvim) ⭐ 71 | 🐛 1 | 🌐 Lua | 📅 2026-04-06 - Syntax highlighting for diffs with Tree-sitter support for `vim-fugitive` and `&diff` buffers.
...
* [spacedentist/resolve.nvim](https://github.com/spacedentist/resolve.nvim) ⭐ 51 | 🐛 7 | 🌐 Lua | 📅 2026-01-25 - Resolve merge conflicts with ease.
...
* [pwntester/octo.nvim](https://github.com/pwntester/octo.nvim) ⭐ 3,218 | 🐛 226 | 🌐 Lua | 📅 2026-04-06 - Work with GitHub issues and PRs.
...
* [nvim-mini/mini.nvim#mini.jump](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for smarter jumping to a single character.
* [nvim-mini/mini.nvim#mini.jump2d](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
* [nvim-mini/mini.nvim#mini.bracketed](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` to go forward/backward with square brackets.
...
* [folke/flash.nvim](https://github.com/folke/flash.nvim) ⭐ 3,991 | 🐛 24 | 🌐 Lua | 📅 2025-10-28 - Navigate your code with search labels, enhanced character motions and Tree-sitter integration.
...
* [smoka7/hop.nvim](https://github.com/smoka7/hop.nvim) ⭐ 768 | 🐛 36 | 🌐 Lua | 📅 2025-08-22 - Hop is an EasyMotion-like plugin allowing you to jump anywhere in a document with as few keystrokes as possible.
...
* [nvim-mini/mini.nvim#mini.clue](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
* [nvim-mini/mini.nvim#mini.keymap](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).
* [folke/which-key.nvim](https://github.com/folke/which-key.nvim) ⭐ 7,041 | 🐛 36 | 🌐 Lua | 📅 2025-10-28 - Shows a popup with possible keybindings of the command you started typing.
...
* [mawkler/demicolon.nvim](https://github.com/mawkler/demicolon.nvim) ⭐ 127 | 🐛 1 | 🌐 Lua | 📅 2026-01-25 - Use `;` and `,` keys to also repeat jumps to diagnostics (e.g. `]d`) and to [nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects?tab=readme-ov-file#text-objects-move) ⭐ 2,725 | 🐛 112 | 🌐 Tree-sitter Query | 📅 2026-04-07 (e.g. `]f`), in addition to repeating `t`/`T`/`f`/`F`.
...
* [nvim-mini/mini.nvim#mini.map](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.
...
* [nvim-mini/mini.nvim#mini.pairs](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
* [nvim-mini/mini.nvim#mini.trailspace](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
* [nvim-mini/mini.nvim#mini.operators](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
* [nvim-mini/mini.nvim#mini.move](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
* [nvim-mini/mini.nvim#mini.ai](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some built-in textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
* [nvim-mini/mini.nvim#mini.splitjoin](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
* [nvim-mini/mini.nvim#mini.basics](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.
...
* [nvim-treesitter/nvim-treesitter-context](https://github.com/nvim-treesitter/nvim-treesitter-context) ⭐ 3,157 | 🐛 22 | 🌐 Janet | 📅 2026-04-02 - Shows floating hover with the current function/block context.
...
* [jake-stewart/multicursor.nvim](https://github.com/jake-stewart/multicursor.nvim) ⭐ 1,443 | 🐛 0 | 🌐 Lua | 📅 2026-03-24 - Adds support for multiple cursors which work how you expect.
...
* [gbprod/yanky.nvim](https://github.com/gbprod/yanky.nvim) ⭐ 1,235 | 🐛 35 | 🌐 Lua | 📅 2026-03-12 - Improved Yank and Put functionalities.
* [monaqa/dial.nvim](https://github.com/monaqa/dial.nvim) ⭐ 1,062 | 🐛 17 | 🌐 Lua | 📅 2025-12-21 - Extended increment/decrement.
...
* [shortcuts/no-neck-pain.nvim](https://github.com/shortcuts/no-neck-pain.nvim) ⭐ 929 | 🐛 16 | 🌐 Lua | 📅 2026-04-03 - Center the currently focused buffer to the middle of your terminal.
...
* [chrisgrieser/nvim-various-textobjs](https://github.com/chrisgrieser/nvim-various-textobjs) ⭐ 758 | 🐛 0 | 🌐 Lua | 📅 2026-04-03 - Bundle of more than 30 new text objects.
...
* [altermo/ultimate-autopair.nvim](https://github.com/altermo/ultimate-autopair.nvim) ⭐ 571 | 🐛 22 | 🌐 Lua | 📅 2026-04-04 - Autopair with extensions.
...
* [XXiaoA/atone.nvim](https://github.com/XXiaoA/atone.nvim) ⭐ 164 | 🐛 2 | 🌐 Lua | 📅 2026-04-06 - Undo tree for visualizing and managing undo history.
...
* [nvim-mini/mini.nvim#mini.comment](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.
...
* [JoosepAlviste/nvim-ts-context-commentstring](https://github.com/JoosepAlviste/nvim-ts-context-commentstring) ⭐ 1,293 | 🐛 21 | 🌐 Lua | 📅 2026-04-04 - Sets the `commentstring` option based on the cursor location in the file. The location is checked via Tree-sitter queries.
...
* [LudoPinelli/comment-box.nvim](https://github.com/LudoPinelli/comment-box.nvim) ⭐ 486 | 🐛 15 | 🌐 Lua | 📅 2024-08-10 - Clarify and beautify your comments using boxes and lines.
...
* [nvim-mini/mini.nvim#mini.align](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for aligning text interactively (with or without instant preview).
* [stevearc/conform.nvim](https://github.com/stevearc/conform.nvim) ⭐ 5,033 | 🐛 93 | 🌐 Lua | 📅 2026-03-10 - A lightweight formatting engine that plays nice with LSP.
...
* [nvim-mini/mini.nvim#mini.indentscope](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.
* [lukas-reineke/indent-blankline.nvim](https://github.com/lukas-reineke/indent-blankline.nvim) ⭐ 4,897 | 🐛 24 | 🌐 Lua | 📅 2026-02-17 - IndentLine replacement in Lua with more features and Tree-sitter support.
...
* [NMAC427/guess-indent.nvim](https://github.com/NMAC427/guess-indent.nvim) ⭐ 620 | 🐛 17 | 🌐 Lua | 📅 2025-03-25 - Automatic indentation style detection.
...
* [saghen/blink.indent](https://github.com/saghen/blink.indent) ⭐ 198 | 🐛 8 | 🌐 Lua | 📅 2026-01-13 - Performant indent guides with scope on every keystroke.
...
* [nvim-mini/mini.nvim#mini.sessions](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for session management (read, write, delete).
* [rmagatti/auto-session](https://github.com/rmagatti/auto-session) ⭐ 1,803 | 🐛 18 | 🌐 Lua | 📅 2026-02-15 - A small automated session manager.
...
* [olimorris/persisted.nvim](https://github.com/olimorris/persisted.nvim) ⭐ 533 | 🐛 0 | 🌐 Lua | 📅 2026-02-02 - Simple session management with Git branching, autosave/autoload and Telescope support.
...
* [azratul/live-share.nvim](https://github.com/azratul/live-share.nvim) ⭐ 243 | 🐛 0 | 🌐 Lua | 📅 2026-04-07 - Provides remote collaboration capabilities from anywhere, making it ideal for pair-programming scenarios.
...
* [nvim-mini/mini.nvim#mini.bufremove](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,612 | 🐛 16 | 🌐 Lua | 📅 2026-04-06 - Smart, seamless, directional navigation and resizing of splits.
...
* [nvim-zh/colorful-winsep.nvim](https://github.com/nvim-zh/colorful-winsep.nvim) ⭐ 668 | 🐛 1 | 🌐 Lua | 📅 2026-02-19 - A configurable color split line.
...
* [yorickpeterse/nvim-window](https://github.com/yorickpeterse/nvim-window) ⭐ 177 | 🐛 0 | 🌐 Lua | 📅 2026-01-20 - Easily jump between windows.
...
* [Eandrju/cellular-automaton.nvim](https://github.com/Eandrju/cellular-automaton.nvim) ⭐ 2,090 | 🐛 12 | 🌐 Lua | 📅 2025-01-31 - It lets you execute aesthetically pleasing, cellular automaton animations based on the content of the current buffer.
...
* [kawre/leetcode.nvim](https://github.com/kawre/leetcode.nvim) ⭐ 2,033 | 🐛 60 | 🌐 Lua | 📅 2025-09-21 - Solve Leetcode problems.
...
* [letieu/jira.nvim](https://github.com/letieu/jira.nvim) ⭐ 232 | 🐛 4 | 🌐 Lua | 📅 2026-04-02 - Manage Jira tasks with a beautiful UI.
* [emrearmagan/atlas.nvim](https://github.com/emrearmagan/atlas.nvim) ⭐ 15 | 🐛 1 | 🌐 Lua | 📅 2026-04-06 - Manage Bitbucket PRs and Jira issues.
...
* [aikhe/wrapped.nvim](https://github.com/aikhe/wrapped.nvim) ⭐ 176 | 🐛 5 | 🌐 Lua | 📅 2026-03-20 - Visualize and review your configuration activity with stats, insights, history, heatmaps and more.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 57 | 🐛 6 | 🌐 Go | 📅 2026-04-08 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [kndndrj/nvim-dbee](https://github.com/kndndrj/nvim-dbee) ⭐ 1,247 | 🐛 76 | 🌐 Go | 📅 2025-07-25 - Interactive database client.
...
* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 30,114 | 🐛 19 | 🌐 Lua | 📅 2026-03-31 - A launch point for your personal Neovim configuration.
* [siduck76/NvChad](https://github.com/siduck76/NvChad) ⭐ 28,065 | 🐛 1 | 🌐 Lua | 📅 2026-02-07 - An attempt to make Neovim's CLI as functional as an IDE while retaining beauty with less bloat.
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 25,769 | 🐛 47 | 🌐 Lua | 📅 2026-04-02 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
* [LunarVim/LunarVim](https://github.com/LunarVim/LunarVim) ⭐ 19,263 | 🐛 34 | 🌐 Lua | 📅 2025-06-05 - This project aims to help one transition away from VSCode, and into a superior text editing experience.
* [AstroNvim/AstroNvim](https://github.com/AstroNvim/AstroNvim) ⭐ 14,232 | 🐛 1 | 🌐 Lua | 📅 2026-04-07 - An aesthetic and feature-rich config that is extensible and easy to use with a great set of plugins.
* [ayamir/nvimdots](https://github.com/ayamir/nvimdots) ⭐ 3,389 | 🐛 11 | 🌐 Lua | 📅 2026-04-06 - A well-configured and structured configuration with NixOS support.
...
* [CosmicNvim/CosmicNvim](https://github.com/CosmicNvim/CosmicNvim) ⭐ 1,147 | 🐛 0 | 🌐 Lua | 📅 2026-03-30 - CosmicNvim is a lightweight and opinionated config for web development, specifically designed to provide a COSMIC programming experience!
* [dam9000/kickstart-modular.nvim](https://github.com/dam9000/kickstart-modular.nvim) ⭐ 967 | 🐛 0 | 🌐 Lua | 📅 2026-04-03 - This is a fork of nvim-lua/kickstart.nvim that moves from a single file to a multi file configuration.
...
* [nvim-mini/MiniMax](https://github.com/nvim-mini/MiniMax) ⭐ 379 | 🐛 2 | 🌐 Lua | 📅 2026-04-07 - A collection of self-contained and extensively commented configurations which mostly use MINI tools.
...
* [Shaobin-Jiang/IceNvim](https://github.com/Shaobin-Jiang/IceNvim) ⭐ 303 | 🐛 3 | 🌐 Lua | 📅 2026-03-02 - A beautiful, powerful and customizable config that is blazingly fast.
...
* [MordechaiHadad/bob](https://github.com/MordechaiHadad/bob) ⭐ 2,073 | 🐛 31 | 🌐 Rust | 📅 2026-03-24 - A cross-platform, easy to use Neovim version manager.
...
* [y3owk1n/nvs](https://github.com/y3owk1n/nvs) ⭐ 31 | 🐛 0 | 🌐 Go | 📅 2026-04-07 - Another Neovim version manager with config switcher.
...
* [m15a/flake-awesome-neovim-plugins](https://github.com/m15a/flake-awesome-neovim-plugins) ⭐ 62 | 🐛 0 | 🌐 Nix | 📅 2026-04-07 - Nix flake that provides a collection of `awesome-neovim` plugins as Nix packages.
* [iamironz/android-nvim-plugin](https://github.com/iamironz/android-nvim-plugin) ⭐ 55 | 🐛 1 | 🌐 Lua | 📅 2026-03-25 - Android build, deploy, and logcat commands with Gradle integration.
...
* [nvim-mini/mini.nvim#mini.notify](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) ⭐ 8,966 | 🐛 35 | 🌐 Lua | 📅 2026-04-07 - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.
* [folke/noice.nvim](https://github.com/folke/noice.nvim) ⭐ 5,686 | 🐛 30 | 🌐 Lua | 📅 2025-11-03 - Highly experimental plugin that completely replaces the UI for messages, cmdline and the popupmenu.
...
* [sitiom/nvim-numbertoggle](https://github.com/sitiom/nvim-numbertoggle) ⭐ 218 | 🐛 2 | 🌐 Lua | 📅 2026-04-08 - Automatically toggle between relative and absolute line numbers.
...
* [jrop/tuis.nvim](https://github.com/jrop/tuis.nvim) ⭐ 137 | 🐛 0 | 🌐 Lua | 📅 2026-01-15 - A collection of interactive TUIs which provides rich, interactive UIs to various CLIs.
