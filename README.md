...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 20,765 | 🐛 57 | 🌐 Lua | 📅 2025-12-17 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [nvim-mini/mini.nvim#mini.deps](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.
...
* [zuqini/zpack.nvim](https://github.com/zuqini/zpack.nvim) ⭐ 119 | 🐛 2 | 🌐 Lua | 📅 2026-04-15 - A thin layer on top of `vim.pack` to support lazy-loading and `lazy.nvim`'s declarative spec.
...
* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,556 | 🐛 32 | 🌐 Lua | 📅 2026-04-16 - Quickstart configurations for the LSP client.

<!--lint enable awesome-spell-check-->

* [nvimdev/lspsaga.nvim](https://github.com/nvimdev/lspsaga.nvim) ⭐ 3,778 | 🐛 100 | 🌐 Lua | 📅 2026-03-03 - A light-weight LSP plugin based on the built-in LSP with a highly performant UI.
* [mfussenegger/nvim-lint](https://github.com/mfussenegger/nvim-lint) ⭐ 2,706 | 🐛 44 | 🌐 Lua | 📅 2026-04-09 - An asynchronous linter plugin, complementary to the built-in Language Server Protocol support.
* [j-hui/fidget.nvim](https://github.com/j-hui/fidget.nvim) ⭐ 2,508 | 🐛 21 | 🌐 Lua | 📅 2026-04-01 - Standalone UI for LSP progress.
* [ray-x/lsp\_signature.nvim](https://github.com/ray-x/lsp_signature.nvim) ⭐ 2,347 | 🐛 87 | 🌐 Lua | 📅 2026-04-07 - LSP signature hint when you type.
* [stevearc/aerial.nvim](https://github.com/stevearc/aerial.nvim) ⭐ 2,268 | 🐛 77 | 🌐 Lua | 📅 2026-02-25 - A code outline window for skimming and quick navigation.
...
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 992 | 🐛 11 | 🌐 Lua | 📅 2026-04-17 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,726 | 🐛 96 | 🌐 JavaScript | 📅 2026-04-18 catalog.
...
* [mrcjkb/rustaceanvim](https://github.com/mrcjkb/rustaceanvim) ⭐ 2,938 | 🐛 18 | 🌐 Lua | 📅 2026-04-20 - A heavily modified fork of rust-tools.nvim that does not require a `setup` call and does not depend on nvim-lspconfig.
* [rachartier/tiny-inline-diagnostic.nvim](https://github.com/rachartier/tiny-inline-diagnostic.nvim) ⭐ 1,643 | 🐛 0 | 🌐 Lua | 📅 2026-04-17 - Display prettier diagnostic messages. Display one line diagnostic messages where the cursor is, with icons and colors.
...
* [DNLHC/glance.nvim](https://github.com/DNLHC/glance.nvim) ⭐ 909 | 🐛 19 | 🌐 Lua | 📅 2025-06-16 - A pretty window for previewing, navigating and editing your LSP locations.
...
* [mrcjkb/haskell-tools.nvim](https://github.com/mrcjkb/haskell-tools.nvim) ⭐ 592 | 🐛 22 | 🌐 Lua | 📅 2026-04-20 - Seamless integration for Haskell development tools like `haskell-language-server` and Hoogle.
...
* [linrongbin16/lsp-progress.nvim](https://github.com/linrongbin16/lsp-progress.nvim) ⭐ 234 | 🐛 1 | 🌐 Lua | 📅 2026-02-02 - A performant LSP progress status.
...
* [ryan-WORK/ohm](https://github.com/ryan-WORK/ohm) ⭐ 10 | 🐛 0 | 🌐 Go | 📅 2026-04-18 - A persistent LSP process manager daemon for Neovim. Fixes memory bloat, stuck diagnostics, monorepo server duplication, and session degradation.
...
* [mason-org/mason.nvim](https://github.com/mason-org/mason.nvim) ⭐ 10,213 | 🐛 273 | 🌐 Lua | 📅 2026-04-06 - Portable package manager that runs everywhere Neovim runs. Easily install and manage LSP servers, DAP servers, linters, and formatters.

### Diagnostics

* [folke/trouble.nvim](https://github.com/folke/trouble.nvim) ⭐ 6,754 | 🐛 21 | 🌐 Lua | 📅 2025-10-31 - A pretty diagnostics list to help you solve all the trouble your code is causing.
...
* [hrsh7th/nvim-cmp](https://github.com/hrsh7th/nvim-cmp) ⭐ 9,401 | 🐛 301 | 🌐 Lua | 📅 2026-03-25 - Completion engine written in Lua, successor of `nvim-compe`.
...
* [nvim-mini/mini.nvim#mini.completion](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 6,187 | 🐛 110 | 🌐 Lua | 📅 2026-04-19 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [mikavilpas/blink-ripgrep.nvim](https://github.com/mikavilpas/blink-ripgrep.nvim) ⭐ 112 | 🐛 2 | 🌐 TypeScript | 📅 2026-04-20 - `blink.cmp` source for `ripgrep` / `git grep`.
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 11 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 44,690 | 🐛 62 | 🌐 C | 📅 2026-04-16.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 4,055 | 🐛 14 | 🌐 Lua | 📅 2026-04-19 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,551 | 🐛 59 | 🌐 Vim Script | 📅 2026-01-09.
...
* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 17,793 | 🐛 54 | 🌐 Lua | 📅 2026-03-30 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,475 | 🐛 12 | 🌐 Lua | 📅 2026-04-19 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
...
* [CopilotC-Nvim/CopilotChat.nvim](https://github.com/CopilotC-Nvim/CopilotChat.nvim) ⭐ 3,621 | 🐛 16 | 🌐 Lua | 📅 2026-04-16 - A chat interface for GitHub Copilot that allows you to directly ask and receive answers to coding-related questions.
* [nickjvandyke/opencode.nvim](https://github.com/nickjvandyke/opencode.nvim) ⭐ 3,228 | 🐛 12 | 🌐 Lua | 📅 2026-04-15 - OpenCode AI assistant integration.
...
* [Exafunction/windsurf.nvim](https://github.com/Exafunction/windsurf.nvim) ⭐ 1,266 | 🐛 115 | 🌐 Lua | 📅 2026-04-02 - Free, ultrafast Copilot alternative. Supports LSP and Tree-sitter.
* [milanglacier/minuet-ai.nvim](https://github.com/milanglacier/minuet-ai.nvim) ⭐ 1,105 | 🐛 13 | 🌐 Lua | 📅 2026-04-18 - Minuet offers code completion from LLM providers including OpenAI (compatible), Gemini, Claude, Ollama, Deepseek and more providers, with support for nvim-cmp, blink.cmp and virtual-text frontend.
...
* [dlants/magenta.nvim](https://github.com/dlants/magenta.nvim) ⭐ 438 | 🐛 14 | 🌐 TypeScript | 📅 2026-04-19 - Leverage coding assistants for chat and code generation. Provides tools for the AI/LLM agent to explore and edit your code, like Aider, Cursor and Windsurf.
* [carlos-algms/agentic.nvim](https://github.com/carlos-algms/agentic.nvim) ⭐ 408 | 🐛 6 | 🌐 Lua | 📅 2026-04-18 - Chat interface for AI ACP providers such as Claude, Gemini, Codex, OpenCode and Cursor.
...
* [GeorgesAlkhouri/nvim-aider](https://github.com/GeorgesAlkhouri/nvim-aider) ⭐ 373 | 🐛 5 | 🌐 Lua | 📅 2025-10-28 - Seamlessly integrate Aider for an AI-assisted coding experience.
...
* [cursortab/cursortab.nvim](https://github.com/cursortab/cursortab.nvim) ⭐ 163 | 🐛 9 | 🌐 Go | 📅 2026-04-13 - Edit completions and cursor predictions with multiple AI providers.
...
* [Flemma-Dev/flemma.nvim](https://github.com/Flemma-Dev/flemma.nvim) ⭐ 52 | 🐛 1 | 🌐 Lua | 📅 2026-04-19 - A first-class AI workspace.
...
* [wsdjeg/chat.nvim](https://github.com/wsdjeg/chat.nvim) ⭐ 25 | 🐛 1 | 🌐 Lua | 📅 2026-04-19 - A lightweight, extensible chat plugin with AI integration, multiple providers, and built-in tools.
...
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 8 | 🐛 4 | 🌐 Lua | 📅 2026-04-05 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 11,648 | 🐛 587 | 🌐 Python | 📅 2026-04-15 tool.
...
* [nvim-flutter/flutter-tools.nvim](https://github.com/nvim-flutter/flutter-tools.nvim) ⭐ 1,380 | 🐛 34 | 🌐 Lua | 📅 2026-01-14 - Build Flutter and Dart applications using the native LSP.
* [chomosuke/typst-preview.nvim](https://github.com/chomosuke/typst-preview.nvim) ⭐ 901 | 🐛 11 | 🌐 Lua | 📅 2026-03-30 - Preview Typst documents in the browser, instant update on each keystroke, and cross jump between code and preview.
...
* [Julian/lean.nvim](https://github.com/Julian/lean.nvim) ⭐ 510 | 🐛 36 | 🌐 Lua | 📅 2026-04-20 - Support for the [Lean Theorem Prover](https://leanprover.github.io/).
...
* [ray-x/go.nvim](https://github.com/ray-x/go.nvim) ⭐ 2,622 | 🐛 96 | 🌐 Lua | 📅 2026-04-13 - Golang plugin based on LSP and Tree-sitter.
...
* [mistweaverco/kulala.nvim](https://github.com/mistweaverco/kulala.nvim) ⭐ 1,963 | 🐛 19 | 🌐 Lua | 📅 2026-03-16 - A minimal HTTP-client interface.
...
* [iamcco/markdown-preview.nvim](https://github.com/iamcco/markdown-preview.nvim) ⭐ 7,816 | 🐛 261 | 🌐 JavaScript | 📅 2024-07-23 - Preview Markdown on your modern browser with synchronised scrolling and flexible configuration.
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 4,432 | 🐛 10 | 🌐 Lua | 📅 2026-04-12 - Improve viewing Markdown files directly.
* [OXY2DEV/markview.nvim](https://github.com/OXY2DEV/markview.nvim) ⭐ 3,432 | 🐛 3 | 🌐 Lua | 📅 2026-04-18 - A hackable Markdown, Typst, LaTeX, HTML (inline) and YAML renderer.
...
* [YousefHadder/markdown-plus.nvim](https://github.com/YousefHadder/markdown-plus.nvim) ⭐ 238 | 🐛 2 | 🌐 Lua | 📅 2026-04-19 - Provides a full editing experience for Markdown files which includes support for lists, links, TOC, and more with simple and fast keymaps.
...
* [gbprod/phpactor.nvim](https://github.com/gbprod/phpactor.nvim) ⭐ 94 | 🐛 2 | 🌐 Lua | 📅 2026-01-07 - Lua version of [phpactor](https://github.com/phpactor/phpactor) ⭐ 1,851 | 🐛 295 | 🌐 PHP | 📅 2026-04-18.
...
* [nvim-mini/mini.nvim#mini.surround](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-surround.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for working with text surroundings (add, delete, replace, find, highlight). Supports dot-repeat, different search methods, "last"/"next" extended mappings, Tree-sitter integration, and more.
* [kylechui/nvim-surround](https://github.com/kylechui/nvim-surround) ⭐ 4,179 | 🐛 8 | 🌐 Lua | 📅 2026-04-05 - A plugin for adding/changing/deleting surrounding delimiter pairs.
...
* [romus204/tree-sitter-manager.nvim](https://github.com/romus204/tree-sitter-manager.nvim) ⭐ 346 | 🐛 13 | 🌐 Tree-sitter Query | 📅 2026-04-13 - A lightweight Tree-sitter parser manager for Neovim 0.12+ to replace the archived `nvim-treesitter` plugin.
* [IndianBoy42/tree-sitter-just](https://github.com/IndianBoy42/tree-sitter-just) ⭐ 188 | 🐛 7 | 🌐 Just | 📅 2026-03-25 - Tree-sitter grammar for [Justfiles](https://github.com/casey/just) ⭐ 32,989 | 🐛 306 | 🌐 Rust | 📅 2026-04-19.
...
* [nvim-mini/mini.nvim#mini.snippets](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.
* [L3MON4D3/LuaSnip](https://github.com/L3MON4D3/LuaSnip) ⭐ 4,321 | 🐛 128 | 🌐 Lua | 📅 2026-04-05 - A snippet engine written in Lua.
...
* [dcampos/nvim-snippy](https://github.com/dcampos/nvim-snippy) ⭐ 340 | 🐛 8 | 🌐 Lua | 📅 2026-04-09 - Snippet plugin written in Lua with support for [vim-snippets](https://github.com/honza/vim-snippets) ⭐ 4,872 | 🐛 85 | 🌐 Vim Snippet | 📅 2025-10-28.
...
* [ThePrimeagen/harpoon](https://github.com/ThePrimeagen/harpoon/tree/harpoon2) ⭐ 9,035 | 🐛 150 | 🌐 Lua | 📅 2025-10-31 - A per project, auto updating and editable marks utility for fast file navigation.
* [chentoast/marks.nvim](https://github.com/chentoast/marks.nvim) ⭐ 1,154 | 🐛 56 | 🌐 Lua | 📅 2025-05-13 - A better user experience for viewing and interacting with Vim marks.
...
* [cbochs/grapple.nvim](https://github.com/cbochs/grapple.nvim) ⭐ 700 | 🐛 26 | 🌐 Lua | 📅 2024-09-29 - Provides tagging, cursor tracking, and immediate navigation to important project files.
...
* [MagicDuck/grug-far.nvim](https://github.com/MagicDuck/grug-far.nvim) ⭐ 1,878 | 🐛 0 | 🌐 Lua | 📅 2026-04-11 - Buffer-based live search and replace with full power of `rg` flags. Grug like!
...
* [nvim-telescope/telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) ⭐ 19,329 | 🐛 458 | 🌐 Lua | 📅 2026-04-19 - Telescope.nvim is a highly [extendable](https://github.com/nvim-telescope/telescope.nvim/wiki/Extensions) ⭐ 19,329 | 🐛 458 | 🌐 Lua | 📅 2026-04-19 A highly extensible fuzzy finder over lists.
* [nvim-mini/mini.nvim#mini.fuzzy](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
* [nvim-mini/mini.nvim#mini.pick](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
* [nvim-mini/mini.nvim#mini.extra](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.
* [folke/snacks.nvim#picker](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) ⭐ 7,467 | 🐛 115 | 🌐 Lua | 📅 2026-03-21 - A modern fuzzy-finder to navigate the Neovim universe.
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 5,193 | 🐛 55 | 🌐 Rust | 📅 2026-04-19 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,216 | 🐛 11 | 🌐 Lua | 📅 2026-04-20 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,760 | 🐛 18 | 🌐 Rust | 📅 2026-04-15 as its fzf binary.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 368 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 35,814 | 🐛 163 | 🌐 Rust | 📅 2026-04-13, a smart directory picker that tracks your usage.
...
* [juniorsundar/refer.nvim](https://github.com/juniorsundar/refer.nvim) ⭐ 47 | 🐛 3 | 🌐 Lua | 📅 2026-04-11 - A minimalist picker that doesn't get in your way.
...
* [willyelm/pulse.nvim](https://github.com/willyelm/pulse.nvim) ⭐ 24 | 🐛 0 | 🌐 Lua | 📅 2026-03-30 - A single entrypoint for commands. Use prefixes to quickly access diagnostics, Git and more via pickers.
...
* [nvim-mini/mini.nvim#mini.files](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.
...
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,481 | 🐛 133 | 🌐 Lua | 📅 2026-02-24 - Edit your filesystem like a buffer.
* [nvim-neo-tree/neo-tree.nvim](https://github.com/nvim-neo-tree/neo-tree.nvim) ⭐ 5,380 | 🐛 171 | 🌐 Lua | 📅 2026-04-17 - Browse the file system and other tree-like structures in whatever style suits you, including sidebars, floating windows, `netrw` split style, or all of them at once.
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,693 | 🐛 93 | 🌐 Python | 📅 2026-04-20 - File manager. Better than NERDTree.
* [mikavilpas/yazi.nvim](https://github.com/mikavilpas/yazi.nvim) ⭐ 1,671 | 🐛 8 | 🌐 Lua | 📅 2026-04-20 - Integration with the Yazi terminal file manager.
...
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 462 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,496 | 🐛 2 | 🌐 C | 📅 2026-04-19 and Lua.
...
* [kelly-lin/ranger.nvim](https://github.com/kelly-lin/ranger.nvim) ⭐ 182 | 🐛 11 | 🌐 Lua | 📅 2024-11-18 - [Ranger](https://github.com/ranger/ranger) ⭐ 17,139 | 🐛 916 | 🌐 Python | 📅 2026-04-17 integration.
* [Xuyuanp/yanil](https://github.com/Xuyuanp/yanil) ⭐ 98 | 🐛 5 | 🌐 Lua | 📅 2026-01-15 - Yet Another Nerdtree In Lua.
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 98 | 🐛 2 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 36,763 | 🐛 66 | 🌐 Rust | 📅 2026-04-19).
...
* [nvim-mini/mini.nvim#mini.visits](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.
...
* [DrKJeff16/project.nvim](https://github.com/DrKJeff16/project.nvim) ⭐ 158 | 🐛 2 | 🌐 Lua | 📅 2026-04-18 - Project manager with project root detection, documented code and lots of improvements, including `snacks.nvim`, `fzf-lua` and `picker.nvim` support.
...
* [mrjones2014/codesettings.nvim](https://github.com/mrjones2014/codesettings.nvim) ⭐ 65 | 🐛 2 | 🌐 Lua | 📅 2026-04-17 - Easily load project-local settings (like `.vscode/settings.json`) into Neovim 0.11+ native LSP settings.
...
* [nvim-mini/mini.nvim#mini.hipatterns](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.
* [folke/twilight.nvim](https://github.com/folke/twilight.nvim) ⭐ 1,523 | 🐛 0 | 🌐 Lua | 📅 2025-10-28 - Dim inactive portions of the code you're editing using Tree-sitter.
* [catgoose/nvim-colorizer.lua](https://github.com/catgoose/nvim-colorizer.lua) ⭐ 1,056 | 🐛 6 | 🌐 Lua | 📅 2026-04-19 - A high-performance color highlighter which has no external dependencies.
...
* [xzbdmw/colorful-menu.nvim](https://github.com/xzbdmw/colorful-menu.nvim) ⭐ 469 | 🐛 4 | 🌐 Lua | 📅 2025-11-25 - Colorize your auto completion menu using Tree-sitter.
...
* [folke/tokyonight.nvim](https://github.com/folke/tokyonight.nvim) ⭐ 7,971 | 🐛 16 | 🌐 Lua | 📅 2026-03-24 - ***`[TS][LSP][L/D][Lua]`*** A clean, dark and light theme written in Lua, with support for LSP, Tree-sitter and lots of plugins.
* [sainnhe/everforest](https://github.com/sainnhe/everforest) ⭐ 3,970 | 🐛 6 | 🌐 Vim Script | 📅 2026-04-16 - ***`[TS][LSP][L/D]`*** A green based colorscheme designed to be warm, soft and easy on the eyes.
...
* [projekt0n/github-nvim-theme](https://github.com/projekt0n/github-nvim-theme) ⭐ 2,451 | 🐛 28 | 🌐 Lua | 📅 2024-12-31 - ***`[TS][LSP][L/D][Lua]`*** A GitHub theme, kitty, alacritty written in Lua. Support built-in LSP and Tree-sitter.
* [navarasu/onedark.nvim](https://github.com/navarasu/onedark.nvim) ⭐ 1,958 | 🐛 54 | 🌐 Lua | 📅 2026-04-13 - ***`[TS][LSP][Lua]`*** A One Dark Theme written in Lua based on Atom's One Dark Theme.
...
* [bluz71/vim-moonfly-colors](https://github.com/bluz71/vim-moonfly-colors) ⭐ 1,270 | 🐛 0 | 🌐 Lua | 📅 2026-04-02 - ***`[TS][LSP][Lua]`*** A dark charcoal colorscheme with Tree-sitter support.
...
* [AlexvZyl/nordic.nvim](https://github.com/AlexvZyl/nordic.nvim) ⭐ 1,006 | 🐛 1 | 🌐 Lua | 📅 2026-04-19 - ***`[TS][Lua]`*** Nord theme, but warmer and darker. Supports a variety of plugins and other platforms.
...
* [bluz71/vim-nightfly-colors](https://github.com/bluz71/vim-nightfly-colors) ⭐ 924 | 🐛 0 | 🌐 Lua | 📅 2026-04-02 - ***`[TS][LSP][Lua]`*** A dark midnight colorscheme with Tree-sitter support.
...
* [yonatan-perel/lake-dweller.nvim](https://github.com/yonatan-perel/lake-dweller.nvim) ⭐ 32 | 🐛 1 | 🌐 Lua | 📅 2026-04-16 - ***`[TS][LSP][Lua]`*** Dark and opinionated with selective highlighting aiming to be readable at a glance.
* [wurli/cobalt.nvim](https://github.com/wurli/cobalt.nvim) ⭐ 27 | 🐛 0 | 🌐 Lua | 📅 2026-04-10 - ***`[TS][LSP][Lua]`*** A (mostly) faithful port of the classic blue theme from TextMate.
...
* [nvim-mini/mini.nvim#colorschemes](https://github.com/nvim-mini/mini.nvim#plugin-color-schemes) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - ***`[TS][LSP][L/D][Lua]`*** Color schemes included in `mini.nvim`. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.
* [catppuccin/nvim](https://github.com/catppuccin/nvim) ⭐ 7,360 | 🐛 11 | 🌐 Lua | 📅 2026-04-06 - ***`[TS][LSP][L/D][Lua]`*** Warm mid-tone dark theme to show off your vibrant self! With support for native LSP, Tree-sitter, and more.
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 6,080 | 🐛 91 | 🌐 Lua | 📅 2025-10-15 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
...
* [ellisonleao/gruvbox.nvim](https://github.com/ellisonleao/gruvbox.nvim) ⭐ 2,519 | 🐛 27 | 🌐 Lua | 📅 2026-04-15 - ***`[TS][LSP][L/D][Lua]`*** Gruvbox community colorscheme Lua port.
* [scottmckendry/cyberdream.nvim](https://github.com/scottmckendry/cyberdream.nvim) ⭐ 1,306 | 🐛 4 | 🌐 Lua | 📅 2026-04-11 - ***`[TS][L/D][Lua]`*** A high-contrast, futuristic and vibrant coloursheme.
...
* [xero/miasma.nvim](https://github.com/xero/miasma.nvim) ⭐ 531 | 🐛 5 | 🌐 Vim Script | 📅 2025-07-12 - ***`[TS][LSP]`*** A dark pastel color scheme inspired by the woods. Built using lush and supports Tree-sitter, diagnostics, CMP, Git-Signs, Telescope, Which-key, Lazy, and more.
...
* [ramojus/mellifluous.nvim](https://github.com/ramojus/mellifluous.nvim) ⭐ 447 | 🐛 4 | 🌐 Lua | 📅 2026-01-22 - ***`[TS][LSP][L/D][Lua]`*** Pleasant and productive colorscheme.
...
* [oxfist/night-owl.nvim](https://github.com/oxfist/night-owl.nvim) ⭐ 344 | 🐛 5 | 🌐 Lua | 📅 2024-09-12 - ***`[TS][LSP][Lua]`*** A [Night Owl colorscheme port from VSCode](https://github.com/sdras/night-owl-vscode-theme) ⭐ 2,945 | 🐛 48 | 📅 2024-12-31 with support for Tree-sitter and semantic tokens.
...
* [gbprod/nord.nvim](https://github.com/gbprod/nord.nvim) ⭐ 298 | 🐛 7 | 🌐 Lua | 📅 2026-04-14 - ***`[TS][LSP][Lua]`*** An arctic, north-bluish clean and elegant theme, based on Nord Palette.
...
* [Verf/deepwhite.nvim](https://github.com/Verf/deepwhite.nvim) ⭐ 171 | 🐛 0 | 🌐 Lua | 📅 2026-04-17 - ***`[TS][LSP][Lua]`*** A light colorscheme inspired by [flatwhite-syntax](https://github.com/biletskyy/flatwhite-syntax) ⭐ 192 | 🐛 15 | 🌐 CSS | 📅 2020-04-27 and [elegant-emacs](https://github.com/rougier/elegant-emacs) ⭐ 1,433 | 🐛 8 | 🌐 Emacs Lisp | 📅 2021-11-22.
...
* [hyperb1iss/silkcircuit](https://github.com/hyperb1iss/silkcircuit) ⭐ 48 | 🐛 2 | 🌐 Lua | 📅 2026-04-19 - ***`[TS][LSP][L/D][Lua]`*** Vibrant cyberpunk color system with five variants, 40+ plugin integrations, WCAG AA compliant. Supports multiple editors, terminals and CLI tools.
...
* [calind/selenized.nvim](https://github.com/calind/selenized.nvim) ⭐ 28 | 🐛 3 | 🌐 Lua | 📅 2025-08-06 - ***`[TS][LSP][L/D][Lua]`*** Lua port of [selenized](https://github.com/jan-warchol/selenized) ⭐ 899 | 🐛 58 | 🌐 Emacs Lisp | 📅 2025-09-28 with support for Tree-sitter, `nvim-cmp`, GitSigns, and more.
...
* [nvim-mini/mini.nvim#mini.base16](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
* [nvim-mini/mini.nvim#mini.colors](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
* [nvim-mini/mini.nvim#mini.hues](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.
...
* [Bekaboo/dropbar.nvim](https://github.com/Bekaboo/dropbar.nvim) ⭐ 1,536 | 🐛 16 | 🌐 Lua | 📅 2025-10-05 - IDE-like breadcrumbs, out of the box.
...
* [nvim-mini/mini.nvim#mini.statusline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.
* [nvim-lualine/lualine.nvim](https://github.com/nvim-lualine/lualine.nvim) ⭐ 7,887 | 🐛 268 | 🌐 Lua | 📅 2026-04-12 - Easily configurable, blazingly fast statusline.
...
* [ojroques/nvim-hardline](https://github.com/ojroques/nvim-hardline) ⭐ 203 | 🐛 2 | 🌐 Lua | 📅 2023-12-27 - A statusline / bufferline inspired by [vim-airline](https://github.com/vim-airline/vim-airline) ⭐ 17,951 | 🐛 36 | 🌐 Vim Script | 📅 2026-04-13 that aims to be as light and simple as possible.
...
* [nvim-mini/mini.nvim#mini.tabline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.
* [akinsho/bufferline.nvim](https://github.com/akinsho/bufferline.nvim) ⭐ 4,293 | 🐛 100 | 🌐 Lua | 📅 2025-01-14 - A snazzy bufferline built using Lua.
* [romgrk/barbar.nvim](https://github.com/romgrk/barbar.nvim) ⭐ 2,681 | 🐛 34 | 🌐 Lua | 📅 2025-12-02 - A tabline with re-orderable, auto-sizing, clickable tabs, icons, nice highlighting, sort-by commands and a magic jump-to-buffer mode.
* [nanozuki/tabby.nvim](https://github.com/nanozuki/tabby.nvim) ⭐ 744 | 🐛 8 | 🌐 Lua | 📅 2026-01-07 - A minimal, configurable tabline that allows using tabs as workspace multiplexers.
* [willothy/nvim-cokeline](https://github.com/willothy/nvim-cokeline) ⭐ 625 | 🐛 13 | 🌐 Lua | 📅 2025-01-24 - A bufferline for people with addictive personalities.
...
* [nvim-mini/mini.nvim#mini.cursorword](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).
...
* [ya2s/nvim-cursorline](https://github.com/ya2s/nvim-cursorline) ⭐ 465 | 🐛 7 | 🌐 Lua | 📅 2026-02-14 - Highlights cursor words and lines.
...
* [nvim-mini/mini.nvim#mini.starter](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.
* [nvimdev/dashboard-nvim](https://github.com/nvimdev/dashboard-nvim) ⭐ 2,808 | 🐛 73 | 🌐 Lua | 📅 2026-04-17 - A minimalist dashboard, inspired by doom-emacs.
* [goolord/alpha-nvim](https://github.com/goolord/alpha-nvim) ⭐ 2,358 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - A fast and highly customizable greeter like [vim-startify](https://github.com/mhinz/vim-startify) ⭐ 5,397 | 🐛 80 | 🌐 Vim Script | 📅 2024-01-05/dashboard-nvim.
...
* [3rd/image.nvim](https://github.com/3rd/image.nvim) ⭐ 1,959 | 🐛 55 | 🌐 Lua | 📅 2026-02-21 - Add image support through kitty's graphics protocol or ueberzugpp.
...
* [vyfor/cord.nvim](https://github.com/vyfor/cord.nvim) ⭐ 606 | 🐛 0 | 🌐 Lua | 📅 2026-04-14 - Highly extensible Rich Presence for Discord.
...
* [davidgranstrom/scnvim](https://github.com/davidgranstrom/scnvim) ⭐ 261 | 🐛 23 | 🌐 Lua | 📅 2026-04-13 - A frontend for SuperCollider.
...
* [sanjay-np/nvim-yt-player](https://github.com/sanjay-np/nvim-yt-player) ⭐ 14 | 🐛 0 | 🌐 Lua | 📅 2026-04-16 - Play YouTube audio using `mpv` and `yt-dlp` via IPC socket.
...
* [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ⭐ 7,269 | 🐛 214 | 🌐 Lua | 📅 2026-04-09 - Modernity meets insane extensibility. The future of organizing your life.
* [nvim-orgmode/orgmode](https://github.com/nvim-orgmode/orgmode) ⭐ 3,723 | 🐛 142 | 🌐 Lua | 📅 2026-04-16 - Org-mode clone written in Lua.
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 1,788 | 🐛 70 | 🌐 Lua | 📅 2026-04-19 - Plugin for Obsidian, written in Lua.
...
* [bngarren/checkmate.nvim](https://github.com/bngarren/checkmate.nvim) ⭐ 364 | 🐛 8 | 🌐 Lua | 📅 2025-11-15 - A full-featured Markdown-based TODO plugin.
...
* [backdround/global-note.nvim](https://github.com/backdround/global-note.nvim) ⭐ 149 | 🐛 4 | 🌐 Lua | 📅 2024-02-14 - One global note in a floating window.
...
* [AlejandroSuero/freeze-code.nvim](https://github.com/AlejandroSuero/freeze-code.nvim) ⭐ 32 | 🐛 2 | 🌐 Lua | 📅 2025-03-15 - Code screenshot plugin that makes use of [freeze](https://github.com/charmbracelet/freeze) ⭐ 4,464 | 🐛 68 | 🌐 Go | 📅 2026-04-13 inside the editor.
...
* [emrearmagan/dockyard.nvim](https://github.com/emrearmagan/dockyard.nvim) ⭐ 20 | 🐛 0 | 🌐 Lua | 📅 2026-04-09 - Docker dashboard for managing containers, images, networks, and logs.
...
* [hat0uma/csvview.nvim](https://github.com/hat0uma/csvview.nvim) ⭐ 605 | 🐛 16 | 🌐 Lua | 📅 2026-02-14 - An asynchronous CSV/TSV table viewer with real-time updates, configurable comments and delimiters, and multiple display modes.
...
* [theKnightsOfRohan/csvlens.nvim](https://github.com/theKnightsOfRohan/csvlens.nvim) ⭐ 39 | 🐛 1 | 🌐 Lua | 📅 2024-04-28 - A port of [YS-L/csvlens](https://github.com/YS-L/csvlens) ⭐ 3,726 | 🐛 59 | 🌐 Rust | 📅 2026-03-29, for easy previewing of tabular data.
...
* [nvim-mini/mini.nvim#mini.animate](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).
* [sphamba/smear-cursor.nvim](https://github.com/sphamba/smear-cursor.nvim) ⭐ 1,782 | 🐛 7 | 🌐 Lua | 📅 2026-04-15 - Animate the cursor with a smear effect in all terminals. Inspired by Neovide's animated cursor.
...
* [akinsho/toggleterm.nvim](https://github.com/akinsho/toggleterm.nvim) ⭐ 5,469 | 🐛 88 | 🌐 Lua | 📅 2025-03-09 - Easily manage multiple terminal windows.
* [kassio/neoterm](https://github.com/kassio/neoterm) ⭐ 1,337 | 🐛 31 | 🌐 Vim Script | 📅 2023-03-09 - Wrapper of some `:terminal` functions.
* [mikesmithgh/kitty-scrollback.nvim](https://github.com/mikesmithgh/kitty-scrollback.nvim) ⭐ 851 | 🐛 27 | 🌐 Lua | 📅 2026-04-17 - Open your kitty scrollback buffer. Ameowzing.
...
* [logicmagix/tide42](https://github.com/logicmagix/tide42) ⭐ 24 | 🐛 0 | 🌐 Shell | 📅 2026-04-17 - A fully integrated terminal IDE built on Neovim, tmux, and scriptable workflows.
...
* [mfussenegger/nvim-dap](https://github.com/mfussenegger/nvim-dap) ⭐ 7,076 | 🐛 30 | 🌐 Lua | 📅 2026-04-06 - Debug Adapter Protocol client implementation.
...
* [igorlfs/nvim-dap-view](https://github.com/igorlfs/nvim-dap-view) ⭐ 856 | 🐛 12 | 🌐 Lua | 📅 2026-04-18 - A modern, minimalistic UI for nvim-dap.
...
* [kevinhwang91/nvim-bqf](https://github.com/kevinhwang91/nvim-bqf) ⭐ 2,010 | 🐛 19 | 🌐 Lua | 📅 2026-04-02 - Makes the quickfix window better.
* [stevearc/quicker.nvim](https://github.com/stevearc/quicker.nvim) ⭐ 956 | 🐛 20 | 🌐 Lua | 📅 2026-03-10 - Improved quickfix UI and editable quickfix buffer.
...
* [nvim-neotest/neotest](https://github.com/nvim-neotest/neotest) ⭐ 3,067 | 🐛 98 | 🌐 Lua | 📅 2026-04-01 - An extensible framework for interacting with tests within Neovim.
* [andythigpen/nvim-coverage](https://github.com/andythigpen/nvim-coverage) ⭐ 431 | 🐛 17 | 🌐 Lua | 📅 2024-12-18 - Displays coverage information in the sign column.
...
* [stevearc/overseer.nvim](https://github.com/stevearc/overseer.nvim) ⭐ 1,860 | 🐛 77 | 🌐 Lua | 📅 2026-04-01 - A task runner and job management plugin.
* [michaelb/sniprun](https://github.com/michaelb/sniprun) ⭐ 1,692 | 🐛 11 | 🌐 Rust | 📅 2026-04-04 - Run parts of code of any language directly from Neovim.
...
* [Civitasv/cmake-tools.nvim](https://github.com/Civitasv/cmake-tools.nvim) ⭐ 534 | 🐛 14 | 🌐 Lua | 📅 2026-04-09 - CMake integration.
...
* [nvim-mini/mini.nvim#mini.doc](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
* [nvim-mini/mini.nvim#mini.test](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` with framework for writing extensive Neovim plugin tests with support for hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.
* [nvim-lua/plenary.nvim](https://github.com/nvim-lua/plenary.nvim) ⭐ 3,439 | 🐛 154 | 🌐 Lua | 📅 2026-04-10 - Plenary: full; complete; entire; absolute; unqualified. All the Lua functions I don't want to write twice.
* [MunifTanjim/nui.nvim](https://github.com/MunifTanjim/nui.nvim) ⭐ 2,055 | 🐛 31 | 🌐 Lua | 📅 2025-06-08 - UI Component Library.
...
* [DrKJeff16/wezterm-types](https://github.com/DrKJeff16/wezterm-types) ⭐ 192 | 🐛 1 | 🌐 Lua | 📅 2026-04-15 - WezTerm config type annotations for LuaLS, including support for community plugins.
...
* [gregorias/coop.nvim](https://github.com/gregorias/coop.nvim) ⭐ 145 | 🐛 0 | 🌐 Lua | 📅 2026-04-18 - Structured concurrency with Lua coroutines.
...
* [BirdeeHub/lze](https://github.com/BirdeeHub/lze) ⭐ 120 | 🐛 0 | 🌐 Lua | 📅 2026-04-14 - A lazy-loading library for Neovim plugins.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2025-05-23 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 22,018 | 🐛 17 | 🌐 Go | 📅 2026-03-20 or compatible encryption tools for cryptographic safety.
...
* [Olical/nfnl](https://github.com/Olical/nfnl) ⭐ 348 | 🐛 6 | 🌐 Fennel | 📅 2026-04-13 - Streamlined successor to Aniseed, compiling Fennel to Lua on file write.
...
* [nvim-mini/mini.nvim#mini.diff](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
* [nvim-mini/mini.nvim#mini.git](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for enhanced Git integration with current Neovim process that implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.
* [lewis6991/gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) ⭐ 6,741 | 🐛 34 | 🌐 Lua | 📅 2026-04-08 - Git integration: signs, hunk actions, blame, etc.
* [NeogitOrg/neogit](https://github.com/NeogitOrg/neogit) ⭐ 5,295 | 🐛 187 | 🌐 Lua | 📅 2026-04-19 - A Magit clone that may change some things to fit the Vim philosophy.
* [kdheepak/lazygit.nvim](https://github.com/kdheepak/lazygit.nvim) ⭐ 2,256 | 🐛 51 | 🌐 Lua | 📅 2025-12-19 - Plugin for calling lazygit.
* [esmuellert/codediff.nvim](https://github.com/esmuellert/codediff.nvim) ⭐ 1,298 | 🐛 72 | 🌐 Lua | 📅 2026-04-20 - Side-by-side diff with two-tier highlighting (line + character level) using VSCode's algorithm implemented in C.
...
* [linrongbin16/gitlinker.nvim](https://github.com/linrongbin16/gitlinker.nvim) ⭐ 270 | 🐛 5 | 🌐 Lua | 📅 2026-04-07 - Maintained fork of "ruifm's gitlinker", refactored with bug fixes, ssh aliases, blame support and other improvements.
...
* [chojs23/ec](https://github.com/chojs23/ec) ⭐ 182 | 🐛 1 | 🌐 Go | 📅 2026-04-17 - A TUI native Git mergetool with 3 panes.
* [dlyongemallo/diffview.nvim](https://github.com/dlyongemallo/diffview.nvim) ⭐ 140 | 🐛 5 | 🌐 Lua | 📅 2026-04-18 - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev. Maintained fork of sindrets/diffview\.nvim.
...
* [kokusenz/deltaview.nvim](https://github.com/kokusenz/deltaview.nvim) ⭐ 82 | 🐛 2 | 🌐 Lua | 📅 2026-04-14 - Inline/unified diff viewer with Tree-sitter syntax highlighting and diff highlighting in the style of [delta](https://github.com/dandavison/delta) ⭐ 30,326 | 🐛 379 | 🌐 Rust | 📅 2026-03-28, with enhanced navigational features.
* [barrettruth/diffs.nvim](https://github.com/barrettruth/diffs.nvim) ⭐ 72 | 🐛 1 | 🌐 Lua | 📅 2026-04-20 - Syntax highlighting for diffs with Tree-sitter support for `vim-fugitive` and `&diff` buffers.
...
* [spacedentist/resolve.nvim](https://github.com/spacedentist/resolve.nvim) ⭐ 53 | 🐛 8 | 🌐 Lua | 📅 2026-01-25 - Resolve merge conflicts with ease.
...
* [pwntester/octo.nvim](https://github.com/pwntester/octo.nvim) ⭐ 3,240 | 🐛 239 | 🌐 Lua | 📅 2026-04-16 - Work with GitHub issues and PRs.
...
* [harrisoncramer/GitLab.nvim](https://github.com/harrisoncramer/GitLab.nvim) ⭐ 375 | 🐛 17 | 🌐 Lua | 📅 2026-04-18 - Review pull requests and manage other GitLab resources.
...
* [nvim-mini/mini.nvim#mini.jump](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for smarter jumping to a single character.
* [nvim-mini/mini.nvim#mini.jump2d](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
* [nvim-mini/mini.nvim#mini.bracketed](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` to go forward/backward with square brackets.
...
* [folke/flash.nvim](https://github.com/folke/flash.nvim) ⭐ 4,011 | 🐛 23 | 🌐 Lua | 📅 2025-10-28 - Navigate your code with search labels, enhanced character motions and Tree-sitter integration.
...
* [tris203/precognition.nvim](https://github.com/tris203/precognition.nvim) ⭐ 1,322 | 🐛 13 | 🌐 Lua | 📅 2026-01-31 - Precognition uses virtual text and gutter signs to show available motions.
...
* [Aaronik/Treewalker.nvim](https://github.com/aaronik/Treewalker.nvim) ⭐ 598 | 🐛 1 | 🌐 Lua | 📅 2026-04-10 - Move seamlessly around the abstract syntax tree.
...
* [nvim-mini/mini.nvim#mini.clue](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
* [nvim-mini/mini.nvim#mini.keymap](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).
* [folke/which-key.nvim](https://github.com/folke/which-key.nvim) ⭐ 7,065 | 🐛 38 | 🌐 Lua | 📅 2025-10-28 - Shows a popup with possible keybindings of the command you started typing.
...
* [nvimtools/hydra.nvim](https://github.com/nvimtools/hydra.nvim) ⭐ 276 | 🐛 9 | 🌐 Lua | 📅 2025-05-03 - Create custom submodes and menus. Port of Emacs Hydra. Maintained fork of anuvyklack/hydra.nvim.
...
* [karb94/neoscroll.nvim](https://github.com/karb94/neoscroll.nvim) ⭐ 2,007 | 🐛 11 | 🌐 Lua | 📅 2025-12-31 - Smooth scrolling.
...
* [nvim-mini/mini.nvim#mini.map](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.
...
* [nvim-mini/mini.nvim#mini.pairs](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
* [nvim-mini/mini.nvim#mini.trailspace](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
* [nvim-mini/mini.nvim#mini.operators](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
* [nvim-mini/mini.nvim#mini.move](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
* [nvim-mini/mini.nvim#mini.ai](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some built-in textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
* [nvim-mini/mini.nvim#mini.splitjoin](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
* [nvim-mini/mini.nvim#mini.basics](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.
...
* [folke/zen-mode.nvim](https://github.com/folke/zen-mode.nvim) ⭐ 2,122 | 🐛 18 | 🌐 Lua | 📅 2025-10-28 - Distraction-free coding.
...
* [jake-stewart/multicursor.nvim](https://github.com/jake-stewart/multicursor.nvim) ⭐ 1,454 | 🐛 0 | 🌐 Lua | 📅 2026-03-24 - Adds support for multiple cursors which work how you expect.
* [Wansmer/treesj](https://github.com/Wansmer/treesj) ⭐ 1,317 | 🐛 5 | 🌐 Lua | 📅 2026-04-16 - Splitting/joining blocks of code like arrays, hashes, statements, objects, dictionaries, etc. Using Tree-sitter. Inspired by greatest splitjoin.vim.
...
* [XXiaoA/atone.nvim](https://github.com/XXiaoA/atone.nvim) ⭐ 172 | 🐛 4 | 🌐 Lua | 📅 2026-04-11 - Undo tree for visualizing and managing undo history.
* [gregorias/coerce.nvim](https://github.com/gregorias/coerce.nvim) ⭐ 165 | 🐛 0 | 🌐 Lua | 📅 2026-04-18 - Change keyword case.
...
* [bennypowers/splitjoin.nvim](https://github.com/bennypowers/splitjoin.nvim) ⭐ 93 | 🐛 0 | 🌐 Lua | 📅 2026-04-18 - Split and join various syntax structures.
...
* [nvim-mini/mini.nvim#mini.comment](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.
...
* [folke/todo-comments.nvim](https://github.com/folke/todo-comments.nvim) ⭐ 4,111 | 🐛 20 | 🌐 Lua | 📅 2025-11-10 - Highlight, list and search TODO comments in your projects.
* [danymat/neogen](https://github.com/danymat/neogen) ⭐ 1,640 | 🐛 44 | 🌐 Lua | 📅 2026-01-10 - A better annotation generator which supports multiple languages and annotation conventions.
...
* [kevinhwang91/nvim-ufo](https://github.com/kevinhwang91/nvim-ufo) ⭐ 2,906 | 🐛 46 | 🌐 Lua | 📅 2026-01-11 - Ultra fold with modern looking and performance boosting.
...
* [nvim-mini/mini.nvim#mini.align](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for aligning text interactively (with or without instant preview).
* [stevearc/conform.nvim](https://github.com/stevearc/conform.nvim) ⭐ 5,064 | 🐛 93 | 🌐 Lua | 📅 2026-03-10 - A lightweight formatting engine that plays nice with LSP.
...
* [nvim-mini/mini.nvim#mini.indentscope](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.
...
* [NMAC427/guess-indent.nvim](https://github.com/NMAC427/guess-indent.nvim) ⭐ 623 | 🐛 17 | 🌐 Lua | 📅 2025-03-25 - Automatic indentation style detection.
...
* [nvim-mini/mini.nvim#mini.cmdline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cmdline.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for command line tweaks. Adds autocompletion with customizable delay, autocorrection for words with fixed candidates, and autopeek command range in a floating window.
...
* [nvim-mini/mini.nvim#mini.sessions](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for session management (read, write, delete).
* [rmagatti/auto-session](https://github.com/rmagatti/auto-session) ⭐ 1,811 | 🐛 24 | 🌐 Lua | 📅 2026-04-15 - A small automated session manager.
...
* [esensar/nvim-dev-container](https://github.com/esensar/nvim-dev-container) ⭐ 713 | 🐛 10 | 🌐 Lua | 📅 2026-02-13 - Provide functionality similar to VSCode's [remote container development](https://code.visualstudio.com/docs/remote/containers) plugin, with other functionalities that enable development in Docker containers.
* [nosduco/remote-sshfs.nvim](https://github.com/nosduco/remote-sshfs.nvim) ⭐ 397 | 🐛 18 | 🌐 Lua | 📅 2026-04-05 - Explore, edit, and develop on a remote machine via SSHFS.
...
* [azratul/live-share.nvim](https://github.com/azratul/live-share.nvim) ⭐ 245 | 🐛 0 | 🌐 Lua | 📅 2026-04-14 - Provides remote collaboration capabilities from anywhere, making it ideal for pair-programming scenarios.
...
* [SUSTech-data/neopyter](https://github.com/SUSTech-data/neopyter) ⭐ 164 | 🐛 5 | 🌐 Lua | 📅 2026-04-19 - Edit in Neovim and preview/run in Jupyter Lab.
...
* [nvim-mini/mini.nvim#mini.bufremove](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,624 | 🐛 14 | 🌐 Lua | 📅 2026-04-17 - Smart, seamless, directional navigation and resizing of splits.
...
* [nvim-zh/colorful-winsep.nvim](https://github.com/nvim-zh/colorful-winsep.nvim) ⭐ 673 | 🐛 1 | 🌐 Lua | 📅 2026-04-18 - A configurable color split line.
...
* [aserowy/tmux.nvim](https://github.com/aserowy/tmux.nvim) ⭐ 792 | 🐛 15 | 🌐 Lua | 📅 2026-04-13 - Tmux integration features pane movement and resizing.
...
* [kawre/leetcode.nvim](https://github.com/kawre/leetcode.nvim) ⭐ 2,044 | 🐛 60 | 🌐 Lua | 📅 2025-09-21 - Solve Leetcode problems.
...
* [barrettruth/cp.nvim](https://github.com/barrettruth/cp.nvim) ⭐ 9 | 🐛 0 | 🌐 Lua | 📅 2026-04-06 - Competitive programming workflow for popular contest platforms (CodeForces, CSES, etc.) Includes automatic test scraping, I/O view, and diff panel.
...
* [gisketch/triforce.nvim](https://github.com/gisketch/triforce.nvim) ⭐ 288 | 🐛 4 | 🌐 Lua | 📅 2026-04-19 - Gamified stat tracker with XP, levels, achievements, and activity heatmaps for your coding sessions with lualine integration.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 60 | 🐛 6 | 🌐 Go | 📅 2026-04-20 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [kndndrj/nvim-dbee](https://github.com/kndndrj/nvim-dbee) ⭐ 1,256 | 🐛 76 | 🌐 Go | 📅 2025-07-25 - Interactive database client.
...
* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 30,274 | 🐛 20 | 🌐 Lua | 📅 2026-04-19 - A launch point for your personal Neovim configuration.
* [siduck76/NvChad](https://github.com/siduck76/NvChad) ⭐ 28,097 | 🐛 2 | 🌐 Lua | 📅 2026-04-13 - An attempt to make Neovim's CLI as functional as an IDE while retaining beauty with less bloat.
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 25,961 | 🐛 49 | 🌐 Lua | 📅 2026-04-02 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
...
* [AstroNvim/AstroNvim](https://github.com/AstroNvim/AstroNvim) ⭐ 14,255 | 🐛 1 | 🌐 Lua | 📅 2026-04-07 - An aesthetic and feature-rich config that is extensible and easy to use with a great set of plugins.
...
* [dam9000/kickstart-modular.nvim](https://github.com/dam9000/kickstart-modular.nvim) ⭐ 974 | 🐛 0 | 🌐 Lua | 📅 2026-04-18 - This is a fork of nvim-lua/kickstart.nvim that moves from a single file to a multi file configuration.
...
* [nvim-mini/MiniMax](https://github.com/nvim-mini/MiniMax) ⭐ 395 | 🐛 3 | 🌐 Lua | 📅 2026-04-18 - A collection of self-contained and extensively commented configurations which mostly use MINI tools.
...
* [MordechaiHadad/bob](https://github.com/MordechaiHadad/bob) ⭐ 2,080 | 🐛 31 | 🌐 Rust | 📅 2026-03-24 - A cross-platform, easy to use Neovim version manager.
...
* [y3owk1n/nvs](https://github.com/y3owk1n/nvs) ⭐ 32 | 🐛 0 | 🌐 Go | 📅 2026-04-19 - Another Neovim version manager with config switcher.
...
* [iamironz/android-nvim-plugin](https://github.com/iamironz/android-nvim-plugin) ⭐ 62 | 🐛 1 | 🌐 Lua | 📅 2026-03-25 - Android build, deploy, and logcat commands with Gradle integration.
* [m15a/flake-awesome-neovim-plugins](https://github.com/m15a/flake-awesome-neovim-plugins) ⭐ 62 | 🐛 0 | 🌐 Nix | 📅 2026-04-19 - Nix flake that provides a collection of `awesome-neovim` plugins as Nix packages.
...
* [nvim-mini/mini.nvim#mini.notify](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) ⭐ 9,035 | 🐛 35 | 🌐 Lua | 📅 2026-04-17 - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.
* [folke/noice.nvim](https://github.com/folke/noice.nvim) ⭐ 5,701 | 🐛 33 | 🌐 Lua | 📅 2025-11-03 - Highly experimental plugin that completely replaces the UI for messages, cmdline and the popupmenu.
* [rcarriga/nvim-notify](https://github.com/rcarriga/nvim-notify) ⭐ 3,547 | 🐛 78 | 🌐 Lua | 📅 2025-09-06 - A fancy, configurable, notification manager.
