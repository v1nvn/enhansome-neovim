...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 20,704 | 🐛 57 | 🌐 Lua | 📅 2025-12-17 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [nvim-mini/mini.nvim#mini.deps](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.
* [lumen-oss/rocks.nvim](https://github.com/lumen-oss/rocks.nvim) ⭐ 1,016 | 🐛 57 | 🌐 Lua | 📅 2026-04-10 - A modern approach to plugin management using LuaRocks, inspired by Cargo.
...
* [zuqini/zpack.nvim](https://github.com/zuqini/zpack.nvim) ⭐ 103 | 🐛 1 | 🌐 Lua | 📅 2026-04-11 - A thin layer on top of `vim.pack` to support lazy-loading and `lazy.nvim`'s declarative spec.
...
* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,521 | 🐛 34 | 🌐 Lua | 📅 2026-04-10 - Quickstart configurations for the LSP client.

<!--lint enable awesome-spell-check-->

* [nvimdev/lspsaga.nvim](https://github.com/nvimdev/lspsaga.nvim) ⭐ 3,775 | 🐛 99 | 🌐 Lua | 📅 2026-03-03 - A light-weight LSP plugin based on the built-in LSP with a highly performant UI.
...
* [j-hui/fidget.nvim](https://github.com/j-hui/fidget.nvim) ⭐ 2,503 | 🐛 21 | 🌐 Lua | 📅 2026-04-01 - Standalone UI for LSP progress.
...
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 989 | 🐛 11 | 🌐 Lua | 📅 2026-04-12 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,710 | 🐛 98 | 🌐 JavaScript | 📅 2026-04-12 catalog.
...
* [nvimtools/none-ls.nvim](https://github.com/nvimtools/none-ls.nvim) ⭐ 3,223 | 🐛 13 | 🌐 Lua | 📅 2026-04-11 - Null-ls.nvim reloaded / Use Neovim as a language server to inject LSP diagnostics, code actions, and more via Lua.
* [mrcjkb/rustaceanvim](https://github.com/mrcjkb/rustaceanvim) ⭐ 2,918 | 🐛 18 | 🌐 Lua | 📅 2026-04-12 - A heavily modified fork of rust-tools.nvim that does not require a `setup` call and does not depend on nvim-lspconfig.
* [rachartier/tiny-inline-diagnostic.nvim](https://github.com/rachartier/tiny-inline-diagnostic.nvim) ⭐ 1,637 | 🐛 0 | 🌐 Lua | 📅 2026-04-05 - Display prettier diagnostic messages. Display one line diagnostic messages where the cursor is, with icons and colors.
...
* [mrcjkb/haskell-tools.nvim](https://github.com/mrcjkb/haskell-tools.nvim) ⭐ 589 | 🐛 23 | 🌐 Lua | 📅 2026-04-12 - Seamless integration for Haskell development tools like `haskell-language-server` and Hoogle.
...
* [rachartier/tiny-code-action.nvim](https://github.com/rachartier/tiny-code-action.nvim) ⭐ 472 | 🐛 0 | 🌐 Lua | 📅 2026-04-11 - Provides a simple way to run and visualize code actions with Telescope.
...
* [mason-org/mason.nvim](https://github.com/mason-org/mason.nvim) ⭐ 10,189 | 🐛 273 | 🌐 Lua | 📅 2026-04-06 - Portable package manager that runs everywhere Neovim runs. Easily install and manage LSP servers, DAP servers, linters, and formatters.
...
* [hrsh7th/nvim-cmp](https://github.com/hrsh7th/nvim-cmp) ⭐ 9,388 | 🐛 301 | 🌐 Lua | 📅 2026-03-25 - Completion engine written in Lua, successor of `nvim-compe`.
...
* [nvim-mini/mini.nvim#mini.completion](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 6,145 | 🐛 106 | 🌐 Lua | 📅 2026-04-08 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [moyiz/blink-emoji.nvim](https://github.com/moyiz/blink-emoji.nvim) ⭐ 74 | 🐛 1 | 🌐 Lua | 📅 2026-04-11 - `blink.cmp` source for GitHub Markdown emojis.
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 11 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 44,396 | 🐛 85 | 🌐 C | 📅 2026-04-05.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 4,047 | 🐛 14 | 🌐 Lua | 📅 2026-04-11 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,530 | 🐛 57 | 🌐 Vim Script | 📅 2026-01-09.
...
* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 17,753 | 🐛 63 | 🌐 Lua | 📅 2026-03-30 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,438 | 🐛 9 | 🌐 Lua | 📅 2026-04-11 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
...
* [CopilotC-Nvim/CopilotChat.nvim](https://github.com/CopilotC-Nvim/CopilotChat.nvim) ⭐ 3,616 | 🐛 24 | 🌐 Lua | 📅 2026-04-06 - A chat interface for GitHub Copilot that allows you to directly ask and receive answers to coding-related questions.
* [nickjvandyke/opencode.nvim](https://github.com/nickjvandyke/opencode.nvim) ⭐ 3,157 | 🐛 9 | 🌐 Lua | 📅 2026-04-09 - OpenCode AI assistant integration.
...
* [milanglacier/minuet-ai.nvim](https://github.com/milanglacier/minuet-ai.nvim) ⭐ 1,091 | 🐛 13 | 🌐 Lua | 📅 2026-04-06 - Minuet offers code completion from LLM providers including OpenAI (compatible), Gemini, Claude, Ollama, Deepseek and more providers, with support for nvim-cmp, blink.cmp and virtual-text frontend.
...
* [carlos-algms/agentic.nvim](https://github.com/carlos-algms/agentic.nvim) ⭐ 395 | 🐛 11 | 🌐 Lua | 📅 2026-04-11 - Chat interface for AI ACP providers such as Claude, Gemini, Codex, OpenCode and Cursor.
...
* [milanglacier/yarepl.nvim#aider-extensions](https://github.com/milanglacier/yarepl.nvim/blob/main/extensions/README.md) ⭐ 248 | 🐛 2 | 🌐 Lua | 📅 2026-04-11 - Integration with [aider-chat](https://aider.chat), a TUI AI coding assistant.
* [cursortab/cursortab.nvim](https://github.com/cursortab/cursortab.nvim) ⭐ 154 | 🐛 10 | 🌐 Go | 📅 2026-04-10 - Edit completions and cursor predictions with multiple AI providers.
...
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 8 | 🐛 4 | 🌐 Lua | 📅 2026-04-05 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 11,591 | 🐛 582 | 🌐 Python | 📅 2026-04-07 tool.
...
* [nvim-java/nvim-java](https://github.com/nvim-java/nvim-java) ⭐ 1,612 | 🐛 35 | 🌐 Lua | 📅 2026-02-05 - Everything you need for a painless Java experience.
...
* [chomosuke/typst-preview.nvim](https://github.com/chomosuke/typst-preview.nvim) ⭐ 891 | 🐛 10 | 🌐 Lua | 📅 2026-03-30 - Preview Typst documents in the browser, instant update on each keystroke, and cross jump between code and preview.
...
* [Julian/lean.nvim](https://github.com/Julian/lean.nvim) ⭐ 505 | 🐛 36 | 🌐 Lua | 📅 2026-04-12 - Support for the [Lean Theorem Prover](https://leanprover.github.io/).
...
* [atomicptr/defold.nvim](https://github.com/atomicptr/defold.nvim) ⭐ 25 | 🐛 8 | 🌐 Rust | 📅 2026-04-09 - Batteries-included development environment for the Defold game engine.
...
* [iamcco/markdown-preview.nvim](https://github.com/iamcco/markdown-preview.nvim) ⭐ 7,799 | 🐛 261 | 🌐 JavaScript | 📅 2024-07-23 - Preview Markdown on your modern browser with synchronised scrolling and flexible configuration.
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 4,386 | 🐛 5 | 🌐 Lua | 📅 2026-04-08 - Improve viewing Markdown files directly.
* [OXY2DEV/markview.nvim](https://github.com/OXY2DEV/markview.nvim) ⭐ 3,416 | 🐛 4 | 🌐 Lua | 📅 2026-03-20 - A hackable Markdown, Typst, LaTeX, HTML (inline) and YAML renderer.
...
* [YousefHadder/markdown-plus.nvim](https://github.com/YousefHadder/markdown-plus.nvim) ⭐ 232 | 🐛 4 | 🌐 Lua | 📅 2026-04-09 - Provides a full editing experience for Markdown files which includes support for lists, links, TOC, and more with simple and fast keymaps.
...
* [rogue-87/inlyne.nvim](https://github.com/rogue-87/inlyne.nvim) ⭐ 3 | 🐛 0 | 🌐 Lua | 📅 2026-03-28 - Wrapper for [inlyne](https://github.com/Inlyne-Project/inlyne) ⭐ 1,287 | 🐛 63 | 🌐 Rust | 📅 2026-03-30 Markdown viewer.
...
* [nvim-mini/mini.nvim#mini.surround](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-surround.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for working with text surroundings (add, delete, replace, find, highlight). Supports dot-repeat, different search methods, "last"/"next" extended mappings, Tree-sitter integration, and more.
* [kylechui/nvim-surround](https://github.com/kylechui/nvim-surround) ⭐ 4,168 | 🐛 8 | 🌐 Lua | 📅 2026-04-05 - A plugin for adding/changing/deleting surrounding delimiter pairs.
* [nvim-treesitter/nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects) ⭐ 2,731 | 🐛 113 | 🌐 Tree-sitter Query | 📅 2026-04-07 - Create your own textobjects using Tree-sitter queries.
...
* [romus204/tree-sitter-manager.nvim](https://github.com/romus204/tree-sitter-manager.nvim) ⭐ 195 | 🐛 7 | 🌐 Tree-sitter Query | 📅 2026-04-10 - A lightweight Tree-sitter parser manager for Neovim 0.12+ to replace the archived `nvim-treesitter` plugin.
* [IndianBoy42/tree-sitter-just](https://github.com/IndianBoy42/tree-sitter-just) ⭐ 186 | 🐛 5 | 🌐 Just | 📅 2026-03-25 - Tree-sitter grammar for [Justfiles](https://github.com/casey/just) ⭐ 32,813 | 🐛 306 | 🌐 Rust | 📅 2026-04-11.
...
* [nvim-mini/mini.nvim#mini.snippets](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.
* [L3MON4D3/LuaSnip](https://github.com/L3MON4D3/LuaSnip) ⭐ 4,317 | 🐛 129 | 🌐 Lua | 📅 2026-04-05 - A snippet engine written in Lua.
* [rafamadriz/friendly-snippets](https://github.com/rafamadriz/friendly-snippets) ⭐ 2,690 | 🐛 72 | 🌐 Lua | 📅 2026-01-23 - Set of preconfigured snippets for different languages.
...
* [ThePrimeagen/harpoon](https://github.com/ThePrimeagen/harpoon/tree/harpoon2) ⭐ 9,012 | 🐛 149 | 🌐 Lua | 📅 2025-10-31 - A per project, auto updating and editable marks utility for fast file navigation.
...
* [chrisgrieser/nvim-rip-substitute](https://github.com/chrisgrieser/nvim-rip-substitute) ⭐ 309 | 🐛 1 | 🌐 Lua | 📅 2026-04-11 - Search and replace in the current buffer or workspace with incremental preview, a convenient UI, and modern regex syntax.
...
* [nvim-telescope/telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) ⭐ 19,291 | 🐛 460 | 🌐 Lua | 📅 2026-04-11 - Telescope.nvim is a highly [extendable](https://github.com/nvim-telescope/telescope.nvim/wiki/Extensions) ⭐ 19,291 | 🐛 460 | 🌐 Lua | 📅 2026-04-11 A highly extensible fuzzy finder over lists.
* [nvim-mini/mini.nvim#mini.fuzzy](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
* [nvim-mini/mini.nvim#mini.pick](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
* [nvim-mini/mini.nvim#mini.extra](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.
* [folke/snacks.nvim#picker](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) ⭐ 7,413 | 🐛 114 | 🌐 Lua | 📅 2026-03-21 - A modern fuzzy-finder to navigate the Neovim universe.
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 4,466 | 🐛 47 | 🌐 Rust | 📅 2026-04-10 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,187 | 🐛 13 | 🌐 Lua | 📅 2026-04-10 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,745 | 🐛 20 | 🌐 Rust | 📅 2026-04-11 as its fzf binary.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 367 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 35,517 | 🐛 160 | 🌐 Rust | 📅 2026-03-23, a smart directory picker that tracks your usage.
...
* [nvim-mini/mini.nvim#mini.files](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.
* [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) ⭐ 8,452 | 🐛 93 | 🌐 Lua | 📅 2026-04-07 - A simple and fast file explorer tree.
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,442 | 🐛 133 | 🌐 Lua | 📅 2026-02-24 - Edit your filesystem like a buffer.
* [nvim-neo-tree/neo-tree.nvim](https://github.com/nvim-neo-tree/neo-tree.nvim) ⭐ 5,362 | 🐛 169 | 🌐 Lua | 📅 2026-04-11 - Browse the file system and other tree-like structures in whatever style suits you, including sidebars, floating windows, `netrw` split style, or all of them at once.
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,689 | 🐛 93 | 🌐 Python | 📅 2026-04-12 - File manager. Better than NERDTree.
* [mikavilpas/yazi.nvim](https://github.com/mikavilpas/yazi.nvim) ⭐ 1,649 | 🐛 12 | 🌐 Lua | 📅 2026-04-11 - Integration with the Yazi terminal file manager.
...
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 460 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,471 | 🐛 1 | 🌐 C | 📅 2026-04-11 and Lua.
...
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 98 | 🐛 2 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 36,290 | 🐛 67 | 🌐 Rust | 📅 2026-04-11).
...
* [nvim-mini/mini.nvim#mini.visits](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.
...
* [nvim-mini/mini.nvim#mini.hipatterns](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.
...
* [xzbdmw/colorful-menu.nvim](https://github.com/xzbdmw/colorful-menu.nvim) ⭐ 465 | 🐛 4 | 🌐 Lua | 📅 2025-11-25 - Colorize your auto completion menu using Tree-sitter.
...
* [folke/tokyonight.nvim](https://github.com/folke/tokyonight.nvim) ⭐ 7,950 | 🐛 15 | 🌐 Lua | 📅 2026-03-24 - ***`[TS][LSP][L/D][Lua]`*** A clean, dark and light theme written in Lua, with support for LSP, Tree-sitter and lots of plugins.
* [sainnhe/everforest](https://github.com/sainnhe/everforest) ⭐ 3,946 | 🐛 8 | 🌐 Vim Script | 📅 2026-01-21 - ***`[TS][LSP][L/D]`*** A green based colorscheme designed to be warm, soft and easy on the eyes.
* [sainnhe/gruvbox-material](https://github.com/sainnhe/gruvbox-material) ⭐ 2,531 | 🐛 8 | 🌐 Vim Script | 📅 2026-04-03 - ***`[TS][LSP]`*** Gruvbox modification with softer contrast and Tree-sitter support.
* [projekt0n/github-nvim-theme](https://github.com/projekt0n/github-nvim-theme) ⭐ 2,449 | 🐛 28 | 🌐 Lua | 📅 2024-12-31 - ***`[TS][LSP][L/D][Lua]`*** A GitHub theme, kitty, alacritty written in Lua. Support built-in LSP and Tree-sitter.
* [navarasu/onedark.nvim](https://github.com/navarasu/onedark.nvim) ⭐ 1,952 | 🐛 55 | 🌐 Lua | 📅 2025-11-24 - ***`[TS][LSP][Lua]`*** A One Dark Theme written in Lua based on Atom's One Dark Theme.
...
* [Mofiqul/vscode.nvim](https://github.com/Mofiqul/vscode.nvim) ⭐ 963 | 🐛 50 | 🌐 Lua | 📅 2025-12-03 - ***`[TS][L/D][Lua]`*** A Lua port of vim-code-dark colorscheme with VSCode light and dark theme.
...
* [everviolet/nvim](https://github.com/everviolet/nvim) ⭐ 632 | 🐛 0 | 🌐 Lua | 📅 2026-03-31 - ***`[TS][LSP][L/D][Lua]`*** A comfy colorscheme for cozy morning coding.
...
* [ThorstenRhau/token](https://github.com/ThorstenRhau/token) ⭐ 138 | 🐛 0 | 🌐 Emacs Lisp | 📅 2026-04-11 - ***`[TS][LSP][L/D][Lua]`*** Token has warm tones and careful contrast, with full Tree-sitter and LSP integration.
...
* [rose-pine/neovim](https://github.com/rose-pine/neovim) ⭐ 2,992 | 🐛 5 | 🌐 Lua | 📅 2026-04-09 - ***`[TS][LSP][L/D][Lua]`*** All natural pine, faux fur and a bit of soho vibes for the classy minimalist.

<!--lint enable awesome-spell-check-->

* [nvim-mini/mini.nvim#colorschemes](https://github.com/nvim-mini/mini.nvim#plugin-color-schemes) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - ***`[TS][LSP][L/D][Lua]`*** Color schemes included in `mini.nvim`. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.
* [catppuccin/nvim](https://github.com/catppuccin/nvim) ⭐ 7,333 | 🐛 10 | 🌐 Lua | 📅 2026-04-06 - ***`[TS][LSP][L/D][Lua]`*** Warm mid-tone dark theme to show off your vibrant self! With support for native LSP, Tree-sitter, and more.
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 6,062 | 🐛 91 | 🌐 Lua | 📅 2025-10-15 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
* [EdenEast/nightfox.nvim](https://github.com/EdenEast/nightfox.nvim) ⭐ 3,960 | 🐛 35 | 🌐 Lua | 📅 2025-02-09 - ***`[TS][LSP][L/D][Lua]`*** A soft dark, fully customizable colorscheme with support for LSP, Tree-sitter and a variety of plugins.
...
* [olimorris/onedarkpro.nvim](https://github.com/olimorris/onedarkpro.nvim) ⭐ 1,050 | 🐛 0 | 🌐 Lua | 📅 2026-04-11 - ***`[TS][L/D][Lua]`*** Atom's iconic One Dark theme. Cacheable, fully customisable, Tree-sitter and LSP semantic token support. Comes with light and dark variants.
...
* [miikanissi/modus-themes.nvim](https://github.com/miikanissi/modus-themes.nvim) ⭐ 418 | 🐛 4 | 🌐 Lua | 📅 2026-03-22 - ***`[TS][LSP][L/D][Lua]`*** Accessible theme, conforming with the highest standard for color contrast (WCAG AAA).
...
* [thesimonho/kanagawa-paper.nvim](https://github.com/thesimonho/kanagawa-paper.nvim) ⭐ 370 | 🐛 2 | 🌐 Lua | 📅 2026-03-16 - ***`[TS][LSP][L/D][Lua]`*** Remixed light and dark Kanagawa colourschemes with muted colors.
...
* [ptdewey/darkearth-nvim](https://github.com/ptdewey/darkearth-nvim) ⭐ 82 | 🐛 0 | 🌐 Fennel | 📅 2026-03-19 - ***`[TS][LSP][Fnl]`*** A dark and earthy colorscheme supporting Tree-sitter and LSP.
...
* [jpwol/thorn.nvim](https://github.com/jpwol/thorn.nvim) ⭐ 76 | 🐛 0 | 🌐 Lua | 📅 2026-04-09 - ***`[TS][LSP][L/D][Lua]`*** A rich green theme with dark and light options. Supports LSP, transparency, many plugins, and more.
...
* [hyperb1iss/silkcircuit](https://github.com/hyperb1iss/silkcircuit) ⭐ 43 | 🐛 2 | 🌐 Lua | 📅 2026-04-10 - ***`[TS][LSP][L/D][Lua]`*** Vibrant cyberpunk color system with five variants, 40+ plugin integrations, WCAG AA compliant. Supports multiple editors, terminals and CLI tools.
...
* [nvim-mini/mini.nvim#mini.base16](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
* [nvim-mini/mini.nvim#mini.colors](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
* [nvim-mini/mini.nvim#mini.hues](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.
...
* [luukvbaal/statuscol.nvim](https://github.com/luukvbaal/statuscol.nvim) ⭐ 605 | 🐛 9 | 🌐 Lua | 📅 2025-06-02 - Configurable 'statuscolumn' with built-in segments and click handlers.
...
* [nvim-mini/mini.nvim#mini.statusline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.
* [nvim-lualine/lualine.nvim](https://github.com/nvim-lualine/lualine.nvim) ⭐ 7,872 | 🐛 267 | 🌐 Lua | 📅 2026-04-12 - Easily configurable, blazingly fast statusline.
...
* [ojroques/nvim-hardline](https://github.com/ojroques/nvim-hardline) ⭐ 202 | 🐛 2 | 🌐 Lua | 📅 2023-12-27 - A statusline / bufferline inspired by [vim-airline](https://github.com/vim-airline/vim-airline) ⭐ 17,951 | 🐛 54 | 🌐 Vim Script | 📅 2026-03-11 that aims to be as light and simple as possible.
...
* [nvim-mini/mini.nvim#mini.tabline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.
* [akinsho/bufferline.nvim](https://github.com/akinsho/bufferline.nvim) ⭐ 4,291 | 🐛 100 | 🌐 Lua | 📅 2025-01-14 - A snazzy bufferline built using Lua.
...
* [nvim-mini/mini.nvim#mini.cursorword](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).
...
* [nvim-mini/mini.nvim#mini.starter](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.
...
* [goolord/alpha-nvim](https://github.com/goolord/alpha-nvim) ⭐ 2,356 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - A fast and highly customizable greeter like [vim-startify](https://github.com/mhinz/vim-startify) ⭐ 5,396 | 🐛 80 | 🌐 Vim Script | 📅 2024-01-05/dashboard-nvim.
...
* [nvim-mini/mini.nvim#mini.icons](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-icons.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` meant as a general icon provider. Uses fixed set of highlight groups. Supports various categories, icon and style customizations, caching for performance. Integrates with built-in filetype matching.
* [nvim-tree/nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons) ⭐ 2,647 | 🐛 18 | 🌐 Lua | 📅 2026-04-09 - A Lua fork of [vim-devicons](https://github.com/ryanoasis/vim-devicons) ⭐ 5,802 | 🐛 70 | 🌐 Vim Script | 📅 2024-05-09.
...
* [HakonHarnes/img-clip.nvim](https://github.com/HakonHarnes/img-clip.nvim) ⭐ 897 | 🐛 9 | 🌐 Lua | 📅 2025-12-19 - Effortlessly embed images into any markup language, like LaTeX, Markdown or Typst.
* [vyfor/cord.nvim](https://github.com/vyfor/cord.nvim) ⭐ 590 | 🐛 0 | 🌐 Lua | 📅 2026-02-17 - Highly extensible Rich Presence for Discord.
...
* [davidgranstrom/scnvim](https://github.com/davidgranstrom/scnvim) ⭐ 259 | 🐛 25 | 🌐 Lua | 📅 2025-10-02 - A frontend for SuperCollider.
...
* [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ⭐ 7,261 | 🐛 211 | 🌐 Lua | 📅 2026-04-09 - Modernity meets insane extensibility. The future of organizing your life.
* [nvim-orgmode/orgmode](https://github.com/nvim-orgmode/orgmode) ⭐ 3,715 | 🐛 141 | 🌐 Lua | 📅 2026-04-01 - Org-mode clone written in Lua.
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 1,762 | 🐛 69 | 🌐 Lua | 📅 2026-04-11 - Plugin for Obsidian, written in Lua.
...
* [josephburgess/nvumi](https://github.com/josephburgess/nvumi) ⭐ 68 | 🐛 1 | 🌐 Lua | 📅 2026-04-09 - Natural language calculator in a scratch buffer.
...
* [zeybek/camouflage.nvim](https://github.com/zeybek/camouflage.nvim) ⭐ 40 | 🐛 1 | 🌐 Lua | 📅 2026-02-14 - Hide sensitive values in configuration files during screen sharing by visually masking secrets in `.env`, `.json`, `.yaml`, `.toml`, and `.properties` files.
...
* [AlejandroSuero/freeze-code.nvim](https://github.com/AlejandroSuero/freeze-code.nvim) ⭐ 31 | 🐛 2 | 🌐 Lua | 📅 2025-03-15 - Code screenshot plugin that makes use of [freeze](https://github.com/charmbracelet/freeze) ⭐ 4,446 | 🐛 68 | 🌐 Go | 📅 2026-04-06 inside the editor.
...
* [hat0uma/csvview.nvim](https://github.com/hat0uma/csvview.nvim) ⭐ 598 | 🐛 16 | 🌐 Lua | 📅 2026-02-14 - An asynchronous CSV/TSV table viewer with real-time updates, configurable comments and delimiters, and multiple display modes.
...
* [theKnightsOfRohan/csvlens.nvim](https://github.com/theKnightsOfRohan/csvlens.nvim) ⭐ 39 | 🐛 1 | 🌐 Lua | 📅 2024-04-28 - A port of [YS-L/csvlens](https://github.com/YS-L/csvlens) ⭐ 3,706 | 🐛 59 | 🌐 Rust | 📅 2026-03-29, for easy previewing of tabular data.
...
* [nvim-mini/mini.nvim#mini.animate](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).
* [sphamba/smear-cursor.nvim](https://github.com/sphamba/smear-cursor.nvim) ⭐ 1,768 | 🐛 7 | 🌐 Lua | 📅 2025-12-01 - Animate the cursor with a smear effect in all terminals. Inspired by Neovide's animated cursor.
...
* [akinsho/toggleterm.nvim](https://github.com/akinsho/toggleterm.nvim) ⭐ 5,454 | 🐛 89 | 🌐 Lua | 📅 2025-03-09 - Easily manage multiple terminal windows.
* [kassio/neoterm](https://github.com/kassio/neoterm) ⭐ 1,337 | 🐛 31 | 🌐 Vim Script | 📅 2023-03-09 - Wrapper of some `:terminal` functions.
* [mikesmithgh/kitty-scrollback.nvim](https://github.com/mikesmithgh/kitty-scrollback.nvim) ⭐ 847 | 🐛 26 | 🌐 Lua | 📅 2026-03-22 - Open your kitty scrollback buffer. Ameowzing.
...
* [mfussenegger/nvim-dap](https://github.com/mfussenegger/nvim-dap) ⭐ 7,064 | 🐛 30 | 🌐 Lua | 📅 2026-04-06 - Debug Adapter Protocol client implementation.
...
* [igorlfs/nvim-dap-view](https://github.com/igorlfs/nvim-dap-view) ⭐ 824 | 🐛 11 | 🌐 Lua | 📅 2026-04-11 - A modern, minimalistic UI for nvim-dap.
...
* [stevearc/quicker.nvim](https://github.com/stevearc/quicker.nvim) ⭐ 951 | 🐛 19 | 🌐 Lua | 📅 2026-03-10 - Improved quickfix UI and editable quickfix buffer.
* [yorickpeterse/nvim-pqf](https://github.com/yorickpeterse/nvim-pqf) ⭐ 181 | 🐛 1 | 🌐 Lua | 📅 2024-08-12 - Prettier quickfix/location list windows.
...
* [nvim-neotest/neotest](https://github.com/nvim-neotest/neotest) ⭐ 3,063 | 🐛 95 | 🌐 Lua | 📅 2026-04-01 - An extensible framework for interacting with tests within Neovim.
...
* [milanglacier/yarepl.nvim](https://github.com/milanglacier/yarepl.nvim) ⭐ 248 | 🐛 2 | 🌐 Lua | 📅 2026-04-11 - Yet Another REPL, flexible, supporting multiple paradigms to interact with REPLs, and native dot repeat without other dependencies.
...
* [nvim-mini/mini.nvim#mini.doc](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
* [nvim-mini/mini.nvim#mini.test](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` with framework for writing extensive Neovim plugin tests with support for hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.
* [nvim-lua/plenary.nvim](https://github.com/nvim-lua/plenary.nvim) ⭐ 3,435 | 🐛 154 | 🌐 Lua | 📅 2026-04-10 - Plenary: full; complete; entire; absolute; unqualified. All the Lua functions I don't want to write twice.
...
* [lumen-oss/lz.n](https://github.com/lumen-oss/lz.n) ⭐ 264 | 🐛 2 | 🌐 Lua | 📅 2026-04-12 - A simple lazy loading library for Neovim plugins.
...
* [BirdeeHub/lze](https://github.com/BirdeeHub/lze) ⭐ 121 | 🐛 1 | 🌐 Lua | 📅 2026-04-12 - A lazy-loading library for Neovim plugins.
* [jrop/morph.nvim](https://github.com/jrop/morph.nvim) ⭐ 110 | 🐛 0 | 🌐 Lua | 📅 2026-04-11 - A React-like renderer for building interactive buffers/TUIs.
...
* [lumen-oss/luarocks-tag-release](https://github.com/lumen-oss/luarocks-tag-release) ⭐ 56 | 🐛 10 | 🌐 Lua | 📅 2026-04-11 - A GitHub action that publishes your Neovim plugins to LuaRocks.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2025-05-23 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 21,937 | 🐛 17 | 🌐 Go | 📅 2026-03-20 or compatible encryption tools for cryptographic safety.
...
* [rktjmp/hotpot.nvim](https://github.com/rktjmp/hotpot.nvim) ⭐ 391 | 🐛 0 | 🌐 Fennel | 📅 2026-04-08 - Seamless, transparent Fennel inside Neovim.
...
* [vuki656/package-info.nvim](https://github.com/vuki656/package-info.nvim) ⭐ 591 | 🐛 27 | 🌐 Lua | 📅 2025-12-27 - Display latest package version as virtual text in package.json.
...
* [nvim-mini/mini.nvim#mini.diff](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
* [nvim-mini/mini.nvim#mini.git](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for enhanced Git integration with current Neovim process that implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.
* [lewis6991/gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) ⭐ 6,718 | 🐛 31 | 🌐 Lua | 📅 2026-04-08 - Git integration: signs, hunk actions, blame, etc.
* [sindrets/diffview.nvim](https://github.com/sindrets/diffview.nvim) ⭐ 5,490 | 🐛 132 | 🌐 Lua | 📅 2024-08-02 - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev.
...
* [kdheepak/lazygit.nvim](https://github.com/kdheepak/lazygit.nvim) ⭐ 2,243 | 🐛 51 | 🌐 Lua | 📅 2025-12-19 - Plugin for calling lazygit.
* [esmuellert/codediff.nvim](https://github.com/esmuellert/codediff.nvim) ⭐ 1,268 | 🐛 72 | 🌐 Lua | 📅 2026-03-31 - Side-by-side diff with two-tier highlighting (line + character level) using VSCode's algorithm implemented in C.
...
* [moyiz/git-dev.nvim](https://github.com/moyiz/git-dev.nvim) ⭐ 109 | 🐛 3 | 🌐 Lua | 📅 2026-04-11 - Open remote Git repositories while editing.
...
* [Kohei-Wada/yadm-git.nvim](https://github.com/Kohei-Wada/yadm-git.nvim) ⭐ 8 | 🐛 0 | 🌐 Lua | 📅 2026-04-11 - Seamless Git plugin support for yadm dotfiles.
...
* [pwntester/octo.nvim](https://github.com/pwntester/octo.nvim) ⭐ 3,227 | 🐛 232 | 🌐 Lua | 📅 2026-04-09 - Work with GitHub issues and PRs.
...
* [nvim-mini/mini.nvim#mini.jump](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for smarter jumping to a single character.
* [nvim-mini/mini.nvim#mini.jump2d](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
* [nvim-mini/mini.nvim#mini.bracketed](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` to go forward/backward with square brackets.
...
* [chrisgrieser/nvim-spider](https://github.com/chrisgrieser/nvim-spider) ⭐ 861 | 🐛 0 | 🌐 Lua | 📅 2026-04-03 - Use the w, e, b motions like a spider. Considers camelCase and skips insignificant punctuation.
...
* [nvim-mini/mini.nvim#mini.clue](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
* [nvim-mini/mini.nvim#mini.keymap](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).
...
* [mawkler/demicolon.nvim](https://github.com/mawkler/demicolon.nvim) ⭐ 127 | 🐛 1 | 🌐 Lua | 📅 2026-01-25 - Use `;` and `,` keys to also repeat jumps to diagnostics (e.g. `]d`) and to [nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects?tab=readme-ov-file#text-objects-move) ⭐ 2,731 | 🐛 113 | 🌐 Tree-sitter Query | 📅 2026-04-07 (e.g. `]f`), in addition to repeating `t`/`T`/`f`/`F`.
...
* [notomo/gesture.nvim](https://github.com/notomo/gesture.nvim) ⭐ 539 | 🐛 0 | 🌐 Lua | 📅 2026-04-12 - Mouse gesture plugin.
...
* [karb94/neoscroll.nvim](https://github.com/karb94/neoscroll.nvim) ⭐ 2,003 | 🐛 11 | 🌐 Lua | 📅 2025-12-31 - Smooth scrolling.
...
* [nvim-mini/mini.nvim#mini.map](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.
...
* [nvim-mini/mini.nvim#mini.pairs](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
* [nvim-mini/mini.nvim#mini.trailspace](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
* [nvim-mini/mini.nvim#mini.operators](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
* [nvim-mini/mini.nvim#mini.move](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
* [nvim-mini/mini.nvim#mini.ai](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some built-in textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
* [nvim-mini/mini.nvim#mini.splitjoin](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
* [nvim-mini/mini.nvim#mini.basics](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.
* [windwp/nvim-autopairs](https://github.com/windwp/nvim-autopairs) ⭐ 3,989 | 🐛 15 | 🌐 Lua | 📅 2026-01-30 - A minimalist autopairs written by Lua.
...
* [jake-stewart/multicursor.nvim](https://github.com/jake-stewart/multicursor.nvim) ⭐ 1,448 | 🐛 0 | 🌐 Lua | 📅 2026-03-24 - Adds support for multiple cursors which work how you expect.
...
* [shortcuts/no-neck-pain.nvim](https://github.com/shortcuts/no-neck-pain.nvim) ⭐ 931 | 🐛 16 | 🌐 Lua | 📅 2026-04-11 - Center the currently focused buffer to the middle of your terminal.
* [HiPhish/rainbow-delimiters.nvim](https://github.com/HiPhish/rainbow-delimiters.nvim) ⭐ 855 | 🐛 24 | 🌐 Lua | 📅 2026-04-06 - Rainbow delimiters with Tree-sitter.
...
* [chrisgrieser/nvim-various-textobjs](https://github.com/chrisgrieser/nvim-various-textobjs) ⭐ 761 | 🐛 0 | 🌐 Lua | 📅 2026-04-03 - Bundle of more than 30 new text objects.
...
* [XXiaoA/atone.nvim](https://github.com/XXiaoA/atone.nvim) ⭐ 166 | 🐛 4 | 🌐 Lua | 📅 2026-04-11 - Undo tree for visualizing and managing undo history.
...
* [zhisme/copy\_with\_context.nvim](https://github.com/zhisme/copy_with_context.nvim) ⭐ 32 | 🐛 4 | 🌐 Lua | 📅 2026-01-29 - Copy lines with file path and line number metadata for sharing code snippets with context.
...
* [nvim-mini/mini.nvim#mini.comment](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.
...
* [kevinhwang91/nvim-ufo](https://github.com/kevinhwang91/nvim-ufo) ⭐ 2,903 | 🐛 45 | 🌐 Lua | 📅 2026-01-11 - Ultra fold with modern looking and performance boosting.
...
* [nvim-mini/mini.nvim#mini.align](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for aligning text interactively (with or without instant preview).
* [stevearc/conform.nvim](https://github.com/stevearc/conform.nvim) ⭐ 5,043 | 🐛 92 | 🌐 Lua | 📅 2026-03-10 - A lightweight formatting engine that plays nice with LSP.
...
* [nvim-mini/mini.nvim#mini.indentscope](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.
* [lukas-reineke/indent-blankline.nvim](https://github.com/lukas-reineke/indent-blankline.nvim) ⭐ 4,904 | 🐛 24 | 🌐 Lua | 📅 2026-02-17 - IndentLine replacement in Lua with more features and Tree-sitter support.
...
* [nvim-mini/mini.nvim#mini.cmdline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cmdline.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for command line tweaks. Adds autocompletion with customizable delay, autocorrection for words with fixed candidates, and autopeek command range in a floating window.
...
* [nvim-mini/mini.nvim#mini.sessions](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for session management (read, write, delete).
* [rmagatti/auto-session](https://github.com/rmagatti/auto-session) ⭐ 1,805 | 🐛 18 | 🌐 Lua | 📅 2026-02-15 - A small automated session manager.
...
* [esensar/nvim-dev-container](https://github.com/esensar/nvim-dev-container) ⭐ 711 | 🐛 10 | 🌐 Lua | 📅 2026-02-13 - Provide functionality similar to VSCode's [remote container development](https://code.visualstudio.com/docs/remote/containers) plugin, with other functionalities that enable development in Docker containers.
...
* [brianhuster/live-preview.nvim](https://github.com/brianhuster/live-preview.nvim) ⭐ 373 | 🐛 25 | 🌐 Lua | 📅 2026-04-12 - Live preview HTML, Markdown and Asciidoc in the browser.
...
* [nvim-mini/mini.nvim#mini.bufremove](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.
...
* [nvim-zh/colorful-winsep.nvim](https://github.com/nvim-zh/colorful-winsep.nvim) ⭐ 670 | 🐛 1 | 🌐 Lua | 📅 2026-02-19 - A configurable color split line.
...
* [aserowy/tmux.nvim](https://github.com/aserowy/tmux.nvim) ⭐ 786 | 🐛 18 | 🌐 Lua | 📅 2026-04-11 - Tmux integration features pane movement and resizing.
...
* [m4xshen/hardtime.nvim](https://github.com/m4xshen/hardtime.nvim) ⭐ 3,739 | 🐛 13 | 🌐 Lua | 📅 2025-09-13 - Helping you establish good command workflow and habit.
...
* [emrearmagan/atlas.nvim](https://github.com/emrearmagan/atlas.nvim) ⭐ 16 | 🐛 1 | 🌐 Lua | 📅 2026-04-11 - Manage Bitbucket PRs and Jira issues.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 57 | 🐛 6 | 🌐 Go | 📅 2026-04-12 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 30,168 | 🐛 20 | 🌐 Lua | 📅 2026-03-31 - A launch point for your personal Neovim configuration.
* [siduck76/NvChad](https://github.com/siduck76/NvChad) ⭐ 28,078 | 🐛 2 | 🌐 Lua | 📅 2026-02-07 - An attempt to make Neovim's CLI as functional as an IDE while retaining beauty with less bloat.
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 25,826 | 🐛 48 | 🌐 Lua | 📅 2026-04-02 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
...
* [AstroNvim/AstroNvim](https://github.com/AstroNvim/AstroNvim) ⭐ 14,237 | 🐛 1 | 🌐 Lua | 📅 2026-04-07 - An aesthetic and feature-rich config that is extensible and easy to use with a great set of plugins.
...
* [dam9000/kickstart-modular.nvim](https://github.com/dam9000/kickstart-modular.nvim) ⭐ 969 | 🐛 0 | 🌐 Lua | 📅 2026-04-03 - This is a fork of nvim-lua/kickstart.nvim that moves from a single file to a multi file configuration.
...
* [nvim-mini/MiniMax](https://github.com/nvim-mini/MiniMax) ⭐ 385 | 🐛 2 | 🌐 Lua | 📅 2026-04-11 - A collection of self-contained and extensively commented configurations which mostly use MINI tools.
...
* [y3owk1n/nvs](https://github.com/y3owk1n/nvs) ⭐ 31 | 🐛 0 | 🌐 Go | 📅 2026-04-11 - Another Neovim version manager with config switcher.
...
* [m15a/flake-awesome-neovim-plugins](https://github.com/m15a/flake-awesome-neovim-plugins) ⭐ 62 | 🐛 0 | 🌐 Nix | 📅 2026-04-11 - Nix flake that provides a collection of `awesome-neovim` plugins as Nix packages.
...
* [nvim-mini/mini.nvim#mini.notify](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) ⭐ 8,987 | 🐛 37 | 🌐 Lua | 📅 2026-04-11 - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.
* [folke/noice.nvim](https://github.com/folke/noice.nvim) ⭐ 5,687 | 🐛 31 | 🌐 Lua | 📅 2025-11-03 - Highly experimental plugin that completely replaces the UI for messages, cmdline and the popupmenu.
* [rcarriga/nvim-notify](https://github.com/rcarriga/nvim-notify) ⭐ 3,544 | 🐛 77 | 🌐 Lua | 📅 2025-09-06 - A fancy, configurable, notification manager.
