...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 20,246 | 🐛 50 | 🌐 Lua | 📅 2025-12-17 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [nvim-mini/mini.nvim#mini.deps](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.
* [lumen-oss/rocks.nvim](https://github.com/lumen-oss/rocks.nvim) ⭐ 1,005 | 🐛 55 | 🌐 Lua | 📅 2026-02-08 - A modern approach to plugin management using Luarocks, inspired by Cargo.
* [alex-popov-tech/store.nvim](https://github.com/alex-popov-tech/store.nvim) ⭐ 317 | 🐛 0 | 🌐 Lua | 📅 2026-02-03 - Plugins discovery tool with hourly updated database, and one-key installation for `lazy.nvim` and `vim.pack`.
...
* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,342 | 🐛 34 | 🌐 Lua | 📅 2026-02-12 - Quickstart configurations for the LSP client.

<!--lint enable awesome-spell-check-->

* [nvimdev/lspsaga.nvim](https://github.com/nvimdev/lspsaga.nvim) ⭐ 3,745 | 🐛 99 | 🌐 Lua | 📅 2025-06-25 - A light-weight LSP plugin based on the built-in LSP with a highly performant UI.
* [mfussenegger/nvim-lint](https://github.com/mfussenegger/nvim-lint) ⭐ 2,640 | 🐛 44 | 🌐 Lua | 📅 2026-01-31 - An asynchronous linter plugin, complementary to the built-in Language Server Protocol support.
...
* [stevearc/aerial.nvim](https://github.com/stevearc/aerial.nvim) ⭐ 2,215 | 🐛 74 | 🌐 Lua | 📅 2026-01-18 - A code outline window for skimming and quick navigation.
...
* [rmagatti/goto-preview](https://github.com/rmagatti/goto-preview) ⭐ 1,023 | 🐛 10 | 🌐 Lua | 📅 2025-12-26 - Previewing native LSP's goto definition calls in floating windows.
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 971 | 🐛 11 | 🌐 Lua | 📅 2026-02-12 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,643 | 🐛 102 | 🌐 JavaScript | 📅 2026-02-14 catalog.
...
* [rachartier/tiny-inline-diagnostic.nvim](https://github.com/rachartier/tiny-inline-diagnostic.nvim) ⭐ 1,568 | 🐛 0 | 🌐 Lua | 📅 2026-01-17 - Display prettier diagnostic messages. Display one line diagnostic messages where the cursor is, with icons and colors.
...
* [jmbuhr/otter.nvim](https://github.com/jmbuhr/otter.nvim) ⭐ 836 | 🐛 17 | 🌐 Lua | 📅 2026-02-13 - Provides LSP features and a nvim-cmp completion source for languages embedded in other documents.
...
* [mrcjkb/haskell-tools.nvim](https://github.com/mrcjkb/haskell-tools.nvim) ⭐ 570 | 🐛 22 | 🌐 Lua | 📅 2026-02-09 - Seamless integration for Haskell development tools like `haskell-language-server` and Hoogle.
...
* [soulis-1256/eagle.nvim](https://github.com/soulis-1256/eagle.nvim) ⭐ 342 | 🐛 0 | 🌐 Lua | 📅 2026-02-09 - Mouse-hover LSP hints.
...
* [mason-org/mason.nvim](https://github.com/mason-org/mason.nvim) ⭐ 10,028 | 🐛 267 | 🌐 Lua | 📅 2026-01-07 - Portable package manager that runs everywhere Neovim runs. Easily install and manage LSP servers, DAP servers, linters, and formatters.

### Diagnostics

* [folke/trouble.nvim](https://github.com/folke/trouble.nvim) ⭐ 6,669 | 🐛 17 | 🌐 Lua | 📅 2025-10-31 - A pretty diagnostics list to help you solve all the trouble your code is causing.
...
* [hrsh7th/nvim-cmp](https://github.com/hrsh7th/nvim-cmp) ⭐ 9,323 | 🐛 298 | 🌐 Lua | 📅 2026-01-23 - Completion engine written in Lua, successor of `nvim-compe`.
  ...
  * [hrsh7th/cmp-path](https://github.com/hrsh7th/cmp-path) ⭐ 684 | 🐛 38 | 🌐 Lua | 📅 2025-07-30 - `nvim-cmp` source for filesystem paths.
  ...
  * [hrsh7th/cmp-buffer](https://github.com/hrsh7th/cmp-buffer) ⭐ 666 | 🐛 37 | 🌐 Lua | 📅 2025-04-01 - `nvim-cmp` source for buffer words.
...
* [nvim-mini/mini.nvim#mini.completion](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 5,929 | 🐛 140 | 🌐 Lua | 📅 2026-02-13 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [mikavilpas/blink-ripgrep.nvim](https://github.com/mikavilpas/blink-ripgrep.nvim) ⭐ 111 | 🐛 2 | 🌐 Lua | 📅 2026-02-14 - `blink.cmp` source for `ripgrep` / `git grep`.
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 10 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 41,741 | 🐛 40 | 🌐 C | 📅 2026-02-12.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 3,958 | 🐛 33 | 🌐 Lua | 📅 2026-02-14 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,353 | 🐛 46 | 🌐 Vim Script | 📅 2026-01-09.
* [ms-jpq/coq\_nvim](https://github.com/ms-jpq/coq_nvim) ⭐ 3,774 | 🐛 186 | 🌐 Python | 📅 2026-01-06 - Fast as FUCK completion. SQLite, concurrent scheduler, hundreds of hours of optimization.
...
* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 17,363 | 🐛 70 | 🌐 Lua | 📅 2026-02-03 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,135 | 🐛 22 | 🌐 Lua | 📅 2026-02-14 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
...
* [CopilotC-Nvim/CopilotChat.nvim](https://github.com/CopilotC-Nvim/CopilotChat.nvim) ⭐ 3,556 | 🐛 19 | 🌐 Lua | 📅 2026-02-12 - A chat interface for GitHub Copilot that allows you to directly ask and receive answers to coding-related questions.
* [nickjvandyke/opencode.nvim](https://github.com/nickjvandyke/opencode.nvim) ⭐ 2,521 | 🐛 19 | 🌐 Lua | 📅 2026-02-13 - OpenCode AI assistant integration.
...
* [milanglacier/minuet-ai.nvim](https://github.com/milanglacier/minuet-ai.nvim) ⭐ 1,007 | 🐛 14 | 🌐 Lua | 📅 2026-02-03 - Minuet offers code completion from LLM providers including OpenAI (compatible), Gemini, Claude, Ollama, Deepseek and more providers, with support for nvim-cmp, blink.cmp and virtual-text frontend.
* [Davidyz/VectorCode](https://github.com/davidyz/vectorcode) ⭐ 797 | 🐛 14 | 🌐 Python | 📅 2025-12-26 - Supercharge your LLM experience with repository-level RAG.
...
* [Kurama622/llm.nvim](https://github.com/Kurama622/llm.nvim) ⭐ 458 | 🐛 3 | 🌐 Lua | 📅 2026-02-13 - Free large language model (LLM) support, provides commands to interact with LLM.
...
* [kiddos/gemini.nvim](https://github.com/kiddos/gemini.nvim) ⭐ 242 | 🐛 9 | 🌐 Lua | 📅 2025-11-29 - Bindings to Google Gemini API.
* [carlos-algms/agentic.nvim](https://github.com/carlos-algms/agentic.nvim) ⭐ 199 | 🐛 9 | 🌐 Lua | 📅 2026-02-11 - Chat interface for AI ACP providers such as Claude, Gemini, Codex, OpenCode and Cursor.
...
* [Flemma-Dev/flemma.nvim](https://github.com/Flemma-Dev/flemma.nvim) ⭐ 38 | 🐛 0 | 🌐 Lua | 📅 2026-02-13 - A first-class AI workspace.
...
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 8 | 🐛 4 | 🌐 Lua | 📅 2025-12-31 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 11,129 | 🐛 557 | 🌐 Python | 📅 2026-02-07 tool.
...
* [chomosuke/typst-preview.nvim](https://github.com/chomosuke/typst-preview.nvim) ⭐ 829 | 🐛 13 | 🌐 Lua | 📅 2025-12-31 - Preview Typst documents in the browser, instant update on each keystroke, and cross jump between code and preview.
...
* [Julian/lean.nvim](https://github.com/Julian/lean.nvim) ⭐ 476 | 🐛 32 | 🌐 Lua | 📅 2026-02-06 - Support for the [Lean Theorem Prover](https://leanprover.github.io/).
...
* [leblocks/hopcsharp.nvim](https://github.com/leblocks/hopcsharp.nvim) ⭐ 11 | 🐛 10 | 🌐 Lua | 📅 2026-02-13 - Provides LSP-less navigation and type-hierarchy information in C# repositories.
...
* [mistweaverco/kulala.nvim](https://github.com/mistweaverco/kulala.nvim) ⭐ 1,893 | 🐛 11 | 🌐 Lua | 📅 2026-02-11 - A minimal HTTP-client interface.
...
* [iamcco/markdown-preview.nvim](https://github.com/iamcco/markdown-preview.nvim) ⭐ 7,690 | 🐛 257 | 🌐 JavaScript | 📅 2024-07-23 - Preview Markdown on your modern browser with synchronised scrolling and flexible configuration.
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 4,116 | 🐛 9 | 🌐 Lua | 📅 2026-02-03 - Improve viewing Markdown files directly.
* [OXY2DEV/markview.nvim](https://github.com/OXY2DEV/markview.nvim) ⭐ 3,265 | 🐛 3 | 🌐 Lua | 📅 2026-02-02 - A hackable Markdown, Typst, LaTeX, HTML (inline) and YAML renderer.
...
* [Zeioth/markmap.nvim](https://github.com/Zeioth/markmap.nvim) ⭐ 235 | 🐛 2 | 🌐 Lua | 📅 2025-11-11 - Visualize your Markdown as mindmaps.
...
* [Prgebish/sigil.nvim](https://github.com/Prgebish/sigil.nvim) ⭐ 23 | 🐛 0 | 🌐 Lua | 📅 2026-02-13 - Implementation of Emacs' `prettify-symbols-mode` to visually replace text patterns with Unicode symbols while editing LaTeX and Typst files.
...
* [nvim-treesitter/nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter) ⭐ 13,256 | 🐛 268 | 🌐 Tree-sitter Query | 📅 2026-02-11 - Tree-sitter configurations and abstraction layer.
* [nvim-mini/mini.nvim#mini.surround](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-surround.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for working with text surroundings (add, delete, replace, find, highlight). Supports dot-repeat, different search methods, "last"/"next" extended mappings, Tree-sitter integration, and more.
...
* [nvim-treesitter/nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects) ⭐ 2,662 | 🐛 109 | 🌐 Tree-sitter Query | 📅 2026-01-28 - Create your own textobjects using Tree-sitter queries.
...
* [IndianBoy42/tree-sitter-just](https://github.com/IndianBoy42/tree-sitter-just) ⭐ 179 | 🐛 4 | 🌐 Just | 📅 2026-02-09 - Tree-sitter grammar for [Justfiles](https://github.com/casey/just) ⭐ 31,245 | 🐛 387 | 🌐 Rust | 📅 2026-02-11.
...
* [MeanderingProgrammer/treesitter-modules.nvim](https://github.com/MeanderingProgrammer/treesitter-modules.nvim) ⭐ 148 | 🐛 0 | 🌐 Lua | 📅 2026-02-05 - Original modules from nvim-treesitter master branch.
...
* [nvim-mini/mini.nvim#mini.snippets](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.
* [L3MON4D3/LuaSnip](https://github.com/L3MON4D3/LuaSnip) ⭐ 4,271 | 🐛 128 | 🌐 Lua | 📅 2026-01-19 - A snippet engine written in Lua.
* [rafamadriz/friendly-snippets](https://github.com/rafamadriz/friendly-snippets) ⭐ 2,645 | 🐛 66 | 🌐 Lua | 📅 2026-01-23 - Set of preconfigured snippets for different languages.
...
* [dcampos/nvim-snippy](https://github.com/dcampos/nvim-snippy) ⭐ 340 | 🐛 8 | 🌐 Lua | 📅 2025-09-21 - Snippet plugin written in Lua with support for [vim-snippets](https://github.com/honza/vim-snippets) ⭐ 4,872 | 🐛 85 | 🌐 Vim Snippet | 📅 2025-10-28.
...
* [ThePrimeagen/harpoon](https://github.com/ThePrimeagen/harpoon/tree/harpoon2) ⭐ 8,892 | 🐛 150 | 🌐 Lua | 📅 2025-10-31 - A per project, auto updating and editable marks utility for fast file navigation.
...
* [MagicDuck/grug-far.nvim](https://github.com/MagicDuck/grug-far.nvim) ⭐ 1,765 | 🐛 3 | 🌐 Lua | 📅 2026-02-02 - Buffer-based live search and replace with full power of `rg` flags. Grug like!
...
* [2KAbhishek/seeker.nvim](https://github.com/2KAbhishek/seeker.nvim) ⭐ 119 | 🐛 2 | 🌐 Lua | 📅 2026-02-13 - Progressive file seeker built on top of `snacks.nvim`.
...
* [nvim-telescope/telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) ⭐ 19,042 | 🐛 484 | 🌐 Lua | 📅 2026-02-03 - Telescope.nvim is a highly [extendable](https://github.com/nvim-telescope/telescope.nvim/wiki/Extensions) ⭐ 19,042 | 🐛 484 | 🌐 Lua | 📅 2026-02-03 A highly extensible fuzzy finder over lists.
* [nvim-mini/mini.nvim#mini.fuzzy](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
* [nvim-mini/mini.nvim#mini.pick](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
* [nvim-mini/mini.nvim#mini.extra](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.
* [folke/snacks.nvim#picker](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) ⭐ 7,054 | 🐛 91 | 🌐 Lua | 📅 2025-11-18 - A modern fuzzy-finder to navigate the Neovim universe.
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,062 | 🐛 9 | 🌐 Lua | 📅 2026-02-12 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,554 | 🐛 26 | 🌐 Rust | 📅 2026-02-13 as its fzf binary.
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 1,302 | 🐛 49 | 🌐 Rust | 📅 2026-02-14 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 367 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 33,360 | 🐛 152 | 🌐 Rust | 📅 2026-02-07, a smart directory picker that tracks your usage.
...
* [nvim-mini/mini.nvim#mini.files](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.
* [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) ⭐ 8,368 | 🐛 100 | 🌐 Lua | 📅 2026-02-14 - A simple and fast file explorer tree.
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,242 | 🐛 122 | 🌐 Lua | 📅 2026-01-17 - Edit your filesystem like a buffer.
* [nvim-neo-tree/neo-tree.nvim](https://github.com/nvim-neo-tree/neo-tree.nvim) ⭐ 5,223 | 🐛 168 | 🌐 Lua | 📅 2026-02-13 - Browse the file system and other tree-like structures in whatever style suits you, including sidebars, floating windows, `netrw` split style, or all of them at once.
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,684 | 🐛 93 | 🌐 Python | 📅 2026-02-14 - File manager. Better than NERDTree.
* [mikavilpas/yazi.nvim](https://github.com/mikavilpas/yazi.nvim) ⭐ 1,544 | 🐛 10 | 🌐 Lua | 📅 2026-02-13 - Integration with the Yazi terminal file manager.
* [kevinhwang91/rnvimr](https://github.com/kevinhwang91/rnvimr) ⭐ 841 | 🐛 10 | 🌐 Python | 📅 2026-01-11 - A simple yet amazing file explorer.
* [A7Lavinraj/fyler.nvim](https://github.com/A7Lavinraj/fyler.nvim) ⭐ 661 | 🐛 20 | 🌐 Lua | 📅 2026-02-10 - File manager which can edit file system like a buffer with tree view.
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 450 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,232 | 🐛 1 | 🌐 C | 📅 2026-02-14 and Lua.
...
* [kelly-lin/ranger.nvim](https://github.com/kelly-lin/ranger.nvim) ⭐ 179 | 🐛 11 | 🌐 Lua | 📅 2024-11-18 - [Ranger](https://github.com/ranger/ranger) ⭐ 16,863 | 🐛 926 | 🌐 Python | 📅 2026-01-22 integration.
* [Xuyuanp/yanil](https://github.com/Xuyuanp/yanil) ⭐ 98 | 🐛 5 | 🌐 Lua | 📅 2026-01-15 - Yet Another Nerdtree In Lua.
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 97 | 🐛 2 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 32,578 | 🐛 64 | 🌐 Rust | 📅 2026-02-13).
...
* [nvim-mini/mini.nvim#mini.visits](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.
...
* [DrKJeff16/project.nvim](https://github.com/DrKJeff16/project.nvim) ⭐ 134 | 🐛 1 | 🌐 Lua | 📅 2026-02-13 - Project manager with project root detection, documented code and lots of improvements, including `snacks.nvim`, `fzf-lua` and `picker.nvim` support.
...
* [mrjones2014/codesettings.nvim](https://github.com/mrjones2014/codesettings.nvim) ⭐ 50 | 🐛 0 | 🌐 Lua | 📅 2026-02-14 - Easily load project-local settings (like `.vscode/settings.json`) into Neovim 0.11+ native LSP settings.
...
* [TheLazyCat00/workspaces-nvim](https://github.com/TheLazyCat00/workspaces-nvim) ⭐ 3 | 🐛 0 | 🌐 Lua | 📅 2026-02-12 - Pin files to specific keys within a project workspace, giving you quick access to your most important files.
...
* [nvim-mini/mini.nvim#mini.hipatterns](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.
...
* [folke/tokyonight.nvim](https://github.com/folke/tokyonight.nvim) ⭐ 7,807 | 🐛 16 | 🌐 Lua | 📅 2025-11-05 - ***`[TS][LSP][L/D][Lua]`*** A clean, dark and light theme written in Lua, with support for LSP, Tree-sitter and lots of plugins.
...
* [sainnhe/gruvbox-material](https://github.com/sainnhe/gruvbox-material) ⭐ 2,486 | 🐛 8 | 🌐 Vim Script | 📅 2026-01-21 - ***`[TS][LSP]`*** Gruvbox modification with softer contrast and Tree-sitter support.
* [projekt0n/github-nvim-theme](https://github.com/projekt0n/github-nvim-theme) ⭐ 2,419 | 🐛 26 | 🌐 Lua | 📅 2024-12-31 - ***`[TS][LSP][L/D][Lua]`*** A GitHub theme, kitty, alacritty written in Lua. Support built-in LSP and Tree-sitter.
* [navarasu/onedark.nvim](https://github.com/navarasu/onedark.nvim) ⭐ 1,916 | 🐛 55 | 🌐 Lua | 📅 2025-11-24 - ***`[TS][LSP][Lua]`*** A One Dark Theme written in Lua based on Atom's One Dark Theme.
...
* [marko-cerovac/material.nvim](https://github.com/marko-cerovac/material.nvim) ⭐ 1,070 | 🐛 6 | 🌐 Lua | 📅 2026-01-05 - ***`[TS][LSP][L/D][Lua]`*** Material.nvim is a highly configurable colorscheme written in Lua and based on the material palette.
...
* [Mofiqul/vscode.nvim](https://github.com/Mofiqul/vscode.nvim) ⭐ 944 | 🐛 51 | 🌐 Lua | 📅 2025-12-03 - ***`[TS][L/D][Lua]`*** A Lua port of vim-code-dark colorscheme with VSCode light and dark theme.
...
* [everviolet/nvim](https://github.com/everviolet/nvim) ⭐ 578 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - ***`[TS][LSP][L/D][Lua]`*** A comfy colorscheme for cozy morning coding.
* [neanias/everforest-nvim](https://github.com/neanias/everforest-nvim) ⭐ 418 | 🐛 7 | 🌐 Lua | 📅 2025-11-02 - ***`[TS][LSP][L/D][Lua]`*** A Lua port of the Everforest colour scheme.
...
* [rockerBOO/boo-colorscheme-nvim](https://github.com/rockerBOO/boo-colorscheme-nvim) ⭐ 238 | 🐛 3 | 🌐 Lua | 📅 2026-02-10 - ***`[TS][Lua]`*** A colorscheme with handcrafted support for LSP, Tree-sitter.
...
* [ofirgall/ofirkai.nvim](https://github.com/ofirgall/ofirkai.nvim) ⭐ 136 | 🐛 14 | 🌐 Lua | 📅 2026-02-13 - ***`[TS][LSP][Lua]`*** Monokai theme that aims to feel like Sublime Text.
...
* [yonatan-perel/lake-dweller.nvim](https://github.com/yonatan-perel/lake-dweller.nvim) ⭐ 11 | 🐛 0 | 🌐 Lua | 📅 2026-02-04 - ***`[TS][LSP][Lua]`*** Dark and opinionated with selective highlighting aiming to be readable at a glance.
...
* [nvim-mini/mini.nvim#colorschemes](https://github.com/nvim-mini/mini.nvim#plugin-color-schemes) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - ***`[TS][LSP][L/D][Lua]`*** Color schemes included in `mini.nvim`. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.
* [catppuccin/nvim](https://github.com/catppuccin/nvim) ⭐ 7,196 | 🐛 15 | 🌐 Lua | 📅 2026-02-02 - ***`[TS][LSP][L/D][Lua]`*** Warm mid-tone dark theme to show off your vibrant self! With support for native LSP, Tree-sitter, and more.
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 5,906 | 🐛 90 | 🌐 Lua | 📅 2025-10-15 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
* [EdenEast/nightfox.nvim](https://github.com/EdenEast/nightfox.nvim) ⭐ 3,896 | 🐛 36 | 🌐 Lua | 📅 2025-02-09 - ***`[TS][LSP][L/D][Lua]`*** A soft dark, fully customizable colorscheme with support for LSP, Tree-sitter and a variety of plugins.
* [ellisonleao/gruvbox.nvim](https://github.com/ellisonleao/gruvbox.nvim) ⭐ 2,464 | 🐛 27 | 🌐 Lua | 📅 2026-01-13 - ***`[TS][LSP][L/D][Lua]`*** Gruvbox community colorscheme Lua port.
* [scottmckendry/cyberdream.nvim](https://github.com/scottmckendry/cyberdream.nvim) ⭐ 1,255 | 🐛 5 | 🌐 Lua | 📅 2026-01-27 - ***`[TS][L/D][Lua]`*** A high-contrast, futuristic and vibrant coloursheme.
...
* [olimorris/onedarkpro.nvim](https://github.com/olimorris/onedarkpro.nvim) ⭐ 1,026 | 🐛 0 | 🌐 Lua | 📅 2026-01-15 - ***`[TS][L/D][Lua]`*** Atom's iconic One Dark theme. Cacheable, fully customisable, Tree-sitter and LSP semantic token support. Comes with light and dark variants.
...
* [miikanissi/modus-themes.nvim](https://github.com/miikanissi/modus-themes.nvim) ⭐ 402 | 🐛 5 | 🌐 Lua | 📅 2025-10-05 - ***`[TS][LSP][L/D][Lua]`*** Accessible theme, conforming with the highest standard for color contrast (WCAG AAA).
...
* [Mofiqul/adwaita.nvim](https://github.com/Mofiqul/adwaita.nvim) ⭐ 281 | 🐛 13 | 🌐 Lua | 📅 2026-01-07 - ***`[TS][LSP][L/D][Lua]`*** Colorscheme based on GNOME Adwaita syntax with support for popular plugins.
...
* [Verf/deepwhite.nvim](https://github.com/Verf/deepwhite.nvim) ⭐ 155 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - ***`[TS][LSP][Lua]`*** A light colorscheme inspired by [flatwhite-syntax](https://github.com/biletskyy/flatwhite-syntax) ⭐ 187 | 🐛 15 | 🌐 CSS | 📅 2020-04-27 and [elegant-emacs](https://github.com/rougier/elegant-emacs) ⭐ 1,427 | 🐛 9 | 🌐 Emacs Lisp | 📅 2021-11-22.
...
* [bakageddy/alduin.nvim](https://github.com/bakageddy/alduin.nvim) ⭐ 17 | 🐛 0 | 🌐 Lua | 📅 2024-01-27 - ***`[TS][LSP][Lua]`*** A port of [alduin](https://github.com/AlessandroYorba/alduin) ⭐ 477 | 🐛 9 | 🌐 Vim script | 📅 2022-08-31 theme to Lua with Tree-sitter and semantic highlights support.
...
* [nvim-mini/mini.nvim#mini.base16](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
* [nvim-mini/mini.nvim#mini.colors](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
* [nvim-mini/mini.nvim#mini.hues](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.
...
* [OXY2DEV/bars.nvim](https://github.com/OXY2DEV/bars.nvim) ⭐ 91 | 🐛 1 | 🌐 Lua | 📅 2026-02-14 - A starting point/guide for creating custom statusline, statuscolumn, tabline and winbar.
...
* [nvim-mini/mini.nvim#mini.statusline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.
* [nvim-lualine/lualine.nvim](https://github.com/nvim-lualine/lualine.nvim) ⭐ 7,733 | 🐛 265 | 🌐 Lua | 📅 2025-11-23 - Easily configurable, blazingly fast statusline.
* [rebelot/heirline.nvim](https://github.com/rebelot/heirline.nvim) ⭐ 1,241 | 🐛 28 | 🌐 Lua | 📅 2025-05-23 - A no-nonsense statusline designed around recursive inheritance to be exceptionally fast and versatile.
* [b0o/incline.nvim](https://github.com/b0o/incline.nvim) ⭐ 1,009 | 🐛 9 | 🌐 Lua | 📅 2025-12-18 - Lightweight floating statuslines, intended for use with Neovim's new global statusline.
...
* [ojroques/nvim-hardline](https://github.com/ojroques/nvim-hardline) ⭐ 200 | 🐛 2 | 🌐 Lua | 📅 2023-12-27 - A statusline / bufferline inspired by [vim-airline](https://github.com/vim-airline/vim-airline) ⭐ 17,937 | 🐛 50 | 🌐 Vim Script | 📅 2025-12-23 that aims to be as light and simple as possible.
...
* [nvim-mini/mini.nvim#mini.tabline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.
...
* [romgrk/barbar.nvim](https://github.com/romgrk/barbar.nvim) ⭐ 2,646 | 🐛 32 | 🌐 Lua | 📅 2025-12-02 - A tabline with re-orderable, auto-sizing, clickable tabs, icons, nice highlighting, sort-by commands and a magic jump-to-buffer mode.
...
* [nvim-mini/mini.nvim#mini.cursorword](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).
...
* [nvim-mini/mini.nvim#mini.starter](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.
* [nvimdev/dashboard-nvim](https://github.com/nvimdev/dashboard-nvim) ⭐ 2,775 | 🐛 73 | 🌐 Lua | 📅 2025-08-31 - A minimalist dashboard, inspired by doom-emacs.
...
* [3rd/image.nvim](https://github.com/3rd/image.nvim) ⭐ 1,871 | 🐛 57 | 🌐 Lua | 📅 2025-09-07 - Add image support through Kitty's graphics protocol or ueberzugpp.
...
* [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ⭐ 7,213 | 🐛 219 | 🌐 Lua | 📅 2026-02-01 - Modernity meets insane extensibility. The future of organizing your life.
...
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 1,531 | 🐛 70 | 🌐 Lua | 📅 2026-02-13 - Plugin for Obsidian, written in Lua.
...
* [niuiic/todo.nvim](https://github.com/niuiic/todo.nvim) ⭐ 17 | 🐛 0 | 🌐 Lua | 📅 2024-11-05 - Simple but powerful TODO manager based on text.
...
* [ymich9963/mdnotes.nvim](https://github.com/ymich9963/mdnotes.nvim) ⭐ 6 | 🐛 3 | 🌐 Lua | 📅 2026-02-13 - Simple and improved Markdown note taking.
...
* [AlejandroSuero/freeze-code.nvim](https://github.com/AlejandroSuero/freeze-code.nvim) ⭐ 31 | 🐛 2 | 🌐 Lua | 📅 2025-03-15 - Code screenshot plugin that makes use of [freeze](https://github.com/charmbracelet/freeze) ⭐ 4,338 | 🐛 67 | 🌐 Go | 📅 2026-02-09 inside the editor.
...
* [theKnightsOfRohan/csvlens.nvim](https://github.com/theKnightsOfRohan/csvlens.nvim) ⭐ 39 | 🐛 1 | 🌐 Lua | 📅 2024-04-28 - A port of [YS-L/csvlens](https://github.com/YS-L/csvlens) ⭐ 3,451 | 🐛 53 | 🌐 Rust | 📅 2026-02-02, for easy previewing of tabular data.
...
* [nvim-mini/mini.nvim#mini.animate](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).
* [sphamba/smear-cursor.nvim](https://github.com/sphamba/smear-cursor.nvim) ⭐ 1,661 | 🐛 6 | 🌐 Lua | 📅 2025-12-01 - Animate the cursor with a smear effect in all terminals. Inspired by Neovide's animated cursor.
...
* [akinsho/toggleterm.nvim](https://github.com/akinsho/toggleterm.nvim) ⭐ 5,366 | 🐛 84 | 🌐 Lua | 📅 2025-03-09 - Easily manage multiple terminal windows.
* [kassio/neoterm](https://github.com/kassio/neoterm) ⭐ 1,337 | 🐛 31 | 🌐 Vim Script | 📅 2023-03-09 - Wrapper of some `:terminal` functions.
* [mikesmithgh/kitty-scrollback.nvim](https://github.com/mikesmithgh/kitty-scrollback.nvim) ⭐ 818 | 🐛 29 | 🌐 Lua | 📅 2026-01-21 - Open your Kitty scrollback buffer. Ameowzing.
...
* [TheLazyCat00/runner-nvim](https://github.com/TheLazyCat00/runner-nvim) ⭐ 3 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - Run commands in a floating terminal and keep track of the last command executed per CWD, making it easy to repeat build or test commands.
...
* [mfussenegger/nvim-dap](https://github.com/mfussenegger/nvim-dap) ⭐ 6,939 | 🐛 29 | 🌐 Lua | 📅 2026-02-11 - Debug Adapter Protocol client implementation.
* [rcarriga/nvim-dap-ui](https://github.com/rcarriga/nvim-dap-ui) ⭐ 3,278 | 🐛 107 | 🌐 Lua | 📅 2025-07-09 - A UI for nvim-dap.
* [theHamsta/nvim-dap-virtual-text](https://github.com/theHamsta/nvim-dap-virtual-text) ⭐ 1,052 | 🐛 10 | 🌐 Lua | 📅 2025-05-25 - Virtual text support for nvim-dap.
...
* [nvim-neotest/neotest](https://github.com/nvim-neotest/neotest) ⭐ 3,018 | 🐛 105 | 🌐 Lua | 📅 2025-11-08 - An extensible framework for interacting with tests within Neovim.
...
* [Vigemus/iron.nvim](https://github.com/Vigemus/iron.nvim) ⭐ 1,297 | 🐛 57 | 🌐 Lua | 📅 2026-01-05 - Interactive REPLs of over 30 languages embedded.
* [benlubas/molten-nvim](https://github.com/benlubas/molten-nvim) ⭐ 1,104 | 🐛 39 | 🌐 Python | 📅 2025-11-05 - Enables running code chunks via the Jupyter kernel. Output (including image output) is rendered in a floating window below the code.
...
* [al1-ce/just.nvim](https://github.com/al1-ce/just.nvim) ⭐ 45 | 🐛 7 | 🌐 Lua | 📅 2025-12-29 - Task runner for justfiles.
...
* [nvim-mini/mini.nvim#mini.doc](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
* [nvim-mini/mini.nvim#mini.test](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` with framework for writing extensive Neovim plugin tests with support for hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.
* [nvim-lua/plenary.nvim](https://github.com/nvim-lua/plenary.nvim) ⭐ 3,381 | 🐛 156 | 🌐 Lua | 📅 2025-07-26 - Plenary: full; complete; entire; absolute; unqualified. All the Lua functions I don't want to write twice.
* [MunifTanjim/nui.nvim](https://github.com/MunifTanjim/nui.nvim) ⭐ 2,024 | 🐛 30 | 🌐 Lua | 📅 2025-06-08 - UI Component Library.
* [folke/lazydev.nvim](https://github.com/folke/lazydev.nvim) ⭐ 1,448 | 🐛 6 | 🌐 Lua | 📅 2025-11-06 - Faster LuaLS setup.
...
* [DrKJeff16/wezterm-types](https://github.com/DrKJeff16/wezterm-types) ⭐ 152 | 🐛 2 | 🌐 Lua | 📅 2026-02-14 - WezTerm config type annotations for Lua Language Server.
...
* [jrop/morph.nvim](https://github.com/jrop/morph.nvim) ⭐ 98 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - A React-like renderer for building interactive buffers/TUIs.
...
* [lumen-oss/luarocks-tag-release](https://github.com/lumen-oss/luarocks-tag-release) ⭐ 55 | 🐛 10 | 🌐 Lua | 📅 2026-02-13 - A GitHub action that publishes your Neovim plugins to LuaRocks.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 11 | 🐛 0 | 🌐 Lua | 📅 2025-05-23 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 21,286 | 🐛 13 | 🌐 Go | 📅 2026-02-02 or compatible encryption tools for cryptographic safety.
...
* [aileot/nvim-thyme](https://github.com/aileot/nvim-thyme) ⭐ 38 | 🐛 2 | 🌐 Fennel | 📅 2025-11-04 - Zero-overhead Fennel JIT compiler with safety rollbacks and [parinfer-rust](https://github.com/eraserhd/parinfer-rust) ⭐ 609 | 🐛 35 | 🌐 Rust | 📅 2026-01-03 integration.
...
* [vuki656/package-info.nvim](https://github.com/vuki656/package-info.nvim) ⭐ 586 | 🐛 26 | 🌐 Lua | 📅 2025-12-27 - Display latest package version as virtual text in package.json.
...
* [Silletr/LazyDeveloperHelper](https://github.com/Silletr/LazyDeveloperHelper) ⭐ 12 | 🐛 0 | 🌐 Python | 📅 2026-02-13 - Python dependencies manager, with auto-adding to your `requirements.txt` file.
...
* [nvim-mini/mini.nvim#mini.diff](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
* [nvim-mini/mini.nvim#mini.git](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for enhanced Git integration with current Neovim process that implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.
* [lewis6991/gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) ⭐ 6,558 | 🐛 33 | 🌐 Lua | 📅 2026-02-13 - Git integration: signs, hunk actions, blame, etc.
* [sindrets/diffview.nvim](https://github.com/sindrets/diffview.nvim) ⭐ 5,333 | 🐛 132 | 🌐 Lua | 📅 2024-08-02 - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev.
...
* [kdheepak/lazygit.nvim](https://github.com/kdheepak/lazygit.nvim) ⭐ 2,181 | 🐛 49 | 🌐 Lua | 📅 2025-12-19 - Plugin for calling lazygit.
* [esmuellert/codediff.nvim](https://github.com/esmuellert/codediff.nvim) ⭐ 1,089 | 🐛 41 | 🌐 Lua | 📅 2026-02-11 - Side-by-side diff with two-tier highlighting (line + character level) using VSCode's algorithm implemented in C.
...
* [axkirillov/unified.nvim](https://github.com/axkirillov/unified.nvim) ⭐ 125 | 🐛 5 | 🌐 Lua | 📅 2026-02-13 - Displaying inline unified diffs directly in your buffer.
* [moyiz/git-dev.nvim](https://github.com/moyiz/git-dev.nvim) ⭐ 107 | 🐛 2 | 🌐 Lua | 📅 2025-12-06 - Open remote Git repositories while editing.
* [chojs23/ec](https://github.com/chojs23/ec) ⭐ 99 | 🐛 1 | 🌐 Go | 📅 2026-02-13 - A TUI native Git mergetool with 3 panes.
...
* [jceb/jiejie.nvim](https://github.com/jceb/jiejie.nvim) ⭐ 42 | 🐛 2 | 🌐 Lua | 📅 2026-02-02 - Frontend for Jujutsu in the style of `fugitive`.
...
* [YouSame2/inlinediff-nvim](https://github.com/YouSame2/inlinediff-nvim) ⭐ 17 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - Provides a better inline Git diff view, meant to be used alongside your favorite Git plugin (e.g. `gitsigns`).
...
* [pwntester/octo.nvim](https://github.com/pwntester/octo.nvim) ⭐ 3,104 | 🐛 225 | 🌐 Lua | 📅 2026-01-22 - Work with GitHub issues and PRs.
...
* [nvim-mini/mini.nvim#mini.jump](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for smarter jumping to a single character.
* [nvim-mini/mini.nvim#mini.jump2d](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
* [nvim-mini/mini.nvim#mini.bracketed](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` to go forward/backward with square brackets.
...
* [folke/flash.nvim](https://github.com/folke/flash.nvim) ⭐ 3,890 | 🐛 19 | 🌐 Lua | 📅 2025-10-28 - Navigate your code with search labels, enhanced character motions and Tree-sitter integration.
...
* [chrisgrieser/nvim-spider](https://github.com/chrisgrieser/nvim-spider) ⭐ 836 | 🐛 0 | 🌐 Lua | 📅 2026-02-10 - Use the w, e, b motions like a spider. Considers camelCase and skips insignificant punctuation.
...
* [HawkinsT/pathfinder.nvim](https://github.com/HawkinsT/pathfinder.nvim) ⭐ 60 | 🐛 3 | 🌐 Lua | 📅 2025-11-17 - Enhances gf/gF/gx with look-ahead and smarter file, line/column number, and link resolution. Also provides visual targets for files/links, new motion commands, and link description retrieval.
...
* [nvim-mini/mini.nvim#mini.clue](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
* [nvim-mini/mini.nvim#mini.keymap](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).
* [folke/which-key.nvim](https://github.com/folke/which-key.nvim) ⭐ 6,935 | 🐛 38 | 🌐 Lua | 📅 2025-10-28 - Shows a popup with possible keybindings of the command you started typing.
...
* [max397574/better-escape.nvim](https://github.com/max397574/better-escape.nvim) ⭐ 775 | 🐛 6 | 🌐 Lua | 📅 2025-04-29 - Create shortcuts to escape insert mode without getting delay.
...
* [karb94/neoscroll.nvim](https://github.com/karb94/neoscroll.nvim) ⭐ 1,970 | 🐛 11 | 🌐 Lua | 📅 2025-12-31 - Smooth scrolling.
...
* [nvim-mini/mini.nvim#mini.map](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.
...
* [dstein64/nvim-scrollview](https://github.com/dstein64/nvim-scrollview) ⭐ 680 | 🐛 5 | 🌐 Lua | 📅 2026-02-05 - Display interactive scrollbars.
...
* [nvim-mini/mini.nvim#mini.pairs](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
* [nvim-mini/mini.nvim#mini.trailspace](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
* [nvim-mini/mini.nvim#mini.operators](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
* [nvim-mini/mini.nvim#mini.move](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
* [nvim-mini/mini.nvim#mini.ai](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some built-in textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
* [nvim-mini/mini.nvim#mini.splitjoin](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
* [nvim-mini/mini.nvim#mini.basics](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.
...
* [windwp/nvim-ts-autotag](https://github.com/windwp/nvim-ts-autotag) ⭐ 2,051 | 🐛 8 | 🌐 Lua | 📅 2026-02-04 - Use Tree-sitter to autoclose and autorename XML, HTML, JSX tag.
* [jake-stewart/multicursor.nvim](https://github.com/jake-stewart/multicursor.nvim) ⭐ 1,381 | 🐛 0 | 🌐 Lua | 📅 2026-02-01 - Adds support for multiple cursors which work how you expect.
...
* [shortcuts/no-neck-pain.nvim](https://github.com/shortcuts/no-neck-pain.nvim) ⭐ 903 | 🐛 19 | 🌐 Lua | 📅 2026-02-11 - Center the currently focused buffer to the middle of your terminal.
* [nacro90/numb.nvim](https://github.com/nacro90/numb.nvim) ⭐ 839 | 🐛 1 | 🌐 Lua | 📅 2026-01-17 - Peek lines in a non-obtrusive way.
* [HiPhish/rainbow-delimiters.nvim](https://github.com/HiPhish/rainbow-delimiters.nvim) ⭐ 833 | 🐛 19 | 🌐 Lua | 📅 2026-01-11 - Rainbow delimiters with Tree-sitter.
...
* [nemanjamalesija/smart-paste.nvim](https://github.com/nemanjamalesija/smart-paste.nvim) ⭐ 64 | 🐛 2 | 🌐 Lua | 📅 2026-02-13 - Automatic indentation of pasted code using a three-tier indent strategy (indentexpr / Tree-sitter / heuristic).
...
* [nvim-mini/mini.nvim#mini.comment](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.
* [numToStr/Comment.nvim](https://github.com/numToStr/Comment.nvim) ⭐ 4,579 | 🐛 80 | 🌐 Lua | 📅 2024-08-19 - Smart and powerful comment plugin. Supports commentstring, motions, dot-repeat and more.
* [folke/todo-comments.nvim](https://github.com/folke/todo-comments.nvim) ⭐ 4,046 | 🐛 24 | 🌐 Lua | 📅 2025-11-10 - Highlight, list and search TODO comments in your projects.
...
* [chrisgrieser/nvim-origami](https://github.com/chrisgrieser/nvim-origami) ⭐ 457 | 🐛 2 | 🌐 Lua | 📅 2026-02-10 - Fold with relentless elegance.
...
* [nvim-mini/mini.nvim#mini.align](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for aligning text interactively (with or without instant preview).
* [stevearc/conform.nvim](https://github.com/stevearc/conform.nvim) ⭐ 4,911 | 🐛 86 | 🌐 Lua | 📅 2026-01-18 - A lightweight formatting engine that plays nice with LSP.
...
* [nvim-mini/mini.nvim#mini.indentscope](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.
* [lukas-reineke/indent-blankline.nvim](https://github.com/lukas-reineke/indent-blankline.nvim) ⭐ 4,857 | 🐛 24 | 🌐 Lua | 📅 2025-03-17 - IndentLine replacement in Lua with more features and Tree-sitter support.
* [shellRaining/hlchunk.nvim](https://github.com/shellRaining/hlchunk.nvim) ⭐ 890 | 🐛 32 | 🌐 Lua | 📅 2025-12-15 - A Lua implementation of `nvim-hlchunk`, contains more features, such as highlight `{}` chunk, indent line, space blank etc.
...
* [nvim-mini/mini.nvim#mini.cmdline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cmdline.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for command line tweaks. Adds autocompletion with customizable delay, autocorrection for words with fixed candidates, and autopeek command range in a floating window.
...
* [nvim-mini/mini.nvim#mini.sessions](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for session management (read, write, delete).
...
* [esensar/nvim-dev-container](https://github.com/esensar/nvim-dev-container) ⭐ 703 | 🐛 10 | 🌐 Lua | 📅 2026-02-13 - Provide functionality similar to VSCode's [remote container development](https://code.visualstudio.com/docs/remote/containers) plugin, with other functionalities that enable development in Docker containers.
...
* [uhs-robert/sshfs.nvim](https://github.com/uhs-robert/sshfs.nvim) ⭐ 151 | 🐛 5 | 🌐 Lua | 📅 2026-01-21 - Mount remote systems via SSHFS with smart picker auto-detect (Telescope/Oil/Snacks/Neo-tree/fzf-lua/Yazi/Ranger etc.).
...
* [gruvw/strudel.nvim](https://github.com/gruvw/strudel.nvim) ⭐ 395 | 🐛 4 | 🌐 JavaScript | 📅 2025-12-06 - Live coding controller for [strudel](https://strudel.cc).
...
* [nvim-mini/mini.nvim#mini.bufremove](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,547 | 🐛 13 | 🌐 Lua | 📅 2026-02-13 - Smart, seamless, directional navigation and resizing of splits.
...
* [anuvyklack/windows.nvim](https://github.com/anuvyklack/windows.nvim) ⭐ 634 | 🐛 22 | 🌐 Lua | 📅 2023-07-08 - Automatically expand width of the current window. Maximizes and restore it. And all this with nice animations!
...
* [Eandrju/cellular-automaton.nvim](https://github.com/Eandrju/cellular-automaton.nvim) ⭐ 2,075 | 🐛 12 | 🌐 Lua | 📅 2025-01-31 - It lets you execute aesthetically pleasing, cellular automaton animations based on the content of the current buffer.
...
* [kawre/leetcode.nvim](https://github.com/kawre/leetcode.nvim) ⭐ 1,971 | 🐛 56 | 🌐 Lua | 📅 2025-09-21 - Solve Leetcode problems.
* [xeluxee/competitest.nvim](https://github.com/xeluxee/competitest.nvim) ⭐ 568 | 🐛 16 | 🌐 Lua | 📅 2025-05-13 - A plugin to automate testcases management and checking for Competitive Programming contests.
...
* [gisketch/triforce.nvim](https://github.com/gisketch/triforce.nvim) ⭐ 266 | 🐛 3 | 🌐 Lua | 📅 2026-02-11 - Gamified stat tracker with XP, levels, achievements, and activity heatmaps for your coding sessions with lualine integration.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 14 | 🐛 2 | 🌐 Go | 📅 2026-02-14 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [kndndrj/nvim-dbee](https://github.com/kndndrj/nvim-dbee) ⭐ 1,216 | 🐛 75 | 🌐 Go | 📅 2025-07-25 - Interactive database client.
...
* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 29,414 | 🐛 58 | 🌐 Lua | 📅 2026-01-27 - A launch point for your personal Neovim configuration.
* [siduck76/NvChad](https://github.com/siduck76/NvChad) ⭐ 27,870 | 🐛 1 | 🌐 Lua | 📅 2026-02-07 - An attempt to make Neovim's CLI as functional as an IDE while retaining beauty with less bloat.
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 25,034 | 🐛 56 | 🌐 Lua | 📅 2025-11-11 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
* [LunarVim/LunarVim](https://github.com/LunarVim/LunarVim) ⭐ 19,222 | 🐛 34 | 🌐 Lua | 📅 2025-06-05 - This project aims to help one transition away from VSCode, and into a superior text editing experience.
* [AstroNvim/AstroNvim](https://github.com/AstroNvim/AstroNvim) ⭐ 14,108 | 🐛 1 | 🌐 Lua | 📅 2026-02-11 - An aesthetic and feature-rich config that is extensible and easy to use with a great set of plugins.
* [ayamir/nvimdots](https://github.com/ayamir/nvimdots) ⭐ 3,371 | 🐛 13 | 🌐 Lua | 📅 2026-02-01 - A well-configured and structured configuration with NixOS support.
...
* [CosmicNvim/CosmicNvim](https://github.com/CosmicNvim/CosmicNvim) ⭐ 1,145 | 🐛 2 | 🌐 Lua | 📅 2026-02-03 - CosmicNvim is a lightweight and opinionated config for web development, specifically designed to provide a COSMIC programming experience!
...
* [doctorfree/nvim-lazyman](https://github.com/doctorfree/nvim-lazyman) ⭐ 421 | 🐛 9 | 🌐 HTML | 📅 2025-11-21 - Configuration manager and a modular configuration on its own. Supports over 40 preconfigured configurations.
...
* [nvim-mini/MiniMax](https://github.com/nvim-mini/MiniMax) ⭐ 307 | 🐛 1 | 🌐 Lua | 📅 2026-02-13 - A collection of self-contained and extensively commented configurations which mostly use MINI tools.
...
* [MordechaiHadad/bob](https://github.com/MordechaiHadad/bob) ⭐ 2,003 | 🐛 28 | 🌐 Rust | 📅 2026-02-13 - A cross-platform, easy to use Neovim version manager.
...
* [y3owk1n/nvs](https://github.com/y3owk1n/nvs) ⭐ 28 | 🐛 1 | 🌐 Go | 📅 2026-02-14 - Another Neovim version manager with config switcher.
...
* [m15a/flake-awesome-neovim-plugins](https://github.com/m15a/flake-awesome-neovim-plugins) ⭐ 62 | 🐛 0 | 🌐 Nix | 📅 2026-02-13 - Nix flake that provides a collection of `awesome-neovim` plugins as Nix packages.
...
* [nvim-mini/mini.nvim#mini.notify](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) ⭐ 8,730 | 🐛 36 | 🌐 Lua | 📅 2026-02-13 - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.
* [folke/noice.nvim](https://github.com/folke/noice.nvim) ⭐ 5,601 | 🐛 28 | 🌐 Lua | 📅 2025-11-03 - Highly experimental plugin that completely replaces the UI for messages, cmdline and the popupmenu.
...
* [xieyonn/spinner.nvim](https://github.com/xieyonn/spinner.nvim) ⭐ 80 | 🐛 0 | 🌐 Lua | 📅 2026-02-13 - Extensible spinner framework for animated spinners in statusline, tabline, winbar, buffer, cmdline, or next to the cursor.
...
* [Weyaaron/nvim-training](https://github.com/Weyaaron/nvim-training) ⭐ 118 | 🐛 4 | 🌐 Lua | 📅 2026-01-18 - A beginner-friendly tool for training your 'muscle memory' using small, repeatable tasks.
