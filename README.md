...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 20,651 | 🐛 57 | 🌐 Lua | 📅 2025-12-17 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [nvim-mini/mini.nvim#mini.deps](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.
* [lumen-oss/rocks.nvim](https://github.com/lumen-oss/rocks.nvim) ⭐ 1,014 | 🐛 56 | 🌐 Lua | 📅 2026-02-21 - A modern approach to plugin management using LuaRocks, inspired by Cargo.
...
* [zuqini/zpack.nvim](https://github.com/zuqini/zpack.nvim) ⭐ 95 | 🐛 1 | 🌐 Lua | 📅 2026-04-06 - A thin layer on top of `vim.pack` to support lazy-loading and `lazy.nvim`'s declarative spec.
...
* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,500 | 🐛 31 | 🌐 Lua | 📅 2026-04-06 - Quickstart configurations for the LSP client.
...
* [mfussenegger/nvim-lint](https://github.com/mfussenegger/nvim-lint) ⭐ 2,680 | 🐛 46 | 🌐 Lua | 📅 2026-03-26 - An asynchronous linter plugin, complementary to the built-in Language Server Protocol support.
* [j-hui/fidget.nvim](https://github.com/j-hui/fidget.nvim) ⭐ 2,499 | 🐛 21 | 🌐 Lua | 📅 2026-04-01 - Standalone UI for LSP progress.
* [ray-x/lsp\_signature.nvim](https://github.com/ray-x/lsp_signature.nvim) ⭐ 2,346 | 🐛 90 | 🌐 Lua | 📅 2026-04-04 - LSP signature hint when you type.
...
* [onsails/lspkind.nvim](https://github.com/onsails/lspkind.nvim) ⭐ 1,679 | 🐛 15 | 🌐 Lua | 📅 2026-01-29 - The plugin adds VSCode-like icons to LSP completions.
...
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 987 | 🐛 11 | 🌐 Lua | 📅 2026-04-03 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,704 | 🐛 111 | 🌐 JavaScript | 📅 2026-04-03 catalog.
...
* [nvimtools/none-ls.nvim](https://github.com/nvimtools/none-ls.nvim) ⭐ 3,222 | 🐛 10 | 🌐 Lua | 📅 2026-04-06 - Null-ls.nvim reloaded / Use Neovim as a language server to inject LSP diagnostics, code actions, and more via Lua.
* [mrcjkb/rustaceanvim](https://github.com/mrcjkb/rustaceanvim) ⭐ 2,908 | 🐛 18 | 🌐 Lua | 📅 2026-04-07 - A heavily modified fork of rust-tools.nvim that does not require a `setup` call and does not depend on nvim-lspconfig.
* [rachartier/tiny-inline-diagnostic.nvim](https://github.com/rachartier/tiny-inline-diagnostic.nvim) ⭐ 1,617 | 🐛 0 | 🌐 Lua | 📅 2026-04-05 - Display prettier diagnostic messages. Display one line diagnostic messages where the cursor is, with icons and colors.
* [mfussenegger/nvim-jdtls](https://github.com/mfussenegger/nvim-jdtls) ⭐ 1,457 | 🐛 1 | 🌐 Lua | 📅 2026-02-10 - Extensions for the built-in LSP support for the Eclipse JDT Language Server.
...
* [mrcjkb/haskell-tools.nvim](https://github.com/mrcjkb/haskell-tools.nvim) ⭐ 585 | 🐛 22 | 🌐 Lua | 📅 2026-04-07 - Seamless integration for Haskell development tools like `haskell-language-server` and Hoogle.
...
* [Wansmer/symbol-usage.nvim](https://github.com/Wansmer/symbol-usage.nvim) ⭐ 476 | 🐛 2 | 🌐 Lua | 📅 2026-04-06 - Display references, definitions and implementations of document symbols.
* [rachartier/tiny-code-action.nvim](https://github.com/rachartier/tiny-code-action.nvim) ⭐ 454 | 🐛 0 | 🌐 Lua | 📅 2026-04-07 - Provides a simple way to run and visualize code actions with Telescope.
...
* [chrisgrieser/nvim-lsp-endhints](https://github.com/chrisgrieser/nvim-lsp-endhints) ⭐ 234 | 🐛 0 | 🌐 Lua | 📅 2026-04-06 - Display LSP inlay hints at the end of the line, rather than within the line.
...
* [mason-org/mason.nvim](https://github.com/mason-org/mason.nvim) ⭐ 10,179 | 🐛 271 | 🌐 Lua | 📅 2026-04-06 - Portable package manager that runs everywhere Neovim runs. Easily install and manage LSP servers, DAP servers, linters, and formatters.

### Diagnostics

* [folke/trouble.nvim](https://github.com/folke/trouble.nvim) ⭐ 6,730 | 🐛 20 | 🌐 Lua | 📅 2025-10-31 - A pretty diagnostics list to help you solve all the trouble your code is causing.
...
* [hrsh7th/nvim-cmp](https://github.com/hrsh7th/nvim-cmp) ⭐ 9,382 | 🐛 299 | 🌐 Lua | 📅 2026-03-25 - Completion engine written in Lua, successor of `nvim-compe`.
  * [hrsh7th/cmp-nvim-lsp](https://github.com/hrsh7th/cmp-nvim-lsp) ⭐ 1,497 | 🐛 29 | 🌐 Lua | 📅 2025-11-13 - `nvim-cmp` source for the built-in LSP client.
  ...
  * [hrsh7th/cmp-buffer](https://github.com/hrsh7th/cmp-buffer) ⭐ 668 | 🐛 38 | 🌐 Lua | 📅 2025-04-01 - `nvim-cmp` source for buffer words.
...
* [nvim-mini/mini.nvim#mini.completion](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 6,120 | 🐛 102 | 🌐 Lua | 📅 2026-04-04 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [mikavilpas/blink-ripgrep.nvim](https://github.com/mikavilpas/blink-ripgrep.nvim) ⭐ 112 | 🐛 2 | 🌐 TypeScript | 📅 2026-04-07 - `blink.cmp` source for `ripgrep` / `git grep`.
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 11 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 44,105 | 🐛 67 | 🌐 C | 📅 2026-04-05.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 4,037 | 🐛 15 | 🌐 Lua | 📅 2026-04-07 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,522 | 🐛 56 | 🌐 Vim Script | 📅 2026-01-09.
* [ms-jpq/coq\_nvim](https://github.com/ms-jpq/coq_nvim) ⭐ 3,789 | 🐛 187 | 🌐 Python | 📅 2026-01-06 - Fast as FUCK completion. SQLite, concurrent scheduler, hundreds of hours of optimization.
...
* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 17,724 | 🐛 71 | 🌐 Lua | 📅 2026-03-30 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,416 | 🐛 7 | 🌐 Lua | 📅 2026-04-06 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
...
* [CopilotC-Nvim/CopilotChat.nvim](https://github.com/CopilotC-Nvim/CopilotChat.nvim) ⭐ 3,612 | 🐛 23 | 🌐 Lua | 📅 2026-04-06 - A chat interface for GitHub Copilot that allows you to directly ask and receive answers to coding-related questions.
* [nickjvandyke/opencode.nvim](https://github.com/nickjvandyke/opencode.nvim) ⭐ 3,096 | 🐛 9 | 🌐 Lua | 📅 2026-04-02 - OpenCode AI assistant integration.
...
* [milanglacier/minuet-ai.nvim](https://github.com/milanglacier/minuet-ai.nvim) ⭐ 1,081 | 🐛 13 | 🌐 Lua | 📅 2026-04-06 - Minuet offers code completion from LLM providers including OpenAI (compatible), Gemini, Claude, Ollama, Deepseek and more providers, with support for nvim-cmp, blink.cmp and virtual-text frontend.
...
* [Kurama622/llm.nvim](https://github.com/Kurama622/llm.nvim) ⭐ 466 | 🐛 1 | 🌐 Lua | 📅 2026-03-12 - Free large language model (LLM) support, provides commands to interact with LLM.
* [dlants/magenta.nvim](https://github.com/dlants/magenta.nvim) ⭐ 433 | 🐛 23 | 🌐 TypeScript | 📅 2026-04-07 - Leverage coding assistants for chat and code generation. Provides tools for the AI/LLM agent to explore and edit your code, like Aider, Cursor and Windsurf.
...
* [carlos-algms/agentic.nvim](https://github.com/carlos-algms/agentic.nvim) ⭐ 374 | 🐛 10 | 🌐 Lua | 📅 2026-04-06 - Chat interface for AI ACP providers such as Claude, Gemini, Codex, OpenCode and Cursor.
...
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 8 | 🐛 4 | 🌐 Lua | 📅 2026-04-05 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 11,546 | 🐛 580 | 🌐 Python | 📅 2026-04-06 tool.
...
* [nvim-java/nvim-java](https://github.com/nvim-java/nvim-java) ⭐ 1,608 | 🐛 35 | 🌐 Lua | 📅 2026-02-05 - Everything you need for a painless Java experience.
...
* [chomosuke/typst-preview.nvim](https://github.com/chomosuke/typst-preview.nvim) ⭐ 886 | 🐛 10 | 🌐 Lua | 📅 2026-03-30 - Preview Typst documents in the browser, instant update on each keystroke, and cross jump between code and preview.
* [dmmulroy/tsc.nvim](https://github.com/dmmulroy/tsc.nvim) ⭐ 542 | 🐛 7 | 🌐 Lua | 📅 2026-01-14 - Asynchronous project-wide TypeScript type-checking using the TypeScript compiler (`tsc`) with results loaded into a quickfix list.
* [quarto-dev/quarto-nvim](https://github.com/quarto-dev/quarto-nvim) ⭐ 505 | 🐛 6 | 🌐 Lua | 📅 2026-01-29 - Tools for working with [Quarto](https://quarto.org/) documents.
* [Julian/lean.nvim](https://github.com/Julian/lean.nvim) ⭐ 504 | 🐛 38 | 🌐 Lua | 📅 2026-04-06 - Support for the [Lean Theorem Prover](https://leanprover.github.io/).
...
* [ray-x/go.nvim](https://github.com/ray-x/go.nvim) ⭐ 2,613 | 🐛 96 | 🌐 Lua | 📅 2026-04-05 - Golang plugin based on LSP and Tree-sitter.
...
* [rest-nvim/rest.nvim](https://github.com/rest-nvim/rest.nvim) ⭐ 2,017 | 🐛 47 | 🌐 Lua | 📅 2025-12-27 - A fast HTTP client written in Lua.
* [mistweaverco/kulala.nvim](https://github.com/mistweaverco/kulala.nvim) ⭐ 1,950 | 🐛 18 | 🌐 Lua | 📅 2026-03-16 - A minimal HTTP-client interface.
...
* [iamcco/markdown-preview.nvim](https://github.com/iamcco/markdown-preview.nvim) ⭐ 7,788 | 🐛 260 | 🌐 JavaScript | 📅 2024-07-23 - Preview Markdown on your modern browser with synchronised scrolling and flexible configuration.
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 4,364 | 🐛 6 | 🌐 Lua | 📅 2026-04-05 - Improve viewing Markdown files directly.
* [OXY2DEV/markview.nvim](https://github.com/OXY2DEV/markview.nvim) ⭐ 3,402 | 🐛 3 | 🌐 Lua | 📅 2026-03-20 - A hackable Markdown, Typst, LaTeX, HTML (inline) and YAML renderer.
...
* [YousefHadder/markdown-plus.nvim](https://github.com/YousefHadder/markdown-plus.nvim) ⭐ 234 | 🐛 3 | 🌐 Lua | 📅 2026-04-06 - Provides a full editing experience for Markdown files which includes support for lists, links, TOC, and more with simple and fast keymaps.
...
* [gbprod/phpactor.nvim](https://github.com/gbprod/phpactor.nvim) ⭐ 94 | 🐛 2 | 🌐 Lua | 📅 2026-01-07 - Lua version of [phpactor](https://github.com/phpactor/phpactor) ⭐ 1,839 | 🐛 298 | 🌐 PHP | 📅 2026-04-06.
...
* [nvim-treesitter/nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects) ⭐ 2,723 | 🐛 114 | 🌐 Tree-sitter Query | 📅 2026-03-21 - Create your own textobjects using Tree-sitter queries.
...
* [IndianBoy42/tree-sitter-just](https://github.com/IndianBoy42/tree-sitter-just) ⭐ 186 | 🐛 5 | 🌐 Just | 📅 2026-03-25 - Tree-sitter grammar for [Justfiles](https://github.com/casey/just) ⭐ 32,663 | 🐛 307 | 🌐 Rust | 📅 2026-04-05.
...
* [nvim-mini/mini.nvim#mini.snippets](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.
* [L3MON4D3/LuaSnip](https://github.com/L3MON4D3/LuaSnip) ⭐ 4,312 | 🐛 128 | 🌐 Lua | 📅 2026-04-05 - A snippet engine written in Lua.
...
* [ThePrimeagen/harpoon](https://github.com/ThePrimeagen/harpoon/tree/harpoon2) ⭐ 8,997 | 🐛 149 | 🌐 Lua | 📅 2025-10-31 - A per project, auto updating and editable marks utility for fast file navigation.
...
* [otavioschwanck/arrow.nvim](https://github.com/otavioschwanck/arrow.nvim) ⭐ 737 | 🐛 34 | 🌐 Lua | 📅 2025-11-28 - Like harpoon, but with a different UX, single keybinding needed and statusline support.
...
* [MagicDuck/grug-far.nvim](https://github.com/MagicDuck/grug-far.nvim) ⭐ 1,852 | 🐛 6 | 🌐 Lua | 📅 2026-04-07 - Buffer-based live search and replace with full power of `rg` flags. Grug like!
...
* [nvim-telescope/telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) ⭐ 19,259 | 🐛 493 | 🌐 Lua | 📅 2026-04-06 - Telescope.nvim is a highly [extendable](https://github.com/nvim-telescope/telescope.nvim/wiki/Extensions) ⭐ 19,259 | 🐛 493 | 🌐 Lua | 📅 2026-04-06 A highly extensible fuzzy finder over lists.
* [nvim-mini/mini.nvim#mini.fuzzy](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
* [nvim-mini/mini.nvim#mini.pick](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
* [nvim-mini/mini.nvim#mini.extra](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.
* [folke/snacks.nvim#picker](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) ⭐ 7,382 | 🐛 112 | 🌐 Lua | 📅 2026-03-21 - A modern fuzzy-finder to navigate the Neovim universe.
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,171 | 🐛 10 | 🌐 Lua | 📅 2026-04-05 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,733 | 🐛 19 | 🌐 Rust | 📅 2026-04-06 as its fzf binary.
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 3,798 | 🐛 53 | 🌐 Rust | 📅 2026-04-06 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 367 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 35,309 | 🐛 158 | 🌐 Rust | 📅 2026-03-23, a smart directory picker that tracks your usage.
...
* [dtormoen/neural-open.nvim](https://github.com/dtormoen/neural-open.nvim) ⭐ 55 | 🐛 1 | 🌐 Lua | 📅 2026-03-11 - Intelligent `snacks.nvim` picker that teaches a neural network to rank files by what you're most likely to open next.
* [juniorsundar/refer.nvim](https://github.com/juniorsundar/refer.nvim) ⭐ 45 | 🐛 2 | 🌐 Lua | 📅 2026-04-06 - A minimalist picker that doesn't get in your way.
...
* [willyelm/pulse.nvim](https://github.com/willyelm/pulse.nvim) ⭐ 16 | 🐛 0 | 🌐 Lua | 📅 2026-03-30 - A single entrypoint for commands. Use prefixes to quickly access diagnostics, Git and more via pickers.
...
* [nvim-mini/mini.nvim#mini.files](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.
* [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) ⭐ 8,444 | 🐛 93 | 🌐 Lua | 📅 2026-04-07 - A simple and fast file explorer tree.
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,422 | 🐛 130 | 🌐 Lua | 📅 2026-02-24 - Edit your filesystem like a buffer.
* [nvim-neo-tree/neo-tree.nvim](https://github.com/nvim-neo-tree/neo-tree.nvim) ⭐ 5,349 | 🐛 169 | 🌐 Lua | 📅 2026-04-04 - Browse the file system and other tree-like structures in whatever style suits you, including sidebars, floating windows, `netrw` split style, or all of them at once.
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,688 | 🐛 93 | 🌐 Python | 📅 2026-04-07 - File manager. Better than NERDTree.
* [mikavilpas/yazi.nvim](https://github.com/mikavilpas/yazi.nvim) ⭐ 1,631 | 🐛 8 | 🌐 Lua | 📅 2026-04-07 - Integration with the Yazi terminal file manager.
...
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 459 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,453 | 🐛 1 | 🌐 C | 📅 2026-04-06 and Lua.
...
* [kelly-lin/ranger.nvim](https://github.com/kelly-lin/ranger.nvim) ⭐ 181 | 🐛 11 | 🌐 Lua | 📅 2024-11-18 - [Ranger](https://github.com/ranger/ranger) ⭐ 17,105 | 🐛 931 | 🌐 Python | 📅 2026-04-04 integration.
* [Xuyuanp/yanil](https://github.com/Xuyuanp/yanil) ⭐ 98 | 🐛 5 | 🌐 Lua | 📅 2026-01-15 - Yet Another Nerdtree In Lua.
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 98 | 🐛 2 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 36,058 | 🐛 65 | 🌐 Rust | 📅 2026-04-07).
...
* [nvim-mini/mini.nvim#mini.visits](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.
...
* [mrjones2014/codesettings.nvim](https://github.com/mrjones2014/codesettings.nvim) ⭐ 64 | 🐛 2 | 🌐 Lua | 📅 2026-04-07 - Easily load project-local settings (like `.vscode/settings.json`) into Neovim 0.11+ native LSP settings.
...
* [chrisgrieser/nvim-early-retirement](https://github.com/chrisgrieser/nvim-early-retirement) ⭐ 249 | 🐛 0 | 🌐 Lua | 📅 2026-04-06 - Send buffers into early retirement by automatically closing them after x minutes of inactivity.
...
* [nvim-mini/mini.nvim#mini.hipatterns](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.
* [folke/twilight.nvim](https://github.com/folke/twilight.nvim) ⭐ 1,518 | 🐛 0 | 🌐 Lua | 📅 2025-10-28 - Dim inactive portions of the code you're editing using Tree-sitter.
* [catgoose/nvim-colorizer.lua](https://github.com/catgoose/nvim-colorizer.lua) ⭐ 1,033 | 🐛 1 | 🌐 Lua | 📅 2026-03-27 - A high-performance color highlighter which has no external dependencies.
...
* [nvzone/minty](https://github.com/nvzone/minty) ⭐ 583 | 🐛 2 | 🌐 Lua | 📅 2025-02-28 - Beautifully crafted color tools.
...
* [rasulomaroff/reactive.nvim](https://github.com/rasulomaroff/reactive.nvim) ⭐ 242 | 🐛 8 | 🌐 Lua | 📅 2025-12-30 - Set global and window-specific highlights or trigger callbacks when modes/operators change or windows are switched.
...
* [folke/tokyonight.nvim](https://github.com/folke/tokyonight.nvim) ⭐ 7,938 | 🐛 14 | 🌐 Lua | 📅 2026-03-24 - ***`[TS][LSP][L/D][Lua]`*** A clean, dark and light theme written in Lua, with support for LSP, Tree-sitter and lots of plugins.
...
* [sainnhe/gruvbox-material](https://github.com/sainnhe/gruvbox-material) ⭐ 2,523 | 🐛 8 | 🌐 Vim Script | 📅 2026-04-03 - ***`[TS][LSP]`*** Gruvbox modification with softer contrast and Tree-sitter support.
* [projekt0n/github-nvim-theme](https://github.com/projekt0n/github-nvim-theme) ⭐ 2,445 | 🐛 28 | 🌐 Lua | 📅 2024-12-31 - ***`[TS][LSP][L/D][Lua]`*** A GitHub theme, kitty, alacritty written in Lua. Support built-in LSP and Tree-sitter.
* [navarasu/onedark.nvim](https://github.com/navarasu/onedark.nvim) ⭐ 1,951 | 🐛 54 | 🌐 Lua | 📅 2025-11-24 - ***`[TS][LSP][Lua]`*** A One Dark Theme written in Lua based on Atom's One Dark Theme.
* [sainnhe/sonokai](https://github.com/sainnhe/sonokai) ⭐ 1,929 | 🐛 1 | 🌐 Vim Script | 📅 2026-01-21 - ***`[TS][LSP]`*** High Contrast and Vivid Color Scheme based on Monokai Pro.
...
* [marko-cerovac/material.nvim](https://github.com/marko-cerovac/material.nvim) ⭐ 1,081 | 🐛 6 | 🌐 Lua | 📅 2026-02-23 - ***`[TS][LSP][L/D][Lua]`*** Material.nvim is a highly configurable colorscheme written in Lua and based on the material palette.
* [AlexvZyl/nordic.nvim](https://github.com/AlexvZyl/nordic.nvim) ⭐ 1,001 | 🐛 4 | 🌐 Lua | 📅 2026-04-05 - ***`[TS][Lua]`*** Nord theme, but warmer and darker. Supports a variety of plugins and other platforms.
...
* [savq/melange-nvim](https://github.com/savq/melange-nvim) ⭐ 944 | 🐛 12 | 🌐 Lua | 📅 2025-12-10 - ***`[TS][LSP][L/D][Lua]`*** Warm colorscheme written in Lua with support for various terminal emulators.
...
* [fenetikm/falcon](https://github.com/fenetikm/falcon) ⭐ 833 | 🐛 12 | 🌐 Vim Script | 📅 2026-03-21 - ***`[TS][Lua]`*** A colour scheme for terminals, Vim and friends.
...
* [neanias/everforest-nvim](https://github.com/neanias/everforest-nvim) ⭐ 429 | 🐛 9 | 🌐 Lua | 📅 2026-03-08 - ***`[TS][LSP][L/D][Lua]`*** A Lua port of the Everforest colour scheme.
...
* [rose-pine/neovim](https://github.com/rose-pine/neovim) ⭐ 2,983 | 🐛 5 | 🌐 Lua | 📅 2025-12-21 - ***`[TS][LSP][L/D][Lua]`*** All natural pine, faux fur and a bit of soho vibes for the classy minimalist.

<!--lint enable awesome-spell-check-->

* [nvim-mini/mini.nvim#colorschemes](https://github.com/nvim-mini/mini.nvim#plugin-color-schemes) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - ***`[TS][LSP][L/D][Lua]`*** Color schemes included in `mini.nvim`. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.
* [catppuccin/nvim](https://github.com/catppuccin/nvim) ⭐ 7,311 | 🐛 10 | 🌐 Lua | 📅 2026-04-06 - ***`[TS][LSP][L/D][Lua]`*** Warm mid-tone dark theme to show off your vibrant self! With support for native LSP, Tree-sitter, and more.
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 6,045 | 🐛 91 | 🌐 Lua | 📅 2025-10-15 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
* [EdenEast/nightfox.nvim](https://github.com/EdenEast/nightfox.nvim) ⭐ 3,951 | 🐛 35 | 🌐 Lua | 📅 2025-02-09 - ***`[TS][LSP][L/D][Lua]`*** A soft dark, fully customizable colorscheme with support for LSP, Tree-sitter and a variety of plugins.
* [ellisonleao/gruvbox.nvim](https://github.com/ellisonleao/gruvbox.nvim) ⭐ 2,504 | 🐛 27 | 🌐 Lua | 📅 2026-03-09 - ***`[TS][LSP][L/D][Lua]`*** Gruvbox community colorscheme Lua port.
...
* [olimorris/onedarkpro.nvim](https://github.com/olimorris/onedarkpro.nvim) ⭐ 1,047 | 🐛 0 | 🌐 Lua | 📅 2026-03-10 - ***`[TS][L/D][Lua]`*** Atom's iconic One Dark theme. Cacheable, fully customisable, Tree-sitter and LSP semantic token support. Comes with light and dark variants.
...
* [mellow-theme/mellow.nvim](https://github.com/mellow-theme/mellow.nvim) ⭐ 415 | 🐛 1 | 🌐 Lua | 📅 2026-03-30 - ***`[TS][LSP][Lua]`*** A soothing dark color scheme with Tree-sitter support.
...
* [oxfist/night-owl.nvim](https://github.com/oxfist/night-owl.nvim) ⭐ 343 | 🐛 5 | 🌐 Lua | 📅 2024-09-12 - ***`[TS][LSP][Lua]`*** A [Night Owl colorscheme port from VSCode](https://github.com/sdras/night-owl-vscode-theme) ⭐ 2,945 | 🐛 47 | 📅 2024-12-31 with support for Tree-sitter and semantic tokens.
...
* [ankushbhagats/pastel.nvim](https://github.com/ankushbhagats/pastel.nvim) ⭐ 29 | 🐛 0 | 🌐 Lua | 📅 2026-04-05 - ***`[TS][LSP][L/D][Lua]`*** Elegant pastel colorschemes with advanced customization, styles, and integrations.
...
* [nvim-mini/mini.nvim#mini.base16](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
* [nvim-mini/mini.nvim#mini.colors](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
* [nvim-mini/mini.nvim#mini.hues](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.
...
* [RRethy/base16-nvim](https://github.com/RRethy/base16-nvim) ⭐ 629 | 🐛 5 | 🌐 Lua | 📅 2026-04-07 - A base16 colorscheme builder. Includes support for Tree-sitter and LSP highlight groups.
...
* [f-person/auto-dark-mode.nvim](https://github.com/f-person/auto-dark-mode.nvim) ⭐ 485 | 🐛 11 | 🌐 Lua | 📅 2026-03-29 - Follow the system appearance on macOS.
...
* [nvim-mini/mini.nvim#mini.statusline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.
* [nvim-lualine/lualine.nvim](https://github.com/nvim-lualine/lualine.nvim) ⭐ 7,851 | 🐛 269 | 🌐 Lua | 📅 2026-04-04 - Easily configurable, blazingly fast statusline.
* [rebelot/heirline.nvim](https://github.com/rebelot/heirline.nvim) ⭐ 1,259 | 🐛 28 | 🌐 Lua | 📅 2025-05-23 - A no-nonsense statusline designed around recursive inheritance to be exceptionally fast and versatile.
...
* [ojroques/nvim-hardline](https://github.com/ojroques/nvim-hardline) ⭐ 201 | 🐛 2 | 🌐 Lua | 📅 2023-12-27 - A statusline / bufferline inspired by [vim-airline](https://github.com/vim-airline/vim-airline) ⭐ 17,950 | 🐛 52 | 🌐 Vim Script | 📅 2026-03-11 that aims to be as light and simple as possible.
...
* [nvim-mini/mini.nvim#mini.tabline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.
* [akinsho/bufferline.nvim](https://github.com/akinsho/bufferline.nvim) ⭐ 4,286 | 🐛 100 | 🌐 Lua | 📅 2025-01-14 - A snazzy bufferline built using Lua.
...
* [nanozuki/tabby.nvim](https://github.com/nanozuki/tabby.nvim) ⭐ 742 | 🐛 7 | 🌐 Lua | 📅 2026-01-07 - A minimal, configurable tabline that allows using tabs as workspace multiplexers.
...
* [nvim-mini/mini.nvim#mini.cursorword](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).
...
* [nvim-mini/mini.nvim#mini.starter](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.
...
* [nvim-mini/mini.nvim#mini.icons](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-icons.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` meant as a general icon provider. Uses fixed set of highlight groups. Supports various categories, icon and style customizations, caching for performance. Integrates with built-in filetype matching.
* [nvim-tree/nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons) ⭐ 2,644 | 🐛 18 | 🌐 Lua | 📅 2026-04-07 - A Lua fork of [vim-devicons](https://github.com/ryanoasis/vim-devicons) ⭐ 5,800 | 🐛 70 | 🌐 Vim Script | 📅 2024-05-09.
...
* [3rd/image.nvim](https://github.com/3rd/image.nvim) ⭐ 1,944 | 🐛 55 | 🌐 Lua | 📅 2026-02-21 - Add image support through kitty's graphics protocol or ueberzugpp.
...
* [vyfor/cord.nvim](https://github.com/vyfor/cord.nvim) ⭐ 586 | 🐛 0 | 🌐 Lua | 📅 2026-02-17 - Highly extensible Rich Presence for Discord.
...
* [sanjay-np/nvim-yt-player](https://github.com/sanjay-np/nvim-yt-player) ⭐ 13 | 🐛 0 | 🌐 Lua | 📅 2026-04-06 - Play YouTube audio using `mpv` and `yt-dlp` via IPC socket.
...
* [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ⭐ 7,262 | 🐛 211 | 🌐 Lua | 📅 2026-04-04 - Modernity meets insane extensibility. The future of organizing your life.
* [nvim-orgmode/orgmode](https://github.com/nvim-orgmode/orgmode) ⭐ 3,708 | 🐛 141 | 🌐 Lua | 📅 2026-04-01 - Org-mode clone written in Lua.
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 1,737 | 🐛 72 | 🌐 Lua | 📅 2026-04-06 - Plugin for Obsidian, written in Lua.
...
* [bngarren/checkmate.nvim](https://github.com/bngarren/checkmate.nvim) ⭐ 361 | 🐛 8 | 🌐 Lua | 📅 2025-11-15 - A full-featured Markdown-based TODO plugin.
...
* [ymic9963/mdnotes.nvim](https://github.com/ymic9963/mdnotes.nvim) ⭐ 24 | 🐛 13 | 🌐 Lua | 📅 2026-04-06 - Simple, improved, and extensible Markdown note taking.
...
* [AlejandroSuero/freeze-code.nvim](https://github.com/AlejandroSuero/freeze-code.nvim) ⭐ 31 | 🐛 2 | 🌐 Lua | 📅 2025-03-15 - Code screenshot plugin that makes use of [freeze](https://github.com/charmbracelet/freeze) ⭐ 4,434 | 🐛 68 | 🌐 Go | 📅 2026-04-06 inside the editor.
...
* [emrearmagan/dockyard.nvim](https://github.com/emrearmagan/dockyard.nvim) ⭐ 17 | 🐛 0 | 🌐 Lua | 📅 2026-04-07 - Docker dashboard for managing containers, images, networks, and logs.
...
* [hat0uma/csvview.nvim](https://github.com/hat0uma/csvview.nvim) ⭐ 593 | 🐛 16 | 🌐 Lua | 📅 2026-02-14 - An asynchronous CSV/TSV table viewer with real-time updates, configurable comments and delimiters, and multiple display modes.
...
* [theKnightsOfRohan/csvlens.nvim](https://github.com/theKnightsOfRohan/csvlens.nvim) ⭐ 39 | 🐛 1 | 🌐 Lua | 📅 2024-04-28 - A port of [YS-L/csvlens](https://github.com/YS-L/csvlens) ⭐ 3,696 | 🐛 59 | 🌐 Rust | 📅 2026-03-29, for easy previewing of tabular data.
...
* [nvim-mini/mini.nvim#mini.animate](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).
* [sphamba/smear-cursor.nvim](https://github.com/sphamba/smear-cursor.nvim) ⭐ 1,759 | 🐛 6 | 🌐 Lua | 📅 2025-12-01 - Animate the cursor with a smear effect in all terminals. Inspired by Neovide's animated cursor.
* [rachartier/tiny-glimmer.nvim](https://github.com/rachartier/tiny-glimmer.nvim/) ⭐ 406 | 🐛 1 | 🌐 Lua | 📅 2026-01-19 - Adds subtle animations to various operations.
...
* [akinsho/toggleterm.nvim](https://github.com/akinsho/toggleterm.nvim) ⭐ 5,445 | 🐛 89 | 🌐 Lua | 📅 2025-03-09 - Easily manage multiple terminal windows.
...
* [TheLazyCat00/runner-nvim](https://github.com/TheLazyCat00/runner-nvim) ⭐ 9 | 🐛 1 | 🌐 Lua | 📅 2026-02-11 - Run commands in a floating terminal and keep track of the last command executed per CWD, making it easy to repeat build or test commands.
...
* [mfussenegger/nvim-dap](https://github.com/mfussenegger/nvim-dap) ⭐ 7,044 | 🐛 29 | 🌐 Lua | 📅 2026-04-06 - Debug Adapter Protocol client implementation.
...
* [igorlfs/nvim-dap-view](https://github.com/igorlfs/nvim-dap-view) ⭐ 807 | 🐛 9 | 🌐 Lua | 📅 2026-04-03 - A modern, minimalistic UI for nvim-dap.
* [sakhnik/nvim-gdb](https://github.com/sakhnik/nvim-gdb) ⭐ 774 | 🐛 5 | 🌐 Lua | 📅 2025-12-31 - Thin wrapper for GDB, LLDB, PDB/PDB++ and BashDB.
* [andrewferrier/debugprint.nvim](https://github.com/andrewferrier/debugprint.nvim) ⭐ 518 | 🐛 9 | 🌐 Lua | 📅 2026-04-06 - Debugging the print() way.
...
* [stevearc/quicker.nvim](https://github.com/stevearc/quicker.nvim) ⭐ 944 | 🐛 19 | 🌐 Lua | 📅 2026-03-10 - Improved quickfix UI and editable quickfix buffer.
...
* [Vigemus/iron.nvim](https://github.com/Vigemus/iron.nvim) ⭐ 1,326 | 🐛 57 | 🌐 Lua | 📅 2026-02-20 - Interactive REPLs of over 30 languages embedded.
...
* [Civitasv/cmake-tools.nvim](https://github.com/Civitasv/cmake-tools.nvim) ⭐ 531 | 🐛 12 | 🌐 Lua | 📅 2026-04-02 - CMake integration.
...
* [nvim-mini/mini.nvim#mini.doc](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
* [nvim-mini/mini.nvim#mini.test](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` with framework for writing extensive Neovim plugin tests with support for hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.
* [nvim-lua/plenary.nvim](https://github.com/nvim-lua/plenary.nvim) ⭐ 3,430 | 🐛 155 | 🌐 Lua | 📅 2025-07-26 - Plenary: full; complete; entire; absolute; unqualified. All the Lua functions I don't want to write twice.
* [MunifTanjim/nui.nvim](https://github.com/MunifTanjim/nui.nvim) ⭐ 2,047 | 🐛 30 | 🌐 Lua | 📅 2025-06-08 - UI Component Library.
* [folke/lazydev.nvim](https://github.com/folke/lazydev.nvim) ⭐ 1,493 | 🐛 7 | 🌐 Lua | 📅 2026-03-14 - Faster LuaLS setup.
...
* [DrKJeff16/wezterm-types](https://github.com/DrKJeff16/wezterm-types) ⭐ 189 | 🐛 1 | 🌐 Lua | 📅 2026-04-07 - WezTerm config type annotations for LuaLS, including support for community plugins.
...
* [BirdeeHub/lze](https://github.com/BirdeeHub/lze) ⭐ 117 | 🐛 1 | 🌐 Lua | 📅 2026-04-05 - A lazy-loading library for Neovim plugins.
...
* [lumen-oss/luarocks-tag-release](https://github.com/lumen-oss/luarocks-tag-release) ⭐ 56 | 🐛 10 | 🌐 Lua | 📅 2026-04-06 - A GitHub action that publishes your Neovim plugins to LuaRocks.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2025-05-23 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 21,894 | 🐛 17 | 🌐 Go | 📅 2026-03-20 or compatible encryption tools for cryptographic safety.
...
* [Olical/conjure](https://github.com/Olical/conjure) ⭐ 2,077 | 🐛 91 | 🌐 Fennel | 📅 2026-03-28 - Interactive evaluation (Clojure, Fennel, Janet, Racket, Hy, MIT Scheme, Guile).
* [Olical/aniseed](https://github.com/Olical/aniseed) ⭐ 645 | 🐛 7 | 🌐 Fennel | 📅 2025-06-12 - Configure and extend Neovim with Fennel.
* [rktjmp/hotpot.nvim](https://github.com/rktjmp/hotpot.nvim) ⭐ 390 | 🐛 0 | 🌐 Fennel | 📅 2026-04-06 - Seamless, transparent Fennel inside Neovim.
* [Olical/nfnl](https://github.com/Olical/nfnl) ⭐ 344 | 🐛 9 | 🌐 Fennel | 📅 2026-04-02 - Streamlined successor to Aniseed, compiling Fennel to Lua on file write.
...
* [nvim-mini/mini.nvim#mini.diff](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
* [nvim-mini/mini.nvim#mini.git](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for enhanced Git integration with current Neovim process that implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.
* [lewis6991/gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) ⭐ 6,698 | 🐛 32 | 🌐 Lua | 📅 2026-04-06 - Git integration: signs, hunk actions, blame, etc.
...
* [NeogitOrg/neogit](https://github.com/NeogitOrg/neogit) ⭐ 5,267 | 🐛 184 | 🌐 Lua | 📅 2026-04-01 - A Magit clone that may change some things to fit the Vim philosophy.
* [kdheepak/lazygit.nvim](https://github.com/kdheepak/lazygit.nvim) ⭐ 2,237 | 🐛 51 | 🌐 Lua | 📅 2025-12-19 - Plugin for calling lazygit.
* [esmuellert/codediff.nvim](https://github.com/esmuellert/codediff.nvim) ⭐ 1,254 | 🐛 66 | 🌐 Lua | 📅 2026-03-31 - Side-by-side diff with two-tier highlighting (line + character level) using VSCode's algorithm implemented in C.
* [f-person/git-blame.nvim](https://github.com/f-person/git-blame.nvim) ⭐ 1,078 | 🐛 11 | 🌐 Lua | 📅 2025-11-05 - Show Git blame info.
* [tanvirtin/vgit.nvim](https://github.com/tanvirtin/vgit.nvim) ⭐ 843 | 🐛 15 | 🌐 Lua | 📅 2026-03-28 - Visual Git Plugin to enhance your Git experience.
...
* [linrongbin16/gitlinker.nvim](https://github.com/linrongbin16/gitlinker.nvim) ⭐ 268 | 🐛 5 | 🌐 Lua | 📅 2026-04-07 - Maintained fork of "ruifm's gitlinker", refactored with bug fixes, ssh aliases, blame support and other improvements.
...
* [chojs23/ec](https://github.com/chojs23/ec) ⭐ 166 | 🐛 1 | 🌐 Go | 📅 2026-03-24 - A TUI native Git mergetool with 3 panes.
...
* [Kohei-Wada/yadm-git.nvim](https://github.com/Kohei-Wada/yadm-git.nvim) ⭐ 8 | 🐛 1 | 🌐 Lua | 📅 2026-04-06 - Seamless Git plugin support for yadm dotfiles.
...
* [pwntester/octo.nvim](https://github.com/pwntester/octo.nvim) ⭐ 3,217 | 🐛 226 | 🌐 Lua | 📅 2026-04-06 - Work with GitHub issues and PRs.
...
* [nvim-mini/mini.nvim#mini.jump](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for smarter jumping to a single character.
* [nvim-mini/mini.nvim#mini.jump2d](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
* [nvim-mini/mini.nvim#mini.bracketed](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` to go forward/backward with square brackets.
...
* [folke/flash.nvim](https://github.com/folke/flash.nvim) ⭐ 3,987 | 🐛 25 | 🌐 Lua | 📅 2025-10-28 - Navigate your code with search labels, enhanced character motions and Tree-sitter integration.
...
* [Aaronik/Treewalker.nvim](https://github.com/aaronik/Treewalker.nvim) ⭐ 597 | 🐛 1 | 🌐 Lua | 📅 2026-04-05 - Move seamlessly around the abstract syntax tree.
...
* [nvim-mini/mini.nvim#mini.clue](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
* [nvim-mini/mini.nvim#mini.keymap](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).
...
* [mawkler/demicolon.nvim](https://github.com/mawkler/demicolon.nvim) ⭐ 127 | 🐛 1 | 🌐 Lua | 📅 2026-01-25 - Use `;` and `,` keys to also repeat jumps to diagnostics (e.g. `]d`) and to [nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects?tab=readme-ov-file#text-objects-move) ⭐ 2,723 | 🐛 114 | 🌐 Tree-sitter Query | 📅 2026-03-21 (e.g. `]f`), in addition to repeating `t`/`T`/`f`/`F`.
...
* [nvim-mini/mini.nvim#mini.map](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.
...
* [lewis6991/satellite.nvim](https://github.com/lewis6991/satellite.nvim) ⭐ 708 | 🐛 16 | 🌐 Lua | 📅 2026-03-31 - Decorate scrollbar.
...
* [nvim-mini/mini.nvim#mini.pairs](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
* [nvim-mini/mini.nvim#mini.trailspace](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
* [nvim-mini/mini.nvim#mini.operators](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
* [nvim-mini/mini.nvim#mini.move](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
* [nvim-mini/mini.nvim#mini.ai](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some built-in textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
* [nvim-mini/mini.nvim#mini.splitjoin](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
* [nvim-mini/mini.nvim#mini.basics](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.
...
* [windwp/nvim-ts-autotag](https://github.com/windwp/nvim-ts-autotag) ⭐ 2,079 | 🐛 9 | 🌐 Lua | 📅 2026-02-04 - Use Tree-sitter to autoclose and autorename XML, HTML, JSX tag.
* [jake-stewart/multicursor.nvim](https://github.com/jake-stewart/multicursor.nvim) ⭐ 1,442 | 🐛 0 | 🌐 Lua | 📅 2026-03-24 - Adds support for multiple cursors which work how you expect.
...
* [gbprod/yanky.nvim](https://github.com/gbprod/yanky.nvim) ⭐ 1,234 | 🐛 35 | 🌐 Lua | 📅 2026-03-12 - Improved Yank and Put functionalities.
* [monaqa/dial.nvim](https://github.com/monaqa/dial.nvim) ⭐ 1,061 | 🐛 17 | 🌐 Lua | 📅 2025-12-21 - Extended increment/decrement.
* [cshuaimin/ssr.nvim](https://github.com/cshuaimin/ssr.nvim) ⭐ 991 | 🐛 18 | 🌐 Lua | 📅 2026-04-06 - Tree-sitter based structural search and replace.
...
* [HiPhish/rainbow-delimiters.nvim](https://github.com/HiPhish/rainbow-delimiters.nvim) ⭐ 855 | 🐛 21 | 🌐 Lua | 📅 2026-04-06 - Rainbow delimiters with Tree-sitter.
...
* [chrisgrieser/nvim-various-textobjs](https://github.com/chrisgrieser/nvim-various-textobjs) ⭐ 757 | 🐛 0 | 🌐 Lua | 📅 2026-04-03 - Bundle of more than 30 new text objects.
...
* [m4xshen/autoclose.nvim](https://github.com/m4xshen/autoclose.nvim) ⭐ 639 | 🐛 13 | 🌐 Lua | 📅 2026-03-22 - A minimalist autoclose plugin written in Lua.
...
* [brenton-leighton/multiple-cursors.nvim](https://github.com/brenton-leighton/multiple-cursors.nvim) ⭐ 402 | 🐛 2 | 🌐 Lua | 📅 2026-01-02 - A multi-cursor plugin that works in normal, insert/replace, or visual modes, and with almost every command.
...
* [Wansmer/sibling-swap.nvim](https://github.com/Wansmer/sibling-swap.nvim) ⭐ 181 | 🐛 2 | 🌐 Lua | 📅 2026-04-06 - Different way to swapping arguments and other siblings with Tree-sitter.
...
* [XXiaoA/atone.nvim](https://github.com/XXiaoA/atone.nvim) ⭐ 163 | 🐛 2 | 🌐 Lua | 📅 2026-04-06 - Undo tree for visualizing and managing undo history.
...
* [nvim-mini/mini.nvim#mini.comment](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.
* [numToStr/Comment.nvim](https://github.com/numToStr/Comment.nvim) ⭐ 4,625 | 🐛 81 | 🌐 Lua | 📅 2024-08-19 - Smart and powerful comment plugin. Supports commentstring, motions, dot-repeat and more.
* [folke/todo-comments.nvim](https://github.com/folke/todo-comments.nvim) ⭐ 4,100 | 🐛 19 | 🌐 Lua | 📅 2025-11-10 - Highlight, list and search TODO comments in your projects.
...
* [JoosepAlviste/nvim-ts-context-commentstring](https://github.com/JoosepAlviste/nvim-ts-context-commentstring) ⭐ 1,292 | 🐛 20 | 🌐 Lua | 📅 2026-04-04 - Sets the `commentstring` option based on the cursor location in the file. The location is checked via Tree-sitter queries.
...
* [chrisgrieser/nvim-origami](https://github.com/chrisgrieser/nvim-origami) ⭐ 481 | 🐛 3 | 🌐 Lua | 📅 2026-04-06 - Fold with relentless elegance.
...
* [nvim-mini/mini.nvim#mini.align](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for aligning text interactively (with or without instant preview).
* [stevearc/conform.nvim](https://github.com/stevearc/conform.nvim) ⭐ 5,030 | 🐛 93 | 🌐 Lua | 📅 2026-03-10 - A lightweight formatting engine that plays nice with LSP.
...
* [nvim-mini/mini.nvim#mini.indentscope](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.
...
* [shellRaining/hlchunk.nvim](https://github.com/shellRaining/hlchunk.nvim) ⭐ 895 | 🐛 33 | 🌐 Lua | 📅 2025-12-15 - A Lua implementation of `nvim-hlchunk`, contains more features, such as highlight `{}` chunk, indent line, space blank etc.
* [NMAC427/guess-indent.nvim](https://github.com/NMAC427/guess-indent.nvim) ⭐ 618 | 🐛 16 | 🌐 Lua | 📅 2025-03-25 - Automatic indentation style detection.
...
* [nvim-mini/mini.nvim#mini.cmdline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cmdline.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for command line tweaks. Adds autocompletion with customizable delay, autocorrection for words with fixed candidates, and autopeek command range in a floating window.
...
* [nvim-mini/mini.nvim#mini.sessions](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for session management (read, write, delete).
...
* [nosduco/remote-sshfs.nvim](https://github.com/nosduco/remote-sshfs.nvim) ⭐ 392 | 🐛 18 | 🌐 Lua | 📅 2026-04-05 - Explore, edit, and develop on a remote machine via SSHFS.
...
* [azratul/live-share.nvim](https://github.com/azratul/live-share.nvim) ⭐ 243 | 🐛 0 | 🌐 Lua | 📅 2026-04-06 - Provides remote collaboration capabilities from anywhere, making it ideal for pair-programming scenarios.
...
* [kiyoon/jupynium.nvim](https://github.com/kiyoon/jupynium.nvim) ⭐ 754 | 🐛 10 | 🌐 Python | 📅 2025-12-26 - Selenium-automated Jupyter Notebook that is synchronised with Neovim in real-time.
...
* [brianhuster/live-preview.nvim](https://github.com/brianhuster/live-preview.nvim) ⭐ 370 | 🐛 25 | 🌐 Lua | 📅 2026-03-29 - Live preview HTML, Markdown and Asciidoc in the browser.
...
* [nvim-mini/mini.nvim#mini.bufremove](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,608 | 🐛 16 | 🌐 Lua | 📅 2026-04-06 - Smart, seamless, directional navigation and resizing of splits.
...
* [kawre/leetcode.nvim](https://github.com/kawre/leetcode.nvim) ⭐ 2,032 | 🐛 60 | 🌐 Lua | 📅 2025-09-21 - Solve Leetcode problems.
* [xeluxee/competitest.nvim](https://github.com/xeluxee/competitest.nvim) ⭐ 570 | 🐛 22 | 🌐 Lua | 📅 2025-05-13 - A plugin to automate testcases management and checking for Competitive Programming contests.
...
* [emrearmagan/atlas.nvim](https://github.com/emrearmagan/atlas.nvim) ⭐ 14 | 🐛 0 | 🌐 Lua | 📅 2026-04-06 - Manage Bitbucket PRs and Jira issues.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 57 | 🐛 6 | 🌐 Go | 📅 2026-04-07 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [joryeugene/dadbod-grip.nvim](https://github.com/joryeugene/dadbod-grip.nvim) ⭐ 133 | 🐛 0 | 🌐 Lua | 📅 2026-04-06 - Database editor with inline cell editing, staged mutations with live SQL preview, schema browser, DDL, AI SQL generation, FK navigation, and DuckDB/Parquet support.
...
* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 30,103 | 🐛 19 | 🌐 Lua | 📅 2026-03-31 - A launch point for your personal Neovim configuration.
* [siduck76/NvChad](https://github.com/siduck76/NvChad) ⭐ 28,061 | 🐛 1 | 🌐 Lua | 📅 2026-02-07 - An attempt to make Neovim's CLI as functional as an IDE while retaining beauty with less bloat.
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 25,749 | 🐛 43 | 🌐 Lua | 📅 2026-04-02 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
...
* [AstroNvim/AstroNvim](https://github.com/AstroNvim/AstroNvim) ⭐ 14,228 | 🐛 1 | 🌐 Lua | 📅 2026-04-01 - An aesthetic and feature-rich config that is extensible and easy to use with a great set of plugins.
* [ayamir/nvimdots](https://github.com/ayamir/nvimdots) ⭐ 3,391 | 🐛 11 | 🌐 Lua | 📅 2026-04-06 - A well-configured and structured configuration with NixOS support.
...
* [dam9000/kickstart-modular.nvim](https://github.com/dam9000/kickstart-modular.nvim) ⭐ 966 | 🐛 0 | 🌐 Lua | 📅 2026-04-03 - This is a fork of nvim-lua/kickstart.nvim that moves from a single file to a multi file configuration.
...
* [NormalNvim/NormalNvim](https://github.com/NormalNvim/NormalNvim) ⭐ 707 | 🐛 4 | 🌐 Lua | 📅 2026-04-01 - Configuration focused on stability for your daily work.
...
* [nvim-mini/MiniMax](https://github.com/nvim-mini/MiniMax) ⭐ 378 | 🐛 3 | 🌐 Lua | 📅 2026-04-04 - A collection of self-contained and extensively commented configurations which mostly use MINI tools.
...
* [linrongbin16/lin.nvim](https://github.com/linrongbin16/lin.nvim) ⭐ 91 | 🐛 1 | 🌐 Lua | 📅 2026-04-07 - A highly configured Neovim distribution integrated with tons of utilities for development, inspired by `spf13-vim`.
...
* [MordechaiHadad/bob](https://github.com/MordechaiHadad/bob) ⭐ 2,071 | 🐛 31 | 🌐 Rust | 📅 2026-03-24 - A cross-platform, easy to use Neovim version manager.
...
* [y3owk1n/nvs](https://github.com/y3owk1n/nvs) ⭐ 31 | 🐛 0 | 🌐 Go | 📅 2026-04-06 - Another Neovim version manager with config switcher.
...
* [m15a/flake-awesome-neovim-plugins](https://github.com/m15a/flake-awesome-neovim-plugins) ⭐ 62 | 🐛 0 | 🌐 Nix | 📅 2026-04-06 - Nix flake that provides a collection of `awesome-neovim` plugins as Nix packages.
...
* [nvim-mini/mini.nvim#mini.notify](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) ⭐ 8,962 | 🐛 35 | 🌐 Lua | 📅 2026-04-03 - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.
* [folke/noice.nvim](https://github.com/folke/noice.nvim) ⭐ 5,683 | 🐛 29 | 🌐 Lua | 📅 2025-11-03 - Highly experimental plugin that completely replaces the UI for messages, cmdline and the popupmenu.
...
* [cpea2506/relative-toggle.nvim](https://github.com/cpea2506/relative-toggle.nvim) ⭐ 36 | 🐛 0 | 🌐 Lua | 📅 2025-07-13 - Toggles smoothly between number and relative numbers, supporting various number combinations, highly customizable.
