...
* [savq/paq-nvim](https://github.com/savq/paq-nvim) ⭐ 715 | 🐛 5 | 🌐 Lua | 📅 2025-03-30 - Package manager written in Lua.
...
* [folke/lazy.nvim](https://github.com/folke/lazy.nvim) ⭐ 20,440 | 🐛 51 | 🌐 Lua | 📅 2025-12-17 - A modern plugin manager, featuring a graphical interface, async execution, a lockfile and more.
...
* [nvim-mini/mini.nvim#mini.deps](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-deps.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for managing other plugins. Uses Git and built-in packages to install, update, clean, and snapshot plugins.
...
* [alex-popov-tech/store.nvim](https://github.com/alex-popov-tech/store.nvim) ⭐ 321 | 🐛 0 | 🌐 Lua | 📅 2026-03-06 - Plugins discovery tool with hourly updated database, and one-key installation for `lazy.nvim` and `vim.pack`.
...
* [wsdjeg/nvim-plug](https://github.com/wsdjeg/nvim-plug) ⭐ 31 | 🐛 1 | 🌐 Lua | 📅 2026-02-21 - Asynchronous plugin manager written in Lua.
...
* [neovim/nvim-lspconfig](https://github.com/neovim/nvim-lspconfig) ⭐ 13,423 | 🐛 34 | 🌐 Lua | 📅 2026-03-06 - Quickstart configurations for the LSP client.

<!--lint enable awesome-spell-check-->

* [nvimdev/lspsaga.nvim](https://github.com/nvimdev/lspsaga.nvim) ⭐ 3,753 | 🐛 97 | 🌐 Lua | 📅 2026-03-03 - A light-weight LSP plugin based on the built-in LSP with a highly performant UI.
* [mfussenegger/nvim-lint](https://github.com/mfussenegger/nvim-lint) ⭐ 2,661 | 🐛 42 | 🌐 Lua | 📅 2026-02-23 - An asynchronous linter plugin, complementary to the built-in Language Server Protocol support.
* [j-hui/fidget.nvim](https://github.com/j-hui/fidget.nvim) ⭐ 2,487 | 🐛 21 | 🌐 Lua | 📅 2026-01-13 - Standalone UI for LSP progress.
* [ray-x/lsp\_signature.nvim](https://github.com/ray-x/lsp_signature.nvim) ⭐ 2,338 | 🐛 89 | 🌐 Lua | 📅 2026-03-01 - LSP signature hint when you type.
* [stevearc/aerial.nvim](https://github.com/stevearc/aerial.nvim) ⭐ 2,236 | 🐛 72 | 🌐 Lua | 📅 2026-02-25 - A code outline window for skimming and quick navigation.
* [onsails/lspkind.nvim](https://github.com/onsails/lspkind.nvim) ⭐ 1,667 | 🐛 15 | 🌐 Lua | 📅 2026-01-29 - The plugin adds VSCode-like icons to LSP completions.
...
* [b0o/SchemaStore.nvim](https://github.com/b0o/SchemaStore.nvim) ⭐ 979 | 🐛 11 | 🌐 Lua | 📅 2026-03-04 - Provide access to the [SchemaStore](https://github.com/SchemaStore/schemastore) ⭐ 3,669 | 🐛 113 | 🌐 JavaScript | 📅 2026-03-06 catalog.
...
* [smjonas/inc-rename.nvim](https://github.com/smjonas/inc-rename.nvim) ⭐ 832 | 🐛 10 | 🌐 Lua | 📅 2026-03-02 - Provides an incremental LSP rename command based on the command-preview feature.
...
* [tamago324/nlsp-settings.nvim](https://github.com/tamago324/nlsp-settings.nvim) ⭐ 336 | 🐛 10 | 🌐 Lua | 📅 2026-03-07 - Setup LSP with JSON or YAML files.
...
* [scalameta/nvim-metals](https://github.com/scalameta/nvim-metals) ⭐ 551 | 🐛 22 | 🌐 Lua | 📅 2026-01-16 - Provides a better experience while using [Metals](https://scalameta.org/metals/), the Scala Language Server, using the built-in LSP support.

<!--lint enable double-link-->

* [nvimtools/none-ls.nvim](https://github.com/nvimtools/none-ls.nvim) ⭐ 3,223 | 🐛 9 | 🌐 Lua | 📅 2026-02-16 - Null-ls.nvim reloaded / Use Neovim as a language server to inject LSP diagnostics, code actions, and more via Lua.
* [mrcjkb/rustaceanvim](https://github.com/mrcjkb/rustaceanvim) ⭐ 2,855 | 🐛 18 | 🌐 Lua | 📅 2026-03-04 - A heavily modified fork of rust-tools.nvim that does not require a `setup` call and does not depend on nvim-lspconfig.
* [rachartier/tiny-inline-diagnostic.nvim](https://github.com/rachartier/tiny-inline-diagnostic.nvim) ⭐ 1,588 | 🐛 0 | 🌐 Lua | 📅 2026-02-24 - Display prettier diagnostic messages. Display one line diagnostic messages where the cursor is, with icons and colors.
* [mfussenegger/nvim-jdtls](https://github.com/mfussenegger/nvim-jdtls) ⭐ 1,444 | 🐛 1 | 🌐 Lua | 📅 2026-02-10 - Extensions for the built-in LSP support for the Eclipse JDT Language Server.
* [DNLHC/glance.nvim](https://github.com/DNLHC/glance.nvim) ⭐ 865 | 🐛 17 | 🌐 Lua | 📅 2025-06-16 - A pretty window for previewing, navigating and editing your LSP locations.
* [jmbuhr/otter.nvim](https://github.com/jmbuhr/otter.nvim) ⭐ 846 | 🐛 17 | 🌐 Lua | 📅 2026-02-14 - Provides LSP features and a nvim-cmp completion source for languages embedded in other documents.
...
* [zeioth/garbage-day.nvim](https://github.com/Zeioth/garbage-day.nvim) ⭐ 503 | 🐛 1 | 🌐 Lua | 📅 2026-02-25 - Garbage collector that stops inactive LSP clients to free RAM.
...
* [rachartier/tiny-code-action.nvim](https://github.com/rachartier/tiny-code-action.nvim) ⭐ 449 | 🐛 0 | 🌐 Lua | 📅 2026-02-25 - Provides a simple way to run and visualize code actions with Telescope.
...
* [creativenull/efmls-configs-nvim](https://github.com/creativenull/efmls-configs-nvim) ⭐ 306 | 🐛 1 | 🌐 Lua | 📅 2026-01-13 - An unofficial collection of linters and formatters configured for efm-langserver to work with built-in LSP.
* [jinzhongjia/LspUI.nvim](https://github.com/jinzhongjia/LspUI.nvim) ⭐ 278 | 🐛 0 | 🌐 Lua | 📅 2026-03-03 - A modern and useful UI that wraps LSP operations.
...
* [esmuellert/nvim-eslint](https://github.com/esmuellert/nvim-eslint) ⭐ 81 | 🐛 3 | 🌐 Python | 📅 2026-02-21 - Bundle VSCode ESLint language server and utilize the native LSP client to provide a all-in-one ESLint experience.
...
* [nemanjamalesija/ts-expand-hover.nvim](https://github.com/nemanjamalesija/ts-expand-hover.nvim) ⭐ 40 | 🐛 1 | 🌐 Lua | 📅 2026-03-06 - Progressively expand and collapse TypeScript type aliases inside the hover float.
...
* [mason-org/mason.nvim](https://github.com/mason-org/mason.nvim) ⭐ 10,089 | 🐛 266 | 🌐 Lua | 📅 2026-01-07 - Portable package manager that runs everywhere Neovim runs. Easily install and manage LSP servers, DAP servers, linters, and formatters.

### Diagnostics

* [folke/trouble.nvim](https://github.com/folke/trouble.nvim) ⭐ 6,690 | 🐛 18 | 🌐 Lua | 📅 2025-10-31 - A pretty diagnostics list to help you solve all the trouble your code is causing.
* [piersolenski/wtf.nvim](https://github.com/piersolenski/wtf.nvim) ⭐ 585 | 🐛 2 | 🌐 Lua | 📅 2026-03-02 - AI powered diagnostic debugging, helps explain complex errors and offers custom tailored solutions.
...
* [Kurama622/clean-diagnostic](https://github.com/Kurama622/clean-diagnostic) ⭐ 4 | 🐛 0 | 🌐 Lua | 📅 2026-03-04 - Display diagnostic count using virtual text, and show diagnostic details in a floating window.
...
* [hrsh7th/nvim-cmp](https://github.com/hrsh7th/nvim-cmp) ⭐ 9,350 | 🐛 299 | 🌐 Lua | 📅 2026-01-23 - Completion engine written in Lua, successor of `nvim-compe`.
  * [hrsh7th/cmp-nvim-lsp](https://github.com/hrsh7th/cmp-nvim-lsp) ⭐ 1,491 | 🐛 29 | 🌐 Lua | 📅 2025-11-13 - `nvim-cmp` source for the built-in LSP client.
...
* [nvim-mini/mini.nvim#mini.completion](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-completion.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for asynchronous two-stage completion. Supports showing completion item info and independent function signature.
* [saghen/blink.cmp](https://github.com/saghen/blink.cmp) ⭐ 6,017 | 🐛 142 | 🌐 Lua | 📅 2026-03-05 - Really fast completion with LSP and snippet support, along with signature help, cmdline completion, and autobracket support (based on semantic tokens).
  ...
  * [mikavilpas/blink-ripgrep.nvim](https://github.com/mikavilpas/blink-ripgrep.nvim) ⭐ 112 | 🐛 1 | 🌐 TypeScript | 📅 2026-03-07 - `blink.cmp` source for `ripgrep` / `git grep`.
  * [Kasier-Yang/blink-cmp-avante](https://github.com/Kaiser-Yang/blink-cmp-avante) ⭐ 107 | 🐛 3 | 🌐 Lua | 📅 2025-07-24 - `blink-cmp` source for Avante.
  ...
  * [mgalliou/blink-cmp-tmux](https://github.com/mgalliou/blink-cmp-tmux) ⭐ 10 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - `blink.cmp` source for [tmux](https://github.com/tmux/tmux) ⭐ 42,689 | 🐛 53 | 🌐 C | 📅 2026-03-06.
...
* [zbirenbaum/copilot.lua](https://github.com/zbirenbaum/copilot.lua) ⭐ 3,994 | 🐛 14 | 🌐 Lua | 📅 2026-03-07 - Fully featured Lua replacement for [GitHub/copilot.vim](https://github.com/github/copilot.vim) ⭐ 11,419 | 🐛 50 | 🌐 Vim Script | 📅 2026-01-09.
...
* [yetone/avante.nvim](https://github.com/yetone/avante.nvim) ⭐ 17,518 | 🐛 65 | 🌐 Lua | 📅 2026-03-06 - Chat with your code as if you are in Cursor AI IDE.
* [olimorris/codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ⭐ 6,257 | 🐛 24 | 🌐 Lua | 📅 2026-03-07 - Copilot Chat like experience, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI.
* [jackMort/ChatGPT.nvim](https://github.com/jackMort/ChatGPT.nvim) ⭐ 4,017 | 🐛 111 | 🌐 Lua | 📅 2026-01-13 - Effortless Natural Language Generation with OpenAI's ChatGPT API.
* [CopilotC-Nvim/CopilotChat.nvim](https://github.com/CopilotC-Nvim/CopilotChat.nvim) ⭐ 3,582 | 🐛 21 | 🌐 Lua | 📅 2026-02-12 - A chat interface for GitHub Copilot that allows you to directly ask and receive answers to coding-related questions.
* [nickjvandyke/opencode.nvim](https://github.com/nickjvandyke/opencode.nvim) ⭐ 2,793 | 🐛 20 | 🌐 Lua | 📅 2026-03-07 - OpenCode AI assistant integration.
* [David-Kunz/gen.nvim](https://github.com/David-Kunz/gen.nvim) ⭐ 1,516 | 🐛 25 | 🌐 Lua | 📅 2025-05-03 - Generate text using LLMs (via Ollama) with customizable prompts.
* [Robitx/gp.nvim](https://github.com/Robitx/gp.nvim) ⭐ 1,310 | 🐛 70 | 🌐 Lua | 📅 2025-08-11 - ChatGPT like sessions and instructable text/code operations in your favorite editor.
* [Exafunction/windsurf.nvim](https://github.com/Exafunction/windsurf.nvim) ⭐ 1,252 | 🐛 115 | 🌐 Lua | 📅 2025-04-30 - Free, ultrafast Copilot alternative. Supports LSP and Tree-sitter.
* [milanglacier/minuet-ai.nvim](https://github.com/milanglacier/minuet-ai.nvim) ⭐ 1,046 | 🐛 15 | 🌐 Lua | 📅 2026-02-03 - Minuet offers code completion from LLM providers including OpenAI (compatible), Gemini, Claude, Ollama, Deepseek and more providers, with support for nvim-cmp, blink.cmp and virtual-text frontend.
* [Davidyz/VectorCode](https://github.com/davidyz/vectorcode) ⭐ 816 | 🐛 16 | 🌐 Python | 📅 2026-02-23 - Supercharge your LLM experience with repository-level RAG.
...
* [Kurama622/llm.nvim](https://github.com/Kurama622/llm.nvim) ⭐ 464 | 🐛 1 | 🌐 Lua | 📅 2026-03-07 - Free large language model (LLM) support, provides commands to interact with LLM.
* [dlants/magenta.nvim](https://github.com/dlants/magenta.nvim) ⭐ 427 | 🐛 29 | 🌐 TypeScript | 📅 2026-03-07 - Leverage coding assistants for chat and code generation. Provides tools for the AI/LLM agent to explore and edit your code, like Aider, Cursor and Windsurf.
...
* [carlos-algms/agentic.nvim](https://github.com/carlos-algms/agentic.nvim) ⭐ 239 | 🐛 8 | 🌐 Lua | 📅 2026-03-04 - Chat interface for AI ACP providers such as Claude, Gemini, Codex, OpenCode and Cursor.
...
* [Flemma-Dev/flemma.nvim](https://github.com/Flemma-Dev/flemma.nvim) ⭐ 47 | 🐛 1 | 🌐 Lua | 📅 2026-03-07 - A first-class AI workspace.
...
* [wsdjeg/chat.nvim](https://github.com/wsdjeg/chat.nvim) ⭐ 18 | 🐛 1 | 🌐 Lua | 📅 2026-03-07 - A lightweight, extensible chat plugin with AI integration, multiple providers, and built-in tools.
...
* [julwrites/llm-nvim](https://github.com/julwrites/llm-nvim) ⭐ 8 | 🐛 4 | 🌐 Lua | 📅 2025-12-31 - Comprehensive integration with the [LLM](https://github.com/simonw/llm) ⭐ 11,289 | 🐛 563 | 🌐 Python | 📅 2026-03-06 tool.
...
* [nvim-java/nvim-java](https://github.com/nvim-java/nvim-java) ⭐ 1,588 | 🐛 34 | 🌐 Lua | 📅 2026-02-05 - Everything you need for a painless Java experience.
* [nvim-flutter/flutter-tools.nvim](https://github.com/nvim-flutter/flutter-tools.nvim) ⭐ 1,361 | 🐛 32 | 🌐 Lua | 📅 2026-01-14 - Build Flutter and Dart applications using the native LSP.
* [chomosuke/typst-preview.nvim](https://github.com/chomosuke/typst-preview.nvim) ⭐ 850 | 🐛 15 | 🌐 Lua | 📅 2025-12-31 - Preview Typst documents in the browser, instant update on each keystroke, and cross jump between code and preview.
...
* [Julian/lean.nvim](https://github.com/Julian/lean.nvim) ⭐ 487 | 🐛 34 | 🌐 Lua | 📅 2026-03-03 - Support for the [Lean Theorem Prover](https://leanprover.github.io/).
...
* [nanotee/sqls.nvim](https://github.com/nanotee/sqls.nvim) ⭐ 245 | 🐛 11 | 🌐 Lua | 📅 2025-09-02 - SQL database connection plugin + LSP client.
* [apyra/nvim-unity.nvim](https://github.com/apyra/nvim-unity) ⭐ 98 | 🐛 9 | 🌐 C# | 📅 2026-02-22 - Use Neovim as your default Unity editor with full LSP support via OmniSharp.
...
* [ray-x/go.nvim](https://github.com/ray-x/go.nvim) ⭐ 2,605 | 🐛 96 | 🌐 Lua | 📅 2026-03-08 - Golang plugin based on LSP and Tree-sitter.
...
* [mistweaverco/kulala.nvim](https://github.com/mistweaverco/kulala.nvim) ⭐ 1,915 | 🐛 14 | 🌐 Lua | 📅 2026-02-11 - A minimal HTTP-client interface.
...
* [abidibo/nvim-httpyac](https://github.com/abidibo/nvim-httpyac) ⭐ 15 | 🐛 0 | 🌐 Lua | 📅 2026-01-20 - Provides integration with `httpYac`.
...
* [iamcco/markdown-preview.nvim](https://github.com/iamcco/markdown-preview.nvim) ⭐ 7,729 | 🐛 259 | 🌐 JavaScript | 📅 2024-07-23 - Preview Markdown on your modern browser with synchronised scrolling and flexible configuration.
* [MeanderingProgrammer/render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim) ⭐ 4,220 | 🐛 4 | 🌐 Lua | 📅 2026-03-05 - Improve viewing Markdown files directly.
* [OXY2DEV/markview.nvim](https://github.com/OXY2DEV/markview.nvim) ⭐ 3,305 | 🐛 1 | 🌐 Lua | 📅 2026-03-07 - A hackable Markdown, Typst, LaTeX, HTML (inline) and YAML renderer.
* [toppair/peek.nvim](https://github.com/toppair/peek.nvim) ⭐ 845 | 🐛 37 | 🌐 TypeScript | 📅 2024-08-20 - Preview Markdown in a webview window.
...
* [Zeioth/markmap.nvim](https://github.com/Zeioth/markmap.nvim) ⭐ 239 | 🐛 2 | 🌐 Lua | 📅 2025-11-11 - Visualize your Markdown as mindmaps.
* [tadmccorkle/markdown.nvim](https://github.com/tadmccorkle/markdown.nvim) ⭐ 232 | 🐛 8 | 🌐 Lua | 📅 2025-12-22 - Configurable tools for Markdown files, including inline-style, link, and navigation keymaps, table of contents, improved list editing, and more.
...
* [Thiago4532/mdmath.nvim](https://github.com/Thiago4532/mdmath.nvim) ⭐ 210 | 🐛 14 | 🌐 Lua | 📅 2024-12-27 - A Markdown equation previewer, using kitty Graphics Protocol.
* [YousefHadder/markdown-plus.nvim](https://github.com/YousefHadder/markdown-plus.nvim) ⭐ 198 | 🐛 15 | 🌐 Lua | 📅 2026-03-08 - Provides a full editing experience for Markdown files which includes support for lists, links, TOC, and more with simple and fast keymaps.
...
* [Kicamon/markdown-table-mode.nvim](https://github.com/Kicamon/markdown-table-mode.nvim) ⭐ 95 | 🐛 6 | 🌐 Lua | 📅 2025-07-13 - Markdown format plugin like vim-table-mode but write in Lua.
* [SCJangra/table-nvim](https://github.com/SCJangra/table-nvim) ⭐ 71 | 🐛 1 | 🌐 Lua | 📅 2026-02-25 - A Markdown table editor that formats the table as you type.
...
* [gbprod/phpactor.nvim](https://github.com/gbprod/phpactor.nvim) ⭐ 93 | 🐛 2 | 🌐 Lua | 📅 2026-01-07 - Lua version of [phpactor](https://github.com/phpactor/phpactor) ⭐ 1,821 | 🐛 297 | 🌐 PHP | 📅 2026-03-06.
* [ta-tikoma/php.easy.nvim](https://github.com/ta-tikoma/php.easy.nvim) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2026-02-25 - Methods of assistance in PHP development: create classes, constants, methods, properties; simple copying and deleting of an entity.
...
* [Who5673/who5673-nasm](https://github.com/Who5673/who5673-nasm) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2026-01-05 - Helps people program Netwide Assembler language faster and more convenient using snippets.
...
* [acidsugarx/babel.nvim](https://github.com/acidsugarx/babel.nvim) ⭐ 12 | 🐛 3 | 🌐 Lua | 📅 2026-03-01 - Translate text using Google Translate with async support, float display, and multi-picker integration.
...
* [nvim-treesitter/nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter) ⭐ 13,357 | 🐛 269 | 🌐 Tree-sitter Query | 📅 2026-03-07 - Tree-sitter configurations and abstraction layer.
* [nvim-mini/mini.nvim#mini.surround](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-surround.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for working with text surroundings (add, delete, replace, find, highlight). Supports dot-repeat, different search methods, "last"/"next" extended mappings, Tree-sitter integration, and more.
* [kylechui/nvim-surround](https://github.com/kylechui/nvim-surround) ⭐ 4,128 | 🐛 8 | 🌐 Lua | 📅 2026-03-07 - A plugin for adding/changing/deleting surrounding delimiter pairs.
* [nvim-treesitter/nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects) ⭐ 2,699 | 🐛 110 | 🌐 Tree-sitter Query | 📅 2026-03-04 - Create your own textobjects using Tree-sitter queries.
...
* [IndianBoy42/tree-sitter-just](https://github.com/IndianBoy42/tree-sitter-just) ⭐ 181 | 🐛 6 | 🌐 Just | 📅 2026-02-09 - Tree-sitter grammar for [Justfiles](https://github.com/casey/just) ⭐ 31,900 | 🐛 393 | 🌐 Rust | 📅 2026-03-07.
* [LhKipp/nvim-nu](https://github.com/LhKipp/nvim-nu) ⭐ 159 | 🐛 4 | 🌐 Lua | 📅 2024-12-10 - Basic editor support for the nushell language.
* [fei6409/log-highlight.nvim](https://github.com/fei6409/log-highlight.nvim) ⭐ 155 | 🐛 0 | 🌐 Vim Script | 📅 2026-02-14 - Generic log syntax highlighting and log filetype management support.
...
* [desdic/agrolens.nvim](https://github.com/desdic/agrolens.nvim) ⭐ 69 | 🐛 0 | 🌐 Lua | 📅 2026-01-04 - Navigate via Tree-sitter nodes using Telescope or FZF.
...
* [nvim-mini/mini.nvim#mini.snippets](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-snippets.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` to manage and expand snippets. Supports LSP snippet syntax, flexible loaders, fuzzy prefix matching, interactive selection, snippet session with rich visualization, and more.
* [L3MON4D3/LuaSnip](https://github.com/L3MON4D3/LuaSnip) ⭐ 4,292 | 🐛 129 | 🌐 Lua | 📅 2026-01-19 - A snippet engine written in Lua.
* [rafamadriz/friendly-snippets](https://github.com/rafamadriz/friendly-snippets) ⭐ 2,666 | 🐛 65 | 🌐 Lua | 📅 2026-01-23 - Set of preconfigured snippets for different languages.
...
* [dcampos/nvim-snippy](https://github.com/dcampos/nvim-snippy) ⭐ 341 | 🐛 8 | 🌐 Lua | 📅 2025-09-21 - Snippet plugin written in Lua with support for [vim-snippets](https://github.com/honza/vim-snippets) ⭐ 4,873 | 🐛 85 | 🌐 Vim Snippet | 📅 2025-10-28.
...
* [ThePrimeagen/harpoon](https://github.com/ThePrimeagen/harpoon/tree/harpoon2) ⭐ 8,939 | 🐛 150 | 🌐 Lua | 📅 2025-10-31 - A per project, auto updating and editable marks utility for fast file navigation.
* [chentoast/marks.nvim](https://github.com/chentoast/marks.nvim) ⭐ 1,146 | 🐛 56 | 🌐 Lua | 📅 2025-05-13 - A better user experience for viewing and interacting with Vim marks.
...
* [cbochs/grapple.nvim](https://github.com/cbochs/grapple.nvim) ⭐ 688 | 🐛 24 | 🌐 Lua | 📅 2024-09-29 - Provides tagging, cursor tracking, and immediate navigation to important project files.
* [LintaoAmons/bookmarks.nvim](https://github.com/LintaoAmons/bookmarks.nvim) ⭐ 286 | 🐛 17 | 🌐 Lua | 📅 2025-10-24 - Your new bookmarks option: simple yet powerful.
...
* [fnune/recall.nvim](https://github.com/fnune/recall.nvim) ⭐ 92 | 🐛 3 | 🌐 Lua | 📅 2026-03-06 - Recall refines the use of marks by focusing on global marks, streamlining their usage and enhancing their visibility and navigability.
...
* [dimtion/guttermarks.nvim](https://github.com/dimtion/guttermarks.nvim) ⭐ 46 | 🐛 0 | 🌐 Lua | 📅 2026-02-23 - Display marks in the buffer gutter.
...
* [MagicDuck/grug-far.nvim](https://github.com/MagicDuck/grug-far.nvim) ⭐ 1,821 | 🐛 6 | 🌐 Lua | 📅 2026-03-03 - Buffer-based live search and replace with full power of `rg` flags. Grug like!
* [kevinhwang91/nvim-hlslens](https://github.com/kevinhwang91/nvim-hlslens) ⭐ 898 | 🐛 9 | 🌐 Lua | 📅 2026-01-11 - Helps you better glance searched information, seamlessly jump matched instances.
...
* [ray-x/sad.nvim](https://github.com/ray-x/sad.nvim) ⭐ 204 | 🐛 4 | 🌐 Lua | 📅 2025-05-01 - Space Age seD integration. Batch file edit tool, a wrapper for [sad](https://github.com/ms-jpq/sad) ⭐ 2,012 | 🐛 28 | 🌐 Rust | 📅 2025-09-30
...
* [polirritmico/telescope-lazy-plugins.nvim](https://github.com/polirritmico/telescope-lazy-plugins.nvim) ⭐ 74 | 🐛 0 | 🌐 Lua | 📅 2025-02-15 - A Telescope picker to quickly access plugins configurations from the lazy.nvim spec.
...
* [nvim-telescope/telescope.nvim](https://github.com/nvim-telescope/telescope.nvim) ⭐ 19,154 | 🐛 487 | 🌐 Lua | 📅 2026-02-16 - Telescope.nvim is a highly [extendable](https://github.com/nvim-telescope/telescope.nvim/wiki/Extensions) ⭐ 19,154 | 🐛 487 | 🌐 Lua | 📅 2026-02-16 A highly extensible fuzzy finder over lists.
* [nvim-mini/mini.nvim#mini.fuzzy](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-fuzzy.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` with functions to perform fuzzy matching of one string to others along with fast Telescope sorter.
* [nvim-mini/mini.nvim#mini.pick](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pick.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` with general purpose interactive non-blocking picker that has one window design, toggleable preview, flexible and fast default match, and much more.
* [nvim-mini/mini.nvim#mini.extra](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-extra.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` with extra functionality for its modules. Contains 20+ 'mini.pick' pickers, 'mini.ai' textobjects, and more.
* [folke/snacks.nvim#picker](https://github.com/folke/snacks.nvim/blob/main/docs/picker.md) ⭐ 7,180 | 🐛 94 | 🌐 Lua | 📅 2026-03-01 - A modern fuzzy-finder to navigate the Neovim universe.
* [ibhagwan/fzf-lua](https://github.com/ibhagwan/fzf-lua) ⭐ 4,111 | 🐛 8 | 🌐 Lua | 📅 2026-03-08 - The Lua version of `fzf.vim`, high-performance and fully async, supports `nvim-web-devicons`, Git indicators, LSP, quickfix/location lists and more. Also supports [`skim`](https://github.com/lotabout/skim) ⭐ 6,649 | 🐛 21 | 🌐 Rust | 📅 2026-03-07 as its fzf binary.
* [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) ⭐ 1,544 | 🐛 34 | 🌐 Rust | 📅 2026-03-06 - Fuzzy file picker with a standalone native implementation of file indexing and typo resistant fuzzy matcher. Includes all the QOL features, file previews (and images), frecency sorting, last query matching, proximity, Git status bonuses and much more.
...
* [bassamsdata/namu.nvim](https://github.com/bassamsdata/namu.nvim) ⭐ 418 | 🐛 5 | 🌐 Lua | 📅 2026-02-17 - Flexible and sleek fuzzy picker, LSP symbol navigator, and more.
...
* [jvgrootveld/telescope-zoxide](https://github.com/jvgrootveld/telescope-zoxide) ⭐ 367 | 🐛 8 | 🌐 Lua | 📅 2024-08-28 - Telescope integration for [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 34,168 | 🐛 153 | 🌐 Rust | 📅 2026-03-05, a smart directory picker that tracks your usage.
...
* [dtormoen/neural-open.nvim](https://github.com/dtormoen/neural-open.nvim) ⭐ 47 | 🐛 1 | 🌐 Lua | 📅 2026-03-04 - Intelligent `snacks.nvim` picker that teaches a neural network to rank files by what you're most likely to open next.
* [juniorsundar/refer.nvim](https://github.com/juniorsundar/refer.nvim) ⭐ 43 | 🐛 3 | 🌐 Lua | 📅 2026-03-02 - A minimalist picker that doesn't get in your way.
...
* [nvim-mini/mini.nvim#mini.files](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-files.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` providing file explorer with column view capable of manipulating file system by editing text. Can create/delete/rename/copy/move files/directories inside and across directories.
* [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) ⭐ 8,414 | 🐛 99 | 🌐 Lua | 📅 2026-03-06 - A simple and fast file explorer tree.
* [stevearc/oil.nvim](https://github.com/stevearc/oil.nvim) ⭐ 6,318 | 🐛 127 | 🌐 Lua | 📅 2026-02-24 - Edit your filesystem like a buffer.
* [nvim-neo-tree/neo-tree.nvim](https://github.com/nvim-neo-tree/neo-tree.nvim) ⭐ 5,297 | 🐛 166 | 🌐 Lua | 📅 2026-02-26 - Browse the file system and other tree-like structures in whatever style suits you, including sidebars, floating windows, `netrw` split style, or all of them at once.
* [ms-jpq/chadtree](https://github.com/ms-jpq/chadtree) ⭐ 1,687 | 🐛 93 | 🌐 Python | 📅 2026-03-08 - File manager. Better than NERDTree.
* [mikavilpas/yazi.nvim](https://github.com/mikavilpas/yazi.nvim) ⭐ 1,581 | 🐛 8 | 🌐 Lua | 📅 2026-03-07 - Integration with the Yazi terminal file manager.
...
* [luukvbaal/nnn.nvim](https://github.com/luukvbaal/nnn.nvim) ⭐ 455 | 🐛 1 | 🌐 Lua | 📅 2025-04-18 - File explorer powered by [nnn](https://github.com/jarun/nnn) ⭐ 21,365 | 🐛 1 | 🌐 C | 📅 2026-02-23 and Lua.
...
* [SidOfc/carbon.nvim](https://github.com/SidOfc/carbon.nvim) ⭐ 185 | 🐛 1 | 🌐 Lua | 📅 2025-02-04 - The simple directory tree viewer written in Lua.
* [X3eRo0/dired.nvim](https://github.com/X3eRo0/dired.nvim) ⭐ 185 | 🐛 4 | 🌐 Lua | 📅 2026-03-05 - A file browser inspired by Emacs Dired.
* [kelly-lin/ranger.nvim](https://github.com/kelly-lin/ranger.nvim) ⭐ 180 | 🐛 11 | 🌐 Lua | 📅 2024-11-18 - [Ranger](https://github.com/ranger/ranger) ⭐ 16,991 | 🐛 927 | 🌐 Python | 📅 2026-02-25 integration.
* [Xuyuanp/yanil](https://github.com/Xuyuanp/yanil) ⭐ 98 | 🐛 5 | 🌐 Lua | 📅 2026-01-15 - Yet Another Nerdtree In Lua.
* [rolv-apneseth/tfm.nvim](https://github.com/Rolv-Apneseth/tfm.nvim) ⭐ 98 | 🐛 2 | 🌐 Lua | 📅 2026-01-18 - Similar to `fm-nvim`, this provides integration for several popular terminal file managers (including [yazi](https://github.com/sxyazi/yazi) ⭐ 33,583 | 🐛 59 | 🌐 Rust | 📅 2026-03-07).
...
* [nvim-mini/mini.nvim#mini.visits](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-visits.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` to persistently track and reuse file system visits. Allows listing "recent"/"frequent"/"frecent" visits, adding/removing labels to visits and other data.
...
* [DrKJeff16/project.nvim](https://github.com/DrKJeff16/project.nvim) ⭐ 144 | 🐛 1 | 🌐 Lua | 📅 2026-03-06 - Project manager with project root detection, documented code and lots of improvements, including `snacks.nvim`, `fzf-lua` and `picker.nvim` support.
...
* [SalOrak/whaler.nvim](https://github.com/SalOrak/whaler.nvim) ⭐ 73 | 🐛 1 | 🌐 Lua | 📅 2026-01-31 - Telescope extension to move between directories blazingly fast.
* [nyngwang/suave.lua](https://github.com/nyngwang/suave.lua) ⭐ 70 | 🐛 10 | 🌐 Lua | 📅 2025-08-02 - Multi-tabs project session automation.
* [mrjones2014/codesettings.nvim](https://github.com/mrjones2014/codesettings.nvim) ⭐ 60 | 🐛 0 | 🌐 Lua | 📅 2026-03-08 - Easily load project-local settings (like `.vscode/settings.json`) into Neovim 0.11+ native LSP settings.
...
* [j-morano/buffer\_manager.nvim](https://github.com/j-morano/buffer_manager.nvim) ⭐ 389 | 🐛 3 | 🌐 Lua | 📅 2026-02-04 - Add one or more buffers, reorder them, save them inside a file or just delete them very easily from a small floating window.
* [chrisgrieser/nvim-early-retirement](https://github.com/chrisgrieser/nvim-early-retirement) ⭐ 247 | 🐛 0 | 🌐 Lua | 📅 2026-02-06 - Send buffers into early retirement by automatically closing them after x minutes of inactivity.
...
* [ahkohd/buffer-sticks.nvim](https://github.com/ahkohd/buffer-sticks.nvim) ⭐ 80 | 🐛 1 | 🌐 Lua | 📅 2026-02-26 - Cosmetic buffers indicator and picker.
...
* [TheLazyCat00/workspaces-nvim](https://github.com/TheLazyCat00/workspaces-nvim) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2026-02-14 - Pin files to specific keys within a project workspace, giving you quick access to your most important files.
...
* [nvim-mini/mini.nvim#mini.hipatterns](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hipatterns.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` to highlight patterns in text with configurable highlighters. Works asynchronously with configurable debounce delay.
...
* [catgoose/nvim-colorizer.lua](https://github.com/catgoose/nvim-colorizer.lua) ⭐ 1,008 | 🐛 1 | 🌐 Lua | 📅 2026-03-07 - A high-performance color highlighter which has no external dependencies.
...
* [nvzone/minty](https://github.com/nvzone/minty) ⭐ 579 | 🐛 2 | 🌐 Lua | 📅 2025-02-28 - Beautifully crafted color tools.
* [xzbdmw/colorful-menu.nvim](https://github.com/xzbdmw/colorful-menu.nvim) ⭐ 442 | 🐛 2 | 🌐 Lua | 📅 2025-11-25 - Colorize your auto completion menu using Tree-sitter.
* [max397574/colortils.nvim](https://github.com/max397574/colortils.nvim) ⭐ 436 | 🐛 8 | 🌐 Lua | 📅 2025-01-10 - Provides utils to work with colors (picker, conversion).
...
* [miversen33/sunglasses.nvim](https://github.com/miversen33/sunglasses.nvim) ⭐ 157 | 🐛 7 | 🌐 Lua | 📅 2025-01-13 - Dynamic Colorscheme/highlight adjuster on window switching.
...
* [Mr-LLLLL/interestingwords.nvim](https://github.com/Mr-LLLLL/interestingwords.nvim) ⭐ 53 | 🐛 0 | 🌐 Lua | 📅 2024-08-19 - Highlight multiple word same time and navigate word under cursor with scrolling smoothly, display search count in virualtext.
...
* [folke/tokyonight.nvim](https://github.com/folke/tokyonight.nvim) ⭐ 7,858 | 🐛 15 | 🌐 Lua | 📅 2025-11-05 - ***`[TS][LSP][L/D][Lua]`*** A clean, dark and light theme written in Lua, with support for LSP, Tree-sitter and lots of plugins.
* [sainnhe/everforest](https://github.com/sainnhe/everforest) ⭐ 3,888 | 🐛 7 | 🌐 Vim Script | 📅 2026-01-21 - ***`[TS][LSP][L/D]`*** A green based colorscheme designed to be warm, soft and easy on the eyes.
...
* [nyoom-engineering/oxocarbon.nvim](https://github.com/nyoom-engineering/oxocarbon.nvim) ⭐ 1,530 | 🐛 19 | 🌐 Fennel | 📅 2025-09-05 - ***`[TS][LSP][L/D][Lua]`*** A dark and light theme written in Fennel, inspired by IBM Carbon.
* [dracula/vim](https://github.com/dracula/vim) ⭐ 1,378 | 🐛 12 | 🌐 Vim Script | 📅 2026-02-28 - ***`[TS][LSP]`*** Famous beautiful dark powered theme.
* [bluz71/vim-moonfly-colors](https://github.com/bluz71/vim-moonfly-colors) ⭐ 1,254 | 🐛 0 | 🌐 Lua | 📅 2026-01-18 - ***`[TS][LSP][Lua]`*** A dark charcoal colorscheme with Tree-sitter support.
...
* [marko-cerovac/material.nvim](https://github.com/marko-cerovac/material.nvim) ⭐ 1,076 | 🐛 6 | 🌐 Lua | 📅 2026-02-23 - ***`[TS][LSP][L/D][Lua]`*** Material.nvim is a highly configurable colorscheme written in Lua and based on the material palette.
...
* [AlexvZyl/nordic.nvim](https://github.com/AlexvZyl/nordic.nvim) ⭐ 994 | 🐛 4 | 🌐 Lua | 📅 2026-02-08 - ***`[TS][Lua]`*** Nord theme, but warmer and darker. Supports a variety of plugins and other platforms.
* [shaunsingh/nord.nvim](https://github.com/shaunsingh/nord.nvim) ⭐ 983 | 🐛 33 | 🌐 Lua | 📅 2024-06-25 - ***`[TS][Lua]`*** A colorscheme based off of the Nord Color Palette.
...
* [bluz71/vim-nightfly-colors](https://github.com/bluz71/vim-nightfly-colors) ⭐ 925 | 🐛 0 | 🌐 Lua | 📅 2026-01-18 - ***`[TS][LSP][Lua]`*** A dark midnight colorscheme with Tree-sitter support.
...
* [everviolet/nvim](https://github.com/everviolet/nvim) ⭐ 590 | 🐛 0 | 🌐 Lua | 📅 2026-03-02 - ***`[TS][LSP][L/D][Lua]`*** A comfy colorscheme for cozy morning coding.
* [neanias/everforest-nvim](https://github.com/neanias/everforest-nvim) ⭐ 424 | 🐛 7 | 🌐 Lua | 📅 2025-11-02 - ***`[TS][LSP][L/D][Lua]`*** A Lua port of the Everforest colour scheme.
...
* [rockerBOO/boo-colorscheme-nvim](https://github.com/rockerBOO/boo-colorscheme-nvim) ⭐ 249 | 🐛 3 | 🌐 Lua | 📅 2026-02-10 - ***`[TS][Lua]`*** A colorscheme with handcrafted support for LSP, Tree-sitter.
...
* [oskarnurm/koda.nvim](https://github.com/oskarnurm/koda.nvim) ⭐ 242 | 🐛 2 | 🌐 Lua | 📅 2026-03-07 - ***`[TS][LSP][L/D][Lua]`*** Code's quiet companion. A minimalist colorscheme, written in Lua.
...
* [kdheepak/monochrome.nvim](https://github.com/kdheepak/monochrome.nvim) ⭐ 163 | 🐛 1 | 🌐 Lua | 📅 2021-07-14 - ***`[TS][Lua]`*** A 16-bit monochrome colorscheme that uses [HSLuv](https://www.hsluv.org/) for perceptually distinct gray colors, with support for Tree-sitter and other commonly used plugins.
...
* [serhez/teide.nvim](https://github.com/serhez/teide.nvim) ⭐ 150 | 🐛 1 | 🌐 Lua | 📅 2026-01-12 - ***`[TS][LSP][L/D][Lua]`*** A fork of folke's `tokyonight.nvim` with a different color palette.
...
* [uhs-robert/oasis.nvim](https://github.com/uhs-robert/oasis.nvim) ⭐ 119 | 🐛 3 | 🌐 CSS | 📅 2026-03-07 - ***`[TS][LSP][L/D][Lua]`*** Desert theme from Vim ported to Neovim and made modern with 12 variants, a collection of dark themes for every color of the rainbow.
...
* [yonatan-perel/lake-dweller.nvim](https://github.com/yonatan-perel/lake-dweller.nvim) ⭐ 20 | 🐛 0 | 🌐 Lua | 📅 2026-03-03 - ***`[TS][LSP][Lua]`*** Dark and opinionated with selective highlighting aiming to be readable at a glance.
* [silentium-theme/silentium.nvim](https://github.com/silentium-theme/silentium.nvim) ⭐ 16 | 🐛 0 | 🌐 Lua | 📅 2026-03-06 - ***`[TS][Luа]`*** Pragmatic and monochrome theme with the goal to increase reading speed and reduce eye strain by highlighting only what is needed.
...
* [rose-pine/neovim](https://github.com/rose-pine/neovim) ⭐ 2,959 | 🐛 5 | 🌐 Lua | 📅 2025-12-21 - ***`[TS][LSP][L/D][Lua]`*** All natural pine, faux fur and a bit of soho vibes for the classy minimalist.

<!--lint enable awesome-spell-check-->

* [nvim-mini/mini.nvim#colorschemes](https://github.com/nvim-mini/mini.nvim#plugin-color-schemes) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - ***`[TS][LSP][L/D][Lua]`*** Color schemes included in `mini.nvim`. All of them prioritize high contrast ratio for reading text and computing palettes in perceptually uniform color spaces.
* [catppuccin/nvim](https://github.com/catppuccin/nvim) ⭐ 7,234 | 🐛 16 | 🌐 Lua | 📅 2026-03-07 - ***`[TS][LSP][L/D][Lua]`*** Warm mid-tone dark theme to show off your vibrant self! With support for native LSP, Tree-sitter, and more.
* [rebelot/kanagawa.nvim](https://github.com/rebelot/kanagawa.nvim) ⭐ 5,978 | 🐛 91 | 🌐 Lua | 📅 2025-10-15 - ***`[TS][LSP][L/D][Lua]`*** A dark colorscheme inspired by the colors of the famous painting by Katsushika Hokusai.
* [EdenEast/nightfox.nvim](https://github.com/EdenEast/nightfox.nvim) ⭐ 3,921 | 🐛 36 | 🌐 Lua | 📅 2025-02-09 - ***`[TS][LSP][L/D][Lua]`*** A soft dark, fully customizable colorscheme with support for LSP, Tree-sitter and a variety of plugins.
* [ellisonleao/gruvbox.nvim](https://github.com/ellisonleao/gruvbox.nvim) ⭐ 2,472 | 🐛 28 | 🌐 Lua | 📅 2026-02-15 - ***`[TS][LSP][L/D][Lua]`*** Gruvbox community colorscheme Lua port.
* [scottmckendry/cyberdream.nvim](https://github.com/scottmckendry/cyberdream.nvim) ⭐ 1,274 | 🐛 5 | 🌐 Lua | 📅 2026-01-27 - ***`[TS][L/D][Lua]`*** A high-contrast, futuristic and vibrant coloursheme.
* [zenbones-theme/zenbones.nvim](https://github.com/zenbones-theme/zenbones.nvim) ⭐ 1,074 | 🐛 16 | 🌐 Vim Script | 📅 2026-02-11 - ***`[TS][LSP][L/D][Lua]`*** A collection of Vim/Neovim colorschemes designed to highlight code using contrasts and font variations.
* [olimorris/onedarkpro.nvim](https://github.com/olimorris/onedarkpro.nvim) ⭐ 1,038 | 🐛 0 | 🌐 Lua | 📅 2026-02-25 - ***`[TS][L/D][Lua]`*** Atom's iconic One Dark theme. Cacheable, fully customisable, Tree-sitter and LSP semantic token support. Comes with light and dark variants.
...
* [rmehri01/onenord.nvim](https://github.com/rmehri01/onenord.nvim) ⭐ 626 | 🐛 0 | 🌐 Lua | 📅 2025-12-25 - ***`[TS][LSP][L/D][Lua]`*** A colorscheme that combines the Nord and Atom One Dark color palettes for a more vibrant programming experience.
...
* [xero/miasma.nvim](https://github.com/xero/miasma.nvim) ⭐ 491 | 🐛 5 | 🌐 Vim Script | 📅 2025-07-12 - ***`[TS][LSP]`*** A dark pastel color scheme inspired by the woods. Built using lush and supports Tree-sitter, diagnostics, CMP, Git-Signs, Telescope, Which-key, Lazy, and more.
* [luisiacc/gruvbox-baby](https://github.com/luisiacc/gruvbox-baby) ⭐ 452 | 🐛 8 | 🌐 Lua | 📅 2024-01-25 - ***`[TS][LSP][Lua]`*** A modern gruvbox theme with full Tree-sitter support.
...
* [uloco/bluloco.nvim](https://github.com/uloco/bluloco.nvim) ⭐ 427 | 🐛 10 | 🌐 Lua | 📅 2026-02-24 - ***`[TS][LSP][L/D][Lua]`*** A fancy and sophisticated colorscheme for night and day coding. Supports LSP, Tree-sitter and all the plugins you love.
...
* [mellow-theme/mellow.nvim](https://github.com/mellow-theme/mellow.nvim) ⭐ 405 | 🐛 1 | 🌐 Lua | 📅 2025-09-02 - ***`[TS][LSP][Lua]`*** A soothing dark color scheme with Tree-sitter support.
* [thesimonho/kanagawa-paper.nvim](https://github.com/thesimonho/kanagawa-paper.nvim) ⭐ 365 | 🐛 3 | 🌐 Lua | 📅 2026-03-07 - ***`[TS][LSP][L/D][Lua]`*** Remixed light and dark Kanagawa colourschemes with muted colors.
...
* [FrenzyExists/aquarium-vim](https://github.com/FrenzyExists/aquarium-vim) ⭐ 316 | 🐛 6 | 🌐 Vim Script | 📅 2024-11-27 - ***`[TS][L/D]`*** A dark, yet vibrant colorscheme.
...
* [Mofiqul/adwaita.nvim](https://github.com/Mofiqul/adwaita.nvim) ⭐ 284 | 🐛 13 | 🌐 Lua | 📅 2026-01-07 - ***`[TS][LSP][L/D][Lua]`*** Colorscheme based on GNOME Adwaita syntax with support for popular plugins.
* [0xstepit/flow.nvim](https://github.com/0xstepit/flow.nvim) ⭐ 283 | 🐛 4 | 🌐 Lua | 📅 2026-02-25 - ***`[TS][L/D][Lua]`*** Carefully designed colors to help focusing during coding plus fluorescent details. Support many plugins and tools.
...
* [dasupradyumna/midnight.nvim](https://github.com/dasupradyumna/midnight.nvim) ⭐ 229 | 🐛 2 | 🌐 Lua | 📅 2024-11-01 - ***`[TS][LSP][Lua]`*** A modern black theme with comfortable color contrast for a pleasant visual experience, with LSP and Tree-sitter support.
...
* [Verf/deepwhite.nvim](https://github.com/Verf/deepwhite.nvim) ⭐ 162 | 🐛 0 | 🌐 Lua | 📅 2026-02-19 - ***`[TS][LSP][Lua]`*** A light colorscheme inspired by [flatwhite-syntax](https://github.com/biletskyy/flatwhite-syntax) ⭐ 188 | 🐛 15 | 🌐 CSS | 📅 2020-04-27 and [elegant-emacs](https://github.com/rougier/elegant-emacs) ⭐ 1,431 | 🐛 9 | 🌐 Emacs Lisp | 📅 2021-11-22.
...
* [nyngwang/nvimgelion](https://github.com/nyngwang/nvimgelion) ⭐ 133 | 🐛 4 | 🌐 Vim Script | 📅 2024-03-07 - ***`[TS]`*** Neon Genesis Evangelion but for Vimmers.
...
* [phha/zenburn.nvim](https://github.com/phha/zenburn.nvim) ⭐ 111 | 🐛 4 | 🌐 Lua | 📅 2024-07-02 - ***`[TS][Lua]`*** A low-contrast dark colorscheme with support for various plugins.
...
* [samharju/synthweave.nvim](https://github.com/samharju/synthweave.nvim) ⭐ 63 | 🐛 1 | 🌐 Lua | 📅 2025-09-25 - ***`[TS][LSP][Lua]`*** Synthwave '84 colorscheme port.
...
* [calind/selenized.nvim](https://github.com/calind/selenized.nvim) ⭐ 28 | 🐛 3 | 🌐 Lua | 📅 2025-08-06 - ***`[TS][LSP][L/D][Lua]`*** Lua port of [selenized](https://github.com/jan-warchol/selenized) ⭐ 891 | 🐛 57 | 🌐 Emacs Lisp | 📅 2025-09-28 with support for Tree-sitter, `nvim-cmp`, GitSigns, and more.
...
* [bakageddy/alduin.nvim](https://github.com/bakageddy/alduin.nvim) ⭐ 17 | 🐛 0 | 🌐 Lua | 📅 2024-01-27 - ***`[TS][LSP][Lua]`*** A port of [alduin](https://github.com/AlessandroYorba/alduin) ⭐ 482 | 🐛 9 | 🌐 Vim script | 📅 2022-08-31 theme to Lua with Tree-sitter and semantic highlights support.
...
* [dybdeskarphet/gruvbox-minimal.nvim](https://github.com/dybdeskarphet/gruvbox-minimal.nvim) ⭐ 14 | 🐛 0 | 🌐 Lua | 📅 2026-02-21 - ***`[TS][L/D][Lua]`*** A Gruvbox Material theme conceptually inspired by Alabaster.
...
* [nvim-mini/mini.nvim#mini.base16](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-base16.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` with fast implementation of base16 theme for manually supplied palette.
* [nvim-mini/mini.nvim#mini.colors](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-colors.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` to tweak and save any color scheme. Also can animate transition and convert between some color spaces.
* [nvim-mini/mini.nvim#mini.hues](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-hues.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` to generate configurable color scheme. Takes only background and foreground colors as required arguments. Can adjust number of hues for non-base colors, saturation, accent color, plugin integration.
...
* [RRethy/base16-nvim](https://github.com/RRethy/base16-nvim) ⭐ 621 | 🐛 4 | 🌐 Lua | 📅 2026-03-05 - A base16 colorscheme builder. Includes support for Tree-sitter and LSP highlight groups.
...
* [SmiteshP/nvim-navic](https://github.com/SmiteshP/nvim-navic) ⭐ 1,641 | 🐛 29 | 🌐 Lua | 📅 2025-12-29 - A simple statusline/winbar component that uses LSP to show your current code context.
* [Bekaboo/dropbar.nvim](https://github.com/Bekaboo/dropbar.nvim) ⭐ 1,510 | 🐛 10 | 🌐 Lua | 📅 2025-10-05 - IDE-like breadcrumbs, out of the box.
...
* [OXY2DEV/bars.nvim](https://github.com/OXY2DEV/bars.nvim) ⭐ 91 | 🐛 1 | 🌐 Lua | 📅 2026-02-18 - A starting point/guide for creating custom statusline, statuscolumn, tabline and winbar.
...
* [nvim-mini/mini.nvim#mini.statusline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-statusline.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for minimal and fast statusline. Supports content change depending on window width.
* [nvim-lualine/lualine.nvim](https://github.com/nvim-lualine/lualine.nvim) ⭐ 7,785 | 🐛 269 | 🌐 Lua | 📅 2025-11-23 - Easily configurable, blazingly fast statusline.
* [rebelot/heirline.nvim](https://github.com/rebelot/heirline.nvim) ⭐ 1,248 | 🐛 28 | 🌐 Lua | 📅 2025-05-23 - A no-nonsense statusline designed around recursive inheritance to be exceptionally fast and versatile.
...
* [windwp/windline.nvim](https://github.com/windwp/windline.nvim) ⭐ 518 | 🐛 0 | 🌐 Lua | 📅 2025-10-22 - The next generation statusline. Animation statusline.
...
* [ojroques/nvim-hardline](https://github.com/ojroques/nvim-hardline) ⭐ 200 | 🐛 2 | 🌐 Lua | 📅 2023-12-27 - A statusline / bufferline inspired by [vim-airline](https://github.com/vim-airline/vim-airline) ⭐ 17,943 | 🐛 52 | 🌐 Vim Script | 📅 2026-02-27 that aims to be as light and simple as possible.
...
* [Zeioth/heirline-components.nvim](https://github.com/Zeioth/heirline-components.nvim) ⭐ 151 | 🐛 3 | 🌐 Lua | 📅 2026-02-25 - 30+ `heirline.nvim` components to be used out of the box to create the perfect user interface.
...
* [nvim-mini/mini.nvim#mini.tabline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-tabline.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for minimal tabline showing listed buffers in case of one tab and falling back to default otherwise.
* [akinsho/bufferline.nvim](https://github.com/akinsho/bufferline.nvim) ⭐ 4,263 | 🐛 99 | 🌐 Lua | 📅 2025-01-14 - A snazzy bufferline built using Lua.
* [romgrk/barbar.nvim](https://github.com/romgrk/barbar.nvim) ⭐ 2,658 | 🐛 33 | 🌐 Lua | 📅 2025-12-02 - A tabline with re-orderable, auto-sizing, clickable tabs, icons, nice highlighting, sort-by commands and a magic jump-to-buffer mode.
* [nanozuki/tabby.nvim](https://github.com/nanozuki/tabby.nvim) ⭐ 734 | 🐛 7 | 🌐 Lua | 📅 2026-01-07 - A minimal, configurable tabline that allows using tabs as workspace multiplexers.
...
* [nvim-mini/mini.nvim#mini.cursorword](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cursorword.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for automatic highlighting of word under cursor (displayed after customizable delay).
...
* [mawkler/modicator.nvim](https://github.com/mawkler/modicator.nvim) ⭐ 368 | 🐛 3 | 🌐 Lua | 📅 2025-10-24 - Cursor line number mode indicator. Changes the `CursorLineNr` highlight based on Vim mode.
...
* [nvim-mini/mini.nvim#mini.starter](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-starter.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for start screen. Displayed items are fully customizable, item selection can be done using prefix query with instant visual feedback.
* [nvimdev/dashboard-nvim](https://github.com/nvimdev/dashboard-nvim) ⭐ 2,789 | 🐛 73 | 🌐 Lua | 📅 2025-08-31 - A minimalist dashboard, inspired by doom-emacs.
...
* [CWood-sdf/spaceport.nvim](https://github.com/CWood-sdf/spaceport.nvim) ⭐ 145 | 🐛 0 | 🌐 Lua | 📅 2026-01-02 - The start screen that gets you to your projects blazingly fast.
...
* [leo-alvarenga/homecoming.nvim](https://github.com/leo-alvarenga/homecoming.nvim) ⭐ 3 | 🐛 0 | 🌐 Lua | 📅 2026-03-03 - A dead-simple, customizable and cozy dashboard with sane defaults and zero config required.
...
* [nvim-mini/mini.nvim#mini.icons](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-icons.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` meant as a general icon provider. Uses fixed set of highlight groups. Supports various categories, icon and style customizations, caching for performance. Integrates with built-in filetype matching.
* [nvim-tree/nvim-web-devicons](https://github.com/nvim-tree/nvim-web-devicons) ⭐ 2,625 | 🐛 18 | 🌐 Lua | 📅 2026-03-08 - A Lua fork of [vim-devicons](https://github.com/ryanoasis/vim-devicons) ⭐ 5,800 | 🐛 70 | 🌐 Vim Script | 📅 2024-05-09.
* [2KAbhishek/nerdy.nvim](https://github.com/2KAbhishek/nerdy.nvim/) ⭐ 388 | 🐛 0 | 🌐 Lua | 📅 2026-01-20 - Find and insert the latest nerd font glyphs.
...
* [3rd/image.nvim](https://github.com/3rd/image.nvim) ⭐ 1,906 | 🐛 47 | 🌐 Lua | 📅 2026-02-21 - Add image support through kitty's graphics protocol or ueberzugpp.
...
* [HakonHarnes/img-clip.nvim](https://github.com/HakonHarnes/img-clip.nvim) ⭐ 879 | 🐛 9 | 🌐 Lua | 📅 2025-12-19 - Effortlessly embed images into any markup language, like LaTeX, Markdown or Typst.
* [vyfor/cord.nvim](https://github.com/vyfor/cord.nvim) ⭐ 563 | 🐛 0 | 🌐 Lua | 📅 2026-02-17 - Highly extensible Rich Presence for Discord.
...
* [sanjay-np/nvim-yt-player](https://github.com/sanjay-np/nvim-yt-player) ⭐ 11 | 🐛 0 | 🌐 Lua | 📅 2026-03-02 - Play YouTube audio using `mpv` and `yt-dlp` via IPC socket.
...
* [nvim-neorg/neorg](https://github.com/nvim-neorg/neorg) ⭐ 7,250 | 🐛 226 | 🌐 Lua | 📅 2026-03-06 - Modernity meets insane extensibility. The future of organizing your life.
* [nvim-orgmode/orgmode](https://github.com/nvim-orgmode/orgmode) ⭐ 3,694 | 🐛 139 | 🌐 Lua | 📅 2026-02-19 - Org-mode clone written in Lua.
* [nvim-telekasten/telekasten.nvim](https://github.com/nvim-telekasten/telekasten.nvim) ⭐ 1,648 | 🐛 66 | 🌐 Lua | 📅 2026-02-03 - Work with a text-based, Markdown zettelkasten / wiki and mix it with a journal, based on telescope.nvim.
* [obsidian-nvim/obsidian.nvim](https://github.com/obsidian-nvim/obsidian.nvim) ⭐ 1,631 | 🐛 65 | 🌐 Lua | 📅 2026-03-08 - Plugin for Obsidian, written in Lua.
...
* [jakewvincent/mkdnflow.nvim](https://github.com/jakewvincent/mkdnflow.nvim) ⭐ 786 | 🐛 16 | 🌐 Lua | 📅 2026-02-27 - Fluent Markdown notebook navigation and management (create links, follow links, create and manage to-do lists, reference bib files, and more).
* [jbyuki/nabla.nvim](https://github.com/jbyuki/nabla.nvim) ⭐ 736 | 🐛 24 | 🌐 Lua | 📅 2025-04-21 - Take your scientific notes.
* [bngarren/checkmate.nvim](https://github.com/bngarren/checkmate.nvim) ⭐ 354 | 🐛 7 | 🌐 Lua | 📅 2025-11-15 - A full-featured Markdown-based TODO plugin.
...
* [backdround/global-note.nvim](https://github.com/backdround/global-note.nvim) ⭐ 146 | 🐛 4 | 🌐 Lua | 📅 2024-02-14 - One global note in a floating window.
...
* [ymich9963/mdnotes.nvim](https://github.com/ymich9963/mdnotes.nvim) ⭐ 9 | 🐛 2 | 🌐 Lua | 📅 2026-03-07 - Simple and improved Markdown note taking.
...
* [carloscalla/notepad.nvim](https://github.com/carloscalla/notepad.nvim) ⭐ 3 | 🐛 0 | 🌐 Lua | 📅 2026-01-27 - Quick note-taking in Markdown with both repo-specific and global notepad support.
...
* [mistricky/codesnap.nvim](https://github.com/mistricky/codesnap.nvim) ⭐ 923 | 🐛 27 | 🌐 Lua | 📅 2026-03-04 - Snapshot plugin with rich features that can make pretty code snapshots.
* [code-biscuits/nvim-biscuits](https://github.com/code-biscuits/nvim-biscuits) ⭐ 324 | 🐛 9 | 🌐 Lua | 📅 2026-03-02 - A port of Assorted Biscuits. Ends up with more supported languages too.
* [axieax/urlview.nvim](https://github.com/axieax/urlview.nvim) ⭐ 272 | 🐛 7 | 🌐 Lua | 📅 2025-11-30 - Browse all URLs in the current buffer.
...
* [mluders/comfy-line-numbers.nvim](https://github.com/mluders/comfy-line-numbers.nvim) ⭐ 116 | 🐛 8 | 🌐 Lua | 📅 2026-01-26 - Limits relative numbers to only show left-hand digits on the keyboard.
* [sontungexpt/url-open](https://github.com/sontungexpt/url-open) ⭐ 107 | 🐛 9 | 🌐 Lua | 📅 2025-10-29 - Open URLs under the cursor and create highlight effects for them.
...
* [y3owk1n/time-machine.nvim](https://github.com/y3owk1n/time-machine.nvim) ⭐ 72 | 🐛 0 | 🌐 Lua | 📅 2025-12-14 - Take control of your edit history with an interactive timeline, diff previews, taggings, live reloading trees and cleanup functions.
...
* [redoxahmii/json-to-types.nvim](https://github.com/redoxahmii/json-to-types.nvim) ⭐ 55 | 🐛 0 | 🌐 Lua | 📅 2026-02-18 - Convert JSON objects to type definitions for multiple languages.
* [necrom4/calcium.nvim](https://github.com/necrom4/calcium.nvim) ⭐ 44 | 🐛 0 | 🌐 Lua | 📅 2025-12-27 - A powerful [`lua-lib-math`](https://www.lua.org/pil/18.html) in-buffer calculator with visual mode, functions and variable support.
...
* [AlejandroSuero/freeze-code.nvim](https://github.com/AlejandroSuero/freeze-code.nvim) ⭐ 31 | 🐛 2 | 🌐 Lua | 📅 2025-03-15 - Code screenshot plugin that makes use of [freeze](https://github.com/charmbracelet/freeze) ⭐ 4,373 | 🐛 68 | 🌐 Go | 📅 2026-02-23 inside the editor.
...
* [glyccogen/imprint.nvim](https://github.com/glyccogen/imprint.nvim) ⭐ 13 | 🐛 0 | 🌐 Lua | 📅 2026-02-15 - Take WYSIWYG screenshots of your code via Playwright and headless Chromium, preserving your colorscheme and highlights.
...
* [stikypiston/cheaty.nvim](https://github.com/stikypiston/cheaty.nvim) ⭐ 6 | 🐛 0 | 🌐 Lua | 📅 2026-02-24 - A simple, configurable cheatsheet.
...
* [hat0uma/csvview.nvim](https://github.com/hat0uma/csvview.nvim) ⭐ 563 | 🐛 15 | 🌐 Lua | 📅 2026-02-14 - An asynchronous CSV/TSV table viewer with real-time updates, configurable comments and delimiters, and multiple display modes.
...
* [theKnightsOfRohan/csvlens.nvim](https://github.com/theKnightsOfRohan/csvlens.nvim) ⭐ 39 | 🐛 1 | 🌐 Lua | 📅 2024-04-28 - A port of [YS-L/csvlens](https://github.com/YS-L/csvlens) ⭐ 3,564 | 🐛 56 | 🌐 Rust | 📅 2026-02-02, for easy previewing of tabular data.
...
* [nvim-mini/mini.nvim#mini.animate](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-animate.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` to add out of the box animations for common built-in actions (cursor movement, scroll, resize, window open/close).
* [sphamba/smear-cursor.nvim](https://github.com/sphamba/smear-cursor.nvim) ⭐ 1,705 | 🐛 6 | 🌐 Lua | 📅 2025-12-01 - Animate the cursor with a smear effect in all terminals. Inspired by Neovide's animated cursor.
* [rachartier/tiny-glimmer.nvim](https://github.com/rachartier/tiny-glimmer.nvim/) ⭐ 400 | 🐛 1 | 🌐 Lua | 📅 2026-01-19 - Adds subtle animations to various operations.
* [gen740/SmoothCursor.nvim](https://github.com/gen740/SmoothCursor.nvim) ⭐ 393 | 🐛 3 | 🌐 Lua | 📅 2024-09-18 - Add fancy sub-cursor to signcolumn to show your scroll or jump direction.
* [y3owk1n/undo-glow.nvim](https://github.com/y3owk1n/undo-glow.nvim/) ⭐ 90 | 🐛 0 | 🌐 Lua | 📅 2025-12-14 - Animated glow/highlight effects for editing operations (undo, redo, yank, paste, etc.) with fully customizable animations and appearance.
* [LuxVim/nvim-luxmotion](https://github.com/LuxVim/nvim-luxmotion) ⭐ 47 | 🐛 0 | 🌐 Lua | 📅 2026-02-27 - Smooth, high‑performance motion and scrolling animations — 60fps fluid cursor moves, word jumps, and viewport scrolling, all in one.
...
* [akinsho/toggleterm.nvim](https://github.com/akinsho/toggleterm.nvim) ⭐ 5,411 | 🐛 86 | 🌐 Lua | 📅 2025-03-09 - Easily manage multiple terminal windows.
...
* [chomosuke/term-edit.nvim](https://github.com/chomosuke/term-edit.nvim) ⭐ 210 | 🐛 7 | 🌐 Lua | 📅 2024-10-17 - Allowing you to edit your command in the terminal just like any other buffer.
...
* [waiting-for-dev/ergoterm.nvim](https://github.com/waiting-for-dev/ergoterm.nvim) ⭐ 96 | 🐛 0 | 🌐 Lua | 📅 2026-02-05 - Seamless terminal workflow integration with smart picker-based terminal selection, flexible text sending and persistent configuration.
...
* [jlesquembre/nterm.nvim](https://github.com/jlesquembre/nterm.nvim) ⭐ 58 | 🐛 1 | 🌐 Lua | 📅 2026-03-03 - Interact with the terminal, with notifications.
...
* [logicmagix/tide42](https://github.com/logicmagix/tide42) ⭐ 23 | 🐛 0 | 🌐 Shell | 📅 2026-03-07 - A fully integrated terminal IDE built on Neovim, tmux, and scriptable workflows.
...
* [LuxVim/nvim-luxterm](https://github.com/LuxVim/nvim-luxterm) ⭐ 12 | 🐛 1 | 🌐 Lua | 📅 2026-02-11 - A floating-window terminal session manager, offering elegant multi-terminal organization, live previews, and intuitive navigation with modern UI design. Manage, switch, and customize multiple terminals effortlessly.
...
* [TheLazyCat00/runner-nvim](https://github.com/TheLazyCat00/runner-nvim) ⭐ 6 | 🐛 1 | 🌐 Lua | 📅 2026-02-11 - Run commands in a floating terminal and keep track of the last command executed per CWD, making it easy to repeat build or test commands.
...
* [mfussenegger/nvim-dap](https://github.com/mfussenegger/nvim-dap) ⭐ 6,982 | 🐛 28 | 🌐 Lua | 📅 2026-03-06 - Debug Adapter Protocol client implementation.
* [rcarriga/nvim-dap-ui](https://github.com/rcarriga/nvim-dap-ui) ⭐ 3,292 | 🐛 106 | 🌐 Lua | 📅 2025-07-09 - A UI for nvim-dap.
...
* [igorlfs/nvim-dap-view](https://github.com/igorlfs/nvim-dap-view) ⭐ 746 | 🐛 6 | 🌐 Lua | 📅 2026-03-07 - A modern, minimalistic UI for nvim-dap.
* [andrewferrier/debugprint.nvim](https://github.com/andrewferrier/debugprint.nvim) ⭐ 512 | 🐛 11 | 🌐 Lua | 📅 2026-03-05 - Debugging the print() way.
...
* [evanmcpheron/rocketlog.nvim](https://github.com/evanmcpheron/rocketlog.nvim) ⭐ 2 | 🐛 0 | 🌐 Lua | 📅 2026-03-06 - Seamlessly add logging for JavaScript and TypeScript files, with log and metadata searching.

### Quickfix

* [kevinhwang91/nvim-bqf](https://github.com/kevinhwang91/nvim-bqf) ⭐ 1,996 | 🐛 17 | 🌐 Lua | 📅 2026-02-02 - Makes the quickfix window better.
* [stevearc/quicker.nvim](https://github.com/stevearc/quicker.nvim) ⭐ 922 | 🐛 17 | 🌐 Lua | 📅 2026-02-23 - Improved quickfix UI and editable quickfix buffer.
...
* [nvim-neotest/neotest](https://github.com/nvim-neotest/neotest) ⭐ 3,040 | 🐛 110 | 🌐 Lua | 📅 2025-11-08 - An extensible framework for interacting with tests within Neovim.
...
* [mr-u0b0dy/crazy-coverage.nvim](https://github.com/mr-u0b0dy/crazy-coverage.nvim) ⭐ 12 | 🐛 4 | 🌐 Lua | 📅 2026-03-01 - Display code coverage.
...
* [stevearc/overseer.nvim](https://github.com/stevearc/overseer.nvim) ⭐ 1,833 | 🐛 71 | 🌐 Lua | 📅 2026-02-24 - A task runner and job management plugin.
...
* [Vigemus/iron.nvim](https://github.com/Vigemus/iron.nvim) ⭐ 1,310 | 🐛 56 | 🌐 Lua | 📅 2026-02-20 - Interactive REPLs of over 30 languages embedded.
* [benlubas/molten-nvim](https://github.com/benlubas/molten-nvim) ⭐ 1,122 | 🐛 38 | 🌐 Python | 📅 2026-03-01 - Enables running code chunks via the Jupyter kernel. Output (including image output) is rendered in a floating window below the code.
* [CRAG666/code\_runner.nvim](https://github.com/CRAG666/code_runner.nvim) ⭐ 677 | 🐛 8 | 🌐 Lua | 📅 2026-02-13 - The best code runner you could have, with super powers.
* [rafcamlet/nvim-luapad](https://github.com/rafcamlet/nvim-luapad) ⭐ 672 | 🐛 5 | 🌐 Lua | 📅 2026-02-07 - Interactive scratchpad for running Lua code.
* [Zeioth/compiler.nvim](https://github.com/Zeioth/compiler.nvim) ⭐ 657 | 🐛 9 | 🌐 Lua | 📅 2025-08-14 - Compiler for building and running your code without having to configure anything.
* [Civitasv/cmake-tools.nvim](https://github.com/Civitasv/cmake-tools.nvim) ⭐ 523 | 🐛 25 | 🌐 Lua | 📅 2026-03-08 - CMake integration.
...
* [Zeioth/makeit.nvim](https://github.com/Zeioth/makeit.nvim) ⭐ 45 | 🐛 6 | 🌐 Lua | 📅 2025-06-24 - Makefile runner based on overseer.
...
* [hadishahpuri/nvimlaunch](https://github.com/hadishahpuri/nvimlaunch) ⭐ 5 | 🐛 0 | 🌐 Lua | 📅 2026-03-02 - Define, run, and manage project-specific commands.
* [wsdjeg/code-runner.nvim](https://github.com/wsdjeg/code-runner.nvim) ⭐ 5 | 🐛 1 | 🌐 Lua | 📅 2025-12-18 - Async code runner with range support.
* [mikeboiko/nvim-flow](https://github.com/mikeboiko/nvim-flow) ⭐ 4 | 🐛 0 | 🌐 Lua | 📅 2026-03-06 - File-scoped command runner with YAML configuration, command preview, debug integration, and traceback quickfix.
...
* [nvim-mini/mini.nvim#mini.doc](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-doc.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for generation of help files from EmmyLua-like annotations. Allows flexible customization of output via hook functions.
* [nvim-mini/mini.nvim#mini.test](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-test.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` with framework for writing extensive Neovim plugin tests with support for hierarchical tests, hooks, parametrization, filtering, screen tests, "busted-style" emulation, customizable reporters, and more.
* [nvim-lua/plenary.nvim](https://github.com/nvim-lua/plenary.nvim) ⭐ 3,408 | 🐛 156 | 🌐 Lua | 📅 2025-07-26 - Plenary: full; complete; entire; absolute; unqualified. All the Lua functions I don't want to write twice.
* [MunifTanjim/nui.nvim](https://github.com/MunifTanjim/nui.nvim) ⭐ 2,030 | 🐛 30 | 🌐 Lua | 📅 2025-06-08 - UI Component Library.
* [folke/lazydev.nvim](https://github.com/folke/lazydev.nvim) ⭐ 1,465 | 🐛 6 | 🌐 Lua | 📅 2025-11-06 - Faster LuaLS setup.
...
* [lumen-oss/lz.n](https://github.com/lumen-oss/lz.n) ⭐ 249 | 🐛 0 | 🌐 Lua | 📅 2026-03-08 - A simple lazy loading library for Neovim plugins.
* [ray-x/guihua.lua](https://github.com/ray-x/guihua.lua) ⭐ 184 | 🐛 5 | 🌐 Lua | 📅 2026-03-08 - A Lua UI library. Includes a fzy search bar, list view and tree view modules.
* [DrKJeff16/wezterm-types](https://github.com/DrKJeff16/wezterm-types) ⭐ 182 | 🐛 1 | 🌐 Lua | 📅 2026-03-06 - WezTerm config type annotations for LuaLS, including support for community plugins.
...
* [gregorias/coop.nvim](https://github.com/gregorias/coop.nvim) ⭐ 142 | 🐛 0 | 🌐 Lua | 📅 2025-07-24 - Structured concurrency with Lua coroutines.
...
* [BirdeeHub/lze](https://github.com/BirdeeHub/lze) ⭐ 106 | 🐛 1 | 🌐 Lua | 📅 2026-03-08 - A lazy-loading library for Neovim plugins.
* [jrop/morph.nvim](https://github.com/jrop/morph.nvim) ⭐ 102 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - A React-like renderer for building interactive buffers/TUIs.
...
* [lumen-oss/luarocks-tag-release](https://github.com/lumen-oss/luarocks-tag-release) ⭐ 57 | 🐛 10 | 🌐 Lua | 📅 2026-03-07 - A GitHub action that publishes your Neovim plugins to LuaRocks.
...
* [chrisgve/databox.nvim](https://github.com/chrisgve/databox.nvim) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2025-05-23 - Encrypted storage for Lua tables using [age](https://github.com/FiloSottile/age) ⭐ 21,562 | 🐛 16 | 🌐 Go | 📅 2026-02-02 or compatible encryption tools for cryptographic safety.
...
* [Olical/conjure](https://github.com/Olical/conjure) ⭐ 2,064 | 🐛 94 | 🌐 Fennel | 📅 2026-02-13 - Interactive evaluation (Clojure, Fennel, Janet, Racket, Hy, MIT Scheme, Guile).
...
* [Olical/nfnl](https://github.com/Olical/nfnl) ⭐ 341 | 🐛 6 | 🌐 Fennel | 📅 2025-11-02 - Streamlined successor to Aniseed, compiling Fennel to Lua on file write.
...
* [nvim-mini/mini.nvim#mini.diff](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-diff.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` to interactively visualize difference between buffer text and its reference. Provides toggleable detailed overview in text area, built-in apply/reset/textobject/goto mappings, and more.
* [nvim-mini/mini.nvim#mini.git](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-git.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for enhanced Git integration with current Neovim process that implements tracking of Git related data, `:Git` user command, and various helpers to explore Git history.
* [lewis6991/gitsigns.nvim](https://github.com/lewis6991/gitsigns.nvim) ⭐ 6,623 | 🐛 30 | 🌐 Lua | 📅 2026-03-06 - Git integration: signs, hunk actions, blame, etc.
* [sindrets/diffview.nvim](https://github.com/sindrets/diffview.nvim) ⭐ 5,398 | 🐛 133 | 🌐 Lua | 📅 2024-08-02 - Single tabpage interface for easily cycling through diffs for all modified files for any Git rev.
* [NeogitOrg/neogit](https://github.com/NeogitOrg/neogit) ⭐ 5,200 | 🐛 169 | 🌐 Lua | 📅 2026-03-06 - A Magit clone that may change some things to fit the Vim philosophy.
* [kdheepak/lazygit.nvim](https://github.com/kdheepak/lazygit.nvim) ⭐ 2,205 | 🐛 49 | 🌐 Lua | 📅 2025-12-19 - Plugin for calling lazygit.
* [esmuellert/codediff.nvim](https://github.com/esmuellert/codediff.nvim) ⭐ 1,159 | 🐛 36 | 🌐 Lua | 📅 2026-03-07 - Side-by-side diff with two-tier highlighting (line + character level) using VSCode's algorithm implemented in C.
...
* [chojs23/ec](https://github.com/chojs23/ec) ⭐ 146 | 🐛 2 | 🌐 Go | 📅 2026-03-06 - A TUI native Git mergetool with 3 panes.
...
* [barrettruth/diffs.nvim](https://github.com/barrettruth/diffs.nvim) ⭐ 55 | 🐛 1 | 🌐 Lua | 📅 2026-03-08 - Syntax highlighting for diffs with Tree-sitter support for `vim-fugitive` and `&diff` buffers.
* [spacedentist/resolve.nvim](https://github.com/spacedentist/resolve.nvim) ⭐ 49 | 🐛 4 | 🌐 Lua | 📅 2026-01-25 - Resolve merge conflicts with ease.
* [jceb/jiejie.nvim](https://github.com/jceb/jiejie.nvim) ⭐ 44 | 🐛 1 | 🌐 Lua | 📅 2026-03-07 - Frontend for Jujutsu in the style of `fugitive`.
...
* [YouSame2/inlinediff-nvim](https://github.com/YouSame2/inlinediff-nvim) ⭐ 23 | 🐛 0 | 🌐 Lua | 📅 2026-02-11 - Provides a better inline Git diff view, meant to be used alongside your favorite Git plugin (e.g. `gitsigns`).
...
* [Sengoku11/commitpad.nvim](https://github.com/Sengoku11/commitpad.nvim) ⭐ 9 | 🐛 0 | 🌐 Lua | 📅 2026-02-22 - Write informative commits with persistent worktree-isolated drafts, visual 50/72 guides, and a Markdown buffer.
...
* [pwntester/octo.nvim](https://github.com/pwntester/octo.nvim) ⭐ 3,154 | 🐛 221 | 🌐 Lua | 📅 2026-03-06 - Work with GitHub issues and PRs.
...
* [topaxi/pipeline.nvim](https://github.com/topaxi/pipeline.nvim) ⭐ 182 | 🐛 1 | 🌐 Lua | 📅 2026-03-03 - View and dispatch GitHub Actions workflow and GitLab CI pipeline runs.
...
* [cd-4/git-needy.nvim](https://github.com/cd-4/git-needy.nvim) ⭐ 3 | 🐛 0 | 🌐 Lua | 📅 2026-03-08 - Keeps a tally of workflows that need to be reviewed in your statusbar.

### GitLab

* [harrisoncramer/GitLab.nvim](https://github.com/harrisoncramer/GitLab.nvim) ⭐ 362 | 🐛 31 | 🌐 Lua | 📅 2026-01-31 - Review pull requests and manage other GitLab resources.
...
* [nvim-mini/mini.nvim#mini.jump](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for smarter jumping to a single character.
* [nvim-mini/mini.nvim#mini.jump2d](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-jump2d.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for smarter jumping within visible lines via iterative label filtering. Supports custom jump targets (spots), labels, hooks, allowed windows and lines, and more.
* [nvim-mini/mini.nvim#mini.bracketed](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bracketed.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` to go forward/backward with square brackets.
* [ggandor/leap.nvim](https://github.com/ggandor/leap.nvim) ⭐ 5,024 | 🐛 38 | 🌐 Fennel | 📅 2026-01-25 - A refined successor of Lightspeed, aiming to establish a widely accepted standard interface extension for moving around in Vim-like editors.
* [folke/flash.nvim](https://github.com/folke/flash.nvim) ⭐ 3,932 | 🐛 20 | 🌐 Lua | 📅 2025-10-28 - Navigate your code with search labels, enhanced character motions and Tree-sitter integration.
...
* [tris203/precognition.nvim](https://github.com/tris203/precognition.nvim) ⭐ 1,314 | 🐛 13 | 🌐 Lua | 📅 2026-01-31 - Precognition uses virtual text and gutter signs to show available motions.
* [abecodes/tabout.nvim](https://github.com/abecodes/tabout.nvim) ⭐ 851 | 🐛 6 | 🌐 Lua | 📅 2024-12-10 - Jump out of bracket pairs, quotes, objects, etc.
* [chrisgrieser/nvim-spider](https://github.com/chrisgrieser/nvim-spider) ⭐ 844 | 🐛 0 | 🌐 Lua | 📅 2026-02-26 - Use the w, e, b motions like a spider. Considers camelCase and skips insignificant punctuation.
* [smoka7/hop.nvim](https://github.com/smoka7/hop.nvim) ⭐ 762 | 🐛 36 | 🌐 Lua | 📅 2025-08-22 - Hop is an EasyMotion-like plugin allowing you to jump anywhere in a document with as few keystrokes as possible.
* [Aaronik/Treewalker.nvim](https://github.com/aaronik/Treewalker.nvim) ⭐ 588 | 🐛 1 | 🌐 Lua | 📅 2025-12-28 - Move seamlessly around the abstract syntax tree.
...
* [woosaaahh/sj.nvim](https://github.com/woosaaahh/sj.nvim) ⭐ 129 | 🐛 0 | 🌐 Lua | 📅 2023-08-06 - Search based navigation combined with quick jump features.
...
* [backdround/neowords.nvim](https://github.com/backdround/neowords.nvim) ⭐ 61 | 🐛 2 | 🌐 Lua | 📅 2024-09-04 - Hops by any type of words. It gives fine control over `w`, `e`, `b`, `ge` movements.
...
* [kiyoon/repeatable-move.nvim](https://github.com/kiyoon/repeatable-move.nvim) ⭐ 20 | 🐛 0 | 🌐 Lua | 📅 2026-01-25 - Make any motion repeatable with `;` and `,` keys.
...
* [nolleh/warp.nvim](https://github.com/nolleh/warp.nvim) ⭐ 14 | 🐛 0 | 🌐 Lua | 📅 2026-03-05 - Jump based on labels to file paths, URLs, and Markdown links from any buffer.
* [timseriakov/spamguard.nvim](https://github.com/timseriakov/spamguard.nvim) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2025-05-05 - Detects excessive key spamming (jjjj/kkkk) and suggests more efficient alternatives.
* [Mr-LLLLL/treesitter-outer](https://github.com/Mr-LLLLL/treesitter-outer) ⭐ 9 | 🐛 0 | 🌐 Scheme | 📅 2024-06-10 - Jump to outer node with smart.
* [millerjason/neovimacs.nvim](https://github.com/millerjason/neovimacs.nvim) ⭐ 5 | 🐛 0 | 🌐 Vim Script | 📅 2025-01-18 - Provides Emacs movement and buffer keybindings while in insert mode.
...
* [kiyoon/treesitter-indent-object.nvim](https://github.com/kiyoon/treesitter-indent-object.nvim) ⭐ 72 | 🐛 1 | 🌐 Lua | 📅 2025-10-31 - Context-aware indent textobject powered by Tree-sitter.
...
* [nvim-mini/mini.nvim#mini.clue](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-clue.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` to show next key clues. Has opt-in triggers, shows next key information after customizable delay, allows hydra-like submodes, and more.
* [nvim-mini/mini.nvim#mini.keymap](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-keymap.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` with utilities to make special key mappings: multi-step actions (with built-in steps for "smart" `<Tab>`, `<S-Tab>`, `<CR>`, `<BS>`), combos (more general version of "better escape" like behavior).
* [folke/which-key.nvim](https://github.com/folke/which-key.nvim) ⭐ 6,980 | 🐛 36 | 🌐 Lua | 📅 2025-10-28 - Shows a popup with possible keybindings of the command you started typing.
...
* [max397574/better-escape.nvim](https://github.com/max397574/better-escape.nvim) ⭐ 778 | 🐛 6 | 🌐 Lua | 📅 2025-04-29 - Create shortcuts to escape insert mode without getting delay.
* [FeiyouG/commander.nvim](https://github.com/FeiyouG/commander.nvim) ⭐ 422 | 🐛 7 | 🌐 Lua | 📅 2024-06-08 - Create and manage keybindings and commands in a more organized manner and search them quickly through Telescope.
* [chrisgrieser/nvim-recorder](https://github.com/chrisgrieser/nvim-recorder) ⭐ 276 | 🐛 0 | 🌐 Lua | 📅 2026-02-06 - Simplifying and improving how you interact with macros.
* [nvimtools/hydra.nvim](https://github.com/nvimtools/hydra.nvim) ⭐ 269 | 🐛 8 | 🌐 Lua | 📅 2025-05-03 - Create custom submodes and menus. Port of Emacs Hydra. Maintained fork of anuvyklack/hydra.nvim.
* [tris203/hawtkeys.nvim](https://github.com/tris203/hawtkeys.nvim) ⭐ 240 | 🐛 6 | 🌐 Lua | 📅 2026-02-27 - Suggest new easy-to-hit keymaps and find issues with your current keymap configurations.
...
* [mawkler/demicolon.nvim](https://github.com/mawkler/demicolon.nvim) ⭐ 114 | 🐛 0 | 🌐 Lua | 📅 2026-01-25 - Use `;` and `,` keys to also repeat jumps to diagnostics (e.g. `]d`) and to [nvim-treesitter-textobjects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects?tab=readme-ov-file#text-objects-move) ⭐ 2,699 | 🐛 110 | 🌐 Tree-sitter Query | 📅 2026-03-04 (e.g. `]f`), in addition to repeating `t`/`T`/`f`/`F`.
* [zdcthomas/yop.nvim](https://github.com/zdcthomas/yop.nvim) ⭐ 85 | 🐛 3 | 🌐 Lua | 📅 2023-05-29 - Easily create your own operators (like `d` and `y`).
...
* [sontungexpt/bim.nvim](https://github.com/sontungexpt/bim.nvim) ⭐ 10 | 🐛 1 | 🌐 Lua | 📅 2025-11-23 - Enhances insert mode key mapping by showing typed keys in real time, without waiting for timeoutlen. It provides a responsive and intuitive insert-mode experience, ideal for complex input workflows like ime.
...
* [karb94/neoscroll.nvim](https://github.com/karb94/neoscroll.nvim) ⭐ 1,981 | 🐛 11 | 🌐 Lua | 📅 2025-12-31 - Smooth scrolling.
...
* [nvim-mini/mini.nvim#mini.map](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-map.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` to show floating window with buffer text overview, scrollbar, and highlights.
* [petertriho/nvim-scrollbar](https://github.com/petertriho/nvim-scrollbar) ⭐ 1,028 | 🐛 30 | 🌐 Lua | 📅 2025-11-17 - Extensible scrollbar that shows diagnostics and search results.
...
* [gorbit99/codewindow.nvim](https://github.com/gorbit99/codewindow.nvim) ⭐ 478 | 🐛 27 | 🌐 Lua | 📅 2025-05-22 - Minimap plugin, that is closely integrated with Tree-sitter and the built-in LSP to display more information to the user.
...
* [nvim-mini/mini.nvim#mini.pairs](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-pairs.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for autopairs which has minimal defaults and functionality to do per-key mapping.
* [nvim-mini/mini.nvim#mini.trailspace](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-trailspace.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for automatic highlighting of trailing whitespace with functionality to remove it.
* [nvim-mini/mini.nvim#mini.operators](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-operators.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` with various text edit operators: replace, exchange, multiply, sort, evaluate.
* [nvim-mini/mini.nvim#mini.move](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-move.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` to move any selection (charwise, linewise, blockwise, current line in Normal mode) in any direction. Handles both `v:count` and undo history.
* [nvim-mini/mini.nvim#mini.ai](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-ai.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for extending and creating `a`/`i` textobjects. It enhances some built-in textobjects, creates extensive set of new ones (like `a*`, `a<Space>`, `a?`, and more), and allows user to create their own (via Lua patterns or functions). Supports dot-repeat, different search methods, consecutive application, and more.
* [nvim-mini/mini.nvim#mini.splitjoin](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-splitjoin.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` to split and join arguments. Has customizable pre and post hooks. Works inside comments.
* [nvim-mini/mini.nvim#mini.basics](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-basics.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` with customizable configuration presets for common options, mappings, and autocommands.
* [windwp/nvim-autopairs](https://github.com/windwp/nvim-autopairs) ⭐ 3,962 | 🐛 15 | 🌐 Lua | 📅 2026-01-30 - A minimalist autopairs written by Lua.
* [nvim-treesitter/nvim-treesitter-context](https://github.com/nvim-treesitter/nvim-treesitter-context) ⭐ 3,135 | 🐛 19 | 🌐 Janet | 📅 2026-03-06 - Shows floating hover with the current function/block context.
* [folke/zen-mode.nvim](https://github.com/folke/zen-mode.nvim) ⭐ 2,098 | 🐛 17 | 🌐 Lua | 📅 2025-10-28 - Distraction-free coding.
* [windwp/nvim-ts-autotag](https://github.com/windwp/nvim-ts-autotag) ⭐ 2,062 | 🐛 8 | 🌐 Lua | 📅 2026-02-04 - Use Tree-sitter to autoclose and autorename XML, HTML, JSX tag.
* [jake-stewart/multicursor.nvim](https://github.com/jake-stewart/multicursor.nvim) ⭐ 1,418 | 🐛 0 | 🌐 Lua | 📅 2026-02-28 - Adds support for multiple cursors which work how you expect.
...
* [shortcuts/no-neck-pain.nvim](https://github.com/shortcuts/no-neck-pain.nvim) ⭐ 911 | 🐛 16 | 🌐 Lua | 📅 2026-02-18 - Center the currently focused buffer to the middle of your terminal.
* [HiPhish/rainbow-delimiters.nvim](https://github.com/HiPhish/rainbow-delimiters.nvim) ⭐ 842 | 🐛 20 | 🌐 Lua | 📅 2026-02-24 - Rainbow delimiters with Tree-sitter.
* [nacro90/numb.nvim](https://github.com/nacro90/numb.nvim) ⭐ 841 | 🐛 1 | 🌐 Lua | 📅 2026-01-17 - Peek lines in a non-obtrusive way.
* [debugloop/telescope-undo.nvim](https://github.com/debugloop/telescope-undo.nvim) ⭐ 790 | 🐛 5 | 🌐 Lua | 📅 2025-01-31 - A telescope extension to visualize your undo tree and fuzzy-search changes in it.
...
* [m4xshen/autoclose.nvim](https://github.com/m4xshen/autoclose.nvim) ⭐ 635 | 🐛 13 | 🌐 Lua | 📅 2025-07-21 - A minimalist autoclose plugin written in Lua.
* [altermo/ultimate-autopair.nvim](https://github.com/altermo/ultimate-autopair.nvim) ⭐ 566 | 🐛 22 | 🌐 Lua | 📅 2026-03-07 - Autopair with extensions.
...
* [brenton-leighton/multiple-cursors.nvim](https://github.com/brenton-leighton/multiple-cursors.nvim) ⭐ 395 | 🐛 1 | 🌐 Lua | 📅 2026-01-02 - A multi-cursor plugin that works in normal, insert/replace, or visual modes, and with almost every command.
...
* [tomiis4/hypersonic.nvim](https://github.com/tomiis4/hypersonic.nvim) ⭐ 233 | 🐛 4 | 🌐 Lua | 📅 2024-08-11 - Provides explanation for RegExp.
...
* [nguyenvukhang/nvim-toggler](https://github.com/nguyenvukhang/nvim-toggler) ⭐ 191 | 🐛 3 | 🌐 Lua | 📅 2024-06-15 - Invert text, such as toggling between `true` and `false`.
* [nat-418/boole.nvim](https://github.com/nat-418/boole.nvim) ⭐ 185 | 🐛 12 | 🌐 Lua | 📅 2024-06-06 - Toggle booleans and common string values.
...
* [XXiaoA/atone.nvim](https://github.com/XXiaoA/atone.nvim) ⭐ 149 | 🐛 5 | 🌐 Lua | 📅 2026-03-01 - Undo tree for visualizing and managing undo history.
...
* [tummetott/unimpaired.nvim](https://github.com/tummetott/unimpaired.nvim) ⭐ 99 | 🐛 1 | 🌐 Lua | 📅 2025-10-16 - Lua port of [tpope/vim-unimpaired](https://github.com/tpope/vim-unimpaired) ⭐ 3,447 | 🐛 57 | 🌐 Vim Script | 📅 2025-08-16.
...
* [nemanjamalesija/smart-paste.nvim](https://github.com/nemanjamalesija/smart-paste.nvim) ⭐ 91 | 🐛 0 | 🌐 Lua | 📅 2026-02-21 - Automatic indentation of pasted code using a three-tier indent strategy (indentexpr / Tree-sitter / heuristic).
...
* [wurli/split.nvim](https://github.com/wurli/split.nvim) ⭐ 35 | 🐛 1 | 🌐 Lua | 📅 2025-02-07 - Provides a mapping to split text by delimiter, giving an inverse of the native J command.
...
* [qwavies/smart-backspace.nvim](https://github.com/qwavies/smart-backspace.nvim) ⭐ 27 | 🐛 0 | 🌐 Lua | 📅 2026-03-04 - Context-aware backspace which handles pairs, whitespace and indentation.
* [nxhung2304/lastplace.nvim](https://github.com/nxhung2304/lastplace.nvim) ⭐ 24 | 🐛 0 | 🌐 Shell | 📅 2025-06-30 - Intelligently restore your cursor position when reopening files.
...
* [necrom4/convy.nvim](https://github.com/necrom4/convy.nvim) ⭐ 22 | 🐛 1 | 🌐 Lua | 📅 2026-03-08 - Easily convert strings between various formats.
...
* [nvim-mini/mini.nvim#mini.comment](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-comment.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for per-line commenting. Fully supports dot-repeat.
...
* [folke/todo-comments.nvim](https://github.com/folke/todo-comments.nvim) ⭐ 4,076 | 🐛 20 | 🌐 Lua | 📅 2025-11-10 - Highlight, list and search TODO comments in your projects.
* [danymat/neogen](https://github.com/danymat/neogen) ⭐ 1,626 | 🐛 44 | 🌐 Lua | 📅 2026-01-10 - A better annotation generator which supports multiple languages and annotation conventions.
* [JoosepAlviste/nvim-ts-context-commentstring](https://github.com/JoosepAlviste/nvim-ts-context-commentstring) ⭐ 1,281 | 🐛 22 | 🌐 Lua | 📅 2024-12-07 - Sets the `commentstring` option based on the cursor location in the file. The location is checked via Tree-sitter queries.
...
* [LudoPinelli/comment-box.nvim](https://github.com/LudoPinelli/comment-box.nvim) ⭐ 479 | 🐛 15 | 🌐 Lua | 📅 2024-08-10 - Clarify and beautify your comments using boxes and lines.
...
* [kevinhwang91/nvim-ufo](https://github.com/kevinhwang91/nvim-ufo) ⭐ 2,885 | 🐛 46 | 🌐 Lua | 📅 2026-01-11 - Ultra fold with modern looking and performance boosting.
* [chrisgrieser/nvim-origami](https://github.com/chrisgrieser/nvim-origami) ⭐ 472 | 🐛 2 | 🌐 Lua | 📅 2026-03-06 - Fold with relentless elegance.
...
* [soemre/commentless.nvim](https://github.com/soemre/commentless.nvim) ⭐ 41 | 🐛 0 | 🌐 Lua | 📅 2025-04-26 - Fold all comments to better visualize your code logic, and unfold them whenever needed.
...
* [nvim-mini/mini.nvim#mini.align](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-align.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for aligning text interactively (with or without instant preview).
* [stevearc/conform.nvim](https://github.com/stevearc/conform.nvim) ⭐ 4,951 | 🐛 86 | 🌐 Lua | 📅 2026-03-01 - A lightweight formatting engine that plays nice with LSP.
* [sbdchd/neoformat](https://github.com/sbdchd/neoformat) ⭐ 2,051 | 🐛 129 | 🌐 Vim Script | 📅 2026-02-24 - A code formatting runner.
...
* [nvim-mini/mini.nvim#mini.indentscope](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-indentscope.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for visualizing and operating on indent scope. Supports customization of debounce delay, animation style, and different granularity of options for scope computing algorithm.
* [lukas-reineke/indent-blankline.nvim](https://github.com/lukas-reineke/indent-blankline.nvim) ⭐ 4,873 | 🐛 24 | 🌐 Lua | 📅 2026-02-17 - IndentLine replacement in Lua with more features and Tree-sitter support.
* [shellRaining/hlchunk.nvim](https://github.com/shellRaining/hlchunk.nvim) ⭐ 892 | 🐛 32 | 🌐 Lua | 📅 2025-12-15 - A Lua implementation of `nvim-hlchunk`, contains more features, such as highlight `{}` chunk, indent line, space blank etc.
* [NMAC427/guess-indent.nvim](https://github.com/NMAC427/guess-indent.nvim) ⭐ 609 | 🐛 16 | 🌐 Lua | 📅 2025-03-25 - Automatic indentation style detection.
* [nvimdev/indentmini.nvim](https://github.com/nvimdev/indentmini.nvim) ⭐ 282 | 🐛 1 | 🌐 Lua | 📅 2026-01-04 - A minimal and blazing fast indentline plugin by using the `nvim_set_decoration_provide` API function.
...
* [gh-liu/fold\_line.nvim](https://github.com/gh-liu/fold_line.nvim) ⭐ 55 | 🐛 1 | 🌐 Lua | 📅 2026-01-17 - Lines for indicating code folding, which could achieve an effect similar to indentline by `:set fdm=indent`.
...
* [nvim-mini/mini.nvim#mini.cmdline](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-cmdline.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for command line tweaks. Adds autocompletion with customizable delay, autocorrection for words with fixed candidates, and autopeek command range in a floating window.
* [gelguy/wilder.nvim](https://github.com/gelguy/wilder.nvim) ⭐ 1,470 | 🐛 63 | 🌐 Vim script | 📅 2024-07-17 - A plugin for fuzzy command line autocompletion.
...
* [nvim-mini/mini.nvim#mini.sessions](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-sessions.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for session management (read, write, delete).
* [rmagatti/auto-session](https://github.com/rmagatti/auto-session) ⭐ 1,788 | 🐛 14 | 🌐 Lua | 📅 2026-02-15 - A small automated session manager.
...
* [olimorris/persisted.nvim](https://github.com/olimorris/persisted.nvim) ⭐ 530 | 🐛 0 | 🌐 Lua | 📅 2026-02-02 - Simple session management with Git branching, autosave/autoload and Telescope support.
...
* [nosduco/remote-sshfs.nvim](https://github.com/nosduco/remote-sshfs.nvim) ⭐ 386 | 🐛 17 | 🌐 Lua | 📅 2025-09-30 - Explore, edit, and develop on a remote machine via SSHFS.
* [miversen33/netman.nvim](https://github.com/miversen33/netman.nvim) ⭐ 371 | 🐛 51 | 🌐 Lua | 📅 2025-09-13 - Lua powered Network Resource Manager.
...
* [brianhuster/live-preview.nvim](https://github.com/brianhuster/live-preview.nvim) ⭐ 351 | 🐛 24 | 🌐 Lua | 📅 2026-03-08 - Live preview HTML, Markdown and Asciidoc in the browser.
* [SUSTech-data/neopyter](https://github.com/SUSTech-data/neopyter) ⭐ 160 | 🐛 4 | 🌐 Lua | 📅 2026-01-12 - Edit in Neovim and preview/run in Jupyter Lab.
...
* [nvim-mini/mini.nvim#mini.bufremove](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-bufremove.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` for buffer removing (unshow, delete, wipeout) while saving window layout.
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,578 | 🐛 13 | 🌐 Lua | 📅 2026-03-06 - Smart, seamless, directional navigation and resizing of splits.
...
* [nvim-zh/colorful-winsep.nvim](https://github.com/nvim-zh/colorful-winsep.nvim) ⭐ 658 | 🐛 0 | 🌐 Lua | 📅 2026-02-19 - A configurable color split line.
...
* [wsdjeg/tabman.nvim](https://github.com/wsdjeg/tabman.nvim) ⭐ 15 | 🐛 1 | 🌐 Lua | 📅 2026-02-01 - Navigate between tabs and the windows they contain.
...
* [aserowy/tmux.nvim](https://github.com/aserowy/tmux.nvim) ⭐ 780 | 🐛 16 | 🌐 Lua | 📅 2025-03-19 - Tmux integration features pane movement and resizing.
...
* [rktjmp/playtime.nvim](https://github.com/rktjmp/playtime.nvim) ⭐ 88 | 🐛 2 | 🌐 Fennel | 📅 2025-09-23 - A collection of games such as Freecell, Shenzhen Solitaire and The Emissary.
...
* [kawre/leetcode.nvim](https://github.com/kawre/leetcode.nvim) ⭐ 2,000 | 🐛 57 | 🌐 Lua | 📅 2025-09-21 - Solve Leetcode problems.
...
* [p00f/cphelper.nvim](https://github.com/p00f/cphelper.nvim) ⭐ 150 | 🐛 3 | 🌐 Lua | 📅 2026-03-04 - Helper for competitive programming written in Lua.
...
* [m4xshen/hardtime.nvim](https://github.com/m4xshen/hardtime.nvim) ⭐ 3,710 | 🐛 13 | 🌐 Lua | 📅 2025-09-13 - Helping you establish good command workflow and habit.
* [saxon1964/neovim-tips](https://github.com/saxon1964/neovim-tips) ⭐ 450 | 🐛 1 | 🌐 Lua | 📅 2026-02-06 - Provides hundreds of built-in tips, tricks and shortcuts, with a custom picker interface and the ability to add your own tips.
...
* [letieu/jira.nvim](https://github.com/letieu/jira.nvim) ⭐ 227 | 🐛 6 | 🌐 Lua | 📅 2026-01-16 - Manage Jira tasks with a beautiful UI.
...
* [gisketch/triforce.nvim](https://github.com/gisketch/triforce.nvim) ⭐ 279 | 🐛 3 | 🌐 Lua | 📅 2026-03-06 - Gamified stat tracker with XP, levels, achievements, and activity heatmaps for your coding sessions with lualine integration.
* [aikhe/wrapped.nvim](https://github.com/aikhe/wrapped.nvim) ⭐ 162 | 🐛 3 | 🌐 Lua | 📅 2026-02-27 - Visualize and review your configuration activity with stats, insights, history, heatmaps and more.
* [gaborvecsei/usage-tracker.nvim](https://github.com/gaborvecsei/usage-tracker.nvim) ⭐ 137 | 🐛 3 | 🌐 Lua | 📅 2024-03-10 - Track your Neovim usage and visualize statistics easily.
...
* [Rtarun3606k/takatime](https://github.com/Rtarun3606k/takatime) ⭐ 54 | 🐛 5 | 🌐 Go | 📅 2026-03-08 - Privacy-first WakaTime alternative using Go and MongoDB.
...
* [zongben/dbout.nvim](https://github.com/zongben/dbout.nvim) ⭐ 28 | 🐛 0 | 🌐 Lua | 📅 2026-03-06 - Manage database connections and run SQL queries directly with JSON results.
...
* [joryeugene/dadbod-grip.nvim](https://github.com/joryeugene/dadbod-grip.nvim) ⭐ 4 | 🐛 0 | 🌐 Lua | 📅 2026-03-08 - Database editor with inline cell editing, staged mutations with live SQL preview, schema browser, DDL, AI SQL generation, FK navigation, and DuckDB/Parquet support.
...
* [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) ⭐ 29,717 | 🐛 39 | 🌐 Lua | 📅 2026-02-28 - A launch point for your personal Neovim configuration.
* [siduck76/NvChad](https://github.com/siduck76/NvChad) ⭐ 27,944 | 🐛 0 | 🌐 Lua | 📅 2026-02-07 - An attempt to make Neovim's CLI as functional as an IDE while retaining beauty with less bloat.
* [LazyVim/LazyVim](https://github.com/LazyVim/LazyVim) ⭐ 25,305 | 🐛 37 | 🌐 Lua | 📅 2026-03-01 - Full-fledged IDE powered by **lazy.nvim** to make it easy to customize and extend your config.
...
* [AstroNvim/AstroNvim](https://github.com/AstroNvim/AstroNvim) ⭐ 14,168 | 🐛 1 | 🌐 Lua | 📅 2026-02-18 - An aesthetic and feature-rich config that is extensible and easy to use with a great set of plugins.
* [ayamir/nvimdots](https://github.com/ayamir/nvimdots) ⭐ 3,379 | 🐛 11 | 🌐 Lua | 📅 2026-03-06 - A well-configured and structured configuration with NixOS support.
...
* [CosmicNvim/CosmicNvim](https://github.com/CosmicNvim/CosmicNvim) ⭐ 1,149 | 🐛 0 | 🌐 Lua | 📅 2026-02-27 - CosmicNvim is a lightweight and opinionated config for web development, specifically designed to provide a COSMIC programming experience!
* [dam9000/kickstart-modular.nvim](https://github.com/dam9000/kickstart-modular.nvim) ⭐ 951 | 🐛 3 | 🌐 Lua | 📅 2025-06-14 - This is a fork of nvim-lua/kickstart.nvim that moves from a single file to a multi file configuration.
...
* [NormalNvim/NormalNvim](https://github.com/NormalNvim/NormalNvim) ⭐ 701 | 🐛 3 | 🌐 Lua | 📅 2026-02-25 - Configuration focused on stability for your daily work.
* [crivotz/nv-ide](https://github.com/crivotz/nv-ide) ⭐ 645 | 🐛 2 | 🌐 Lua | 📅 2026-03-06 - Custom configuration oriented for Full-Stack developers (Rails, Ruby, PHP, HTML, CSS, SCSS, JavaScript).
...
* [nvim-mini/MiniMax](https://github.com/nvim-mini/MiniMax) ⭐ 332 | 🐛 2 | 🌐 Lua | 📅 2026-02-19 - A collection of self-contained and extensively commented configurations which mostly use MINI tools.
* [Shaobin-Jiang/IceNvim](https://github.com/Shaobin-Jiang/IceNvim) ⭐ 296 | 🐛 3 | 🌐 Lua | 📅 2026-03-02 - A beautiful, powerful and customizable config that is blazingly fast.
* [Abstract-IDE/Abstract](https://github.com/Abstract-IDE/Abstract) ⭐ 207 | 🐛 2 | 🌐 Lua | 📅 2026-02-23 - Configuration to achieve the power of Modern IDE.
* [shaeinst/roshnivim](https://github.com/shaeinst/roshnivim) ⭐ 207 | 🐛 2 | 🌐 Lua | 📅 2026-02-23 - A predefined config to save you thousands of hours to setup Neovim as an IDE.
...
* [cstsunfu/.sea.nvim](https://github.com/cstsunfu/.sea.nvim) ⭐ 149 | 🐛 0 | 🌐 Lua | 📅 2025-08-03 - A modular configuration with a beautiful UI and some useful features such as a pomodoro clock and window numbers.
* [linrongbin16/lin.nvim](https://github.com/linrongbin16/lin.nvim) ⭐ 90 | 🐛 1 | 🌐 Lua | 📅 2026-03-06 - A highly configured Neovim distribution integrated with tons of utilities for development, inspired by `spf13-vim`.
...
* [abdellatif-temsamani/adev.nvim](https://github.com/abdellatif-temsamani/adev.nvim) ⭐ 4 | 🐛 3 | 🌐 Lua | 📅 2026-02-26 - The over-engineered Neovim distribution for developers who want everything.
...
* [MordechaiHadad/bob](https://github.com/MordechaiHadad/bob) ⭐ 2,022 | 🐛 29 | 🌐 Rust | 📅 2026-02-20 - A cross-platform, easy to use Neovim version manager.
...
* [y3owk1n/nvs](https://github.com/y3owk1n/nvs) ⭐ 30 | 🐛 0 | 🌐 Go | 📅 2026-03-07 - Another Neovim version manager with config switcher.

### Plugin Template

* [ellisonleao/nvim-plugin-template](https://github.com/ellisonleao/nvim-plugin-template) ⭐ 455 | 🐛 2 | 🌐 Lua | 📅 2025-10-08 - Another Neovim plugin template, using GitHub's template feature.
...
* [jkeresman01/spring-initializr.nvim](https://github.com/jkeresman01/spring-initializr.nvim) ⭐ 18 | 🐛 109 | 🌐 Lua | 📅 2026-02-07 - Scaffold Spring Boot projects with a Telescope-powered UI.
* [DrKJeff16/nvim-plugin-boilerplate](https://github.com/DrKJeff16/nvim-plugin-boilerplate) ⭐ 12 | 🐛 0 | 🌐 Shell | 📅 2026-02-25 - A documented template for new plugins generated by a script. Includes tests, CI utilities, etc.

### OS-specific

* [m15a/flake-awesome-neovim-plugins](https://github.com/m15a/flake-awesome-neovim-plugins) ⭐ 62 | 🐛 0 | 🌐 Nix | 📅 2026-03-07 - Nix flake that provides a collection of `awesome-neovim` plugins as Nix packages.
...
* [nvim-mini/mini.nvim#mini.notify](https://github.com/nvim-mini/mini.nvim/blob/main/readmes/mini-notify.md) ⭐ 8,815 | 🐛 36 | 🌐 Lua | 📅 2026-03-03 - Module of `mini.nvim` to show one or more highlighted notifications in a single window. Provides maker of `vim.notify()` implementation and sets up automated LSP progress updates.
* [folke/noice.nvim](https://github.com/folke/noice.nvim) ⭐ 5,628 | 🐛 27 | 🌐 Lua | 📅 2025-11-03 - Highly experimental plugin that completely replaces the UI for messages, cmdline and the popupmenu.
* [rcarriga/nvim-notify](https://github.com/rcarriga/nvim-notify) ⭐ 3,529 | 🐛 74 | 🌐 Lua | 📅 2025-09-06 - A fancy, configurable, notification manager.
* [mcauley-penney/visual-whitespace.nvim](https://github.com/mcauley-penney/visual-whitespace.nvim) ⭐ 450 | 🐛 0 | 🌐 Lua | 📅 2026-02-22 - See whitespace characters in Visual selections, like VSCode.
...
* [sitiom/nvim-numbertoggle](https://github.com/sitiom/nvim-numbertoggle) ⭐ 216 | 🐛 2 | 🌐 Lua | 📅 2025-11-21 - Automatically toggle between relative and absolute line numbers.
* [CosmicNvim/cosmic-ui](https://github.com/CosmicNvim/cosmic-ui) ⭐ 170 | 🐛 0 | 🌐 Lua | 📅 2026-03-07 - Cosmic-UI is a simple wrapper around specific Vim functionality.
* [OXY2DEV/ui.nvim](https://github.com/OXY2DEV/ui.nvim) ⭐ 154 | 🐛 3 | 🌐 Lua | 📅 2026-02-14 - A blueprint/template/guide for customizing the UI.
* [jrop/tuis.nvim](https://github.com/jrop/tuis.nvim) ⭐ 132 | 🐛 0 | 🌐 Lua | 📅 2026-01-15 - A collection of interactive TUIs which provides rich, interactive UIs to various CLIs.
* [xieyonn/spinner.nvim](https://github.com/xieyonn/spinner.nvim) ⭐ 90 | 🐛 1 | 🌐 Lua | 📅 2026-02-26 - Extensible spinner framework for animated spinners in statusline, tabline, winbar, buffer, cmdline, or next to the cursor.
...
* [frans-johansson/lazy-nvim-starter](https://github.com/frans-johansson/lazy-nvim-starter) ⭐ 97 | 🐛 1 | 🌐 Lua | 📅 2023-10-26 - Starter boilerplate with lazy plugin manager.
